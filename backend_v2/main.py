...
from backend_v2.config import ALLOWED_ORIGINS, ALLOWED_ORIGIN_REGEX, CHAT_CONVERSATIONS_PATH, FRONTEND_DIR, PORT  # noqa: E402
from backend_v2.conversations import ConversationStore  # noqa: E402
from backend_v2.runtime import AnswerService  # noqa: E402
...
def main() -> None:
    ...
    uvicorn.run("backend_v2.main:app", host="127.0.0.1", port=PORT, reload=False)

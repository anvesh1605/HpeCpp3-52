...
3
AOS-CX10.09RESTv1APIGuide| (AllAOS-CXSeriesSwitches)
...
AOS-CX 10.09 REST v1 API Guide | (All AOS-CX Series Switches)
...
PATCH, and DELETE regardless of REST API mode. REST APIs that are required to support the Web UI or the
Network Analytics Engine expose POST, PUT, PATCH, or DELETE operations, even if the REST API access
...
| -------------- | --- | ------------- | --- | --- | --- |
8320,8325,8360,8400,10000SwitchSeries:Disabled

...
3
AOS-CX10.09IntroductiontotheWebUIGuide| (8xxxSwitchSeries)
...
|                                       | ViewinganESTProfile                    |         |           |          | 47  |
|                                       | AddinganddeletingaTAProfile            |         |           |          | 47  |
|                                       | EditingaTAProfile                      |         |           |          | 49  |
|                                       | Addinganddeletingacertificate          |         |           |          | 49  |
|                                       | Uploadingacertificate                  |         |           |          | 50  |
|                                       | Viewinganddownloadingacertificate      |         |           |          | 51  |
|                                       | Editingassociatedapplicationdetails    |         |           |          | 51  |
| SupportFilepage                       |                                        |         |           |          | 51  |
|                                       | Creatinganddeletingsupportfiles        |         |           |          | 53  |
|                                       | Downloadingasupportfile                |         |           |          | 53  |
| Finding                               | alert details                          | using   | the Web   | UI       | 55  |
| Working                               | with the                               | network | analytics | features | 58  |
| ViewingagentinformationusingtheWebUI  |                                        |         |           |          | 58  |
| WorkingwithanAnalyticstimeseriesgraph |                                        |         |           |          | 62  |
|                                       | Customizingdatadisplayedonthegraph     |         |           |          | 63  |
|                                       | Zoominginonthegraph                    |         |           |          | 64  |
|                                       | Downloadingthegraphasanimageor.csvfile |         |           |          | 65  |
|                                       | Viewinganalertonthegraph               |         |           |          | 65  |
ArubaNetworkAnalyticsEnginescripts,agents,andtroubleshootinginformation 69
| Support               | and Other          | Resources |     |     | 70  |
| --------------------- | ------------------ | --------- | --- | --- | --- |
| AccessingArubaSupport |                    |           |     |     | 70  |
| AccessingUpdates      |                    |           |     |     | 71  |
|                       | ArubaSupportPortal |           |     |     | 71  |
|                       | MyNetworking       |           |     |     | 71  |
...
AOS-CX 10.09 Introduction to the Web UI Guide | (8xxx Switch Series)
...
Selecting a row in the VLANs list, displays more information on the VLAN in the details pane. Details include:
VLAN mode, Admin State, Link State, and the associated LAG name.
...
Figure 22 Reboot confirmation dialog box
...
AOS-CX Web UI pages | 44

Figure 27 Connected Devices page
...
Figure 28 WebUI Overview Dashboard
...
| Figure30 | AlertspanelonAnalyticsDashboard |     |     |     |     |
| -------- | ------------------------------- | --- | --- | --- | --- |
...
Figure 32 Alert Details dialog box

To view the Action Result Output dialog box for an action, click the Output link.

Finding alert details using the Web UI | 56

Figure 33 Action Result dialog box
...
Figure 34 Analytics panel on Overview page
...
Figure 36 Agent Details panels example
...
Figure 39 Agent Details panel including graph
...
Figure 40 Graph with tooltip displayed
...
Figure 42 Zoom options portion of a graph
...
Figure 43 Graph with down arrow highlighted
...
Figure 44 Agent Details before navigating to an alert
...
Figure 45 Graph with alert but not metric for 1/1/3
...
Figure 46 Alert details box with View on Graph button displayed
...
Figure 47 Dialog box prompting you to clear a metric

a. Clear the selection box for the metrics you no longer want to show. For example:

Figure 48 Dialog box with 1/1/9 removed
...
Figure 49 Graph showing alert and metric 1/1/3

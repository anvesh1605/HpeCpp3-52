...
| Reboot                                                   | reasons                  |              |          | 27  |
| Event                                                    | Logs                     |              |          | 29  |
| Showingandclearingevents                                 |                          |              |          | 29  |
| Supportability                                           |                          | Copy         |          | 30  |
3
AOS-CX10.08DiagnosticsandSupportabilityGuide| (8320,8325,8360SwitchSeries)

| Supportabilitycopycommands         |                                  | 30  |
| ---------------------------------- | -------------------------------- | --- |
|                                    | copycheckpoint                   | 30  |
|                                    | copycommand-output               | 31  |
|                                    | copycore-dumpdaemon              | 32  |
|                                    | copycore-dumpkernel              | 33  |
|                                    | copycore-dumpkernel<STORAGE-URL> | 34  |
|                                    | copydiag-dumpfeature<FEATURE>    | 35  |
|                                    | copydiag-dumplocal-file          | 36  |
|                                    | copy<IMAGE>                      | 37  |
|                                    | copyrunning-config               | 38  |
|                                    | copyshow-techfeature             | 39  |
|                                    | copyshow-techlocal-file          | 40  |
|                                    | copystartup-config               | 41  |
|                                    | copysupport-files                | 42  |
|                                    | copysupport-fileslocal-file      | 44  |
|                                    | copysupport-log                  | 45  |
| Traceroute                         |                                  | 47  |
...
|                                    | ping6                            | 58  |
| Troubleshooting                    |                                  | 61  |
|                                    | Operationnotpermitted            | 61  |
|                                    | Networkisunreachable             | 62  |
|                                    | Destinationhostunreachable       | 62  |
| Remote                             | syslog                           | 63  |
| Remotesyslogcommands               |                                  | 63  |
|                                    | logging                          | 63  |
|                                    | loggingfilter                    | 65  |
|                                    | loggingfacility                  | 68  |
|                                    | loggingpersistent-storage        | 69  |
| Service                            | OS                               | 71  |
| ServiceOSCLIlogin                  |                                  | 71  |
| ServiceOSuseraccounts              |                                  | 72  |
| ServiceOSbootmenu                  |                                  | 72  |
| Consoleconfiguration               |                                  | 73  |
| AOS-CXboot                         |                                  | 73  |
| Filesystemaccess                   |                                  | 74  |
| ServiceOSmountfailure              |                                  | 75  |
| ServiceOSCLIcommandlist            |                                  | 75  |
| ServiceOSCLIfeaturesandlimitations |                                  | 76  |
| ServiceOSCLIcommands               |                                  | 76  |
|                                    | boot                             | 76  |
|                                    | cat                              | 77  |
|                                    | cdpath                           | 78  |
|                                    | config-clear                     | 78  |
...
|                                               | showselftest                             |           |             |            |        | 104 |
| Zeroization                                   |                                          |           |             |            |        | 107 |
| Zeroizationcommands                           |                                          |           |             |            |        | 107 |
|                                               | eraseallzeroize                          |           |             |            |        | 107 |
| Terminal                                      | Monitor                                  |           |             |            |        | 109 |
| Terminalmonitorcommands                       |                                          |           |             |            |        | 109 |
|                                               | loggingconsole{notify|severity|filter}   |           |             |            |        | 109 |
|                                               | showterminal-monitor                     |           |             |            |        | 110 |
|                                               | terminal-monitor{notify|severity|filter} |           |             |            |        | 111 |
| Troubleshooting                               |                                          | Web       | UI and REST | API Access | Issues | 113 |
| HTTP404errorwhenaccessingtheswitchURL         |                                          |           |             |            |        | 113 |
| HTTP401error"Loginfailed:sessionlimitreached" |                                          |           |             |            |        | 113 |
| Support                                       | and Other                                | Resources |             |            |        | 115 |
| AccessingArubaSupport                         |                                          |           |             |            |        | 115 |
| AccessingUpdates                              |                                          |           |             |            |        | 115 |
|                                               | ArubaSupportPortal                       |           |             |            |        | 115 |
|                                               | MyNetworking                             |           |             |            |        | 116 |
| WarrantyInformation                           |                                          |           |             |            |        | 116 |
| RegulatoryInformation                         |                                          |           |             |            |        | 116 |
...
AOS-CX 10.08 Diagnostics and Supportability Guide | (8320, 8325, 8360 Switch Series)
...
switch#
copy core-dump daemon ops-vland sftp://abc@10.0.14.211/vland_coredump.xz vrf
mgmt
Copyingthecoredumpfromdaemonops-vlandtoaremoteURLwithaVRFnamedmgmt:
...
local-filecommandbeforeyouenterthecopy
| diag-dump | <FEATURE-NAME> | basic |     |     |     | diag-dump | local- |
| --------- | -------------- | ----- | --- | --- | --- | --------- | ------ |

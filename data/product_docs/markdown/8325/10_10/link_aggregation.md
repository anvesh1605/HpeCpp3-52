...
| 8325,  | 8360,       | 8400, | 9300,10000 |       | Switch | Series |
...
AOS-CX 10.10 Link Aggregation Guide | (4100i, 6xxx, 8xxx, 9300, 10000 Switch Series)
...
|                                                           | Configuringalayer2dynamicaggregationgroup            | 21  |
...
5
AOS-CX10.10LinkAggregationGuide| (4100i,6xxx,8xxx,9300,10000SwitchSeries)
...
| lag                                 |                                |            | 48  |
| showinterface(LAG)                  |                                |            | 49  |
| showlacpaggregates(LAG)             |                                |            | 51  |
| showlacpconfiguration               |                                |            | 52  |
| showlacpinterfaces                  |                                |            | 52  |
| shutdown(interfacelag)              |                                |            | 55  |
| vlantrunknative(LAG)                |                                |            | 56  |
| Smartlink                           |                                |            | 59  |
| Guidelinesandlimitations            |                                |            | 59  |
| Smartlinkcommands                   |                                |            | 60  |
| Configurationcommands               |                                |            | 60  |
|                                     | smartlinkgroup                 |            | 60  |
|                                     | smartlinkrecv-control-vlan     |            | 61  |
| Groupcontextcommands                |                                |            | 61  |
|                                     | description(smartlinkgroup)    |            | 62  |
|                                     | diag-dumpsmartlinkbasic        |            | 62  |
|                                     | primary-port                   |            | 64  |
|                                     | smartlinkgroupsecondary-port   |            | 64  |
|                                     | control-vlan                   |            | 65  |
|                                     | protected-vlans                |            | 66  |
|                                     | preemption                     |            | 66  |
|                                     | preemption-delay               |            | 67  |
| Displaycommands                     |                                |            | 68  |
|                                     | showsmartlinkgroup             |            | 68  |
|                                     | showsmartlinkgroupall          |            | 69  |
|                                     | showsmartlinkgroupdetail       |            | 70  |
|                                     | showsmartlinkflush-statistics  |            | 71  |
|                                     | clearsmartlinkgroupstatistics  |            | 71  |
|                                     | clearsmartlinkflush-statistics |            | 72  |
|                                     | showrunning-config             |            | 73  |
| Supportabilitycommands              |                                |            | 74  |
|                                     | showcapacitiessmartlink        |            | 74  |
| UFD (Uplink                         | Failure                        | Detection) | 76  |
| Guidelinesandlimitations            |                                |            | 76  |
| BasicUFDconfiguration               |                                |            | 76  |
| UFD(UplinkFailureDetection)commands |                                |            | 77  |
| ufdenable                           |                                |            | 77  |
| ufdsession-id                       |                                |            | 78  |
| links-to-monitor                    |                                |            | 79  |
| links-to-disable                    |                                |            | 80  |
| delay                               |                                |            | 81  |
| showufd                             |                                |            | 82  |
| showcapacitiesufd                   |                                |            | 83  |
| showrunning-configufd               |                                |            | 84  |
| show-techufd                        |                                |            | 85  |
| debugufdall                         |                                |            | 86  |
|6
...
| ---------------------------------- | ------------------ | --------- | --- |
| AccessingHPEArubaNetworkingSupport |                    |           | 88  |
| AccessingUpdates                   |                    |           | 89  |
|                                    | ArubaSupportPortal |           | 89  |
|                                    | MyNetworking       |           | 89  |
| WarrantyInformation                |                    |           | 89  |
| RegulatoryInformation              |                    |           | 90  |
| DocumentationFeedback              |                    |           | 90  |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 7
...
Layer 3 aggregation groups are not supported on the 4100i, 6000, and 6100 Switch Series.
...
destination.
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 14
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 16
...
Current configuration:
!
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 20
...
| switch(config-lag-if)# | vlan trunk | native | 1   |
| ---------------------- | ---------- | ------ | --- |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 22
...
Layer3aggregationgroupsaresupportedonallswitchseriesexcept4100,6000and6100SwitchSeries.
...
aggregationgroupnumberedthesame.
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 24
...
| Aggregate mode                   | : Off         |             |                 |
For8320,8325,8360,8400,9300and10000switchseries:
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 26
...
| ---------------------- | --- | ---------- | ------------------ | --- |
Forexample:
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 28
...
Youmustbeintheglobalconfigurationcontext:switch(config)#.
Procedure
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 30
...
...
!
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 32
...
| switch(config-if)# | show running-config |       |
Current configuration:
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 34
...
| ------- | ------- | ----------- | ----------- | --------- |
Layer3aggregationgroupsarenotsupportedonthe4100i,6000,and6100SwitchSeries.
...
| --- | ---------------------- | --- | -------------- | --- |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 36
...
still available
Symptom
BFDisnotsupportedonthe4100i,6000,and6100SwitchSeries.
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 38
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 40
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 42
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 44
...
| 10.07orearlier      |     |                       | --           |
| Command Information |     |                       |              |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 46
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 48
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 50
...
Description
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 52
...
| 1/5/15  | lag2(mc) |     |                    |        |     |                   |     |         | down |
| Partner | details  |     | of all interfaces: |        |     |                   |     |         |      |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 54
...
VLANIDrange:2to4094.
Usage
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 56
...
| --- | ------------- | --- | --------------------- |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 58
...
| ----- | ------- | -------- | --- | --- | --- |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 61
...
6400
8360
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 63
...
| Command History             |           |     |              |     |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 65
...
Usage
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 67
...
| Platforms      |             | Command | context | Authority    |     |     |     |
6000 Operator(>)orManager OperatorsorAdministratorsorlocalusergroupmemberswith
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 69
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 71
...
| 10.07orearlier      |     |     |     | --           |     |
| Command Information |     |     |     |              |     |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 73
...
6400
8360
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 75
...
switch(config)#
DeletingUFDsession1:
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 78
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 80
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 82
...
| ------- | -------------- | -------------- | --- | --- | --- | --- | --- | --- |
| Current | configuration: |                |     |     |     |     |     |     |
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 84
...
AOS-CX10.10LinkAggregationGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 86

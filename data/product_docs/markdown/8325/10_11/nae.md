...
3
AOS-CX10.11NetworkAnalyticsEngineGuide| (6200,6300,6400,8xxx,9300,10000SwitchSeries)
...
| https-serverauthenticationcertificate |                           |           |               | 161 |
| https-serverauthenticationpassword    |                           |           |               | 162 |
| https-servermax-user-sessions         |                           |           |               | 163 |
| https-serverrestaccess-mode           |                           |           |               | 163 |
| https-serversessioncloseall           |                           |           |               | 164 |
| https-serversession-timeout           |                           |           |               | 165 |
| https-servervrf                       |                           |           |               | 166 |
| showhttps-server                      |                           |           |               | 167 |
| showhttps-serverauthentication        |                           |           |               | 168 |
...
AOS-CX 10.11 Network Analytics Engine Guide | (6200, 6300, 6400, 8xxx, 9300, 10000 Switch Series)
...
AOS-CX 10.11 Network Analytics Engine Guide | (6200, 6300, 6400, 8xxx, 9300, 10000 Switch
...
On the 83xx and 9300 Switch Series
...
Aruba Solution Exchange (ASE) is a utility that allows users to dynamically create configurations for
many Aruba products. The exchange offers a set of solutions certified by Aruba for specific use cases.

The collective knowledge of the Aruba community powers the Solution Exchange. All users are
encouraged to create solutions, modify existing ones, and suggest ideas for new solutions.

Access to the Aruba Solution Exchange is available at:

https://ase.arubanetworks.com/

No login is required to browse the exchange or look at information about solutions. Downloading
solutions or viewing solution source code is free for anyone with a valid user account with the Aruba
...
AOS-CX10.11NetworkAnalyticsEngineGuide| (6200,6300,6400,8xxx,9300,10000Switch
55
Series)
...
| Parameter |     |     |     | Description |
| --------- | --- | --- | --- | ----------- |
n authpriv:Setsthesyslogmessagesourceassecurity
subsystem.
n cron:Setsthesyslogmessagesourceascron
schedulersubsystem.
n ftp:SetsthesyslogmessagesourceasFTPdaemon.
[severity {debug | info | notice | Specifiestheseveritylevelforthesyslogmessage.The
| warning | | err | crit | | alert | | emer}] | severitylevelvaluesare: |
| ------- | ------------ | ------- | -------- | ----------------------- |
n debug:Setsthesyslogseveritylevelasdebug.
n info:Setsthesyslogseverityasinformation
(default).
notice:Setsthesyslogseverityasnotice.
n
n warning:Setsthesyslogseverityaswarning.
n err:Setsthesyslogseverityaserror.
n crit:Setsthesyslogseverityascritical.
n alert:Setsthesyslogseverityasalert.
n emer:Setsthesyslogseverityasemergency.
| <COMMAND> |     |     |     | SpecifiestheCLIcommandtobeexecutedwhentheset |
| --------- | --- | --- | --- | -------------------------------------------- |
conditionortheclearconditionismet.
Example
SettingthestatuslevelfortheNAE-Lite agentcondition:
...
| --- | ---------------------------- | --- | --- | --- | --- | --- | ---------------------------- |
n cpu:ConfigurestheCPU
|     | o system | {cpu | | memory} | {management-module |     | |   |     |
| --- | -------- | ---- | --------- | ------------------ | --- | --- | --- |
monitoring.
|     | line-module} |     | <SLOT-ID> |     |     |     |     |
| --- | ------------ | --- | --------- | --- | --- | --- | --- |
...
o system storage coredump line-module n management-module:Monitors
...
|     | system | storage | {nos | | security | | coredump | |   |     |
| --- | ------ | ------- | ---- | ---------- | ---------- | --- | --- |
o
...
For8320,8325,8360,and9300SwitchSeries:
| n   |          |      |           |     |     |     | utilization.           |
| --- | -------- | ---- | --------- | --- | --- | --- | ---------------------- |
|     | o system | {cpu | | memory} |     |     |     | n security:Monitorsthe |
o system storage {nos | security | coredump | securitystorageutilization.
coredump:Monitorsthe
|     | logs | | selftest} |     |     |     |     | n   |
| --- | ---- | ----------- | --- | --- | --- | --- | --- |
coredumpstorageutilization.
n logs:Monitorsthelogstorage
utilization.
selftest:Monitorstheself-
n
...
days: Sets the time interval in
days. Range: 1 to 365.
...
|          |              | monitor |     | avg_sys_cpu | resource | system cpu line-module | 1/4 |
| -------- | ------------ | ------- | --- | ----------- | -------- | ---------------------- | --- |
...
| ------------------------- | --- | ------- | --- | ---------------- | ------ | --- | --- |
ConfiguringthemonitorforcalculatingtheaverageCPUusageoverthe30minutesduration(8320,
8325,8360,and9300SwitchSeries):
...
switch(config-nae-agent)#
|         |                   | no  | set-condition | monitor line_mdl_state | transition | from |
| ------- | ----------------- | --- | ------------- | ---------------------- | ---------- | ---- |
| "ready" | to "down","error" |     |               |                        |            |      |
...
once in every specified count. Optional. For example, if you
want to monitor mac movement in the VLAN for every 10th
time, then the count must be specified as 10.
...
| --------- | --- | --- | ----------- |
<VRF-NAME>
SpecifiestheVRFname.Required.Length:Upto32alphanumeric
characters.
Usage
Byusingthiscommand,youenableaccesstoboththeWebUIandtotheRESTAPIonthespecifiedVRF.
YoucanenableaccessonmultipleVRFs.
Bydefault,8320,8325,8360,8400,and9300SwitchSerieshaveanHTTPSserverenabledonthemgmt
VRF.

...
| ------ | ------------ | ----- | ----- | ------ | ------ | ----- |
|        | Availability |       |       | Guide  |        |       |
| 4100i, | 6200,        | 6300, | 6400, | 8320,  | 8325,  | 8360, |
...
|                                            | bfddetect-multiplier                        | 28  |
|                                            | bfddisable                                  | 29  |
|                                            | bfdenable(Context:config-hsc)               | 30  |
|                                            | bfddisable(Context:config-hsc)              | 31  |
|                                            | bfdechodisable                              | 31  |
|                                            | bfdecho-src-ip-address                      | 32  |
|                                            | bfdmin-echo-receive-interval                | 33  |
|                                            | bfdmin-receive-interval                     | 34  |
|                                            | bfdmin-transmit-interval                    | 35  |
...
|                                            | neighborfall-overbfd(context:config-router) | 41  |
3
AOS-CX10.11HighAvailabilityGuide| (4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries)
...
|                                    | showhsc                                     |     | 46  |
| ERPS                               |                                             |     | 48  |
| Limitations,Conflicts,orExclusions |                                             |     | 49  |
| ERPSCommands                       |                                             |     | 50  |
|                                    | clearerpsring<RINGID>instance<ID>           |     | 50  |
|                                    | clearerpsstatistics                         |     | 51  |
|                                    | erpsring                                    |     | 52  |
|                                    | erpsring<RINGID><port0|port1>interface      |     | 53  |
|                                    | erpsring<RINGID>description                 |     | 54  |
|                                    | erpsring<RINGID>guard-interval              |     | 55  |
|                                    | erpsring<RINGID>hold-off-interval           |     | 56  |
|                                    | erpsring<RINGID>instance                    |     | 57  |
|                                    | erpsring<RINGID>instance<ID>control-vlan    |     | 58  |
|                                    | erpsring<RINGID>instance<ID>description     |     | 59  |
|                                    | erpsring<RINGID>instance<ID>enable          |     | 60  |
|                                    | erpsring<RINGID>instance<ID>protected-vlans |     | 61  |
...
|                       | erpsring<RINGID>meg-level             |           | 67  |
|                       | erpsring<RINGID>parent-ring           |           | 68  |
|                       | erpsring<RINGID>sub-ring              |           | 69  |
|                       | erpsring<RINGID>tcn-propogation       |           | 70  |
|                       | erpsring<RINGID>transmission-interval |           | 71  |
|                       | erpsring<RINGID>wtr-interval          |           | 72  |
|                       | showerpsstatistics                    |           | 73  |
|                       | showerpsstatus                        |           | 75  |
|                       | showerpssummary                       |           | 77  |
| Support               | and Other                             | Resources | 79  |
| AccessingArubaSupport |                                       |           | 79  |
| AccessingUpdates      |                                       |           | 80  |
...
AOS-CX 10.11 High Availability Guide | (4100i, 6200, 6300, 6400, 8xxx, 9300, 10000 Switch
...
AOS-CX 10.11 High Availability Guide | (4100i, 6200, 6300, 6400, 8xxx, 9300, 10000 Switch Series)
...
| 3. EnableBFDonaBGPinterfacewiththecommandneighbor |     |     |     |     | bfd. |
| ------------------------------------------------- | --- | --- | --- | --- | ---- |
fall-over
...
thoseonwhichBFDwasenabledattheinterfacelevelwiththecommandsip bfdandipv6
ospf
ospfv3 bfd.
Examples
...
| Command Information      |         |         |                    |           |
| Platforms                | Command | context |                    | Authority |
6300 config-ospf-<INSTANCE-TAG> Administratorsorlocalusergroupmemberswith
6400 config-ospfv3-<INSTANCE-TAG> executionrightsforthiscommand.
8320
8325
8360
8400

...
| Client                                            | Filter                                             | 33  |
3
AOS-CX10.12DiagnosticsandSupportabilityGuide| (8100,83xx,9300,10000SwitchSeries)
...
| Traffic                                          |                                  |           | 34  |
| ------------------------------------------------ | -------------------------------- | --------- | --- |
| Stepone:createatrafficclass                      |                                  |           | 34  |
| Steptwo:createapolicy                            |                                  |           | 35  |
| Stepthree:applythepolicy                         |                                  |           | 35  |
| Stepfour:confirmpolicyInstallation               |                                  |           | 36  |
| Stepfive:confirmpolicyresourceconsumption        |                                  |           | 36  |
| Stepsix:configureamirrorsession                  |                                  |           | 37  |
| Stepseven:startpacketcapture                     |                                  |           | 38  |
| Stepeight:capturepacketstoafileormirrorittoahost |                                  |           | 38  |
| Stepnine:checkpackethitcounts                    |                                  |           | 39  |
| Network                                          | Configuration                    | Validator | 41  |
| Showingandclearingevents                         |                                  |           | 41  |
| Networkconfigurationvalidationcommands           |                                  |           | 41  |
|                                                  | switchconfig-validator           |           | 41  |
| Cable Diagnostics                                |                                  |           | 43  |
| HowTDRworksonAOS-CXplatforms                     |                                  |           | 43  |
| Cablediagnosticstests                            |                                  |           | 43  |
| Cablediagnosticcommands                          |                                  |           | 44  |
|                                                  | diagcable-diagnostic             |           | 45  |
| Supportability                                   | Copy                             |           | 48  |
| TFTPVxLANSupport                                 |                                  |           | 48  |
| Supportabilitycopycommands                       |                                  |           | 48  |
|                                                  | copycheckpoint                   |           | 48  |
|                                                  | copycommand-output               |           | 49  |
|                                                  | copycore-dumpdaemon              |           | 51  |
|                                                  | copycore-dumpkernel              |           | 52  |
|                                                  | copycore-dumpkernel<STORAGE-URL> |           | 53  |
|                                                  | copycore-dumpdsm                 |           | 53  |
...
|                                                  | copystartup-config               |           | 61  |
|                                                  | copysupport-files                |           | 62  |
|                                                  | copysupport-fileslocal-file      |           | 64  |
|                                                  | copysupport-log                  |           | 65  |
| Traceroute                                       |                                  |           | 67  |
...
|                                     | Operationnotpermitted           |             | 82  |
| ----------------------------------- | ------------------------------- | ----------- | --- |
|                                     | Networkisunreachable            |             | 83  |
|                                     | Destinationhostunreachable      |             | 83  |
| Packet                              | forwarding                      | information | 85  |
| Packetforwardinginformationcommands |                                 |             | 85  |
|                                     | showforwarding-info             |             | 85  |
| Remote                              | syslog                          |             | 92  |
| SyslogoverVXLAN support             |                                 |             | 92  |
| Remotesyslogcommands                |                                 |             | 92  |
|                                     | clearaccounting-logs            |             | 92  |
|                                     | logging                         |             | 93  |
|                                     | loggingaccounting-format-native |             | 95  |
|                                     | loggingfilter                   |             | 96  |
|                                     | loggingfacility                 |             | 99  |
|                                     | loggingpersistent-storage       |             | 100 |
| Service                             | OS                              |             | 102 |
...
AOS-CX 10.12 Diagnostics and Supportability Guide | (8100, 83xx, 9300, 10000 Switch Series)
...
AOS-CX8360Switchseriescanuseaclassifierpolicytotroubleshootnetworkissuesbymirroring
packetsforcaptureandanalysis.
...
Using Classifier Policies with Mirror Action to Filter Captured Traffic | 35
...
Thefollowingexampleofshowstheoutputofashow resourcescommandissuedona6300switch:
...
ittoahost.
UsingClassifierPolicieswithMirrorActiontoFilterCapturedTraffic|37
...
|                  | 0   | 100 match |        | tcp any           | eq        | https     | any count      |          |
|                  | 0   | 110 match |        | tcp any           | any       | eq http   | count          |          |
UsingClassifierPolicieswithMirrorActiontoFilterCapturedTraffic|39
...
9300
10000
NetworkConfigurationValidator|42
...
switch#
|     | copy scp://root@20.0.1.1/primary.swi |     |     | primary vrf | mgmt |     |
| --- | ------------------------------------ | --- | --- | ----------- | ---- | --- |
...
switch#
|     |     | copy support-files |     | local-file |     | usb:/support_files_dir_path/ |
| --- | --- | ------------------ | --- | ---------- | --- | ---------------------------- |
64
AOS-CX10.12DiagnosticsandSupportabilityGuide| (8100,83xx,9300,10000SwitchSeries)
...
delays of packets across an Internet Protocol (IP) network. It sends a sequence of User Datagram
Protocol (UDP) packets addressed to a destination host. The time-to-live (TTL) value, also known as hop
limit, is used in determining the intermediate routers being traversed towards the destination.
...
Specifies the route for loose source record route. Enter one or
more intermediate router IP addresses separated by ',' for loose
source routing.
...
Packetforwardinginformation|88
...
| Command Information |         |         |              |
| Platforms           | Command | context | Authority    |
8100 ServiceOS(SVOS>) Administratorsorlocalusergroupmemberswithexecutionrights
| 8320 |     |     | forthiscommand. |
| ---- | --- | --- | --------------- |
8325
8360
...
| --------- | --- | --- | ----------- |
-p
Specifiestoremoveparentdirectories.
Example

...
AOS-CX 10.15.xxxx Introduction to the Web UI Guide | (8xxx, 9300, 10000 Switch Series)
...
|           | ConfigMgmtpage                      |                                                |        | 40  |
4
| AOS-CX10.15.xxxx | IntroductiontotheWebUIGuide| |     | (8xxx,9300,10000SwitchSeries) |     |
| ---------------- | ---------------------------- | --- | ----------------------------- | --- |
...
| ViewingagentinformationusingtheWebUI  |                                               |         |           |          | 63  |
| WorkingwithanAnalyticstimeseriesgraph |                                               |         |           |          | 67  |
|                                       | Customizingdatadisplayedonthegraph            |         |           |          | 68  |
|                                       | Zoominginonthegraph                           |         |           |          | 70  |
|                                       | Downloadingthegraphasanimageor.csvfile        |         |           |          | 70  |
|                                       | Viewinganalertonthegraph                      |         |           |          | 71  |
...
Shows: Virtual Switching Extension (VSX) information, including interswitch
link (ISL) state, configuration synchronization state, and the role of this
switch (primary or secondary). Clicking the link displays the VSX page.
...
If Virtual Switching Extension (VSX) is configured, the VSX page shows configuration and status
...
| Figure1 | SNMPPage |     |
| ------- | -------- | --- |
AOS-CX10.15.xxxx IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 34
...
AOS-CX10.15.xxxx IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 38
...
AOS-CX10.15.xxxx IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 44
...
| ------- | -------------------- | --- | --- |
AOS-CX10.15.xxxx IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 50
...
addintheswitch.Youcannotuploadacertificateforthedevice-identityregularcertificateandifthe
certificatestatusisinstalled.
ThesignedcertificatethatyouuploadmustcontainPEMdatainthefollowingchainformat:
| -----BEGIN | CERTIFICATE----- |     |     |
| ---------- | ---------------- | --- | --- |
| -----END   | CERTIFICATE----- |     |     |
| -----BEGIN | CERTIFICATE----- |     |     |
...
| ------- | ---------- | ----------- | ------- |
AOS-CX10.15.xxxx IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 56
...
Working with the network analytics features | 64
...
Workingwiththenetworkanalyticsfeatures|70

...
AOS-CX 10.10 Multicast Guide | (4100i, 6000, 6100 Switch Series)
...
|                                                  | showipigmpinterfacegroups            |          |        | 40  |
|                                                  | showipigmpinterfacestatistics        |          |        | 41  |
|                                                  | showipigmpstatic-groups              |          |        | 42  |
|                                                  | showipigmpstatistics                 |          |        | 43  |
5
AOS-CX10.10MulticastGuide| (4100i,6000,6100SwitchSeries)
...
|                                    | ipv6mldrobustness    |           | 87  |
| ---------------------------------- | -------------------- | --------- | --- |
|                                    | ipv6mldstatic-group  |           | 87  |
|                                    | ipv6mldversion       |           | 88  |
|                                    | ipv6mldversionstrict |           | 89  |
| Support                            | and Other            | Resources | 90  |
| AccessingHPEArubaNetworkingSupport |                      |           | 90  |
| AccessingUpdates                   |                      |           | 91  |
|                                    | ArubaSupportPortal   |           | 91  |
|                                    | MyNetworking         |           | 91  |
| WarrantyInformation                |                      |           | 91  |
| RegulatoryInformation              |                      |           | 92  |
| DocumentationFeedback              |                      |           | 92  |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 7
...
n Make sure that the IGMP querier is enabled. (In IGMPv3 the IGMP querier is enabled by default.)
Configure the IGMP querier on an interface using the following command: ip igmp querier.

n Configure the IGMP querier interval on an interface using the following command: ip igmp querier

interval

<INTERVAL-VALUE>. The interval is from 5-300 seconds, with a default of 125.

n Configure the IGMP last member query interval value in seconds on an interface using the following

command: ip igmp last-member-query-interval

<INTERVAL-VALUE>. The interval is from 1-2 seconds, with a default of 1.

n Configure the IGMP max response time value in seconds on an interface using the following

command: ip igmp querier query-max-response-time <RESPONSE-TIME>. The response time is
from 10-128 seconds, with a default of 10.

n Configure the IGMP robustness (the number of times to retry a query) on an interface using the

following command: ip igmp robustness <VALUE>. The robustness value is from 1-7 with default of
2.
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 20
...
| --------- | --- | --- | --- | --- | ----------- | --- | --- |
<INTERVAL-VALUE>
SpecifiesanIGMPlast-member-query-intervalontheinterface.
Default:1second.Range:1-2seconds.
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 22
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 24
...
Description
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 26
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 28
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 30
...
(#)
commandfromtheoperatorcontext(>)only.
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 32
...
| 0m             | 59s 3m    | 21s        |     |     |     |     |
| Command        | History   |            |     |     |     |     |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 34
...
| ------- | ------- | ------ | --- | --- | --- | --- |
| Command | History |        |     |     |     |     |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 36
...
| Packets    | dropped  |         | by ACL         |         |      |            | 0             | N/A           |
| Command    | History  |         |                |         |      |            |               |               |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 38
...
|           |          |             |              |       | V1        | V2     | Sources   | Sources |
| Vers      | Mode     | Uptime      | Expires      |       | Timer     | Timer  | Forwarded | Blocked |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 40
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 42
...
| --- | --- | --- | ----------------------------------------------------- |
commandfromtheoperatorcontext(>)only.
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 44
...
| blocked <PORT-LIST>. |     |     |     |     |     |
| -------------------- | --- | --- | --- | --- | --- |
n Configurethespecifiedportsinforwardmodeusingthefollowingcommand:ip
igmp snooping
forward
<PORT-LIST>.
...
Prerequisites
YoumustbeintheVLANconfigurationcontext,asindicatedbytheswitch(config-vlan)#prompt.
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 49
...
port.
ToviewIGMPsnoopingstaticgroupsdetailsforthespecifiedVLAN,use:show
n ip igmp snooping
static-groups.
| IGMP         | snooping |                            | commands |     |       |
| ------------ | -------- | -------------------------- | -------- | --- | ----- |
...
| 10.07orearlier |     | --           |     |
Command Information
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 51
...
| switch(config-if)# | no shut    |     |     |
| switch(config-if)# | no routing |     |     |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 53
...
| ------------ | --- | ---------------------- | --- | --- | ------------------------------ | --- |
| static-group |     | <MULTICAST-IP-ADDRESS> |     |     |                                |     |
ThisparameterconfiguresanIGMPsnoopingstaticmulticast
...
| show ip igmp | snooping |     |     |     |
| ------------ | -------- | --- | --- | --- |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 55
...
vlan <vlan-id> parameter to display information for groups on
a specific VLAN.
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 57
...
ConfiguringtheACLtoremovetherulessetinaccesslistmygroup:
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 61
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 63
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 65
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 67
...
| Source        | Type :         | Filter    |                  |     |      |     |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 69
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 71
...
Example
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 73
...
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 75
...
Example
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 77
...
| --------- | ---- | --------- | --- | --- | --- | --- | --- |
| VRF Name  |      | : default |     |     |     |     |     |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 81
...
| -------------------- | ------- | --- | --- | -------- | ----- | ----------- | --- | ------- |
| Command              | History |     |     |          |       |             |     |         |
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 83
...
ThiscommandconfiguresMLDlastmemberqueryintervalvalueinseconds.Thedefaultinterval-value
is1second.
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 85
...
| ipv6 mld static-group |              | <multicast-group-ip> |     |     |     |
Description
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 87
...
Allplatforms config-if Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.10MulticastGuide|(4100i,6000,6100SwitchSeries) 89

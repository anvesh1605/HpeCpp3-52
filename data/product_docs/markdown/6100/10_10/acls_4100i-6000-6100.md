...
AOS-CX 10.10 ACLs and Classifier Policies Guide | (4100i, 6000, 6100 Switch Series)
...
|                                                           | showaccess-listhitcountscontrol-plane  |       | 62  |
|                                                           | showcapacities                         |       | 63  |
...
|                          | classresequence                                   |     | 93  |
|                          | classreset                                        |     | 94  |
|                          | clearpolicyhitcounts                              |     | 95  |
5
AOS-CX10.10ACLsandClassifierPoliciesGuide| (4100i,6000,6100SwitchSeries)

|                                         | policy             |               |          |                | 96  |
| --------------------------------------- | ------------------ | ------------- | -------- | -------------- | --- |
|                                         | policycopy         |               |          |                | 100 |
|                                         | policyresequence   |               |          |                | 101 |
|                                         | policyreset        |               |          |                | 102 |
|                                         | showclass          |               |          |                | 103 |
|                                         | showpolicy         |               |          |                | 104 |
| Classifier                              | policies           | configuration | example  |                | 109 |
| Configuringtheclassifierpoliciesexample |                    |               |          |                | 109 |
| ACL and                                 | Policy             | hardware      | resource | considerations | 112 |
| TCAMlookups                             |                    |               |          |                | 112 |
| Matchingprecedenceorder                 |                    |               |          |                | 112 |
| L4portranges                            |                    |               |          |                | 113 |
| Contextgroupselectors                   |                    |               |          |                | 113 |
| ACLandPolicyhardwareresourcecommands    |                    |               |          |                | 114 |
|                                         | showresources      |               |          |                | 114 |
...
| -------------- | --- | ---- | ----------- | ---------------- | --- | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 12
...
Showing all IPv6 ACLs

show access-list

show access-list ipv6
...
show access-list interface 1/1/1
...
show access-list hitcounts ip MY_ACL vlan 10
...
| access-list     |        | ip TEST_ACL |               |             |     |          |               |
| 10              | permit | tcp         | 172.16.2.0/16 |             | any | ack      |               |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 14
...
YoumayseeaminordiscrepancybetweentheACLloggingstatisticsandthehitcountsstatisticsdue
n
...
| ------- | ---------- | ------------ | ---- | --- |
| switch# | show debug |              |      |     |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 16
...
|                        | Source      | IP          | Address          |         |           | Source          | L4 Port(s) |
|                        | Destination |             | IP               | Address |           | Destination     | L4 Port(s) |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 18
...
|     | QoS | Priority | Code Point: | 4   |     |
| --- | --- | -------- | ----------- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 20
...
Specifies the port, or port range. Port numbers are in the range of 0
...
| Parameter        |     | Description |     |     |
| ---------------- | --- | ----------- | --- | --- |
| PORT><MAX-PORT>] |     | to65535.    |     |     |
n eq <PORT>-specifiestheLayer4port.
n gt <PORT>-specifiesanyLayer4portgreaterthantheindicated
port.
n lt <PORT>-specifiesanyLayer4portlessthantheindicated
port.
n range <MIN-PORT> <MAX-PORT>-specifiestheLayer4port
range.
NOTE:UponapplicationoftheACL,ACEswithL4portrangesmay
...
NOTE:
This parameter cannot be used in any ACL that will be applied
to a VLAN.
...
any
172.16.1.0/255.255.255.0
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 26
...
|     | permit |     | udp |     |
| --- | ------ | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 28
...
| no <SEQUENCE-NUMBER> |     | comment               |     |     |
Description
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 30
...
o <PREFIX-LENGTH> - specifies the address bits to mask

(CIDR subnet mask notation). Range: 1 to 128.
...
| Type                     | Name    |         |             |        |            |     |
| Sequence                 | Comment |         |             |        |            |     |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 34
...
| Command | History |     |     |     |     |     |
| ------- | ------- | --- | --- | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 36
...
1122.3344.5566/ffff.ffff.0000
any
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 40
...
| Command | History |     |     |     |
| ------- | ------- | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 42
...
|     | QoS | Priority | Code | Point: | 4   |     |     |
| --- | --- | -------- | ---- | ------ | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 44
...
% run 'access-list TYPE NAME reset' to reset access-list to match active
configuration.
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 46
...
Usage
n EachACLofagiventypecanbeappliedtothesameinterfaceorLAGonce.Therefore,usingthe
access-listcommandonaninterfaceorLAGwithanalready-appliedACLofthesametype
apply
willreplacethecurrentlyappliedACL.
...
ip|ipv6|mac SpecifiestheACLtype:ipforIPv4,ipv6forIPv6,ormacforMAC
ACL.
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 50
...
| Command | History |     |     |     |
| ------- | ------- | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 52
...
n All IPv4 or IPv6 ACLs applied to interface VLANs.
...
|     |     | QoS Priority | Code Point: | 4   |     |     |     |
| --- | --- | ------------ | ----------- | --- | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 56
...
------------------------------------------------------------------------------
IPv6 My_ipv6_ACL
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 58
...
|     |     | 0   | implicit | deny any any | any count |     |     |
| --- | --- | --- | -------- | ------------ | --------- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 60
...
| Command | History |     |     |     |     |     |
| ------- | ------- | --- | --- | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 62
...
| ------- | ---------------- | -------- | --- | ------------ | --- | ----------- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 64
...
Formoreinformationonfeaturesthatusethiscommand,refertotheACLsandClassifiersPolicyGuideforyour
switchmodel.
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 66
...
for ingress.
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 72
...
| -------------- | ------------- | ------------- | --------- | --- | --- |
Whenper-interfaceisincluded,uniqueinstancesofthepolicyareappliedtoeachphysical
n
...
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 74
...
| --- | ------------- | --- | --- | --------------------- | --- | --- | --- | --- |
config-vlan
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 76
...
any
any
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 78
...
Parameter Description
7)
n EF-DSCP46(Expedited
Forwarding)
ip-precedence <IP-PRECEDENCE-VALUE> SpecifiesanIPprecedencevalue.
Range:0to7.
...
|     | 20 ignore |     | udp |     |
| --- | --------- | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 84
...
| [tos <TOS-VALUE>]       |              | [fragment] |                | [vlan | <VLAN-ID>]             | [count] |
no <SEQUENCE-NUMBER>
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 86
...
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 90
...
Allplatforms Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 92
...
| Parameter |     |     |     |     | Description |     |
| --------- | --- | --- | --- | --- | ----------- | --- |
{ all | ip <CLASS-NAME>| ipv6 <CLASS-NAME>} Specifieseitherallclassesberesetorspecifies
thetype(ipforIPv4,oripv6forIPv6)andname
oftheclasstobereset.
Examples
Resettingtheuser-specifiedconfigurationtotheactiveconfiguration:
| switch(config)# |     | class | all reset |     |     |     |
| --------------- | --- | ----- | --------- | --- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 94
...
orderedandprioritizedbysequencenumbers.EachentryhasanIPv4/IPv6classandzeroormore
...
asfollows:
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 96
...
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 98
...
Examples
Copyingapolicy:
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 100
...
| switch(config)# | policy | MY_POLICY | reset |     |
| --------------- | ------ | --------- | ----- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 102
...
| Parameter |     |     | Description |     |
| --------- | --- | --- | ----------- | --- |
[ip | ipv6] Selectstheclasstypeforthedisplay:ipforIPv4,ipv6forIPv6.
...
|     |     |     |     | vlan | <VLAN-ID> | [in]] |     |     |
| --- | --- | --- | --- | ---- | --------- | ----- | --- | --- |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 104
...
| 10 class   | ip      | My_ip_Class |               |       |           |         |       |
|            |         |             | 0 10          | match | tcp any   | any ack | count |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 106
...
(#)
commandfromtheoperatorcontext(>)only.
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 108
...
| --------------- | ------ | --------------- | --- | --- | --- |
Classifierpoliciesconfigurationexample|110
...
| interface 1/1/1 |                 |            |      |                    |
| apply policy    | RATE_LIMIT_HTTP | in         |      |                    |
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 111
...
ACLandPolicyhardwareresourceconsiderations|113
...
n Policers
Usage
AOS-CX10.10ACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 114

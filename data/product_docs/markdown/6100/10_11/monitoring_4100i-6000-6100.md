...
| L1-100Mbps                    |                 | downshift    |          | 31  |
| Limitationswithspeeddownshift |                 |              |          | 31  |
| L1-100Mbpsdownshiftcommands   |                 |              |          | 31  |
|                               | downshiftenable |              |          | 31  |
3
AOS-CX10.11MonitoringGuide| (4100i,6000,6100SwitchSeries)

|                                                  | showinterface                     |            | 32  |
| ------------------------------------------------ | --------------------------------- | ---------- | --- |
|                                                  | showinterfacedownshift-enable     |            | 36  |
|                                                  | showrunning-configinterface       |            | 37  |
| Mirroring                                        |                                   |            | 39  |
| Mirrorstatistics                                 |                                   |            | 39  |
...
|                                                  | showmirror                        |            | 46  |
|                                                  | sourceinterface                   |            | 48  |
| Monitoring                                       | a device                          | using SNMP | 51  |
| Power-over-Ethernet                              |                                   |            | 52  |
| PoEcommands                                      |                                   |            | 53  |
|                                                  | lldpdot3poe                       |            | 53  |
|                                                  | lldpmedpoe                        |            | 54  |
|                                                  | power-over-ethernet               |            | 54  |
|                                                  | power-over-ethernetallocate-by    |            | 55  |
|                                                  | power-over-ethernetalways-on      |            | 56  |
|                                                  | power-over-ethernetassigned-class |            | 57  |
|                                                  | power-over-ethernetpre-std-detect |            | 58  |
|                                                  | power-over-ethernetpriority       |            | 59  |
|                                                  | power-over-ethernetquick-poe      |            | 59  |
|                                                  | power-over-ethernetthreshold      |            | 60  |
|                                                  | power-over-ethernettrap           |            | 61  |
|                                                  | showlldplocal                     |            | 62  |
|                                                  | showlldpneighbor                  |            | 63  |
|                                                  | showpower-over-ethernet           |            | 64  |
| Aruba                                            | AirWave                           |            | 66  |
| SNMPsupportandAirWave                            |                                   |            | 66  |
|                                                  | SNMPontheswitch                   |            | 66  |
| SupportedfeatureswithAirWaveandtheAOS-CXswitch   |                                   |            | 67  |
| ConfiguringtheAOS-CXswitchtobemonitoredbyAirWave |                                   |            | 67  |
| AirWavecommands                                  |                                   |            | 68  |
|                                                  | logging                           |            | 68  |
|                                                  | snmp-servercommunity              |            | 70  |
|                                                  | snmp-serverhost                   |            | 71  |
|                                                  | snmp-servervrf                    |            | 73  |
|                                                  | snmpv3context                     |            | 73  |
|                                                  | snmpv3user                        |            | 74  |
...
AOS-CX 10.11 Monitoring Guide | (4100i, 6000, 6100 Switch Series)

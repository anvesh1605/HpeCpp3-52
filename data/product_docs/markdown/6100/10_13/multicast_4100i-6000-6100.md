...
AOS-CX 10.13 Multicast Guide | (4100i, 6000, 6100 Switch Series)
...
| Multicastprotocols                               |                                      |          |        | 11  |
| Multicastaddresses                               |                                      |          |        | 12  |
| Importantconsiderations                          |                                      |          |        | 12  |
| Internet                                         | Group Management                     | Protocol | (IGMP) | 14  |
| IGMPdefaults,protocols,andsupportedconfiguration |                                      |          |        | 14  |
| HowtheIGMPprotocolworks                          |                                      |          |        | 14  |
| ConsiderationswhenconfiguringIGMP                |                                      |          |        | 15  |
| IGMPconfigurationtasklist                        |                                      |          |        | 16  |
| EnablingordisablingIGMP                          |                                      |          |        | 16  |
| SpecifyingtheIGMPversion                         |                                      |          |        | 16  |
| ConfiguringIGMPstaticgroups                      |                                      |          |        | 17  |
| ConfiguringIGMPqueryandresponseparameters        |                                      |          |        | 17  |
| DisablingIGMP                                    |                                      |          |        | 18  |
| ViewingIGMPinformation                           |                                      |          |        | 18  |
| IGMPconfigurationexample                         |                                      |          |        | 19  |
| IGMPcommands                                     |                                      |          |        | 20  |
|                                                  | ipigmp                               |          |        | 20  |
|                                                  | ipigmpapplyaccess-list               |          |        | 21  |
|                                                  | ipigmplast-member-query-interval     |          |        | 22  |
|                                                  | ipigmpquerier                        |          |        | 23  |
|                                                  | ipigmpquerierinterval                |          |        | 24  |
|                                                  | ipigmpquerierquery-max-response-time |          |        | 25  |
|                                                  | ipigmprobustness                     |          |        | 26  |
|                                                  | ipigmprouter-alert-check             |          |        | 27  |
|                                                  | ipigmpstatic-group                   |          |        | 27  |
|                                                  | ipigmpversion                        |          |        | 28  |
|                                                  | ipigmpversionstrict                  |          |        | 29  |
|                                                  | noipigmp                             |          |        | 30  |
|                                                  | showipigmp                           |          |        | 30  |
|                                                  | showipigmpcounters                   |          |        | 31  |
|                                                  | showipigmpgroup                      |          |        | 33  |
|                                                  | showipigmpgroups                     |          |        | 35  |
|                                                  | showipigmpinterface                  |          |        | 37  |
|                                                  | showipigmpinterfacecounters          |          |        | 38  |
|                                                  | showipigmpinterfacegroup             |          |        | 39  |
|                                                  | showipigmpinterfacegroups            |          |        | 41  |
|                                                  | showipigmpinterfacestatistics        |          |        | 42  |
|                                                  | showipigmpstatic-groups              |          |        | 43  |
|                                                  | showipigmpstatistics                 |          |        | 44  |
5
AOS-CX10.13MulticastGuide| (4100i,6000,6100SwitchSeries)
...
|                                    | ipv6mldlast-member-query-interval     |           | 91  |
|                                    | ipv6mldquerierquery-max-response-time |           | 92  |
|                                    | ipv6mldrobustness                     |           | 92  |
|                                    | ipv6mldstatic-group                   |           | 93  |
|                                    | ipv6mldversion                        |           | 94  |
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 7
...
router pim
enable
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 13
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 18
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 22
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 24
...
Allplatforms config-if-vlan Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 26
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 28
...
Configures an IGMP strict version on an interface, depending on the command context you are in.
Drops packets that do not match the configured version.
...
Specifies the IGMP version on the interface. Select 2 for IGMPv2
(RFC2236). Select 3 for IGMPv3 (RFC3376). Values: 2 or 3.
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 30
...
| Release        |          |          |           | Modification |               |               |
| 10.07orearlier |          |          |           | --           |               |               |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 32
...
| Group Address | :         | 239.1.1.10 |     |     |     |     |
| Source        | Address : | 10.1.1.10  |     |     |     |     |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 34
...
| Group Address |             | : 239.1.1.11 |                  |     |     |     |
| Last Reporter |             | : 100.1.1.10 |                  |     |     |     |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 36
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 38
...
| -------------- | ----------- | --- | --- | --- | --- | --- |
| Command        | Information |     |     |     |     |     |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 40
...
| Command   | History    |         |                |     |                   |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 42
...
| Release         |                   |               | Modification |
| 10.07orearlier  |                   |               | --           |
InternetGroupManagementProtocol(IGMP)|43
...
| 10.07orearlier  |             |           |            | --           |
| Command         | Information |           |            |              |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 44
...
| Disabling            | IGMP | snooping         |      |                   |     |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 50
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 52
...
| access-list |     |     |     |     | AssociatesanACLwiththeIGMP. |     |
enable|disable
EnablesordisablesIGMPsnoopingontheVLAN.Bydefault,
...
| version | <2-3> |     |     |     |     |     |
| ------- | ----- | --- | --- | --- | --- | --- |
ConfigurestheIGMPsnoopingversionontheVLAN.Select2
forIGMPv2(RFC2236).Select3forIGMPv3(RFC3376).
Usage
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 56
...
On the 4100i, 6000, and 6100 switch series, a single starg entry is programmed in advance for each join
received and data driven programming of SG entries occurs when the traffic is received from a specific
source for this group. As a result, the starg entry is used to forward the initial traffic and the SG entries
programmed in the multicast forwarding table are used to forward subsequent traffic to all of the
clients (that have sent either IGMPv2 joins or IGMPv3 joins) for all of the active joins in the feature
enabled VLANs.
...
| --------------- | --- | ---- | --- | --- | --- |
switch(config-vlan-2)#
|     |     |     | ip igmp | snooping preprogram-starg | flow enable |
| --- | --- | --- | ------- | ------------------------- | ----------- |
Disablepreprogrammingmulticaststargflows:
| switch(config)# |     | vlan | 2   |     |     |
| --------------- | --- | ---- | --- | --- | --- |
...
errorpacketcounters.
detail
ShowsIGMPSnoopingdetailsforallVLANs,includingjoinedports
...
| no ... |     |     | Negatesanyconfiguredparameter. |
| ------ | --- | --- | ------------------------------ |
packet-exceptions TroubleshootissuesinL2multicastbridgeentriesfordatapackets
forwardedtotheCPU.
static-groups ShowsMLDsnoopingstaticgroupdetails,includingthenumberof
staticgroupsjoined.
statistics
ShowsMLDsnoopingstatistics.
vlan <vlan-id> ShowsIGMPsnoopingprotocolinformationandnumberof
differentgroupsjoinedfortheVLAN.
group
ShowsIGMPsnoopinggroupinformationforthespecifiedVLAN,
includingthenumberofdifferentgroupsjoinedfortheVLAN.
IdentifythegroupbyIP addressorinterfacename.
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 60
...
| --- | --- | --- | ----------------------------------------------------- | --- | --- | --- |
commandfromtheoperatorcontext(>)only.
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 62
...
ConfiguringtheACLtoremovetherulessetinaccesslistmygroup:
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 65
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 67
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 69
...
This command configures the preprogramming of the starg flow feature on MLD snooping enabled
VLANs.
...
source for this group. As a result, the starg entry is used to forward the initial traffic and the SG entries
programmed in the multicast forwarding table are used to forward subsequent traffic to all of the
clients (that have sent either MLDv2 joins or MLDv3 joins) for all of the active joins in the feature
enabled VLANs.
...
Allplatforms config-vlan-<VLAN-ID> Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 73
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 75
...
theparticularACLname.
ThenoformofthiscommanddisablestherulessetfortheACL.
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 77
...
Description
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 79
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 81
...
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 83
...
executionrightsforthiscommand.Operatorscanexecutethis
commandfromtheoperatorcontext(>)only.
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 87
...
ThiscommandremovesallMLDconfigurationsontheinterface.
Example
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 89
...
| --------------- | --- | ------- | --- | -------------------------- | --- |
| Command History |     |         |     |                            |     |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 91
...
| Command History    |     |           |      |              |     |         |
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 93
...
Allplatforms config-if Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.13MulticastGuide|(4100i,6000,6100SwitchSeries) 95

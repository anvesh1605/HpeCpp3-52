...
Switch and port LEDs for 6000 Switch Series and 6100 Switch Ser-
| ies                                    |                               |              |          | 11  |
| -------------------------------------- | ----------------------------- | ------------ | -------- | --- |
| Alarms                                 |                               |              |          | 13  |
| Alarmcommands                          |                               |              |          | 13  |
...
|                                        | downshiftenable               |              |          | 26  |
|                                        | showinterface                 |              |          | 27  |
|                                        | showinterfacedownshift-enable |              |          | 29  |
|                                        | showrunning-configinterface   |              |          | 30  |
| Mirroring                              |                               |              |          | 33  |
| Mirrorstatistics                       |                               |              |          | 33  |
| Classifierpoliciesandmirroringsessions |                               |              |          | 33  |
| Mirroringcommands                      |                               |              |          | 34  |
|                                        | clearmirror                   |              |          | 34  |
|                                        | comment                       |              |          | 34  |
3
AOS-CX10.08MonitoringGuide| (4100i,6000,6100SwitchSeries)

|                                                  | destinationcpu                    |            | 35  |
| ------------------------------------------------ | --------------------------------- | ---------- | --- |
|                                                  | destinationinterface              |            | 36  |
|                                                  | diagnostic                        |            | 37  |
|                                                  | disable                           |            | 38  |
|                                                  | enable                            |            | 39  |
|                                                  | mirrorsession                     |            | 40  |
...
|                                                  | sourceinterface                   |            | 42  |
|                                                  | sourcevlan                        |            | 44  |
| Monitoring                                       | a device                          | using SNMP | 46  |
| Power-over-Ethernet                              |                                   |            | 47  |
| PoEcommands                                      |                                   |            | 48  |
|                                                  | lldpdot3poe                       |            | 48  |
|                                                  | lldpmedpoe                        |            | 49  |
|                                                  | power-over-ethernet               |            | 49  |
|                                                  | power-over-ethernetallocate-by    |            | 50  |
|                                                  | power-over-ethernetalways-on      |            | 51  |
|                                                  | power-over-ethernetassigned-class |            | 52  |
|                                                  | power-over-ethernetpre-std-detect |            | 53  |
|                                                  | power-over-ethernetpriority       |            | 54  |
|                                                  | power-over-ethernetquick-poe      |            | 54  |
|                                                  | power-over-ethernetthreshold      |            | 55  |
|                                                  | power-over-ethernettrap           |            | 56  |
|                                                  | showlldplocal                     |            | 57  |
|                                                  | showlldpneighbor                  |            | 58  |
|                                                  | showpower-over-ethernet           |            | 59  |
| Aruba                                            | AirWave                           |            | 61  |
| SNMPsupportandAirWave                            |                                   |            | 61  |
|                                                  | SNMPontheswitch                   |            | 61  |
| SupportedfeatureswithAirWaveandtheAOS-CXswitch   |                                   |            | 62  |
| ConfiguringtheAOS-CXswitchtobemonitoredbyAirWave |                                   |            | 62  |
|                                                  | logging                           |            | 63  |
|                                                  | snmp-servercommunity              |            | 65  |
|                                                  | snmp-serverhost                   |            | 66  |
|                                                  | snmp-servervrf                    |            | 68  |
|                                                  | snmpv3context                     |            | 68  |
|                                                  | snmpv3user                        |            | 69  |
| Support                                          | and Other                         | Resources  | 72  |
| AccessingArubaSupport                            |                                   |            | 72  |
| AccessingUpdates                                 |                                   |            | 72  |
|                                                  | ArubaSupportPortal                |            | 72  |
|                                                  | MyNetworking                      |            | 73  |
| WarrantyInformation                              |                                   |            | 73  |
...
AOS-CX 10.08 Monitoring Guide | (4100i, 6000, 6100 Switch Series)
...
|     |     |        |          |          | Chapter  | 3      |
| --- | --- | ------ | -------- | -------- | -------- | ------ |
|     |     | Switch | and port | LEDs     | for 6000 | Switch |
|     |     |        | Series   | and 6100 | Switch   | Series |
Switch and port LEDs for 6000 Switch Series and 6100 Switch Series
Table1:SwitchandportLEDs
Table2:SwitchandportLEDs:Labelsanddescription
Label Description
1 ManagementConsoleLED
2 SwitchportLEDsBackModulestatusLED
3 PoEmodeselected
4 SpeedmodeselectedLED
5 UID(UnitIdentification)ResetbuttonUsrmodeselectedLED
6 GlobalStatusLED
7 Resetbutton
8 LEDModestatusLED
9 USB-CConsoleport
Table3:FrontPanelLEDbehavior
...
|     | 6200F/6300Fswitches) |     |     | thebackofthechassis |     |     |
| --- | -------------------- | --- | --- | ------------------- | --- | --- |
11
AOS-CX10.08MonitoringGuide| (4100i,6000,6100SwitchSeries)
...
| --- | --- | -------- | ------------------------- |
temperaturelimit)
*PresstheModeSelectbuttontoswitchbetweenUser(default),PoE,orSpd.
Table4:RearPanelLEDbehavior
...
| --- | --- | --------------- | ----------------------- |
warning
SwitchandportLEDsfor6000SwitchSeriesand6100SwitchSeries|12
...
| extended  |     |     | Displaysthephysicalconnectioninfointabularformat. |     |
| non-zero  |     |     | Displaysonlynonzerostatistics.                    |     |
| LAG       |     |     | DisplaysLAGinterfaceinformation.                  |     |
| LOOPBACK  |     |     | Displaysloopbackinterfaceinformation.             |     |
| TUNNEL    |     |     | Displaystunnelinterfaceinformation.               |     |

...
| VSFpage                             |                                                |               | 35  |
| VSXpage                             |                                                |               | 36  |
| Environmentalpage                   |                                                |               | 37  |
| Logpage                             |                                                |               | 38  |
| NameServerpage                      |                                                |               | 39  |
| SNMPpage                            |                                                |               | 40  |
|                                     | AddinganddeletinganSNMPv3user                  |               | 41  |
3
AOS-CX10.08WebUIGuide|

|                                       | EditinganSNMPv3user                                  |         |           |          | 41  |
| ------------------------------------- | ---------------------------------------------------- | ------- | --------- | -------- | --- |
|                                       | AddinganddeletinganSNMPcommunity                     |         |           |          | 42  |
|                                       | AddinganddeletinganSNMPtrapreceiver                  |         |           |          | 42  |
|                                       | EditinganSNMPtrapreceiver                            |         |           |          | 43  |
| Sessionpage                           |                                                      |         |           |          | 43  |
| ConfigMgmtpage                        |                                                      |         |           |          | 45  |
| FirmwareUpdatepage                    |                                                      |         |           |          | 46  |
| Pingpage                              |                                                      |         |           |          | 47  |
| Traceroutepage                        |                                                      |         |           |          | 48  |
| ShowTechpage                          |                                                      |         |           |          | 49  |
| SpanningTreepage                      |                                                      |         |           |          | 49  |
|                                       | Editingthespanningtreesettings                       |         |           |          | 51  |
| ConnectedClientspage                  |                                                      |         |           |          | 51  |
| ConnectedDevicesConfigurationpage     |                                                      |         |           |          | 52  |
|                                       | Editingconnecteddevicesattheswitchlevel              |         |           |          | 52  |
|                                       | Editingconnecteddevicesconfigurationatinterfacelevel |         |           |          | 53  |
| PKIpage                               |                                                      |         |           |          | 53  |
|                                       | AddinganddeletinganESTProfile                        |         |           |          | 54  |
|                                       | ViewinganESTProfile                                  |         |           |          | 55  |
|                                       | AddinganddeletingaTAProfile                          |         |           |          | 55  |
|                                       | EditingaTAProfile                                    |         |           |          | 57  |
|                                       | Addinganddeletingacertificate                        |         |           |          | 57  |
|                                       | Uploadingacertificate                                |         |           |          | 58  |
|                                       | Viewinganddownloadingacertificate                    |         |           |          | 59  |
|                                       | Editingassociatedapplicationdetails                  |         |           |          | 59  |
| PortSecuritypage                      |                                                      |         |           |          | 60  |
|                                       | Editingportsecurity                                  |         |           |          | 60  |
| SupportFilepage                       |                                                      |         |           |          | 61  |
|                                       | Creatinganddeletingsupportfiles                      |         |           |          | 62  |
|                                       | Downloadingasupportfile                              |         |           |          | 63  |
| Finding                               | alert details                                        | using   | the Web   | UI       | 64  |
| Working                               | with the                                             | network | analytics | features | 67  |
| ViewingagentinformationusingtheWebUI  |                                                      |         |           |          | 67  |
| WorkingwithanAnalyticstimeseriesgraph |                                                      |         |           |          | 70  |
|                                       | Customizingdatadisplayedonthegraph                   |         |           |          | 71  |
|                                       | Zoominginonthegraph                                  |         |           |          | 73  |
|                                       | Downloadingthegraphasanimageor.csvfile               |         |           |          | 73  |
|                                       | Viewinganalertonthegraph                             |         |           |          | 74  |
ArubaNetworkAnalyticsEnginescripts,agents,andtroubleshootinginformation 77
| Support               | and Other          | Resources |     |     | 78  |
| --------------------- | ------------------ | --------- | --- | --- | --- |
| AccessingArubaSupport |                    |           |     |     | 78  |
| AccessingUpdates      |                    |           |     |     | 78  |
|                       | ArubaSupportPortal |           |     |     | 78  |
|                       | MyNetworking       |           |     |     | 79  |
| WarrantyInformation   |                    |           |     |     | 79  |
| RegulatoryInformation |                    |           |     |     | 79  |
| DocumentationFeedback |                    |           |     |     | 79  |
Contents|4
...
Finding alert details using the Web UI | 65
...
Working with the network analytics features | 68

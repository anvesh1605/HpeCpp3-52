...
| ACLs                                | events         |            |            |             |              | 14  |
| Alarm                               | events         |            |            |             |              | 15  |
| ARP                                 | security       | events     |            |             |              | 18  |
| ASIC                                | table          | full error | for        | L3PD events |              | 19  |
| BFD                                 | events         |            |            |             |              | 21  |
| BGP                                 | events         |            |            |             |              | 26  |
| Bluetooth                           |                | Management |            | events      |              | 31  |
| CDP                                 | events         |            |            |             |              | 33  |
| Certificate                         |                | management |            | events      |              | 35  |
| Config                              | Management     |            | events     |             |              | 40  |
| Connectivity                        |                | Fault      | Management |             | (CFM) events | 42  |
...
3
AOS-CXEventLogMessageReferenceGuide10.08| (4100i,6xxx,8xxxSwitchSeries)

| DHCP          | server events |            |          |        |        | 52  |
| ------------- | ------------- | ---------- | -------- | ------ | ------ | --- |
| DHCPv4        | snooping      | events     |          |        |        | 55  |
| DHCPv6        | Relay         | events     |          |        |        | 59  |
| DHCPv6        | snooping      | events     |          |        |        | 60  |
| Dicovery      | and           | Capability | Exchange | (DCBx) | events | 64  |
| DNS client    | events        |            |          |        |        | 66  |
| DPSE events   |               |            |          |        |        | 67  |
| ECMP          | events        |            |          |        |        | 69  |
| ERPS events   |               |            |          |        |        | 71  |
| EVPN          | events        |            |          |        |        | 75  |
| External      | Storage       | events     |          |        |        | 79  |
| Fan events    |               |            |          |        |        | 81  |
| Fault monitor |               | events     |          |        |        | 86  |
| Firmware      | Update        | events     |          |        |        | 88  |
| Hardware      | Health        | Monitor    | events   |        |        | 90  |
| HTTPS         | Server events |            |          |        |        | 93  |
| In-System     | Programming   |            | events   |        |        | 95  |
| Interface     | events        |            |          |        |        | 98  |
| Internal      | storage       | events     |          |        |        | 100 |
| IP source     | lockdown      | events     |          |        |        | 101 |
| IP tunnels    | events        |            |          |        |        | 103 |
| IP-SLA        | events        |            |          |        |        | 107 |
| IPv6 Router   | Advertisement |            | events   |        |        | 109 |
| IRDP events   |               |            |          |        |        | 113 |
| Job scheduler |               | events     |          |        |        | 114 |
| L3 Encap      | capacity      | events     |          |        |        | 115 |
| L3 Resource   | Manager       |            | events   |        |        | 116 |
Contents|4

| LACP        | events      |                    |        |        | 117 |
| ----------- | ----------- | ------------------ | ------ | ------ | --- |
| LAG         | events      |                    |        |        | 123 |
| Layer       | 3 Interface | events             |        |        | 126 |
| LED events  |             |                    |        |        | 133 |
| LLDP        | events      |                    |        |        | 134 |
| Loop        | Protect     | events             |        |        | 137 |
| Loopback    | events      |                    |        |        | 139 |
| MAC         | Address     | mode configuration |        | events | 140 |
| MAC         | Learning    | events             |        |        | 141 |
| MACsec      | events      |                    |        |        | 143 |
| Management  |             | events             |        |        | 144 |
| MDNS        | events      |                    |        |        | 145 |
| MGMD        | events      |                    |        |        | 146 |
| Mirroring   | events      |                    |        |        | 151 |
| Module      | events      |                    |        |        | 153 |
| MSDP        | events      |                    |        |        | 161 |
| Multicast   | Traffic     | Manager            | events |        | 163 |
| Multiple    | spanning    | tree protocol      |        | events | 164 |
| MVRP        | events      |                    |        |        | 168 |
| NAE         | Agents      | events             |        |        | 170 |
| NAE         | events      |                    |        |        | 171 |
| NAE         | Scripts     | events             |        |        | 174 |
| ND snooping |             | events             |        |        | 177 |
| NDM         | events      |                    |        |        | 179 |
| NTP         | events      |                    |        |        | 186 |
| OSPFv2      | events      |                    |        |        | 188 |
| OSPFv3      | events      |                    |        |        | 190 |
...
| Password        | Reset         | events   |               |        | 192 |
| --------------- | ------------- | -------- | ------------- | ------ | --- |
| PIM events      |               |          |               |        | 193 |
| Policies        | events        |          |               |        | 200 |
| Port access     | events        |          |               |        | 201 |
| Port access     | roles         | events   |               |        | 204 |
| Port events     |               |          |               |        | 205 |
| Port security   | events        |          |               |        | 207 |
| Port Statistics | events        |          |               |        | 208 |
| Port access     | group         | based    | policy events |        | 209 |
| Power           | events        |          |               |        | 211 |
| Power           | over Ethernet | events   |               |        | 216 |
| PTP events      |               |          |               |        | 225 |
| QoS ASIC        | Provider      | events   |               |        | 228 |
| Quality         | of Service    | events   |               |        | 230 |
| Rapid           | per VLAN      | Spanning | Tree Protocol | events | 231 |
| RBAC            | events        |          |               |        | 234 |
| Redundant       | Management    |          | events        |        | 235 |
| Replication     | Manager       | events   |               |        | 237 |
| REST            | events        |          |               |        | 238 |
| Self Test       | events        |          |               |        | 249 |
| sFlow           | events        |          |               |        | 250 |
| SFTP            | Client events |          |               |        | 257 |
| Smartlink       | events        |          |               |        | 258 |
| SNMP            | events        |          |               |        | 259 |
| SSH client      | events        |          |               |        | 262 |
| SSH server      | events        |          |               |        | 263 |
| Supportability  | events        |          |               |        | 265 |
Contents|6
...
| SYSMON                |                    | events       |           |           |        |              | 274 |
| TCAM                  | events             |              |           |           |        |              | 276 |
| Temperature           |                    |              | events    |           |        |              | 280 |
| Time                  | management         |              |           | events    |        |              | 283 |
| Transceiver           |                    | events       |           |           |        |              | 284 |
| UDLD                  | events             |              |           |           |        |              | 287 |
| UDP                   | Broadcast          |              | Forwarder |           | events |              | 289 |
| UFD                   | events             |              |           |           |        |              | 290 |
| User                  | management         |              |           | events    |        |              | 291 |
| User-based            |                    | tunnels      |           | events    |        |              | 293 |
| Virtual               | Switching          |              |           | Extension |        | (VSX) events | 300 |
| Virtual               | Switching          |              |           | Framework |        | (VSF) events | 308 |
| VLAN                  | events             |              |           |           |        |              | 318 |
| VLAN                  | Interface          |              | events    |           |        |              | 322 |
| VRF events            |                    |              |           |           |        |              | 323 |
| VRF Manager           |                    |              | events    |           |        |              | 324 |
| VRRP                  | events             |              |           |           |        |              | 325 |
| VSX Sync              |                    | events       |           |           |        |              | 331 |
| VXLAN                 | agent              |              | events    |           |        |              | 332 |
| VXLAN                 | events             |              |           |           |        |              | 333 |
| Zero                  | touch              | provisioning |           |           | events |              | 337 |
| Support               | and                |              | other     | resources |        |              | 343 |
| AccessingArubaSupport |                    |              |           |           |        |              | 343 |
| AccessingUpdates      |                    |              |           |           |        |              | 343 |
|                       | ArubaSupportPortal |              |           |           |        |              | 343 |
|                       | MyNetworking       |              |           |           |        |              | 344 |
| Warrantyinformation   |                    |              |           |           |        |              | 344 |
| RegulatoryInformation |                    |              |           |           |        |              | 344 |
| Documentationfeedback |                    |              |           |           |        |              | 344 |
7
AOS-CXEventLogMessageReferenceGuide10.08| (4100i,6xxx,8xxxSwitchSeries)
...
AOS-CX Event Log Message Reference Guide 10.08 | (4100i, 6xxx, 8xxx Switch Series)
...
ASIC table full error for L3PD events | 20
...
Bluetooth Management events | 32
...
EventID:7710
Certificatemanagementevents|36
...
| ------- | ----------- | ------ | -------------- | --------------- |
Certificatemanagementevents|38
...
DicoveryandCapabilityExchange(DCBx)events|65
...
| Message     | Fan tray <FT_Num>                           | was removed. |
| ----------- | ------------------------------------------- | ------------ |
| Category    | Fan                                         |              |
| Severity    | Warning                                     |              |
...
| Message     | Fan tray <FT_Num>                            | was inserted. |     |
| ----------- | -------------------------------------------- | ------------- | --- |
| Category    | Fan                                          |               |     |
| Severity    | Information                                  |               |     |
| Description | Logeventwhenafantrayisinsertedintothechassis |               |     |
EventID:206
Message Fan module <FMod_Num> in fan tray <FT_Num> was removed.
| Category    | Fan                                         |     |     |
| ----------- | ------------------------------------------- | --- | --- |
| Severity    | Information                                 |     |     |
| Description | Logeventwhenafanmoduleisremovedfromafantray |     |     |
EventID:207
Message Fan module <FMod_Num> in fan tray <FT_Num> was inserted.
| Category    | Fan                                          |     |     |
| ----------- | -------------------------------------------- | --- | --- |
| Severity    | Information                                  |     |     |
| Description | Logeventwhenafanmoduleisinsertedintoafantray |     |     |
EventID:208
Message Unsupported fan tray <FT_Num> detected. Please insert a standard fan
tray.
| Category    | Fan                                        |     |     |
| ----------- | ------------------------------------------ | --- | --- |
| Severity    | Error                                      |     |     |
...
EventID:214
Message <function>: Fan fault in tray <tray_index>, module <fan_index>, reason:
|             | <reason>.':                       | yes |     |     |
| ----------- | --------------------------------- | --- | --- | --- |
| Category    | Fan                               |     |     |     |
| Severity    | Error                             |     |     |     |
...
Message Status of fan <FanModuleIdx> in tray <FanTrayIdx> has changed from
...
EventID:219
| Message     | Fan tray <FT_Num>                    | powered | <Status>. |
| ----------- | ------------------------------------ | ------- | --------- |
| Category    | Fan                                  |         |           |
| Severity    | Information                          |         |           |
| Description | Logeventwhenafantrayispoweredonoroff |         |           |
EventID:220
| Message  | Fan tray <FT_Num> | airflow | is <FT_Dir>. |
| -------- | ----------------- | ------- | ------------ |
| Category | Fan               |         |              |
| Severity | Information       |         |              |
...
<FT_air_curr> airflow fan tray <FT_Num> unsupported; this system
...
Fan tray <FT_Num> FRU EPPROM is incorrectly programmed.
...
<FT_air_curr> airflow fan tray <FT_Num> disabled; this system requires
<FT_air_req> airflow.
...
fan tray <FT_Num> misconfigured; this fan tray has been <En_Dis>.
...
HardwareHealthMonitorevents|91
...
Message IP_SOURCE_LOCKDOWN resource utilization has reached 80 percent of the
...
Message IP_SOURCE_LOCKDOWN resource utilization has exceeded maximum supported
...
EventID:9803
Message IP_SOURCE_LOCKDOWN resource utilization has reduced below 80 percent of
...
EventID:9804
Message IPV4_SOURCE_LOCKDOWN is enabled on interface <interface>
| Category |     | IPsourcelockdown |     |     |     |     |
| -------- | --- | ---------------- | --- | --- | --- | --- |
101
| AOS-CXEventLogMessageReferenceGuide10.08| |     |     | (4100i,6xxx,8xxxSwitchSeries) |     |     |     |
...
IPV4_SOURCE_LOCKDOWN is disabled on interface <interface>
...
IPV6_SOURCE_LOCKDOWN is enabled on interface <interface>
...
IPV6_SOURCE_LOCKDOWN is disabled on interface <interface>
...
| ------- | ---------- | ------ | --------------- | ---------------- |
IPv6RouterAdvertisementevents|110
...
IPv6RouterAdvertisementevents|112
...
EventID:2010
Multiplespanningtreeprotocolevents|165
...
Multiplespanningtreeprotocolevents|167
...
| NAE Agents events |     |     |     |     |
| ----------------- | --- | --- | --- | --- |
ThefollowingaretheeventsrelatedtoNAEagents.
EventID:6901
| Message     | An action                          | has been triggered | by the NAE | agent <name> |
| ----------- | ---------------------------------- | ------------------ | ---------- | ------------ |
| Category    | NAEAgents                          |                    |            |              |
| Severity    | Information                        |                    |            |              |
| Description | ActionhasbeentriggeredbyanNAEagent |                    |            |              |
170
AOS-CXEventLogMessageReferenceGuide10.08| (4100i,6xxx,8xxxSwitchSeries)
...
VSX neighbor datapath init sync status is enabled for peer neighbors
sync
...
VSX neighbor datapath init sync status is enabled

Event ID: 6120

Message

VSX neighbor datapath init sync status is disabled, Peer Neighbors sync
cannot be performed
...
| ----------- | ------------------------------------------- | --- | --- | --- |
| Severity    | Information                                 |     |     |     |
| Description | VSXneighbordatapathinitsyncstatusisdisabled |     |     |     |
EventID:6121
...
EventID:2410
Message Duplicate router-id for <ospf-interface> from source <source-ip>
| Category    | OSPFv2                        |     |     |
| ----------- | ----------------------------- | --- | --- |
| Severity    | Error                         |     |     |
...
Falied to create the role - <role_name>, maximum limit reached'
throttle_count: 100
...
client with MAC address <mac_addr>.': yes
...
Port access group based policy events | 210
...
Power over Ethernet events | 223
...
EventID:12101
Message PTP <type> <delay_mechanism> clock started with profile <profile>.
| Category    | PTP                                 |     |     |
| ----------- | ----------------------------------- | --- | --- |
| Severity    | Information                         |     |     |
...
EventID:5010
RapidperVLANSpanningTreeProtocolevents|232
...
EventID:4603(Severity:Critical)
Message Conflict in authorization configuration. Existing config::URL(<match>),
...
EventID:4604
| Message     | Session started                | for user <user>, | session <sessionid> |
| ----------- | ------------------------------ | ---------------- | ------------------- |
| Category    | REST                           |                  |                     |
| Severity    | Information                    |                  |                     |
| Description | logsthestartofaRESTusersession |                  |                     |
EventID:4605
238
AOS-CXEventLogMessageReferenceGuide10.08| (4100i,6xxx,8xxxSwitchSeries)

| Message     | Session ended                | for user <user>, | session <sessionid> |
| ----------- | ---------------------------- | ---------------- | ------------------- |
| Category    | REST                         |                  |                     |
| Severity    | Information                  |                  |                     |
| Description | logstheendofaRESTusersession |                  |                     |
EventID:4606
...
Error rebooting switch, reboot command: <command>, error received:
<error>
...
Internal error. Closing connection to Aruba Central on location
...
Waiting for Aruba Central location from CLI/DHCP/Aruba Activate Server.
...
Waiting for Aruba Central location from Central Source (CLI/DHCP/Aruba Activate
Server).
...
Connecting to Aruba Central on location <central_location> on VRF <vrf>
...
MDestRx Tunnel is UP - Tunnel Id (<tunnel_id>) Gre Key (<gre_key>)
...
MDestRx Tunnel is DOWN - Tunnel Id (<tunnel_id>) Gre Key (<gre_key>)
Source IP (<src_ip>) Destination IP (<dst_ip>)
...
User bootstrap is failed for client (<mac_addr>) on port (<port>) due
to <reason>.
...
VirtualSwitchingExtension(VSX)events|301
...
EventID:7020
VirtualSwitchingExtension(VSX)events|303
...
| ------- | -------------- | ----- | ------------------------------- |
VirtualSwitchingExtension(VSX)events|305
...
VirtualSwitchingExtension(VSX)events|307
...
EventID:9903
| Message     | Master                         | <member_id> | boot complete |     |     |     |
| ----------- | ------------------------------ | ----------- | ------------- | --- | --- | --- |
| Category    | VirtualSwitchingFramework(VSF) |             |               |     |     |     |
| Severity    | Information                    |             |               |     |     |     |
| Description | logeventforMasterbootcomplete  |             |               |     |     |     |
EventID:9905
...
EventID:9912
VirtualSwitchingFramework(VSF)events|309

Message Stack state is no-split with master id <member_id>' throttle_count: 100
| Category    | VirtualSwitchingFramework(VSF) |     |     |
| ----------- | ------------------------------ | --- | --- |
| Severity    | Information                    |     |     |
...
EventID:9915
Message Member <member_id> elected as commander reason-<reason>
| Category    | VirtualSwitchingFramework(VSF)  |     |     |
| ----------- | ------------------------------- | --- | --- |
| Severity    | Information                     |     |     |
| Description | logeventfortheswitchwonasmaster |     |     |
EventID:9916
...
| ------- | -------- | ------------ | --- | --- |
VirtualSwitchingFramework(VSF)events|311
...
EventID:9927
Message Fragment with master <member_id> is Active' throttle_count: 100
| Category    | VirtualSwitchingFramework(VSF) |     |     |
| ----------- | ------------------------------ | --- | --- |
| Severity    | Information                    |     |     |
| Description | logeventforactivefragment      |     |     |
EventID:9928
| Message | Fragment with | master <member_id> | is Inactive |
| ------- | ------------- | ------------------ | ----------- |
312
| AOS-CXEventLogMessageReferenceGuide10.08| |     | (4100i,6xxx,8xxxSwitchSeries) |     |
| ----------------------------------------- | --- | ----------------------------- | --- |
...
| ------- | ------------ | --- | ------------ | --------- | --- |
VirtualSwitchingFramework(VSF)events|313
...
on interface <port> which is not provisioned on the master for member
<member_id>
...
log event when there is an inconsistency detected between masters provisioned VSF link
configuration and the interface on which switch is attempting to autojoin
...
Virtual Switching Framework (VSF) events | 315
...
Virtual Switching Framework (VSF) events | 317
...
| ----------- | ------------------------------------------ | --- | --- |
| Severity    | Information                                |     |     |
| Description | LogsvirtualrouterhastakencontrolofbackupIP |     |     |
EventID:3705
325
AOS-CXEventLogMessageReferenceGuide10.08| (4100i,6xxx,8xxxSwitchSeries)
...
<inet_type> virtual router <vrid> on interface <interface> lost backup
IP
...
Logs virtual router has lost control of backup IP
...
Zero touch provisioning events | 338
...
EventID:8723
Zerotouchprovisioningevents|340
...
Zero touch provisioning events | 342

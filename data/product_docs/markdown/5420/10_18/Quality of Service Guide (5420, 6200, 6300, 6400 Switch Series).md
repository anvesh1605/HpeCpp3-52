AOS-CX 10.18.xxxx Quality of Service Guide (5420, 6200, 6300,
6400 Switch Series)
...
AOS-CX 10.18.xxxx Quality of Service Guide (5420, ...
...
Virtual Output Queues on 5420, 6200 and 6300 switch series..........................................................24

Virtual Output Queues on 6400 switch series............................................................................................... 25
...
Configuring expedited forwarding for VoIP traffic....................................................................................................32

Configuring rate limiting...........................................................................................................................................................34

Configuring egress queue shaping.....................................................................................................................................35
...
Configuring threshold profiles.............................................................................................................................................. 38

Supporting Ethernet 802.1D Class of Service.............................................................................................................39

Monitoring queue operation...................................................................................................................................................41

QoS commands........................................................................................................................................................................................... 41

clear queue-monitor interface ..............................................................................................................................................42
...
qos egress-rewrite ...................................................................................................................................................................... 59

qos egress-rewrite-map ...........................................................................................................................................................61

qos queue-profile ........................................................................................................................................................................ 63

qos schedule-profile ...................................................................................................................................................................64
...
show interface qos ......................................................................................................................................................................80

show interface queues ..............................................................................................................................................................85

show interface queue-monitor .............................................................................................................................................87

show interface queue-monitor status ...........................................................................................................................102

show qos cos-map ....................................................................................................................................................................105

show qos dscp-map ................................................................................................................................................................ 107

show qos queue-profile ........................................................................................................................................................ 109

show qos schedule-profile ...................................................................................................................................................111

show qos trust ............................................................................................................................................................................113

show qos tunnel ........................................................................................................................................................................ 115

show queue-monitor status ................................................................................................................................................116

strict queue .................................................................................................................................................................................. 117

Feature and Proactive Troubleshooting....................................................................................................................................119

troubleshoot qos .......................................................................................................................................................................120
...
Accessing HPE Aruba Networking Support...............................................................................................................122
...
Queue Monitoring
Virtual Output Queues on 5420, 6200 and 6300 switch series
Virtual Output Queues on 6400 switch series
Terms
...
displays changes from the initial settings.) The 6400 Switch Series only has four queues.
...
The 6200 and 6300v1 Switch Series contain 8 MB of packet buffer memory. Approximately 5 MB are used
for buffering traffic arriving on network ports. Each port can buffer at most 1 MB of packets divided equally
...
The 6300v1 Switch Series includes the following SKUs: JL658A, JL659A,
JL660A, JL661A, JL662A, JL663A, JL664A, JL665A, JL666A, JL667A, JL668A,
JL762A.

The 5420 Switch Series contain 64 megabytes of packet-buffer memory. Appropriately 60 megabytes are
used for buffering traffic arriving on network ports. Each port queue can buffer at most 2 megabytes of
packets in a queue-profile with 8 to 3 queues or 4 megabytes of packets in a queue-profile with 2 to 1
queues.
...
buffering traffic arriving on network ports. Each port queue can buffer at most 4 MB of packets. A single port
can buffer a maximum of 4 MB of packets across all non-empty queues.

NOTE

The 6300v2 Switch Series includes the following SKUs: R8S89A, R8S90A,
R8S91A, R8S92A.
...
switch services the replication queues strictly at the rate of 50G. For ports on the same switch, pointers to
the same packet are placed in the VOQ for each destination port. For ports on remote VSF member switches,
only one copy of the packet data is moved across the VSF link to the destination replication VOQ to optimize
link bandwidth. From there, the destination switch puts pointers to the same packet on the VOQ for each
destination port.

When 3-8 queues are configured on the 6300v1 switch series the egress buffer limit is 2 MB. The most
buffer a single port can use in a given queue is 2MB and that 2 MB is shared between the ports in the queue
that need it. If QoS is not needed then up 1-2 queues can be configured with an egress buffer limit of 4 MB.

NOTE

The 6300v1 switch series is the only platform where collapsing the number of
queues increases the buffer allocation limit.
...
for replicated traffic. The line module services these replication VOQs strictly at a rate of 100 G. For ports
on the same line module, pointers to the same packet are placed in the VOQ for each destination port. For
ports on remote line modules, only one copy of the packet data is moved across the fabric to the destination
...
which packets must be dropped, and is mostly used for packets marked with Assured Forwarding (AF) DSCP
values.
...
Configuring expedited forwarding for VoIP traffic 33
...
Configuring egress port shaping 37
...
For WRED action, it is possible to configure separate thresholds for responsive protocol packets (for
example, TCP) as well as non-responsive protocol packets (for example, UDP).
...
Applicable only on the 5420, 6200, 6300, and 6400v1 Switch Series
...
Supporting Ethernet 802.1D Class of Service 40

Monitoring queue operation

Use the show interface queues command to display the traffic transmitted per queue, and the number of
packets dropped due to the queue being full. ( Tx Bytes  is available on the 5420, 6200 and 6300 Switch
Series.) For example:
...
Interface 1/1/1 is  (Administratively down)
 ...
 Q7              0                     0                 0
Tx Bytes: Total bytes transmitted (available on the 5420, 6200 and 6300 Switch Series). The byte count
may include packet headers and internal metadata that are removed before the packet is transmitted. Packet
...
Queues (VOQs) destined for the egress port. Applicable to the 6400 Switch Series: Because the counts are
...
clear queue-monitor interface 43
...
The min-bandwidth command only applies to 6200 and 6300 Series Switches.
...
cannot be edited or deleted. Use the command show qos queue-profile factory-default to view this profile.
Do not use show running-configuration, as it will only display changes from the initial values. Use show
qos queue-profile [NAME] to view the status of all queue profiles or the settings of the named profile.
...
Applicable only on the HPE Aruba Networking 5420, 6200, 6300, and 6400v1 Switch Series
...
Applicable only on the HPE Aruba Networking 6400v2 Switch Series
...
percent max-threshold 80 percent max-prob 90 percent
...
65 percent max-threshold 95 percent
...
70 percent max-threshold 100 percent max-prob 71 percent
...
(6300 Series Switch only) .

•  Tx Packets: Total packets transmitted. The count includes packets subsequently dropped by an egress

ACL (6300 Series Switch only) .

•  Tx Drops: Total packets dropped by an egress queue due to insufficient capacity.

•  Tx Drops:For the 6300 Series Switch total packets dropped by an egress queue due to insufficient

capacity. For the 6400 Series Switch sum of packets that were dropped across all line modules by Virtual

Public

show interface queues 85

Output Queues (VOQs) destined for the egress port queue due to insufficient capacity. As the counts are
read separately from each line module, the sum is not an instantaneous snapshot.
...
show interface queue-monitor 99
...
show interface queue-monitor 100
...
show interface queue-monitor 101
...
show interface queue-monitor status 103
...
show interface queue-monitor status 104
...
NOTE
The vsx-peer parameter is not supported by the 6300 Series Switch
...
•  The highest numbered queue can be swapped between strict and dwrr` or min-bandwidth (only

applicable for the 6300 Series Switch)

•  The highest numbered queue can be swapped between strict and dwrr (only applicable for the 6400

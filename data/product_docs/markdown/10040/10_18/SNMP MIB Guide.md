AOS-CX 10.18.xxxx SNMP MIB Guide
...
show mac-notify port ................................................................................................................................................... 35

show mac-notify ..............................................................................................................................................................36

show rmon alarm .............................................................................................................................................................37

show snmp agent-port ................................................................................................................................................ 39
...
snmpv3 security-level ..................................................................................................................................................52

snmp-server agent-port ............................................................................................................................................. 53
...
snmp-server system-contact ...................................................................................................................................65

snmp-server system-description ...........................................................................................................................66
...
snmp-server snmpv3-only ........................................................................................................................................ 78

snmp-server trap aaa-server-reachability-status ........................................................................................79

snmp-server trap configuration-changes .........................................................................................................80

snmp-server trap mac-notify ...................................................................................................................................81

snmp-server trap module .......................................................................................................................................... 82

snmp-server trap port-security ..............................................................................................................................83

snmp-server trap snmp ...............................................................................................................................................84

snmp-server trap vsx ................................................................................................................................................... 86

snmp-server trap ............................................................................................................................................................ 87

snmp-server view ........................................................................................................................................................... 89

Entity MIB support.......................................................................................................................................................................91

Location of the MIB files on the web.................................................................................................................................91

Updated MIBs for AOS-CX 10.17....................................................................................................................................... 92

OIDs that support SNMP read-write..................................................................................................................................94

OIDs that support SNMP read-create...............................................................................................................................95

Support and Other Resources............................................................................................................................................................95

Accessing HPE Aruba Networking Support..................................................................................................................96
...
Beginning with AOSCX 10.13, the switch includes overlay partition information
when polling HOST-RESOURCES-MIB. The overlay partition is a read-only
partition, and this is reflected in SNMP queries. For example:

HOST-RESOURCES-MIB::hrFSAccess.3 = INTEGER: readOnly(2)

In earlier software versions, this overlay partition was not exposed via SNMP.
...
snmp-server trap-source interface vrf 69
...
snmp-server response-source 77
...
The Entity MIB (RFC 6933) provides network managers with a standardized method to retrieve physical
containment hierarchies and logical relationships for network devices. This implementation provides read-
only access to Entity MIB objects.

Physical components that are supported include:

•  Chassis - The physical enclosure of the switch

•  Stack - VSF stack entity for VSF-capable platforms

•  Management modules - Control plane components and intake temperature sensors

•  Line cards - Switching fabric and port modules

•  Fabric cards - High-speed switching interconnects

•  Power supplies - PSU modules and their slots

•  Fan trays and fans - Cooling system components and their slots

•  Ports - Network interfaces

•  Transceivers - Port transceiver modules (xcvr) and their slots (xcvr_slot)

•  Sensors - Temperature, fan speed, and power sensors

NOTE

QSFP-to-SFP adapter modules (QSAs) are not represented as separate entities in
the Entity MIB. However, transceivers plugged into QSAs are fully supported and
will be reported as transceiver entities.

The slots for any removable component are also represented. The logical table of the Entity MIB represents
configured VLANs and the associated ports.

A network administrator can use the command [no] system entity trap to enable or disable the switch's
ability to send Entity MIB traps. The entConfigChange trap/notification is sent to configured snmp-server
hosts.
...
Updated MIBs for AOS-CX 10.17 93
...
|     | Public |     | OIDs that support SNMP read-create | 95  |
| --- | ------ | --- | ---------------------------------- | --- |

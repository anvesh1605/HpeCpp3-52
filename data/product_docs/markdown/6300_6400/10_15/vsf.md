...
AOS-CX 10.15.xxx Virtual Switching Framework (VSF) Guide | (6200, 6300 Switch Series)
...
|                                     | Auto-stackingusingHPEArubaNetworkingCXmobileapp |         | 26  |
...
5
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide| (6200,6300SwitchSeries)
...
| VSF commands                  |     |     | 47  |
| description(VSFlink)          |     |     | 47  |
| interface(VSFlink)            |     |     | 47  |
| issurollback-timer            |     |     | 48  |
| issuupdate-software           |     |     | 50  |
| link                          |     |     | 54  |
| member                        |     |     | 56  |
| showissu                      |     |     | 57  |
| showvsf                       |     |     | 62  |
...
| showvsfmember                 |     |     | 66  |
| showvsflink                   |     |     | 67  |
| showvsflinkdetail             |     |     | 68  |
| showvsflinkerror-detail       |     |     | 69  |
| showvsflinkerror-detailmember |     |     | 71  |
| showvsftopology               |     |     | 73  |
| shutdown(vsf)                 |     |     | 74  |
| type(vsfmember)               |     |     | 75  |
| vsfegress-shape               |     |     | 76  |
| vsfforce-auto-join            |     |     | 79  |
| vsfmember                     |     |     | 79  |
| vsfmemberreboot               |     |     | 80  |
|6
...
| vsfrenumber-to                     |                                          |                 |           |                        | 81  |
| ---------------------------------- | ---------------------------------------- | --------------- | --------- | ---------------------- | --- |
| vsfsecondary-member                |                                          |                 |           |                        | 82  |
| vsfsplit-detect                    |                                          |                 |           |                        | 84  |
| vsfstart-auto-stacking             |                                          |                 |           |                        | 85  |
| Configuration                      |                                          | conflict        |           | finder recommendations | 87  |
| Considerations                     |                                          | and             | best      | practices              | 90  |
| Debugging                          | and                                      | troubleshooting |           |                        | 92  |
| Stacksplit                         |                                          |                 |           |                        | 92  |
|                                    | Step1: Verifysplithasoccurred            |                 |           |                        | 92  |
|                                    | Step2:Identifyfailedlinkormember         |                 |           |                        | 93  |
|                                    | Step3:Recoverorreplacefailedlinkormember |                 |           |                        | 94  |
|                                    | Step4:Verifyproperstackoperation         |                 |           |                        | 94  |
| Misconfigurationrecovery           |                                          |                 |           |                        | 94  |
| VSF switchoverbehaviors            |                                          |                 |           |                        | 95  |
| Frequently                         | asked                                    |                 | questions |                        | 96  |
| General                            |                                          |                 |           |                        | 96  |
| Auto-stacking                      |                                          |                 |           |                        | 103 |
| Support                            | and                                      | Other           | Resources |                        | 109 |
| AccessingHPEArubaNetworkingSupport |                                          |                 |           |                        | 109 |
| AccessingUpdates                   |                                          |                 |           |                        | 110 |
| WarrantyInformation                |                                          |                 |           |                        | 110 |
| RegulatoryInformation              |                                          |                 |           |                        | 110 |
| DocumentationFeedback              |                                          |                 |           |                        | 110 |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 7
...
n 6200:VSFallowsstackstobeformedusinganycombinationof24and48-portSKUsofthe6200
family.(A6200F12-portswitchwillformaVSFstackonlywithother6200F12-portswitches.)Upto8
...
| --------- | -------- | --- | --- | --- | --- |
| interface | 1/1/3    |     |     |     |     |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 15
...
VSF port shaping configuration is enabled by default. Use the command 'no vsf egress-shape' to disable
port shaping. See vsf egress-shape for details.
...
| Status               |        | : No                | Split    |
| Split Detection      | Method | : None              |          |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 25
...
To provision a member, the part number of the member must be specified. Refer to type (vsf member)
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 31
...
green.
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 33
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 37
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 39
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 41
...
VSF ISSU is supported on the HPE Aruba Networking 6300 Switch Series (except for S3L75A,S3L76A and S3L77A).
...
Formoreinformationonfeaturesthatusethiscommand,refertotheVirtualSwitchingFramework(VSF)Guide
foryourswitchmodel.
| Command History     |         |         |                    |     |
| ------------------- | ------- | ------- | ------------------ | --- |
...
switch#
| issu | rollback-timer | wait-time | 81  |
| ---- | -------------- | --------- | --- |
The ISSU rollback timer is active. This change will apply on the next ISSU
operation
...
| Command Information |     |                   |     |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 49
...
Initiates ISSU to the alternate boot location. The newer operating system image must be downloaded to
the alternate boot location prior to running this command. Additionally, the current running operating
system version must match the version that is stored in the current boot location or ISSU will not be
allowed.
...
Usage
Notethefollowingpointsbeforerunningthiscommand:
n Theneweroperatingsystemimagemustbedownloadedtothealternatebootlocationpriorto
runningthiscommand.
n Thecurrentrunningoperatingsystemversionmustmatchtheversionthatisstoredinthecurrent
bootlocationorISSUwillnotbeallowed.
n Thisoperationisdisruptiveandwillresultinthemanagementinterfacebeingdisconnectedduring
theprocess.
n Therunningconfigurationwillbestoredincaseanerrorisencounteredthatrequiresarebootto
recovertheswitch.
n DuringtheISSUprocessallmanagementmethods(CLI,REST,WebUI)areblockedfrommaking
configurationchangestotheswitch.TheconfigurationchangesarenotallowedfromthetimeISSU
startsuntilISSUswitchoveriscomplete.ftertheISSUswitchoveriscompleted,switchconfiguration
canresume.
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 51
...
| --------- | --- | ------ |
-----------------------------------------------------------
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 53
...
| ------------------- | --- | --- | --- |
| Command Information |     |     |     |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 55
...
ISSU Summary
============
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 57
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 59
...
| Command | History |     |     |     |     |     |
| ------- | ------- | --- | --- | --- | --- | --- |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 61
...
| --- ------------------- |     |     | -------------- |     | ----------------- |
| ----------------------- | --- | --- | -------------- | --- | ----------------- |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 63
...
| Type                 |     | : S0E91A             |            |                |             |           |
| Model                |     | : 6300M 48-port      | SR10       | 1G/2.5G/5G/10G | PTP/AVB     | Class     |
| 8 PoE 4p 100G MACsec |     |                      |            |                |             |           |
| Status               |     | : Standby            |            |                |             |           |
| ROM Version          |     | : SL.10.02.0000-7755 |            |                |             |           |
| Serial Number        |     | : CN7ZK90012         |            |                |             |           |
| Uptime               |     | : 0d 0h 23m          |            |                |             |           |
...
foryourswitchmodel.
Command History
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 65
...
| MAC Address     |             | : ec:eb:b8:d0:80:40  |                                 |        |
| Type            |             | : JL557A             |                                 |        |
| Model           |             | : HPE_ANW            | JL557A 2930F-48G-740W-PoE+-4SFP | Switch |
| Status          |             | : Conductor          |                                 |        |
| ROM Version     |             | : SL.10.02.0000-7755 |                                 |        |
| Serial          | Number      | : CN7ZK90012         |                                 |        |
| Uptime          |             | : 0d 0h              | 18m                             |        |
...
| Command History |     |     |     |
| --------------- | --- | --- | --- |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 67
...
| show vsf link | error-detail |              |     |     |     |     |     |     |     |     |
Description
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 69
...
| ----------- | ------------- | ------------ | --- | ------ | --- | --- | --- | --- |
| VSF Member: | 1 Link        | 1            |     |        |     |     |     |     |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 71
...
| | 3 |1==2| | 2     | |1==1|       | 1 |       |     |     |     |     |     |     |
| +---+      | +---+ | +---+        |           |     |     |     |     |     |     |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 73
...
!
!
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 75
...
| MAC Address          |     | : 38:21:c7:5c:62:40 |          |
| Egress Shape         |     | : Enabled           |          |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 77
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 79
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 81
...
| Command | History |     |     |
| ------- | ------- | --- | --- |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 83
...
| Command | History |     |     |     |     |
| ------- | ------- | --- | --- | --- | --- |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 85
...
|     | 19  | link                 | 1 1/1/25 |         |     |
|     | 20  | vsf member           | 2        |         |     |
Configurationconflictfinderrecommendations|88
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 89
...
Considerations and best practices | 91
...
Debuggingandtroubleshooting|93
...
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 94
...
Debugging and troubleshooting | 95
...
The HPE Aruba Networking 6300F/M Switch Series supports VSF.

VSF can be formed with a combination of any of the HPE Aruba Networking 6300F/M Switch Series
(JL658A, JL659A, JL660A, JL661A, JL662A, JL663A, JL664A, JL665A, JL666A, JL667A, JL668A, JL762A) or a
combination of any of the Aruba 6200F Switch Series (JL724A, JL725A, JL726A, JL727A, JL728A).
...
| Egress          | Shape    |             |          |     | : Enabled           |          |     |
AOS-CX10.15.xxxVirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 98
...
because the two fragments are simultaneously active. HPE Aruba Networking highly recommends
enabling VSF split-detection to gracefully handle split brain scenarios.

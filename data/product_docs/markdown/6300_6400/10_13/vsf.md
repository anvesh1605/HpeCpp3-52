...
AOS-CX 10.13 Virtual Switching Framework (VSF) Guide | (6200, 6300 Switch Series)
...
5
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide| (6200,6300SwitchSeries)
...
| RegulatoryInformation              |                                          |                 |           |                        | 105 |
| DocumentationFeedback              |                                          |                 |           |                        | 105 |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 7
...
n 6200:VSFallowsstackstobeformedusinganycombinationofSKUsofthe6200familyexcept
R8Q72AandR8V13AwhichcanonlystackwithotherR8Q72AandR8V13ASKUs.Upto8member
switcheswillbeallowed.Connectionsbetweentheswitchesmustuse1GSFP/SFP+with1Gcopper
downlinkportsor10Glinks.
6300:VSFallowsstackstobeformedusinganycombinationofSKUsofthe6300family.Upto10
n
...
links.IfaVSFstackincludesamixofS0E91A/S0X44ASKUandotherSKUs,thenitsupports10Gand
25GVSFlinksonly.
...
VSF supports up to 8 member stacks (for 6200 devices) or 10 member stacks (for 6300 devices) in ring
and chain topology.
...
no shutdown
no routing
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 15
...
n 6200switches,(6200Mand6200F)or
...
switchesonly.Additionally,R8Q72AandR8V13ASKUscanonlystackwithotherR8Q72AandR8V13ASKUs.
...
| 1/1/23     | lag2 |              |     |     |     |
| 2/1/23     | lag2 |              |     |     |     |
| VSF egress |      | port shaping |     |     |     |
Inthe6300switchseries,SKUssuchasS0E91AandS0X44AsupportVSFinterfacelinkspeedsofupto
100G,whileotherSKUsintheseriescansupportinterfacelinkspeedsupto50Gonly.Toensure
seamlessstackingbetweenS0E91A/S0X44ASKUandother6300SKUs,VSFegressportshapingisused.
TheVSF egressportshapingfeaturelimitstherateofegresstrafficonallVSFinterfacesofthestack.
ThismaintainsauniformcommonbandwidthacrosstheVSF interfaces,especiallyifthereisa
differenceininterfacelinkspeedsacrossthestackcontainingatleastoneoftheSKUsS0E91Aor
S0X44A.
Ifthetrafficratedestinedfortheportexceedstheappliedegressbandwidth,theswitchwillbufferthe
excessuptothelimitofthequeues.Formoremoreinformationonbufferlimits,refertotheVirtual
outputqueuessectionintheQualityofServiceGuide.
IfaVSFlinkcomprisesofmultipleinterfaces,theegressportshaperate(ifapplied)isenforced
separatelyoneachindividualinterfacesoftheVSFlink,notontheVSF linkasawhole.
Thisfeaturedoesnotrequireanymanualconfigurationand,itisapplicableonlyona6300VSFstack
containingatleastoneactivememberoftypeS0E91AorS0X44ASKU.IfalltheS0E91AorS0X44ASKU
membersarephysicallyremovedfromthestack,VSFegressportshapingwillnotbeappliedandthe
VSFinterfacescontinuetooperateattheiroriginalspeeds.
Thisfeatureisapplicableonlyfor6300switchseries.VSF egressportshapingwillbeappliedonlytothestack
membersthatareupandoperational.
Ifegressportshapingisapplied,theshow vsfcommanddisplaysthebandwidthrateinkbpsunder
| Egress Shape | Rate.       |         |                     |          |     |
| ------------ | ----------- | ------- | ------------------- | -------- | --- |
| switch#      | show        | vsf     |                     |          |     |
| Force        | Autojoin    |         | : Disabled          |          |     |
...
| Status       |             |         | : No                | Split    |     |
| Split        | Detection   | Method  | : None              |          |     |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 21
...
| 4                       | JL662A         | Not Present       |
Limitations
ThefollowingarelimitationsassociatedwiththeVSF egressportshapingfeature:
n VSFegressportshapingisnotsupportedon6200switchseries.
...
n VSF egressportshapingisnotapplicableforthestandaloneconductordevice.
...
| Mbr Mac Address      |        | type                | Status   |
ID
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 25
...
n For the 6200 device, the default number can be changed to any value from 2 through 8. (The device
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 31
...
green.
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 33
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 37
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 39
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 41
...
VSF ISSU is supported on the Aruba 6300 Switch Series.
...
confirm.Changingtherollback-timerwillnotaffectanactivetimerandwill
...
allowed.
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 49
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 51
...
| 10.10          |                      | Commandintroduced.                 |          |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 53
...
member-2#
Membertoself:
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 55
...
| Finalize      | Upgrade        |     | Pending     | --         |          |
| ISSU Complete |                |     | Pending     | --         |          |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 57
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 59
...
| 2 08:97:34:b1:43:00     |     | JL665A         | Standby           |
| 3 08:97:34:b7:cc:00     |     | SOE91A         | Member            |
TheEgressShapeRatedisplaystheoperationalspeedofthestackwhentheVSFegressportshapingisapplied.
Anerrormessageisdisplayedifportshapingfailstoapplytotheinterface.ThepurposeoftheVSF egressport
shapingfeatureistoensurethatallVSF interfaceoperateatalowestcommonportspeedacrossthestack.This
featureissupportedonlyinthe6300switchseries.
| Command History |     |     |              |
| --------------- | --- | --- | ------------ |
| Release         |     |     | Modification |
...
| Topology    |     |     | : Chain             |
| Status      |     |     | : No Split          |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 63
...
| -------- | ---- | --- | --- | --- |
show vsf link
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 65
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 67
...
| 10.07orearlier |     | --           |     |     |     |     |     |     |
Command Information
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 69
...
| 10.07orearlier      |           |              | --           |     |     |     |     |     |
| Command Information |           |              |              |     |     |     |     |     |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 71
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 73
...
| Do you want     | to continue |            | (y/n)?          | y   |              |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 75
...
| --------------- | --- | ----------- | --- | --- | --- | --- |
Description
RenumbersVSFmember1toavaluefrom2through10(for6300devices)and2through8(forthe6200
...
| 10.07orearlier  |             |               |               |       | --           |                |
| Command         | Information |               |               |       |              |                |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 77
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 79
...
| 6300 |     |     | rightsforthiscommand. |
| ---- | --- | --- | --------------------- |
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 81
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 84
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 89
...
VSFcanbeformedwithacombinationofanyoftheAruba6300F/MSwitchSeriesoracombinationof
anyoftheAruba6200SwitchSeries(exceptR8Q72AandR8V13Awhichcanonlystackwithother
R8Q72AandR8V13ASKUs).
| Can I create | a stack | with a | mix of 6200 and 6300 | switches? |     |     |
| ------------ | ------- | ------ | -------------------- | --------- | --- | --- |
No,aVSFstackcannotbecreatedwithamixof6200and6300switches.Thestackmustbemadeupof
only6200oronly6300switches.Additionally,R8Q72AandR8V13ASKUscanstackonlywithother
R8Q72AandR8V13ASKUs.
Can I form a stack with a mix of 6200 switch series such as R8Q72A and any other SKU
| other than | R8Q72A | or R8V13A? |     |     |     |     |
| ---------- | ------ | ---------- | --- | --- | --- | --- |
No,anR8Q72ASKUswitchcanstackonlywithswitchesoftypeRQ72AorR8V13ASKU.
| What port | speeds | do VSF links | support? |     |     |     |
| --------- | ------ | ------------ | -------- | --- | --- | --- |
n 6200:VSFallowsstackstobeformedusinganycombinationofSKUsofthe6200family.Upto8
memberswitcheswillbeallowed.Connectionsbetweentheswitchesmustuse1GSFP/SFP+with1G
copperdownlinkportsor10Glinks.
...
must have a unique number in the range of 1-10 (for 6300 switches) or 1-8 (for 6200 switches).

What is the supported stack height and topology?

n 6200 platforms can stack up to 8 members with no modular SKU (only fixed SKU).
...
AOS-CX10.13VirtualSwitchingFramework(VSF)Guide|(6200,6300SwitchSeries) 93
...
n Thevsf renumber-tocommandwilltriggerthisconfigurationtotakeeffect.
Therecoveryconsolealsohascommandsthatallowtheusertocopysupportfilestoanexternalserver.
Thisfunctionalityisusefulfortroubleshootingstacking-relatedissues.
| How do | the | management | ports | of each member |     | in a stack work? |
| ------ | --- | ---------- | ----- | -------------- | --- | ---------------- |
Inastack,onlytheconductormanagementinterfaceisactive.Themanagementinterfacecanbe
assignedanIPaddressfordevicemanagementpurposes.Whenaconductordevicefails,thestandby
becomesconductorandactivatesitsmanagementinterface.
| How does | replacing |     | the conductor | switch | in a stack | work? |
| -------- | --------- | --- | ------------- | ------ | ---------- | ----- |
Thereplacementdevicemustbeofthesamepartnumberastheswitchbeingreplaced.Youmustalso
haveastandbyswitchconfiguredforreplacingtheconductorofastackwithoutlosingconfiguration.
...
Will VSF egress port shaping work on a stack without any S0E91A or S0X44A members?

No, VSF egress port shaping will only work on a stack if it contains either S0E91A or S0X44A SKU in the
stack.

How is VSF egress port shaping applied on a VSF link with multiple interfaces?

If a VSF link comprises of multiple interfaces, the egress port shape rate (if applied) is enforced
separately on each individual interfaces of the VSF link, not on the VSF link as a whole

Can I disable VSF egress port shaping?

No, VSF egress port shaping is automatically applied to a stack containing at least one member of type
S0E91A or S0X44A and cannot be disabled.

...
3
| AOS-CX10.09IPServicesGuide| | (6300and6400 | SwitchSeries) |     |
| --------------------------- | ------------ | ------------- | --- |
...
AOS-CX 10.09 IP Services Guide | (6300 and 6400 Switch Series)

5

| Overview                                              |                                   |         |          |        | 150 |
| ----------------------------------------------------- | --------------------------------- | ------- | -------- | ------ | --- |
| NDsnoopingcommands                                    |                                   |         |          |        | 150 |
|                                                       | clearnd-snoopingbinding           |         |          |        | 150 |
|                                                       | clearnd-snoopingstatistics        |         |          |        | 152 |
|                                                       | nd-snooping                       |         |          |        | 152 |
|                                                       | nd-snooping(inconfig-vlancontext) |         |          |        | 153 |
|                                                       | nd-snoopingmac-check              |         |          |        | 154 |
|                                                       | nd-snoopingprefix-list            |         |          |        | 154 |
|                                                       | nd-snoopingmax-bindings           |         |          |        | 155 |
|                                                       | nd-snoopingnd-guard               |         |          |        | 156 |
|                                                       | nd-snoopingra-guard               |         |          |        | 157 |
|                                                       | nd-snoopingra-drop                |         |          |        | 158 |
|                                                       | nd-snoopingtrust                  |         |          |        | 159 |
|                                                       | shownd-snooping                   |         |          |        | 160 |
|                                                       | shownd-snoopingbinding            |         |          |        | 161 |
|                                                       | shownd-snoopingprefix-list        |         |          |        | 162 |
|                                                       | shownd-snoopingstatistics         |         |          |        | 162 |
| IP Tunnels                                            |                                   |         |          |        | 164 |
...
| CreatinganIPv6inIPv6tunnelfortraversingapublicnetwork |                                   |         |          |        | 171 |
...
| ConfiguringdynamicARP inspectionoverVXLAN overlay |                             |           | 216 |
| ARPcommands                                       |                             |           | 216 |
|                                                   | arpinspection               |           | 216 |
|                                                   | arpinspectiontrust          |           | 217 |
|                                                   | arpipv4mac                  |           | 218 |
|                                                   | cleararp                    |           | 219 |
|                                                   | iplocal-proxy-arp           |           | 219 |
|                                                   | ipv6neighbormac             |           | 220 |
|                                                   | ipproxy-arp                 |           | 221 |
|                                                   | showarp                     |           | 222 |
...
|                                                   | showarptimeout              |           | 227 |
|                                                   | showarpvrf                  |           | 228 |
|                                                   | showipv6neighbors           |           | 229 |
|                                                   | showipv6neighborsstate      |           | 230 |
| Network                                           | Load Balancing              | (NLB)     | 232 |
| NLBcommands                                       |                             |           | 232 |
|                                                   | arpipv4mac                  |           | 232 |
|                                                   | showarp                     |           | 233 |
|                                                   | showipigmpsnoopingvlangroup |           | 234 |
...
ThisvaluehasonesettingperinterfaceanddoesnotapplytoRAssentinresponsetoaroutersolicitation
n
...
TheDHCPservercontainstheIPaddressesandconfigurationsettingsforanetworkasdefinedbyanetwork
administrator.ItrespondstoDHCPrequestsissuedbyDHCPclients,returningtherequestednetwork
configurationsettings.
TheDHCPclientrunsonanetworkdevice.ItissuesarequesttoaDHCPservertoobtainanIPaddressfor
thenetworkdevice,andothernetworksettings.
...
| DHCP relay | agent |     |
| ---------- | ----- | --- |
ThefunctionoftheDHCPrelayagentistoforwardtheDHCPmessagestoothersubnetssothattheDHCP
serverdoesnothavetobeonthesamesubnetastheDHCPclients.TheDHCPrelayagenttransfersDHCP
messagesfromtheDHCPclientslocatedonasubnetwithoutaDHCPserver,toothersubnets.Italsorelays
answersfromDHCPserverstoDHCPclients.
Supportedinterfaces
TheDHCPrelayagentissupportedonlayer3interfaces,layer3VLANinterfaces,andLAGinterfaces.DHCP
relayisnotsupportedonthemanagementinterface.
VRFsupport
TheDHCPrelayagentisVRFawareandbehavesasfollowswhenVRFsaredefinedontheswitch:
DHCPclientrequestsreceivedonaninterfaceareforwardedtotheconfiguredserversviatheVRFthat
n
theinterfaceispartof.
DHCPserverresponsesreceivedonaninterfaceareforwardedtotheclientthatisreachableviatheVRF
n
thattheinterfaceispartof.
| DHCPserver | interoperation |     |
| ---------- | -------------- | --- |
BothDHCPrelayandDHCPservercanbeconfiguredonthesameVRF.
| DHCPv4 relay | agent        |     |
| ------------ | ------------ | --- |
| Hopcountin   | DHCPrequests |     |
...
incrementsthehopcountbeforeforwardingDHCPpacketstotheserver.TheDHCPserver,inturn,includes
thehopcountintheDHCPheaderintheresponsesentbacktoaDHCPclient.
| DHCPrelayoption | 82  |     |
| --------------- | --- | --- |
Option82iscalledtherelayagentinformationoption.WhenaDHCPrelayagentforwardsclient-originated
DHCPpacketstoaDHCPserver,theoption82fieldisinserted/replaced,orthepacketwiththisoptionis
dropped.Serversrecognizingtherelayagentinformationoptionmayusetheinformationtoimplement
policiesfortheassignmentofIPaddressesandotherparameters.Therelayagentrelaystheserver-to-client
repliestotheclient.
65
| AOS-CX10.09IPServicesGuide| | (6300and6400 | SwitchSeries) |
| --------------------------- | ------------ | ------------- |
...
ThiscommandrequiresthatyoudefineasourceIPaddressforDHCPrelaywiththecommand
ip source-
...
| --- | --------------- | --- | --------- | ----- | --- | --- |
switch(config-if)#
|     |     |     | ip helper-address |     | 10.10.10.209 | vrf myvrf |
| --- | --- | --- | ----------------- | --- | ------------ | --------- |
...
|     | 1/1/2                |                 | 1.1.1.2         |               |           |       |
|     | switch#              | show            |                 |               |           |       |
|     |                      | ip              | helper-address  |               | interface | 1/1/1 |
|     | BOOTP Gateway        | Entries         |                 |               |           |       |
|     | Interface            |                 | Source          | IP            |           |       |
|     | -------------------- |                 | --------------- |               |           |       |
|     | 1/1/1                |                 | 1.1.1.1         |               |           |       |
...
| Platforms | Commandcontext | Authority |
| --------- | -------------- | --------- |
6300 config-dhcp-server Administratorsorlocalusergroupmemberswithexecutionrights
| 6400 |     | forthiscommand. |
| ---- | --- | --------------- |
bootp
bootp <REMOTE-URL>
...
| Platforms | Commandcontext | Authority |
| --------- | -------------- | --------- |
6300 config-dhcp-server-pool Administratorsorlocalusergroupmemberswithexecution
...
switch(config)#
no dhcp-server external-storage Storage1 file LeaseFile delay 600
CommandHistory
| Release        |     | Modification |
| -------------- | --- | ------------ |
| 10.07orearlier |     | --           |
...
clientstationswillgetaprefixlengthfromactivegatewaythatmay
notbeconsistentwiththeconfiguredrange,andaDHCPerrorwill
occur.Inthefollowingexample,theDHCPrangeprefixissetto16
tomatchthemaskontheIPaddressassignedtointerfaceVLAN2.
...
leases {all-vrfs | vrf <VRF-NAME>} ShowsDHCPv4serverleaseconfigurationsettingsforallVRFsor
aspecificVRF.
...
|     | Platforms | Commandcontext |     | Authority |
| --- | --------- | -------------- | --- | --------- |
6300 config-dhcpv6-server Administratorsorlocalusergroupmemberswithexecutionrights
|     | 6400                |        |     | forthiscommand. |
| --- | ------------------- | ------ | --- | --------------- |
|     | clear dhcpv6-server | leases |     |                 |
...
| Platforms | Commandcontext | Authority |
| --------- | -------------- | --------- |
6300 config-dhcpv6-server-pool Administratorsorlocalusergroupmemberswithexecution
6400 rightsforthiscommand.
enable
enable
Description
...
ShowsDHCPv6serverleaseconfigurationsettingsforallVRFsor
aspecificVRF.
pool <POOL-NAME> [vrf <VRF-NAME>] ShowsDHCPv6serverpoolconfigurationsettingsforallVRFsora
specificVRF.
Examples
...
switch#
|     | show           | dhcpv6-server |               | vrf | primary-vrf |     |
| --- | -------------- | ------------- | ------------- | --- | ----------- | --- |
|     | VRF Name       |               | : primary-vrf |     |             |     |
...
1. 6400 Switch Series only: In a VSX setup, the configured VSX Primary switch writes IP binding entries

to an external storage file. If the VSX Primary switch reboots, the IP Binding entries will not be synced
to the external storage file until the VSX Primary switch comes back up. Once the VSX Primary switch
comes up, it will sync entries from the VSX secondary switch and write the consolidated bindings to
external storage.

2. 6400 Switch Series only: In a VSX setup, external storage should be configured only after the VSX role
...
4. When a port is configured as a trusted port, all the dynamic IP binding entries learned on that port
...
7. 6300 and 6400 Switch Series: VXLAN tunnel is always considered as trusted for DHCPv4 and v6

snooping over VXLAN.

8. 6300 and 6400 Switch Series: VXLAN operational status must be in the forward state to forward the

packets over VXLAN tunnel.
...
If the server is connected through the VXLAN tunnel, then this step can be ignored. This is because the
VXLAN tunnel is always considered as trusted.

5. Validate the DHCPv4 and v6 snooping configuration with the commands show dhcpv4-snooping and
...
managementinterface.
ThenoformofthecommanddisablesDHCPv4snooping,flushingalltheIPbindingslearnedsinceDHCPv4snooping
wasenabled.
Examples
...
Whenconfigured,theswitchstoresalltheIPbindingsinanexternalstoragefilesothattheyareretained
aftertheswitchrestarts.Whentheswitchrestarts,itreadstheIPbindingsfromtheconfiguredexternal
storagefiletopopulateitslocalcache.
...
| Platforms | Commandcontext |     |     |     | Authority |     |     |
| --------- | -------------- | --- | --- | --- | --------- | --- | --- |
6300 config-vlan-<VLAN-ID> OperatorsorAdministratorsorlocalusergroupmemberswith
| 6400 |     |     |     |     | executionrightsforthiscommand.Operatorscanexecutethis |     |     |
| ---- | --- | --- | --- | --- | ----------------------------------------------------- | --- | --- |
commandfromtheoperatorcontext(>)only.
...
2001:1111:2222:3333:4444:5555:6666:7777 00:00:0C:01:02:03 4094 -
...
bedisplayed.Thebindingdatabaserecordcanbeidentifiedbyany
oneofinterface(port),ip,mac,orvlan.
...
OverwhelmingtheswitchcontrolplanewithtoomanyARPpackets.
n
...
Applicableonlyonthe6300SwitchSeries
Procedure
...
IftheconnectedportisVXLANtunnel,thenthisstepcanbeignored.ThisisbecausetheVXLANtunnelis
alwaysconsideredastrusted.
...
| --- | ---------------- | --- | --- | --- | ----------- | --- |
|     | ipv4 <IPV4-ADDR> |     |     |     |             |     |
SpecifiestheIPaddressoftheneighbororthevirtualIPaddressof
...
hexadecimal number from 0 to F. Range: 4096 to 131072. Default:
131072.

Specifies the MAC address of the neighbor
(xx:xx:xx:xx:xx:xx), where x is a hexadecimal number from 0

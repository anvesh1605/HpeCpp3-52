...
|                                                   | address(externalstorage)           |        |          |                    | 30  |
|                                                   | directory                          |        |          |                    | 31  |
|                                                   | disableexternal-storagelogfiles    |        |          |                    | 32  |
|                                                   | enable(external-storagelogfiles)   |        |          |                    | 32  |
|                                                   | external-storage                   |        |          |                    | 33  |
|                                                   | password(external-storage)         |        |          |                    | 34  |
|                                                   | showexternal-storage               |        |          |                    | 35  |
|                                                   | showrunning-configexternal-storage |        |          |                    | 36  |
|                                                   | type(externalstorage)              |        |          |                    | 36  |
|                                                   | username(externalstorage)          |        |          |                    | 37  |
|                                                   | vrf(externalstorage)               |        |          |                    | 38  |
3
AOS-CX10.09MonitoringGuide| (6300,6400SwitchSeries)
...
| downshiftenable                        |           |            | 55  |
| showinterface                          |           |            | 56  |
| showinterfacedownshift-enable          |           |            | 59  |
| showrunning-configinterface            |           |            | 60  |
| Mirroring                              |           |            | 63  |
| Mirrorstatistics                       |           |            | 63  |
| Classifierpoliciesandmirroringsessions |           |            | 63  |
| VLANasasource                          |           |            | 64  |
| Mirroringcommands                      |           |            | 64  |
| clearmirror                            |           |            | 64  |
| comment                                |           |            | 65  |
| copytcpdump-pcap                       |           |            | 66  |
| copytshark-pcap                        |           |            | 67  |
...
| diagnostic                             |           |            | 71  |
| diagutilitiestcpdump                   |           |            | 72  |
| disable(mirrorsession)                 |           |            | 74  |
| enable(mirrorsession)                  |           |            | 75  |
| mirrorsession                          |           |            | 76  |
| showmirror                             |           |            | 76  |
| sourceinterface                        |           |            | 78  |
| sourcevlan                             |           |            | 80  |
| Monitoring                             | a device  | using SNMP | 82  |
| Power-over-Ethernet                    |           |            | 83  |
| PoEcommands                            |           |            | 84  |
| lldpdot3poe                            |           |            | 84  |
| lldpmedpoe                             |           |            | 85  |
| power-over-ethernet                    |           |            | 85  |
| power-over-ethernetallocate-by         |           |            | 86  |
Contents|4

|                                                  | power-over-ethernetalways-on      |           | 87  |
| ------------------------------------------------ | --------------------------------- | --------- | --- |
|                                                  | power-over-ethernetassigned-class |           | 88  |
|                                                  | power-over-ethernetpower-pairs    |           | 89  |
|                                                  | power-over-ethernetpre-std-detect |           | 90  |
|                                                  | power-over-ethernetpriority       |           | 91  |
|                                                  | power-over-ethernetquick-poe      |           | 92  |
|                                                  | power-over-ethernetthreshold      |           | 93  |
|                                                  | power-over-ethernettrap           |           | 93  |
|                                                  | showlldplocal                     |           | 94  |
|                                                  | showlldpneighbor                  |           | 95  |
|                                                  | showpower-over-ethernet           |           | 96  |
| Aruba                                            | AirWave                           |           | 104 |
| SNMPsupportandAirWave                            |                                   |           | 104 |
|                                                  | SNMPontheswitch                   |           | 104 |
| SupportedfeatureswithAirWaveandtheAOS-CXswitch   |                                   |           | 105 |
| ConfiguringtheAOS-CXswitchtobemonitoredbyAirWave |                                   |           | 105 |
...
AOS-CX 10.09 Monitoring Guide | (6300, 6400 Switch Series)
...
| --------- | --- | --- | ----------- | --- | --- |
<TUNNEL-IPV4-ADDR>
SpecifiesthetunneladdressinIPv4format(x.x.x.x),wherexis
adecimalnumberfrom0to255.
<SOURCE-IPv4-ADDR>
SpecifiesthesourceaddressinIPv4format(x.x.x.x),wherexis
adecimalnumberfrom0to255.
...
defaultisused.
count <COUNT-NUM>
Runsthetcpdumpcommanduntilthespecifiednumberof

...
|                                                         | object-groupaddressresequence          | 59  |
|                                                         | object-groupaddressreset               | 59  |
|                                                         | object-groupallreset                   | 60  |
|                                                         | object-groupipaddress                  | 61  |
|                                                         | object-groupipv6address                | 63  |
|                                                         | object-groupport                       | 65  |
|                                                         | object-groupportresequence             | 67  |
|                                                         | object-groupportreset                  | 68  |
|                                                         | showaccess-list                        | 68  |
|                                                         | showaccess-listcontrol-plane           | 74  |
|                                                         | showaccess-listhitcounts               | 76  |
|                                                         | showaccess-listhitcountscontrol-plane  | 79  |
|                                                         | showcapacities                         | 80  |
|                                                         | showcapacities-status                  | 82  |
|                                                         | showobject-group                       | 83  |
| ACL configuration                                       | examples                               | 86  |
3
AOS-CX10.09ACLsandClassifierPoliciesGuide| (6300,6400,8360SwitchSeries)

| IPv4ACLexampleoverview                                    |          |     |     | 86  |
| --------------------------------------------------------- | -------- | --- | --- | --- |
| DefiningandapplyinganIPv4ACL                              |          |     |     | 86  |
| IPv6ACLexampleoverview                                    |          |     |     | 87  |
...
|                          | applypolicy(config)                               |     |     | 96  |
applypolicy(config-if,config-lag-if,config-if-vlan,config-vlan) 97
|                                         | classcopy            |               |                | 101 |
| --------------------------------------- | -------------------- | ------------- | -------------- | --- |
|                                         | classip              |               |                | 102 |
|                                         | classipv6            |               |                | 110 |
...
| TCAMlookups                             |                      |               |                | 141 |
| Matchingprecedenceorder                 |                      |               |                | 142 |
| L4portranges                            |                      |               |                | 142 |
| Contextgroupselectors                   |                      |               |                | 143 |
| ACLandPolicyhardwareresourcecommands    |                      |               |                | 144 |
|                                         | showresources        |               |                | 144 |
|                                         | showresources        |               |                | 146 |
| Support                                 | and Other            | Resources     |                | 148 |
| AccessingArubaSupport                   |                      |               |                | 148 |
...
AOS-CX 10.09 ACLs and Classifier Policies Guide | (6300, 6400, 8360 Switch Series)
...
The following match criteria is not supported. If this match criteria is attempted to be configured, an error

message will be displayed and the action will not be completed.

TTL on IP ACLs

To apply IPv4 and/or IPv6 ACLs to the management interface, apply them to the control plane on the management
...
| --------- | --- | ----------- | --- | --- |
decimalnotation).
<ADDRESS-GROUP>-specifiesanIPv4addressgroupthatyoudefined
n
|     |     | earlierwithobject-group ip | address. |     |
| --- | --- | -------------------------- | -------- | --- |
[{eq|gt|lt} <PORT>|range Specifiestheport, portrange,orportgroup.Portnumbersareinthe
| <MIN-PORT><MAX-PORT>|group |     | rangeof0to65535. |     |     |
| -------------------------- | --- | ---------------- | --- | --- |
<PORT-GROUP>]
n eq <PORT>-specifiestheLayer4port.
gt <PORT>-specifiesanyLayer4portgreaterthantheindicated
n
port.
lt <PORT>-specifiesanyLayer4portlessthantheindicatedport.
n
n range <MIN-PORT> <MAX-PORT>-specifiestheLayer4portrange.
n group <PORT-GROUP>-specifiestheLayer4portgroupthatyou
|     |     | definedearlierwithobject-group | port. |     |
| --- | --- | ------------------------------ | ----- | --- |
...
| psh |     | SpecifiesmatchingontheTCPFlag:Push            | buffered | data to |
receiving application.
| rst |     | SpecifiesmatchingontheTCPFlag:Reset | the | connection. |
| --- | --- | ----------------------------------- | --- | ----------- |
syn SpecifiesmatchingontheTCPFlag:Synchronize sequence numbers.
fin
...
n
n <ICMP-TYPE-VALUE>-specifiesanICMPtypevalue.Range:0to255.
| [icmp-code | <ICMP-CODE-VALUE>] |     |     |     |
| ---------- | ------------------ | --- | --- | --- |
SpecifiestheICMPcodevalue.Range:0to255.
dscp DSCP-SPECIFIER> SpecifiestheDifferentiatedServicesCodePoint(DSCP),eitheranumeric
<DSCP-VALUE>(0to63)oroneofthesekeywords:
AF11-DSCP10(AssuredForwardingClass1,lowdropprobability)
n
n AF12-DSCP12(AssuredForwardingClass1,mediumdrop
probability)
n AF13-DSCP14(AssuredForwardingClass1,highdropprobability)
AF21-DSCP18(AssuredForwardingClass2,lowdropprobability)
n
...
access-listcommandonasubinterfacewithanalready-appliedACLofthesametypewillreplacethe
currentlyappliedACL.
...
subinterfacewillbeshutdown.FixingthefailurewillcausetheLAGsubinterfacetocomebackup.For
thiscasetooccur,theACLmustalreadybesuccessfullyappliedtoexistingsubinterfaceLAGmembers.
ThisisdonetopreventtrafficfromcircumventingtheACLbypassingthroughnewLAGmemberswhere
AccessControlLists|53

theACLwasnotsuccessfullyapplied.ThisonlyoccurswhentheLAGspansmorethanonelinecardor
stackmember.
Examples
Onthe6400SwitchSeries,interfaceidentificationdiffers.
...
mayoptionallyincludeasubinterfaceID<SUB-INT>intherange1
to4094intheform<IF-NAME>.<SUB-INT>,forexample
1/1/4.1.
...
objectgroupscanberesetrespectivelywiththeobject-group resetandobject-group
address port
resetcommands.
Examples
...
Specifies a sequence number for the address entry.
Range: 1 to 4294967295. When omitted, a
sequence number 10 larger than the current
highest sequence number is auto-assigned. Default
auto-assigned sequence numbers are 10, 20, 30,
and so on.

Specifies the IPv4 address.
n <IP-ADDRESS> - specifies the IPv4 host address.
n <PREFIX-LENGTH> - specifies the address bits
to mask (CIDR subnet mask notation). Range: 1

to 32.

n <SUBNET-MASK> - specifies the address bits to
...
n <IP-ADDRESS> - specifies the IPv6 host address.

o <PREFIX-LENGTH> - specifies the address
bits to mask (CIDR subnet mask notation).

Range: 1 to 128.

o <SUBNET-MASK> - specifies the address bits
...
Parameter Description
NOTE:
WhenACLsusingACEsdefinedwithportgroupsare
applied,thesamenumberofhardwareresourcesare
consumedaswhentheportsarespecifieddirectlyin
theACEsandnotinagroup.Keepthisinmindwhen
creatingportgroupsthatincludemanyports.
Althoughhardwareresourceconsumptionisthe
same,withorwithoutportgroupsused,itmaynot
beimmediatelyobviousthatsomeportgroupsthat
youhavedefined,includemanyports.Itis
recommendedthatyounameportgroupsina
mannerthatremindsyouthatagroupincludes
manyports.
Examples
...
may optionally include a subinterface ID <SUB-INT> in the range 1
to 4094 in the form <IF-NAME>.<SUB-INT>, for example
1/1/4.1.
...
ThecontentofaspecificACLthathasbeenappliedtotheControlPlane.
n
...
Specifies the object group type, either address for an IP address,
or port.
...
commands and parameters used to create it rather than in
tabular form.

Specifies that the user-configured object groups be shown as
configured. The output of the command with this parameter may
not be the same as what is active on the switch due to a
misconfigured object group. See Examples in this topic.
...
n 6400 Switch Series only: When a policy is applied to a VLAN, it will create hardware entries on all line cards

and stack members regardless of whether a VLAN member exists on any specific line card.
...
| --------- | -------------- | --- | --- | --------- | --- | --- |
6300 config Administratorsorlocalusergroupmemberswithexecutionrights
| 6400 | Theclass          | mac <CLASS- |     | forthiscommand. |     |     |
| ---- | ----------------- | ----------- | --- | --------------- | --- | --- |
| 8360 | NAME>commandtakes |             |     |                 |     |     |
youintotheconfig-
class-maccontext
...
switch#
|            | show | policy     | hitcounts  | My_Policy | vrf | green routed-in |
| ---------- | ---- | ---------- | ---------- | --------- | --- | --------------- |
| Statistics |      | for Policy | My_Policy: |           |     |                 |
VRF green
...
IngresssubinterfaceapplicationssharelookupswithingressVLANapplications.
| Ingress | Port IP ACL   |                 |       |     |     |     |
| ------- | ------------- | --------------- | ----- | --- | --- | --- |
...
members.Onthe6400switch,showshardwareresourceconsumptionforthespecifiedlinemoduleorfor
alllinemodules.Resourcedataisupdatedevery10seconds.

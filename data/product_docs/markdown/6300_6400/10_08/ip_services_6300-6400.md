...
3
| AOS-CX10.08IPServicesGuide| | (6300and6400 | SwitchSeries) |     |
| --------------------------- | ------------ | ------------- | --- |
...
AOS-CX 10.08 IP Services Guide | (6300 and 6400 Switch Series)

5

|                                                       | nd-snooping(inconfig-vlancontext) |         |          |        | 150 |
| ----------------------------------------------------- | --------------------------------- | ------- | -------- | ------ | --- |
|                                                       | nd-snoopingmac-check              |         |          |        | 151 |
|                                                       | nd-snoopingprefix-list            |         |          |        | 151 |
|                                                       | nd-snoopingmax-bindings           |         |          |        | 152 |
|                                                       | nd-snoopingnd-guard               |         |          |        | 153 |
|                                                       | nd-snoopingra-guard               |         |          |        | 154 |
|                                                       | nd-snoopingra-drop                |         |          |        | 155 |
|                                                       | nd-snoopingtrust                  |         |          |        | 156 |
|                                                       | shownd-snooping                   |         |          |        | 157 |
|                                                       | shownd-snoopingbinding            |         |          |        | 158 |
|                                                       | shownd-snoopingprefix-list        |         |          |        | 159 |
|                                                       | shownd-snoopingstatistics         |         |          |        | 159 |
| IP Tunnels                                            |                                   |         |          |        | 161 |
| ConfiguringanIPtunnel                                 |                                   |         |          |        | 162 |
| CreatingaGREtunnelfortraversingapublicnetwork         |                                   |         |          |        | 162 |
| CreatingtwoGREtunnelstodifferentdestinationaddresses  |                                   |         |          |        | 164 |
| CreatinganIPv6inIPv4tunnelfortraversingapublicnetwork |                                   |         |          |        | 166 |
| CreatinganIPv6inIPv6tunnelfortraversingapublicnetwork |                                   |         |          |        | 168 |
| IPtunnelscommands                                     |                                   |         |          |        | 169 |
|                                                       | description                       |         |          |        | 169 |
|                                                       | destinationip                     |         |          |        | 170 |
|                                                       | destinationipv6                   |         |          |        | 171 |
|                                                       | interfacetunnel                   |         |          |        | 172 |
...
|                                                       | ipv6address                       |         |          |        | 175 |
|                                                       | ipmtu                             |         |          |        | 176 |
|                                                       | showinterfacetunnel               |         |          |        | 177 |
|                                                       | showrunning-configinterfacetunnel |         |          |        | 179 |
|                                                       | shutdown                          |         |          |        | 180 |
|                                                       | sourceip                          |         |          |        | 181 |
|                                                       | sourceipv6                        |         |          |        | 182 |
|                                                       | ttl                               |         |          |        | 183 |
|                                                       | vrfattach                         |         |          |        | 184 |
| IP Source                                             | Lockdown                          |         |          |        | 186 |
| IPv4sourcelockdowncommands                            |                                   |         |          |        | 186 |
|                                                       | ipv4source-binding                |         |          |        | 186 |
|                                                       | ipv4source-lockdown               |         |          |        | 187 |
|                                                       | ipv4source-lockdownhardwareretry  |         |          |        | 188 |
|                                                       | showipv4source-binding            |         |          |        | 189 |
|                                                       | showipv4source-lockdown           |         |          |        | 189 |
| IPv6sourcelockdowncommands                            |                                   |         |          |        | 192 |
|                                                       | ipv6source-binding                |         |          |        | 192 |
|                                                       | ipv6source-lockdown               |         |          |        | 193 |
|                                                       | ipv6source-lockdownhardwareretry  |         |          |        | 194 |
|                                                       | showipv6source-binding            |         |          |        | 195 |
|                                                       | showipv6source-lockdown           |         |          |        | 196 |
| Internet                                              | Control                           | Message | Protocol | (ICMP) | 199 |
| ICMPmessagetypes                                      |                                   |         |          |        | 199 |
| WhenICMPmessagesaresent                               |                                   |         |          |        | 199 |
| ICMPredirectmessages                                  |                                   |         |          |        | 200 |
| WhenICMPredirectmessagesaresent                       |                                   |         |          |        | 200 |
| ICMPcommands                                          |                                   |         |          |        | 200 |
|                                                       | ipicmpredirect                    |         |          |        | 200 |
Contents|6
...
|     | ipicmpthrottle    |     | 201 |
| --- | ----------------- | --- | --- |
|     | ipicmpunreachable |     | 202 |
DNS 203
| DNSclient               |                    |     | 203 |
| ----------------------- | ------------------ | --- | --- |
| ConfiguringtheDNSclient |                    |     | 203 |
| DNSclientcommands       |                    |     | 204 |
|                         | ipdnsdomain-list   |     | 204 |
|                         | ipdnsdomain-name   |     | 205 |
|                         | ipdnshost          |     | 206 |
|                         | ipdnsserveraddress |     | 207 |
|                         | showipdns          |     | 208 |
ARP 211
| ConfiguringproxyARP      |                             |           | 212 |
| ------------------------ | --------------------------- | --------- | --- |
| ConfiguringlocalproxyARP |                             |           | 212 |
| DynamicARPInspection     |                             |           | 213 |
| ARPcommands              |                             |           | 214 |
|                          | arpinspection               |           | 214 |
|                          | arpinspectiontrust          |           | 214 |
|                          | arpipv4mac                  |           | 215 |
|                          | cleararp                    |           | 216 |
|                          | iplocal-proxy-arp           |           | 217 |
|                          | ipv6neighbormac             |           | 218 |
|                          | ipproxy-arp                 |           | 219 |
|                          | showarp                     |           | 219 |
|                          | showarpinspectioninterface  |           | 220 |
|                          | showarpinspectionstatistics |           | 221 |
|                          | showarpstate                |           | 222 |
|                          | showarpsummary              |           | 223 |
|                          | showarptimeout              |           | 225 |
|                          | showarpvrf                  |           | 226 |
|                          | showipv6neighbors           |           | 227 |
|                          | showipv6neighborsstate      |           | 228 |
| Network                  | Load Balancing              | (NLB)     | 230 |
| NLBcommands              |                             |           | 230 |
|                          | arpipv4mac                  |           | 230 |
|                          | showarp                     |           | 231 |
|                          | showipigmpsnoopingvlangroup |           | 231 |
| Support                  | and Other                   | Resources | 233 |
| AccessingArubaSupport    |                             |           | 233 |
| AccessingUpdates         |                             |           | 233 |
|                          | ArubaSupportPortal          |           | 233 |
|                          | MyNetworking                |           | 234 |
| WarrantyInformation      |                             |           | 234 |
| RegulatoryInformation    |                             |           | 234 |
| DocumentationFeedback    |                             |           | 234 |
7
| AOS-CX10.08IPServicesGuide| | (6300and6400 | SwitchSeries) |     |
| --------------------------- | ------------ | ------------- | --- |
...
DNSservers:125.0.0.1and125.0.0.2.
o
...
leases {all-vrfs | vrf <VRF-NAME>} ShowsDHCPv6serverleaseconfigurationsettingsforallVRFsora
specificVRF.
...
Configures switch flash storage to be used for backing up client IP bindings (used by DHCPv4 snooping).
...
To reduce switch flash aging it is recommended that you use external storage (command dhcpv4-snooping
...
| --------------- | --- | --------- | ----- | --- | --- | --- | --- |
switch(config-if)#
|                    |     | dhcpv4-snooping |     |     | max-bindings | 512 |     |
| ------------------ | --- | --------------- | --- | --- | ------------ | --- | --- |
| switch(config-if)# |     | exit            |     |     |              |     |     |
switch(config)#
...
Description
ConfiguresexternalstoragetobeusedforbackingupIPv6bindings(usedbyDHCPv6snooping)toafile.
Whenconfigured,theswitchstoresalltheIPbindingsinanexternalstoragefilesothattheyareretained
aftertheswitchrestarts.Whentheswitchrestarts,itreadstheIPv6bindingsfromtheconfiguredexternal
storagefiletopopulateitslocalcache.
DHCPsnooping|138
...
| Release        |     | Modification                  |     |
| -------------- | --- | ----------------------------- | --- |
| 10.08          |     | Addedflashstorageinformation. |     |
| 10.07orearlier |     | --                            |     |
CommandInformation
| Platforms | Commandcontext | Authority |     |
| --------- | -------------- | --------- | --- |
...
|     | Parameter |     |     |     | Description |     |
| --- | --------- | --- | --- | --- | ----------- | --- |
<MAX-BINDINGS> SpecifiesthemaximumnumberofDHCPv6bindings.Youcanuse
|     |     |     |     |     | theshow capacitiescommandtoseethemaximumavailable |     |
| --- | --- | --- | --- | --- | ------------------------------------------------- | --- |
foryourswitchmodel.
Examples
...
| --------------- | --- | ---------- | -------- | --- |
CommandHistory
InternetControlMessageProtocol(ICMP)|200
...
Allplatforms config Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
InternetControlMessageProtocol(ICMP)|202

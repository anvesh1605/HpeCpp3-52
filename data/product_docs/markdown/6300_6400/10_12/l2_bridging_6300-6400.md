...
| VLANscenario                        |                                               | 37  |
3
AOS-CX10.12Layer-2BridgingGuide| 6300,6400SwitchSeries
...
|                                    | showspanning-treemstdetail              |       | 149 |
|                                    | showspanning-treemst<INSTANCE-ID>       |       | 153 |
|                                    | showspanning-treemst<INSTANCE-ID>detail |       | 154 |
5
AOS-CX10.12Layer-2BridgingGuide| 6300,6400SwitchSeries
...
|                                   | showspanning-treesummaryroot            |           | 216 |
| --------------------------------- | --------------------------------------- | --------- | --- |
|                                   | showspanning-treevlan                   |           | 217 |
|                                   | showspanning-treevlandetail             |           | 218 |
|                                   | spanning-treebpdu-guardtimeout          |           | 220 |
|                                   | spanning-treeextend-system-id           |           | 220 |
|                                   | spanning-treeignore-pvid-inconsistency  |           | 221 |
|                                   | spanning-treelink-type                  |           | 222 |
|                                   | spanning-treemode                       |           | 223 |
|                                   | spanning-treepathcost-type              |           | 225 |
|                                   | spanning-treerpvst-mstpinterconnectvlan |           | 226 |
|                                   | spanning-treetcn-guard                  |           | 226 |
|                                   | spanning-treevlan                       |           | 227 |
|                                   | spanning-treevlancost                   |           | 228 |
|                                   | spanning-treevlanport-priority          |           | 229 |
|                                   | spanning-treetrap                       |           | 230 |
| RPVST+debuggingandtroubleshooting |                                         |           | 233 |
| RPVST+FAQ                         |                                         |           | 234 |
| UDLD                              |                                         |           | 235 |
| ConfiguringUDLD                   |                                         |           | 236 |
| UDLDscenario                      |                                         |           | 237 |
| UDLDcommands                      |                                         |           | 238 |
|                                   | clearudldstatistics                     |           | 238 |
|                                   | showudld                                |           | 239 |
|                                   | udld                                    |           | 241 |
|                                   | udldinterval                            |           | 242 |
|                                   | udldmode                                |           | 244 |
|                                   | udldretries                             |           | 245 |
| Private                           | VLAN                                    |           | 247 |
| PrivateVLANcommands               |                                         |           | 253 |
|                                   | diag-dumpprivate-vlanbasic              |           | 253 |
|                                   | private-vlan                            |           | 253 |
|                                   | private-vlanport-type                   |           | 254 |
|                                   | showcapacitiesprivate-vlan              |           | 256 |
|                                   | showcapacities-statusprivate-vlan       |           | 256 |
|                                   | showprivate-vlan                        |           | 257 |
|                                   | showprivate-vlanassociation             |           | 258 |
|                                   | showprivate-vlaninconsistency           |           | 259 |
|                                   | showprivate-vlanport-type               |           | 261 |
|                                   | showrunning-configurationprivate-vlan   |           | 261 |
|                                   | showtechprivate-vlan                    |           | 262 |
| Support                           | and Other                               | Resources | 265 |
| AccessingArubaSupport             |                                         |           | 265 |
| AccessingUpdates                  |                                         |           | 266 |
|                                   | ArubaSupportPortal                      |           | 266 |
|                                   | MyNetworking                            |           | 266 |
| WarrantyInformation               |                                         |           | 266 |
| RegulatoryInformation             |                                         |           | 266 |
| DocumentationFeedback             |                                         |           | 267 |
7
AOS-CX10.12Layer-2BridgingGuide| 6300,6400SwitchSeries
...
The number of secondary ports allowed is restricted based on the hardware resources available. Some
platforms do not have any restriction.
...
6400 with the following profiles configured:
...
Number of PVLAN secondary ports* allowed
...
24 for JL720A/JL720C models
No limit for all other models

8325/10000

No limit

*physical ports per line card or LAGs

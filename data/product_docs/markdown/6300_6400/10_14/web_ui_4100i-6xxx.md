...
AOS-CX 10.14.xxxx Introduction to the Web UI Guide | (4100i, 6xxx Switch Series)
...
| TroubleshootingWebUIaccessissues    |                                                |               | 11  |
|                                     | HTTP404errorwhenaccessingtheswitchURL          |               | 11  |
|                                     | HTTP401error"Loginfailed:sessionlimitreached"  |               | 11  |
|                                     | "NotAuthorized"isdisplayedinsteadofpagecontent |               | 12  |
| AOS-CX                              | Web                                            | UI overview   | 13  |
| AOS-CXWebUIframework                |                                                |               | 13  |
| CustomizingtheWebUI                 |                                                |               | 14  |
|                                     | Customizingpagelayouts                         |               | 15  |
|                                     | AddingacustompaneltotheOverviewpage            |               | 15  |
|                                     | Customizingtables                              |               | 17  |
...
4
AOS-CX10.14.xxxxIntroductiontotheWebUIGuide| (4100i,6xxxSwitchSeries)
...
|                                       | DownloadingfirmwarefromaremoteHTTPserver             |         |           |          | 51  |
| FirmwareMgmtpage                      |                                                      |         |           |          | 52  |
|                                       | EnablingfirmwaresitedistributionusingtheCLI          |         |           |          | 52  |
|                                       | EnablingfirmwaresitedistributionusingtheWebUI        |         |           |          | 52  |
| Pingpage                              |                                                      |         |           |          | 53  |
| Traceroutepage                        |                                                      |         |           |          | 54  |
| ShowTechpage                          |                                                      |         |           |          | 55  |
| SpanningTreepage                      |                                                      |         |           |          | 55  |
...
|                                       | Editingconnecteddevicesattheswitchlevel              |         |           |          | 58  |
|                                       | Editingconnecteddevicesconfigurationatinterfacelevel |         |           |          | 59  |
| PKIpage                               |                                                      |         |           |          | 59  |
|                                       | AddinganddeletinganESTProfile                        |         |           |          | 61  |
|                                       | ViewinganESTProfile                                  |         |           |          | 61  |
|                                       | AddinganddeletingaTAProfile                          |         |           |          | 61  |
|                                       | EditingaTAProfile                                    |         |           |          | 63  |
|                                       | Addinganddeletingacertificate                        |         |           |          | 63  |
|                                       | Uploadingacertificate                                |         |           |          | 64  |
|                                       | Viewinganddownloadingacertificate                    |         |           |          | 65  |
|                                       | Editingassociatedapplicationdetails                  |         |           |          | 65  |
| PortSecuritypage                      |                                                      |         |           |          | 66  |
|                                       | Editingportsecurity                                  |         |           |          | 66  |
| SupportFilepage                       |                                                      |         |           |          | 67  |
|                                       | Creatinganddeletingsupportfiles                      |         |           |          | 68  |
|                                       | Downloadingasupportfile                              |         |           |          | 69  |
| Finding                               | alert details                                        | using   | the Web   | UI       | 70  |
| Working                               | with the                                             | network | analytics | features | 73  |
| ViewingagentinformationusingtheWebUI  |                                                      |         |           |          | 73  |
| WorkingwithanAnalyticstimeseriesgraph |                                                      |         |           |          | 77  |
|                                       | Customizingdatadisplayedonthegraph                   |         |           |          | 78  |
|                                       | Zoominginonthegraph                                  |         |           |          | 79  |
|                                       | Downloadingthegraphasanimageor.csvfile               |         |           |          | 80  |
|                                       | Viewinganalertonthegraph                             |         |           |          | 80  |
ArubaNetworkAnalyticsEnginescripts,agents,andtroubleshootinginformation 83
| Support                            | and Other | Resources |     |     | 85  |
| ---------------------------------- | --------- | --------- | --- | --- | --- |
| AccessingHPEArubaNetworkingSupport |           |           |     |     | 85  |
| AccessingUpdates                   |           |           |     |     | 86  |
| WarrantyInformation                |           |           |     |     | 86  |
| RegulatoryInformation              |           |           |     |     | 86  |
...
and 6400 switches. The 4100i, 6000, and 6100 switches do not have a mgmt VRF, so https-server is
...
| ----------- | ----- | --- |
Todeleteauser:
1. IntheUserspane,selecttheusertodelete,andclickDelete.Youcannotdeletethedefault
administratoruser.
...
Prerequisites
Youmusthavetheadministratorroletoaddordeleteusers.
Procedure
Tochangethepasswordforauser:
1. Inthenavigationpane,selectUsers.
TheUserspageisdisplayed.
2. IntheUserspanel,selecttheuser,andclickChange Password.
TheChangingPassworddialogboxisdisplayed.
3. Enterthecurrentpassword.
4. Enterthenewpasswordandconfirmthepassword.
Thepasswordcancontainamaximumof32characterswithoutaspace.
| 5. ClickChange | Password. |     |
| -------------- | --------- | --- |
PoE page
ThePoEpagedisplaysthedetailsofthePoEenabledportsintheswitch.Thispageisdisplayedforall
switchesthatcanbestackedandforswitchesthathavePoEports.
| Figure1 PoEpage |     |     |
| --------------- | --- | --- |
AOS-CXWebUIpages|34
...
Priority:Theprioritylevel—Critical,High,orLow.
n
...
| ------- | ------- | --- | --- | --- |
| Summary | panel   |     |     |     |
TheSummarypanelshowsthetopology,splitstatus,splitdetectionmethod,andhealthstatusofthe
switchinthestack.
AOS-CXWebUIpages|36
...
| Figure1 | SNMPPage |     |
| ------- | -------- | --- |
AOS-CX10.14.xxxxIntroductiontotheWebUIGuide|(4100i,6xxxSwitchSeries) 41
...
AOS-CX10.14.xxxxIntroductiontotheWebUIGuide|(4100i,6xxxSwitchSeries) 45
...
Figure7
AOS-CX10.14.xxxxIntroductiontotheWebUIGuide|(4100i,6xxxSwitchSeries) 51
...
AOS-CX10.14.xxxxIntroductiontotheWebUIGuide|(4100i,6xxxSwitchSeries) 57
...
Discovery Protocol (LLDP), and client tracking are enabled or disabled at the switch and interface level.
You can configure these settings to discover and share information about the connected network
devices at the switch and interface level.

Figure 1 Connected Devices page

Status panel

The Status panel displays the status of CDP, LLDP, client tracking, and client tracking probe at the
switch level. You can edit and change the configuration.
...
without reading them. This prevents the switch from learning about LLDP neighbors on that
port.
...
| Figure1      | WebUIOverviewDashboard |     |
| ------------ | ---------------------- | --- |
| Access Ports | panel                  |     |
...
This chapter is not applicable to the 6000 or 6100 Switch Series, which do not support the Network Analytics
...
Working with the network analytics features | 76
...
Working with the network analytics features | 78
...
Working with the network analytics features | 80
...
Working with the network analytics features | 82
...
following:
AOS-CX10.14.xxxxIntroductiontotheWebUIGuide|(4100i,6xxxSwitchSeries) 83
...
Working with the network analytics features | 84

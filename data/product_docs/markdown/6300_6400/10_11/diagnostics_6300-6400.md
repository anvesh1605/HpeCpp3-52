...
3
AOS-CX10.11DiagnosticsandSupportabilityGuide| (6300,6400SwitchSeries)
...
|                                        | copycore-dump[<MEMBER/SLOT>]daemon              |           | 45  |
|                                        | copycore-dump[<MEMBER/SLOT>]kernel              |           | 46  |
|                                        | copycore-dump[<MEMBER/SLOT>]kernel<STORAGE-URL> |           | 48  |
|                                        | copycore-dumpvsfmemberdaemon                    |           | 48  |
|                                        | copycore-dumpvsfmemberkernel                    |           | 49  |
|                                        | copydiag-dumpfeature<FEATURE>                   |           | 50  |
...
|                                        | ping6                                           |           | 81  |
| Troubleshooting                        |                                                 |           | 84  |
|                                        | Operationnotpermitted                           |           | 84  |
|                                        | Networkisunreachable                            |           | 85  |
|                                        | Destinationhostunreachable                      |           | 85  |
| Remote                                 | syslog                                          |           | 86  |
| Remotesyslogcommands                   |                                                 |           | 86  |
|                                        | clearaccounting-logs                            |           | 86  |
Contents|4
...
|                                     | diagon-demand                   | 97  |
|                                     | showdiagnostic                  | 99  |
|                                     | showdiagnosticevents            | 103 |
| Service                             | OS                              | 105 |
| ServiceOSCLIlogin                   |                                 | 105 |
| ServiceOSuseraccounts               |                                 | 106 |
| ServiceOSbootmenu                   |                                 | 106 |
| Consoleconfiguration                |                                 | 107 |
| AOS-CXboot                          |                                 | 107 |
| Filesystemaccess                    |                                 | 108 |
| ServiceOSmountfailure               |                                 | 109 |
| ServiceOSCLIcommandlist             |                                 | 109 |
| ServiceOSCLIfeaturesandlimitations  |                                 | 110 |
| ServiceOSCLIcommands                |                                 | 110 |
|                                     | boot                            | 110 |
|                                     | cat                             | 111 |
|                                     | cdpath                          | 112 |
|                                     | config-clear                    | 112 |
...
|                                     | tftp                            | 132 |
|                                     | version                         | 133 |
| In-System                           | Programming                     | 134 |
| ShowtechcommandlistfortheISPfeature |                                 | 134 |
| In-SystemProgrammingcommands        |                                 | 134 |
5
AOS-CX10.11DiagnosticsandSupportabilityGuide| (6300,6400SwitchSeries)

|                                               | clearupdate-log                          |           |             |            |        | 134 |
| --------------------------------------------- | ---------------------------------------- | --------- | ----------- | ---------- | ------ | --- |
|                                               | showneeded-updates                       |           |             |            |        | 134 |
| Selftest                                      |                                          |           |             |            |        | 136 |
| Selftestcommands                              |                                          |           |             |            |        | 136 |
|                                               | fastboot                                 |           |             |            |        | 136 |
|                                               | showselftest                             |           |             |            |        | 138 |
| Zeroization                                   |                                          |           |             |            |        | 142 |
| Zeroizationcommands                           |                                          |           |             |            |        | 142 |
|                                               | eraseallzeroize                          |           |             |            |        | 142 |
| Terminal                                      | Monitor                                  |           |             |            |        | 145 |
| Terminalmonitorcommands                       |                                          |           |             |            |        | 145 |
|                                               | loggingconsole{notify|severity|filter}   |           |             |            |        | 145 |
|                                               | showterminal-monitor                     |           |             |            |        | 146 |
|                                               | terminal-monitor{notify|severity|filter} |           |             |            |        | 147 |
| Troubleshooting                               |                                          | Web       | UI and REST | API Access | Issues | 149 |
| HTTP404errorwhenaccessingtheswitchURL         |                                          |           |             |            |        | 149 |
| HTTP401error"Loginfailed:sessionlimitreached" |                                          |           |             |            |        | 149 |
...
AOS-CX 10.11 Diagnostics and Supportability Guide | (6300, 6400 Switch Series)
...
| diag-dump | <FEATURE-NAME> | basic |     |     | diag-dump |     |
| --------- | -------------- | ----- | --- | --- | --------- | --- |
...
| --------- | --- | --- | ----------- |
<DEVICE>
Specifiesthedevicetobemounted.Supporteddeviceoptions
includeallandusb.
Examples

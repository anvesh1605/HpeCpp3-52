...
3
AOS-CX10.11IPServicesGuide| (6300,6400 SwitchSeries)
...
AOS-CX 10.11 IP Services Guide | (6300, 6400 Switch Series)
...
|                                                       | shownd-snoopingra-guardvlan              |         |          |        | 210 |
| ----------------------------------------------------- | ---------------------------------------- | ------- | -------- | ------ | --- |
| IPv6 destination                                      |                                          | guard   |          |        | 212 |
| IPv6destinationguardcommands                          |                                          |         |          |        | 212 |
|                                                       | clearipv6destination-guardstatisticsvlan |         |          |        | 212 |
|                                                       | ipv6destinationguard                     |         |          |        | 213 |
|                                                       | showipv6destination-guardstatisticsvlan  |         |          |        | 213 |
|                                                       | showipv6destination-guard                |         |          |        | 214 |
| IP Tunnels                                            |                                          |         |          |        | 216 |
| ConfiguringanIPtunnel                                 |                                          |         |          |        | 217 |
| CreatingaGREtunnelfortraversingapublicnetwork         |                                          |         |          |        | 217 |
| CreatingtwoGREtunnelstodifferentdestinationaddresses  |                                          |         |          |        | 219 |
| CreatinganIPv6inIPv4tunnelfortraversingapublicnetwork |                                          |         |          |        | 221 |
| CreatinganIPv6inIPv6tunnelfortraversingapublicnetwork |                                          |         |          |        | 223 |
| IPtunnelscommands                                     |                                          |         |          |        | 224 |
|                                                       | description                              |         |          |        | 224 |
|                                                       | destinationip                            |         |          |        | 225 |
|                                                       | destinationipv6                          |         |          |        | 226 |
|                                                       | interfacetunnel                          |         |          |        | 227 |
...
|                                                       | ipv6address                              |         |          |        | 230 |
|                                                       | ipmtu                                    |         |          |        | 231 |
|                                                       | showinterfacetunnel                      |         |          |        | 232 |
|                                                       | showrunning-configinterfacetunnel        |         |          |        | 234 |
|                                                       | shutdown                                 |         |          |        | 235 |
|                                                       | sourceip                                 |         |          |        | 236 |
|                                                       | sourceipv6                               |         |          |        | 237 |
|                                                       | ttl                                      |         |          |        | 238 |
|                                                       | vrfattach                                |         |          |        | 239 |
| IP Source                                             | Lockdown                                 |         |          |        | 241 |
| IPsourcelockdowncommands                              |                                          |         |          |        | 241 |
|                                                       | IPsourcelockdownresourceextended         |         |          |        | 241 |
| IPv4sourcelockdowncommands                            |                                          |         |          |        | 242 |
|                                                       | ipv4source-binding                       |         |          |        | 242 |
|                                                       | ipv4source-lockdown                      |         |          |        | 243 |
|                                                       | ipv4source-lockdownhardwareretry         |         |          |        | 244 |
|                                                       | showipv4source-binding                   |         |          |        | 245 |
|                                                       | showipv4source-lockdown                  |         |          |        | 245 |
| IPv6sourcelockdowncommands                            |                                          |         |          |        | 248 |
|                                                       | ipv6source-binding                       |         |          |        | 248 |
|                                                       | ipv6source-lockdown                      |         |          |        | 249 |
|                                                       | ipv6source-lockdownhardwareretry         |         |          |        | 250 |
|                                                       | showipv6source-binding                   |         |          |        | 251 |
|                                                       | showipv6source-lockdown                  |         |          |        | 252 |
| Internet                                              | Control                                  | Message | Protocol | (ICMP) | 255 |
| ICMPmessagetypes                                      |                                          |         |          |        | 255 |
| WhenICMPmessagesaresent                               |                                          |         |          |        | 255 |
| ICMPredirectmessages                                  |                                          |         |          |        | 256 |
| WhenICMPredirectmessagesaresent                       |                                          |         |          |        | 256 |
| ICMPcommands                                          |                                          |         |          |        | 256 |
|                                                       | ipicmpredirect                           |         |          |        | 256 |
|                                                       | ipicmpthrottle                           |         |          |        | 257 |
|                                                       | ipicmpunreachable                        |         |          |        | 258 |
7
| AOS-CX10.11IPServicesGuide| | (6300,6400 | SwitchSeries) |     |     |     |
| --------------------------- | ---------- | ------------- | --- | --- | --- |
...
| ------------------------------------------------- | --------------------------- | --------- | --- |
| DNSclient                                         |                             |           | 259 |
| ConfiguringtheDNSclient                           |                             |           | 259 |
| DNSclientcommands                                 |                             |           | 260 |
|                                                   | ipdnsdomain-list            |           | 260 |
|                                                   | ipdnsdomain-name            |           | 261 |
|                                                   | ipdnshost                   |           | 262 |
|                                                   | ipdnsserveraddress          |           | 263 |
|                                                   | showipdns                   |           | 264 |
| ARP                                               |                             |           | 267 |
| ConfiguringproxyARP                               |                             |           | 268 |
| ConfiguringlocalproxyARP                          |                             |           | 269 |
| ConfiguringdynamicARP inspectionoverVXLAN overlay |                             |           | 269 |
| ARPcommands                                       |                             |           | 269 |
|                                                   | arpinspection               |           | 270 |
|                                                   | arpinspectiontrust          |           | 270 |
|                                                   | arpipv4mac                  |           | 271 |
|                                                   | arpprocess-grat-arp         |           | 272 |
|                                                   | cleararp                    |           | 273 |
|                                                   | debugarp-security           |           | 274 |
|                                                   | iplocal-proxy-arp           |           | 275 |
|                                                   | ipproxy-arp                 |           | 276 |
|                                                   | ipv6neighbormac             |           | 277 |
|                                                   | showarp                     |           | 278 |
|                                                   | showarpinspectioninterface  |           | 279 |
|                                                   | showarpinspectionstatistics |           | 280 |
|                                                   | showarpinspectionvlan       |           | 281 |
|                                                   | showarpstate                |           | 282 |
|                                                   | showarpsummary              |           | 284 |
|                                                   | showarptimeout              |           | 285 |
|                                                   | showarpvrf                  |           | 286 |
|                                                   | showipv6neighbors           |           | 287 |
|                                                   | showipv6neighborsstate      |           | 288 |
|                                                   | showtecharp-security        |           | 289 |
| Network                                           | Load Balancing              | (NLB)     | 292 |
| NLBcommands                                       |                             |           | 292 |
|                                                   | arpipv4mac                  |           | 292 |
|                                                   | showarp                     |           | 293 |
|                                                   | showipigmpsnoopingvlangroup |           | 294 |
| Support                                           | and Other                   | Resources | 295 |
| AccessingArubaSupport                             |                             |           | 295 |
| AccessingUpdates                                  |                             |           | 296 |
|                                                   | ArubaSupportPortal          |           | 296 |
|                                                   | MyNetworking                |           | 296 |
| WarrantyInformation                               |                             |           | 296 |
| RegulatoryInformation                             |                             |           | 296 |
| DocumentationFeedback                             |                             |           | 297 |
Contents|8
...
| ----------- | ------------ | ----------- | ---------- | --- | --- |
n Reachabilitybetweenrelayandserver(s)—ServerreachabilityisrequiredforDHCPRelayfunctionto
work.
Pi1n.gtocheckIPreachabilitybetweenswitchandtheserver(s).
Co2n.firmthepingtestismadeintheappropriateVRFandwiththecorrectgatewayIP.Bydefault,
DHCPRelaypicksthelowestIPaddressontheclient-connectedinterfaceasthegatewayIPaddress.
Whenconfigured,thebootp-gatewayIPaddressisusedasthegatewayIP.
n Source-ipconfiguration—Withthesource-ipconfigurationintheVRF,DHCPrelayusesitasagateway
IPaddresstocommunicatewiththeDHCPserver.
1. Itrequiresdhcp_relay source-interfaceconfigurationforip source-interfacerelayto
work.
...
| --------- | --- | --- | ----------- | --- | --- |
<DOMAIN-NAME>
Specifiesadomainname.Range:1to255printableASCII
characters.
Example
...
AppliedVLANsforsnooping,110-112and120
n
...
| --------------- | ------- | ---------- | -------- | --- |
| Command         | History |            |          |     |
InternetControlMessageProtocol(ICMP)|256
...
Allplatforms config Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
InternetControlMessageProtocol(ICMP)|258
...
category.
packet:SelectstheARPsecuritypacketdebuglogcategory.
n
| severity <LEVEL> |     |     |     |     |     |
| ---------------- | --- | --- | --- | --- | --- |
...
emerg:SetsARPsecuritydebuglogfilteringtoEmergencyonly.
n

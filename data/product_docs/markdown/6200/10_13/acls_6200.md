...
AOS-CX 10.13 ACLs and Classifier Policies Guide | (6200 Switch Series)
...
|     |                                                         | applyaccess-list(toVLAN)               |       | 64  |
|     |                                                         | clearaccess-listhitcounts              |       | 65  |
|     |                                                         | clearaccess-listhitcountscontrol-plane |       | 67  |
|     |                                                         | object-groupaddressresequence          |       | 67  |
|     |                                                         | object-groupaddressreset               |       | 68  |
|     |                                                         | object-groupallreset                   |       | 69  |
|     |                                                         | object-groupipaddress                  |       | 70  |
|     |                                                         | object-groupipv6address                |       | 72  |
|     |                                                         | object-groupport                       |       | 74  |
|     |                                                         | object-groupportresequence             |       | 77  |
|     |                                                         | object-groupportreset                  |       | 77  |
|     |                                                         | showaccess-list                        |       | 78  |
|     |                                                         | showaccess-listcontrol-plane           |       | 83  |
|     |                                                         | showaccess-listhitcounts               |       | 85  |
|     |                                                         | showaccess-listhitcountscontrol-plane  |       | 88  |
|     |                                                         | showaccess-listsecure-update           |       | 89  |
|     |                                                         | showcapacities                         |       | 90  |
|     |                                                         | showcapacities-status                  |       | 91  |
|     |                                                         | showobject-group                       |       | 93  |
5
| AOS-CX10.13 | ACLsandClassifierPoliciesGuide| |     | (6200SwitchSeries) |     |
| ----------- | ------------------------------- | --- | ------------------ | --- |
...
*3*3=81).
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 12
...
| --------------- | --- | ------------- | --- | --- | -------- | --- | --- | --- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 14
...
| objectgroup |     | port |     |     |     |     |
| ----------- | --- | ---- | --- | --- | --- | --- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 16
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 18
...
|     | permit         |     |               |       | tcp    |     |
|     | 2001:2001::2:1 |     |               |       | > 1023 |     |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 20
...
switchmodel.
Command History
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 22
...
| Type                   | Name    |      |             |                    |     |     |
| Sequence               | Comment |      |             |                    |     |     |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 28
...
|          | Destination | IP Address | Destination | L4 Port(s) |
|          | Additional  | Parameters |             |            |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 30
...
| ---- | --- | --- | --- |
any
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 32
...
|     | 2001:2001::2:1 |     |     | > 1023 |     |
any
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 38
...
| --- | --------- | --- | --- | --- |
2001:2011::1/64
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 40
...
ACLcontextwhereyou
entertheACEs.
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 42
...
|     | Hit-counts: |     | enabled |     |     |     |     |     |
| --- | ----------- | --- | ------- | --- | --- | --- | --- | --- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 48
...
|     | QoS Priority | Code Point: | 4   |
| --- | ------------ | ----------- | --- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 50
...
|          | Action      |     |         |     |     | L3 Protocol |            |
|          | Source      | IP  | Address |     |     | Source      | L4 Port(s) |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 52
...
|          | Source      | IP Address       |         |     | Source      | L4 Port(s) |
|          | Destination | IP               | Address |     | Destination | L4 Port(s) |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 56
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 58
...
switch(config-if)#
exit
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 60
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 62
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 64
...
| 10.07orearlier |             |     | --           |     |     |
| Command        | Information |     |              |     |     |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 66
...
hasoccurred.
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 68
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 70
...
| <OBJECT-GROUP-NAME> |     |     |     | Specifiestheaddressobjectgroupname.   |
| <SEQUENCE-NUMBER>   |     |     |     | Specifiesasequencenumberfortheaddress |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 72
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 74
...
| Command Information |     |     |
| ------------------- | --- | --- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 76
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 78
...
syn
ack
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 80
...
Formoreinformationonfeaturesthatusethiscommand,refertotheACLsandClassifiersPolicyGuideforyour
switchmodel.
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 82
...
switchmodel.
Command History
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 84
...
| interface | 1/1/1-1/1/2,lag1 |     | (out):        |              |           |     |     |
| Matched   | Packets          |     | Configuration |              |           |     |     |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 86
...
Formoreinformationonfeaturesthatusethiscommand,refertotheACLsandClassifiersPolicyGuideforyour
switchmodel.
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 88
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 90
...
Number of L3 Groups for IP Tunnels and ECMP Groups currently configured 1
2047
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 92
...
| ---- | ---------------- | --- |
10 192.168.0.1
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 94
...
my_policy
10
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 100
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 102
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 104
...
| --- | ----- | --- | --- | --- | --- |
192.168.0.1
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 106
...
|     | 20 ignore |     | udp |     |
| --- | --------- | --- | --- | --- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 112
...
any
any
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 114
...
| Sequence        | Comment |            |             |     |
|                 | Action  |            | L3 Protocol |     |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 120
...
| ------------------------- | ------- | ----- |
| switch(config)#           | do show | class |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 124
...
| switch(config)# |      | do show | class            |            |     |     |     |
| Type            | Name |         |                  |            |     |     |     |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 126
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 128
...
| -------- | ------- | --- | --- |
Class Type
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 134
...
| --------------- | ------ | --------- | ----- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 136
...
|     |     |     |     | vlan | <VLAN-ID> | [in | | out]] |
| --- | --- | --- | --- | ---- | --------- | ----- | ----- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 138
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 140
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 142
...
| interface 1/1/1 |                 |            |      |                    |
| apply policy    | RATE_LIMIT_HTTP | in         |      |                    |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 146
...
Description
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 149
...
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 151
...
| Command | Information |     |     |     |     |     |     |
| ------- | ----------- | --- | --- | --- | --- | --- | --- |
AOS-CX10.13 ACLsandClassifierPoliciesGuide|(6200SwitchSeries) 153

...
|                                                   | address(externalstorage)           |           |          |          |             | 21  |
|                                                   | directory                          |           |          |          |             | 22  |
|                                                   | disableexternal-storagelogfiles    |           |          |          |             | 23  |
|                                                   | enable(external-storagelogfiles)   |           |          |          |             | 23  |
|                                                   | external-storage                   |           |          |          |             | 24  |
|                                                   | password(external-storage)         |           |          |          |             | 25  |
|                                                   | showexternal-storage               |           |          |          |             | 26  |
|                                                   | showrunning-configexternal-storage |           |          |          |             | 27  |
|                                                   | type(externalstorage)              |           |          |          |             | 27  |
|                                                   | username(externalstorage)          |           |          |          |             | 28  |
|                                                   | vrf(externalstorage)               |           |          |          |             | 29  |
| IP-SLA                                            |                                    |           |          |          |             | 31  |
| IP-SLAguidelines                                  |                                    |           |          |          |             | 31  |
| LimitationswithVoIPSLAs                           |                                    |           |          |          |             | 32  |
| IP-SLAcommands                                    |                                    |           |          |          |             | 32  |
|                                                   | ip-slaresponder                    |           |          |          |             | 32  |
|                                                   | showip-slaresponder                |           |          |          |             | 33  |
|                                                   | showip-slaresponderresults         |           |          |          |             | 34  |
| L1-100Mbps                                        |                                    | downshift |          |          |             | 35  |
| Limitationswithspeeddownshift                     |                                    |           |          |          |             | 35  |
3
AOS-CX10.09MonitoringGuide| (6200SwitchSeries)

| L1-100Mbpsdownshiftcommands                      |                                   |            | 35  |
| ------------------------------------------------ | --------------------------------- | ---------- | --- |
|                                                  | downshiftenable                   |            | 35  |
|                                                  | showinterface                     |            | 36  |
|                                                  | showinterfacedownshift-enable     |            | 39  |
|                                                  | showrunning-configinterface       |            | 39  |
| Mirroring                                        |                                   |            | 42  |
| Mirrorstatistics                                 |                                   |            | 42  |
| Classifierpoliciesandmirroringsessions           |                                   |            | 42  |
| VLANasasource                                    |                                   |            | 43  |
| Mirroringcommands                                |                                   |            | 43  |
|                                                  | clearmirror                       |            | 43  |
|                                                  | comment                           |            | 44  |
|                                                  | copytcpdump-pcap                  |            | 45  |
|                                                  | copytshark-pcap                   |            | 46  |
|                                                  | destinationcpu                    |            | 47  |
|                                                  | destinationinterface              |            | 48  |
|                                                  | destinationtunnel                 |            | 48  |
|                                                  | diagnostic                        |            | 50  |
|                                                  | diagutilitiestcpdump              |            | 51  |
|                                                  | disable(mirrorsession)            |            | 53  |
|                                                  | enable(mirrorsession)             |            | 54  |
|                                                  | mirrorsession                     |            | 55  |
|                                                  | showmirror                        |            | 55  |
|                                                  | sourceinterface                   |            | 57  |
|                                                  | sourcevlan                        |            | 59  |
| Monitoring                                       | a device                          | using SNMP | 61  |
| Power-over-Ethernet                              |                                   |            | 62  |
| PoEcommands                                      |                                   |            | 63  |
|                                                  | lldpdot3poe                       |            | 63  |
|                                                  | lldpmedpoe                        |            | 64  |
|                                                  | power-over-ethernet               |            | 64  |
|                                                  | power-over-ethernetallocate-by    |            | 65  |
|                                                  | power-over-ethernetalways-on      |            | 66  |
|                                                  | power-over-ethernetassigned-class |            | 67  |
|                                                  | power-over-ethernetpre-std-detect |            | 68  |
|                                                  | power-over-ethernetpriority       |            | 68  |
|                                                  | power-over-ethernetquick-poe      |            | 69  |
|                                                  | power-over-ethernetthreshold      |            | 70  |
|                                                  | power-over-ethernettrap           |            | 71  |
|                                                  | showlldplocal                     |            | 72  |
|                                                  | showlldpneighbor                  |            | 72  |
|                                                  | showpower-over-ethernet           |            | 73  |
| Aruba                                            | AirWave                           |            | 78  |
| SNMPsupportandAirWave                            |                                   |            | 78  |
|                                                  | SNMPontheswitch                   |            | 78  |
| SupportedfeatureswithAirWaveandtheAOS-CXswitch   |                                   |            | 79  |
| ConfiguringtheAOS-CXswitchtobemonitoredbyAirWave |                                   |            | 79  |
...
AOS-CX 10.09 Monitoring Guide | (6200 Switch Series)
...
| ----------- | --- | --------------- | --- | -------- | ------- | --- |
| BackLED     |     | Statusofmodular |     | On-Green | Normal  |     |
components
installedinthe
backofthechassis
|     |     | (notapplicablefor |     | SlowFlash-Amber | Faultinoneofthe    |     |
| --- | --- | ----------------- | --- | --------------- | ------------------ | --- |
|     |     | 6200F/6300F       |     |                 | modulesinthebackof |     |
|     |     | switches          |     |                 | thechassis         |     |
12
| AOS-CX10.09MonitoringGuide| | (6200SwitchSeries) |     |     |     |     |     |
| --------------------------- | ------------------ | --- | --- | --- | --- | --- |
...
| Switch LEDs | Function          | State | Meaning            |
| ----------- | ----------------- | ----- | ------------------ |
| PoELED      | IndicatesPortLEDs | Off   | PoEmodenotselected |
areshowingPoE
|     | information(not | On-Green | PoEmodeselected |
| --- | --------------- | -------- | --------------- |
applicablefornon
|     | PoEswitches) | SlowFlash-Amber | HardwarefailurePoE |
| --- | ------------ | --------------- | ------------------ |
enabledport,PoEmode
notselected
...
enabledport,PoEmode
selected
| SpdLED | IndicatesPortLEDs | Off | Speedmodenotselected |
| ------ | ----------------- | --- | -------------------- |
areshowingspeed
|        | information       | On-Green       | Speedmodeselected |
| ------ | ----------------- | -------------- | ----------------- |
|        |                   | NotImplemented | Nofaultdefined    |
| StkLED | IndicatesPortLEDs | Off            | Stackingmodenot   |
|        | areshowing        |                | selected          |
stackingmode
|     | information | On-Green | Stackingmodeselected |
| --- | ----------- | -------- | -------------------- |
|     |             | On-Amber | Aporthasastacking    |
...
selected
| UIDLED | User-configurable | Off                    | Userdefinedthelocated |
| ------ | ----------------- | ---------------------- | --------------------- |
|        | LED               |                        | LED:OFF               |
|        |                   | On/FlashBlue(for30min) | Userdefinedthelocator |
LED:On/Flash
GlobalStatusIndicatorLED Overallstatusof Flash-Green Self-testinprogress
|     | theproduct |     | duringUBOOT,SVOSand |
| --- | ---------- | --- | ------------------- |
AOS-CX
...
| --- | --- | -------- | ------------------------- |
temperaturelimit)
| OOBMStatusIndicatorLED | StatusofOOBM     | Off | OOBMportisnot    |
| ---------------------- | ---------------- | --- | ---------------- |
|                        | Linkconnectivity |     | connected,nolink |
established
|     |     | HalfBright-Green | OOBMportisenabled |
| --- | --- | ---------------- | ----------------- |
andestablishedlinkwith
partner
...
| --- | --- | --------------------- | -------------------- |
lightupisroughly
proportionaltothe%of
fullbandwidthutilization
oftheport
...
voip type. It requires the SLA name, SLA type, and port number as arguments. Source IP/interface ID is a
must for type udp-jitter-voip and optional for other types.
...
| ------------- | --------- | --- | --- |
Capturespacketsbasedontheparticularethernettype.Range: 0-
65535.
Usage
n Whenusingthecommandoption,theonlytrafficcapturedwillbepacketsthathavebeenmirroredto
theCPU.
n Whenusingthecommandoption,commandlinesanitizationisperformedtopreventoptionsthatmay
causeharmorsecurityissues.Thefollowingoptionsareblocked:
o -i/--interface
o -Z
o -B/--buffer-size
o -C
...
Atotaloffourfilescanbesavedatanygivenpointonthedevice.Packetcapturefilesarenotsaved
n

...
|                         | showrunning-configexternal-storage |              |          | 30  |
|                         | type                               |              |          | 30  |
|                         | username                           |              |          | 31  |
|                         | vrf                                |              |          | 32  |
3
AOS-CX10.11MonitoringGuide| (6200SwitchSeries)

| IP-SLA                                 |           |            | 34  |
| -------------------------------------- | --------- | ---------- | --- |
| IP-SLAguidelines                       |           |            | 34  |
| LimitationswithVoIPSLAs                |           |            | 35  |
| IP-SLAcommands                         |           |            | 35  |
| ip-slaresponder                        |           |            | 35  |
| showip-slaresponder                    |           |            | 36  |
| showip-slaresponderresults             |           |            | 37  |
| L1-100Mbps                             | downshift |            | 38  |
| Limitationswithspeeddownshift          |           |            | 38  |
| L1-100Mbpsdownshiftcommands            |           |            | 38  |
| downshiftenable                        |           |            | 38  |
| showinterface                          |           |            | 39  |
| showinterfacedownshift-enable          |           |            | 43  |
| showrunning-configinterface            |           |            | 44  |
| Mirroring                              |           |            | 47  |
| Mirrorstatistics                       |           |            | 47  |
| Classifierpoliciesandmirroringsessions |           |            | 47  |
| VLANasasource                          |           |            | 48  |
| Mirroringcommands                      |           |            | 48  |
| clearmirror                            |           |            | 48  |
| clearmirrorendpoint                    |           |            | 49  |
| comment                                |           |            | 50  |
| copytcpdump-pcap                       |           |            | 51  |
| copytshark-pcap                        |           |            | 52  |
| destinationcpu                         |           |            | 53  |
| destinationinterface                   |           |            | 53  |
| destinationtunnel                      |           |            | 54  |
| diagnostic                             |           |            | 56  |
| diagutilitiestcpdump                   |           |            | 57  |
| disable                                |           |            | 59  |
| enable                                 |           |            | 60  |
| mirrorsession                          |           |            | 61  |
| mirrorendpoint                         |           |            | 61  |
| showmirror                             |           |            | 62  |
| showmirrorendpoint                     |           |            | 64  |
| shutdown                               |           |            | 65  |
| source                                 |           |            | 66  |
| sourceinterface                        |           |            | 66  |
| sourcevlan                             |           |            | 68  |
...
| power-over-ethernetallocate-by         |           |            | 75  |
| power-over-ethernetalways-on           |           |            | 76  |
| power-over-ethernetassigned-class      |           |            | 77  |
| power-over-ethernetpre-std-detect      |           |            | 78  |
| power-over-ethernetpriority            |           |            | 78  |
| power-over-ethernetquick-poe           |           |            | 79  |
Contents|4

|                                                  | power-over-ethernetthreshold |           | 80  |
| ------------------------------------------------ | ---------------------------- | --------- | --- |
|                                                  | power-over-ethernettrap      |           | 81  |
|                                                  | showlldplocal                |           | 82  |
|                                                  | showlldpneighbor             |           | 82  |
|                                                  | showpower-over-ethernet      |           | 83  |
| Aruba                                            | AirWave                      |           | 88  |
...
AOS-CX 10.11 Monitoring Guide | (6200 Switch Series)

...
|                                     | Memberremoval                                 |         | 28  |
3
AOS-CX10.11VirtualSwitchingFramework(VSF)Guide| (6200,6300SwitchSeries)
...
AOS-CX 10.11 Virtual Switching Framework (VSF) Guide | (6200, 6300 Switch Series)
...
VSFESUissupportedontheAruba6300SwitchSeries.
VSFESUissupportedforupgradesbetweenminorreleases.
TheVSFESUfeatureusesISSUcommandsforitsoperations(configuration&showcommands).RefertotheVSF
commandssectionforcommanddetails.
| Upgrade | scope |     |     |     |     |     |
| ------- | ----- | --- | --- | --- | --- | --- |

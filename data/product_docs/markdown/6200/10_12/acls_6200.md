...
|                                                         | InteractionswithVxLANtrafficonanL2VNI  | 11  |
|                                                         | InteractionswithVxLANtrafficonanL3VNI  | 12  |
...
|                                                         | showobject-group                       | 84  |
3
AOS-CX10.12ACLsandClassifierPoliciesGuide| (6200SwitchSeries)
...
AOS-CX 10.12 ACLs and Classifier Policies Guide | (6200 Switch Series)
...
|           |     |     | both                                                   | permitand | denyactions.WorkswithACLsappliedoningress, |     |
egress,orControlPlane.
...
NOTE: For 6000 and 6100 switch series, the outbound (egress)
traffic direction is supported only for MAC ACLs.

n Each ACL of a given type can be applied to the same VLAN once in each direction. Therefore, using

the apply access-list command on a VLAN with an already-applied ACL of the same direction and
...
switch#
clear access-list hitcounts ipv6 My_ipv6_ACL control-plane vrf default
Formoreinformationonfeaturesthatusethiscommand,refertotheACLsandClassifiersPolicyGuideforyour
switchmodel.
| Command History     |         |         |              |
| ------------------- | ------- | ------- | ------------ |
...
| ----------- | --------- | ------ | --- |
Description
Showsinformationaboutyourdefinedpoliciesandwheretheyhavebeenapplied.Whenshow
policy

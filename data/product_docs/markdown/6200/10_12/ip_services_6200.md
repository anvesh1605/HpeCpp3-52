...
3
AOS-CX10.12IPServicesGuide| (6200SwitchSeries)
...
AOS-CX 10.12 IP Services Guide | (6200 Switch Series)
...
|                              | other-config-flag                        |         |          |        | 199 |
| ---------------------------- | ---------------------------------------- | ------- | -------- | ------ | --- |
|                              | router-preference                        |         |          |        | 200 |
|                              | shownd-snoopingra-guardinterface         |         |          |        | 201 |
|                              | shownd-snoopingra-guardpolicy            |         |          |        | 202 |
|                              | shownd-snoopingra-guardvlan              |         |          |        | 203 |
| IPv6 destination             |                                          | guard   |          |        | 205 |
| IPv6destinationguardcommands |                                          |         |          |        | 205 |
|                              | clearipv6destination-guardstatisticsvlan |         |          |        | 205 |
|                              | ipv6destinationguard                     |         |          |        | 206 |
|                              | showipv6destination-guardstatisticsvlan  |         |          |        | 206 |
|                              | showipv6destination-guard                |         |          |        | 207 |
...
|                              | ipv6address                              |         |          |        | 212 |
|                              | ipmtu                                    |         |          |        | 213 |
|                              | showinterfacetunnel                      |         |          |        | 214 |
|                              | showrunning-configinterfacetunnel        |         |          |        | 215 |
|                              | shutdown                                 |         |          |        | 216 |
|                              | sourceip                                 |         |          |        | 217 |
|                              | sourceipv6                               |         |          |        | 218 |
|                              | ttl                                      |         |          |        | 218 |
|                              | vrfattach                                |         |          |        | 219 |
| IPsectunnelscommands         |                                          |         |          |        | 220 |
|                              | description                              |         |          |        | 220 |
|                              | destinationip                            |         |          |        | 221 |
|                              | ipmtu                                    |         |          |        | 222 |
|                              | showcapacities-status                    |         |          |        | 223 |
|                              | showcapacities-statustunneling           |         |          |        | 224 |
|                              | showinterfacetunnel                      |         |          |        | 224 |
|                              | showinterfacetunnelbrief                 |         |          |        | 225 |
|                              | showrunning-configinterfacetunnel        |         |          |        | 226 |
|                              | showrunning-configcurrent-context        |         |          |        | 227 |
|                              | sourceip                                 |         |          |        | 228 |
|                              | vrfattach                                |         |          |        | 228 |
| IPsourcelockdowncommands     |                                          |         |          |        | 229 |
|                              | IPsourcelockdownresourceextended         |         |          |        | 229 |
| IPv4sourcelockdowncommands   |                                          |         |          |        | 230 |
|                              | ipv4source-binding                       |         |          |        | 230 |
|                              | ipv4source-lockdown                      |         |          |        | 231 |
|                              | ipv4source-lockdownhardwareretry         |         |          |        | 232 |
|                              | showipv4source-binding                   |         |          |        | 232 |
|                              | showipv4source-lockdown                  |         |          |        | 233 |
| IPv6sourcelockdowncommands   |                                          |         |          |        | 236 |
|                              | ipv6source-binding                       |         |          |        | 236 |
|                              | ipv6source-lockdown                      |         |          |        | 237 |
|                              | ipv6source-lockdownhardwareretry         |         |          |        | 237 |
|                              | showipv6source-binding                   |         |          |        | 238 |
|                              | showipv6source-lockdown                  |         |          |        | 239 |
...
|                                 | arpcache-limit              |           | 255 |
|                                 | arpinspection               |           | 255 |
|                                 | arpinspectiontrust          |           | 256 |
|                                 | arpipv4mac                  |           | 256 |
|                                 | arpprocess-grat-arp         |           | 257 |
|                                 | cleararp                    |           | 258 |
|                                 | debugarp-security           |           | 259 |
|                                 | iplocal-proxy-arp           |           | 261 |
|                                 | ipproxy-arp                 |           | 262 |
|                                 | ipv6neighbormac             |           | 263 |
|                                 | showarp                     |           | 263 |
|                                 | showarpinspectioninterface  |           | 264 |
|                                 | showarpinspectionstatistics |           | 265 |
|                                 | showarpinspectionvlan       |           | 266 |
|                                 | showarpstate                |           | 267 |
|                                 | showarpsummary              |           | 268 |
|                                 | showarptimeout              |           | 269 |
|                                 | showarpvrf                  |           | 270 |
|                                 | showipv6neighbors           |           | 271 |
|                                 | showipv6neighborsstate      |           | 272 |
|                                 | showtecharp-security        |           | 273 |
| NLBcommands                     |                             |           | 275 |
|                                 | arpipv4mac                  |           | 275 |
|                                 | showarp                     |           | 276 |
|                                 | showipigmpsnoopingvlangroup |           | 276 |
| Support                         | and Other                   | Resources | 278 |
| AccessingArubaSupport           |                             |           | 278 |
| AccessingUpdates                |                             |           | 279 |
|                                 | ArubaSupportPortal          |           | 279 |
|                                 | MyNetworking                |           | 279 |
| WarrantyInformation             |                             |           | 279 |
| RegulatoryInformation           |                             |           | 279 |
| DocumentationFeedback           |                             |           | 280 |
Contents|8
...
switch(config-if)#
ipv6 helper-address multicast 2001:DB8:0:0:0:0:0:1 egress 1/1/2
...
DHCP Relay picks the lowest IP address on the client-connected interface as the gateway IP
address.
...
o
Staticbindingof10.0.0.11forMACaddress24:be:05:24:75:73.
...
that IP address. If the server is not authoritative, then it will ignore DHCPv4 requests received for
unknown leases from unknown hosts.
...
| --------- | --- | --- | --- | ----------- | --- | --- |
<LOW-IPV6-ADDR>
SpecifiesthelowestIPaddressinthepoolinIPv6format
(xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx),wherexisa
hexadecimalnumberfrom0toF.
<HIGH-IPV6-ADDR>
...
Usetheno ip dhcpcommandontherequiredVLANinterfaceormanagementVRFportyoucandisable
theDHCPassignmentsinanArubaAOS-CXswitch.
Astaticconfigurationoptionisavailableonbothports.
6. Can IP DHCP switch assignment be carried out on a Routed only Port (RoP)?
No,RoPisnotsupported.OnlyVLANandOOBMportscanbeallocatedanaddresswithDHCP.
| 7. Can | an Aruba | AOS-CX | switch |     | support | DHCP | IPv6 | Allocation? |
| ------ | -------- | ------ | ------ | --- | ------- | ---- | ---- | ----------- |
Yes,anArubaAOS-CXswitchcansupportDHCPIPv6allocation.However,forZeroTouchProvisioning
(ZTP),IPv4isrequired.
| 8. Do | Aruba | AOS-CX | switches | support |     | DHCP server? |     |     |
| ----- | ----- | ------ | -------- | ------- | --- | ------------ | --- | --- |
SincethesoftwarereleaseofAOS-CX10.10,allplatformssupportDHCPserver,exceptfor6100,6000,
and4100i.
9. Can Aruba AOS-CX switches support DHCP address exclusion from a subnet?
Notformally;however,youcanusestaticbindingstounusedMACaddressesasaworkaroundona
smallerscale.
| 10. Do | all Aruba | AOS-CX | switches |     | support | DHCP | helper? |     |
| ------ | --------- | ------ | -------- | --- | ------- | ---- | ------- | --- |
SincethesoftwarereleaseofAOS-CX10.10,allplatformssupportDHCPhelperforIPv4andIPv6.
11. Can DHCP Server and Relay simultaneously be supported on a switch?
Yes,sincethesoftwarereleaseAOS-CX10.08,theplatformsthatsupportDHCPServerandRelayboth
canbesetupsimultaneously.
...
Range1-255.
Therangeisminimum–255ifonlyaminimumvalueis
specified.
maximum
...
| Release               |           |                | Modification |     |
| 10.07orearlier        |           |                | --           |     |
IPv6destinationguard|208

| Command Information |         |         |           |
| ------------------- | ------- | ------- | --------- |
| Platforms           | Command | context | Authority |
config-ip-if Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
| destination    | ip             |     |     |
| -------------- | -------------- | --- | --- |
...
| --------- | ----------- | --- | --- | --- |
<DESC>
SpecifiesthedescriptivetexttoassociatewiththeIPsectunnel.Range:1to64printableASCII
characters.
Examples
...
| Parameter | Description |     |     |     |
| --------- | ----------- | --- | --- | --- |
<IPV4-ADDR> SpecifiesthesourceIPaddressinIPv4format(x.x.x.x),wherexisadecimalnumberfrom
0to255.
Examples
...
Description
EnablesanddisablesIPsourcelockdownresourceextendedonthedevice.Itsupportsdynamically
sharinghardwareresourcesofIPsourcelockdownwithotherfeatures.
Forexample,onAOS-CX6300switches,8000IPsourcelockdownentriescanbeprogrammedinthe
hardwarebydefault.BydisablingIPresource-extended,thesupportedvaluewillreduceto4000,and
theremainingresourcesaresharedwithotherfeatures.
Iftheresource-extendedfeatureisdisabled,alltheexistingIPsource-bindingsareflushedfromthe
hardwareandreprogrammed.Asaresult,someexistingbindingsdonotgetprogrammedtohardware,
whichexistedbeforetheconfigurationchange.Thereisadisruptionintrafficflowfromtheclientduring
thistransition.
Examples
...
switch(config)#
|     | ipv4 | source-binding | 1 10.2.1.4 | 00:50:56:96:e4:cf | 1/1/1 |
| --- | ---- | -------------- | ---------- | ----------------- | ----- |
...
| --------- | --- | --- | ----------- |
<LIMIT>
SpecifiesthemaximumnumberofentriesintheARPcache.
...
| --------- | ----------- | ------- | ------- | --- | --------- | --- | --- |
| Platforms |             | Command | context |     | Authority |     |     |
config-ifandconfig- Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
if-vlan
| show | arp |     |     |     |     |     |     |
| ---- | --- | --- | --- | --- | --- | --- | --- |

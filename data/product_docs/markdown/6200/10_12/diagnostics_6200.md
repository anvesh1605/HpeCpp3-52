...
3
AOS-CX10.12DiagnosticsandSupportabilityGuide| (6200SwitchSeries)

| Client Filter |     |     | 34  |
| ------------- | --- | --- | --- |
| Logmessages   |     |     | 34  |
Using Classifier Policies with Mirror Action to Filter Captured
| Traffic                                          |                                  |           | 35  |
| ------------------------------------------------ | -------------------------------- | --------- | --- |
| Stepone:createatrafficclass                      |                                  |           | 35  |
| Steptwo:createapolicy                            |                                  |           | 36  |
| Stepthree:applythepolicy                         |                                  |           | 36  |
| Stepfour:confirmpolicyInstallation               |                                  |           | 37  |
| Stepfive:confirmpolicyresourceconsumption        |                                  |           | 37  |
| Stepsix:configureamirrorsession                  |                                  |           | 38  |
| Stepseven:startpacketcapture                     |                                  |           | 39  |
| Stepeight:capturepacketstoafileormirrorittoahost |                                  |           | 39  |
| Stepnine:checkpackethitcounts                    |                                  |           | 40  |
| Network                                          | Configuration                    | Validator | 42  |
| Showingandclearingevents                         |                                  |           | 42  |
| Networkconfigurationvalidationcommands           |                                  |           | 42  |
|                                                  | switchconfig-validator           |           | 42  |
| Cable Diagnostics                                |                                  |           | 44  |
| HowTDRworksonAOS-CXplatforms                     |                                  |           | 44  |
| Cablediagnosticstests                            |                                  |           | 44  |
| Cablediagnosticcommands                          |                                  |           | 45  |
|                                                  | diagcable-diagnostic             |           | 45  |
| Supportability                                   | Copy                             |           | 49  |
| TFTPVxLANSupport                                 |                                  |           | 49  |
| Supportabilitycopycommands                       |                                  |           | 49  |
|                                                  | copycheckpoint                   |           | 49  |
|                                                  | copycommand-output               |           | 50  |
|                                                  | copycore-dumpvsfmemberdaemon     |           | 51  |
...
|                                                  | copysupport-fileslocal-file      |           | 65  |
|                                                  | copysupport-filesvsfmember       |           | 67  |
|                                                  | copysupport-log                  |           | 68  |
|                                                  | copysupport-logvsfmember         |           | 69  |
| Traceroute                                       |                                  |           | 72  |
...
|                                    | logging                         | 88  |
|                                    | loggingaccounting-format-native | 90  |
|                                    | loggingfilter                   | 91  |
|                                    | loggingfacility                 | 94  |
...
|                                               | tftp                                     |           |             |            |        | 128 |
|                                               | version                                  |           |             |            |        | 129 |
| In-System                                     | Programming                              |           |             |            |        | 130 |
| ShowtechcommandlistfortheISPfeature           |                                          |           |             |            |        | 130 |
| In-SystemProgrammingcommands                  |                                          |           |             |            |        | 130 |
|                                               | clearupdate-log                          |           |             |            |        | 130 |
|                                               | showneeded-updates                       |           |             |            |        | 130 |
| Selftest                                      |                                          |           |             |            |        | 132 |
| Selftestcommands                              |                                          |           |             |            |        | 132 |
|                                               | fastboot                                 |           |             |            |        | 132 |
|                                               | showselftest                             |           |             |            |        | 133 |
| Zeroization                                   |                                          |           |             |            |        | 136 |
| Zeroizationcommands                           |                                          |           |             |            |        | 136 |
|                                               | eraseallzeroize                          |           |             |            |        | 136 |
| Terminal                                      | Monitor                                  |           |             |            |        | 139 |
| Terminalmonitorcommands                       |                                          |           |             |            |        | 139 |
|                                               | loggingconsole{notify|severity|filter}   |           |             |            |        | 139 |
|                                               | showterminal-monitor                     |           |             |            |        | 140 |
|                                               | terminal-monitor{notify|severity|filter} |           |             |            |        | 141 |
| Troubleshooting                               |                                          | Web       | UI and REST | API Access | Issues | 143 |
| HTTP404errorwhenaccessingtheswitchURL         |                                          |           |             |            |        | 143 |
| HTTP401error"Loginfailed:sessionlimitreached" |                                          |           |             |            |        | 143 |
| Support                                       | and Other                                | Resources |             |            |        | 145 |
| AccessingArubaSupport                         |                                          |           |             |            |        | 145 |
| AccessingUpdates                              |                                          |           |             |            |        | 146 |
|                                               | ArubaSupportPortal                       |           |             |            |        | 146 |
|                                               | MyNetworking                             |           |             |            |        | 146 |
| WarrantyInformation                           |                                          |           |             |            |        | 146 |
...
AOS-CX 10.12 Diagnostics and Supportability Guide | (6200 Switch Series)
...
Chapter 7
|     |     |     | Using Classifier |           | Policies | with Mirror |
| --- | --- | --- | ---------------- | --------- | -------- | ----------- |
|     |     |     | Action           | to Filter | Captured | Traffic     |
Using Classifier Policies with Mirror Action to Filter Captured Traffic
AOS-CXcanuseaclassifierpolicytotroubleshootnetworkissuesbymirroringpacketsforcaptureand
analysis.
...
example:
TCPandUDPprotocolsshouldincludeentriesforbothsourceanddestinationportmatchesinorder
n
tomirrortrafficeithertoorfromthatportnumber.
n ArubaCentraltrafficutilizesHTTPSandthereforewillmatchthatentry.
Inthisexample,thecountkeywordisincludedsothathitcountscanbemonitoredtoverifythat
n
...
consumes hardware resources and may not be successful if resources are exhausted.
...
(Optional) Apply a policy to a specific physical interface in the egress (out) direction:

Only 6200, 6300, 6400 and 8360 Switch series support egress policies.

Using Classifier Policies with Mirror Action to Filter Captured Traffic | 36

| switch (config)#interface |     |       | 1/1/1  |                |     |
| ------------------------- | --- | ----- | ------ | -------------- | --- |
| switch(config-if)#        |     | apply | policy | support-mirror | out |
ApplyapolicytoaspecificLAGintheingress(in)direction:
| switch (config)#       |     | interface | lag   | 1                     |     |
| ---------------------- | --- | --------- | ----- | --------------------- | --- |
| switch(config-lag-if)# |     |           | apply | policy support-mirror | in  |
(Optional)ApplyapolicytoaspecificLAGintheegress(out)direction:
Only6200,6300,6400and8360Switchseriessupportegresspolicies.
| switch (config)#       |     | interface | lag   | 1                     |     |
| ---------------------- | --- | --------- | ----- | --------------------- | --- |
| switch(config-lag-if)# |     |           | apply | policy support-mirror | out |
ApplyapolicytoaspecificVLANintheingress(in)direction:
| switch (config)#        |     | vlan | 100   |                       |     |
| ----------------------- | --- | ---- | ----- | --------------------- | --- |
| switch(config-if-vlan)# |     |      | apply | policy support-mirror | in  |
ApplyapolicytoaspecificVLANintheegress(out)direction:
| switch (config)#        |     | vlan | 100   |                       |     |
| ----------------------- | --- | ---- | ----- | --------------------- | --- |
...
configuredintheprevioussteps.
| switch (config)# |     | show | class  |     |     |
| ---------------- | --- | ---- | ------ | --- | --- |
| switch (config)# |     | show | policy |     |     |
Theoutputmustnotincludeanylinesstartingwithanexclamationpoint(!), suchas:
...
Next,confirmthattheingressglobalpolicyprocessisconsumingTCAMentries.Iftheswitchisachassis,
eachmoduleshouldshowresourcesconsumed,asthispolicyisinstalledontheASICineachlinecard.
Thefollowingexampleshowstheoutputofashow resourcescommandissuedona6300switch:
...
ittoahost.
UsingClassifierPolicieswithMirrorActiontoFilterCapturedTraffic|38
...
thefollowingexample,packetsaremirroredtoexternalcapturehostconnectedtointerface1/1/2:
| switch(config)#          |     | mirror |     | session     | 1   |           |     |       |     |     |     |     |
| ------------------------ | --- | ------ | --- | ----------- | --- | --------- | --- | ----- | --- | --- | --- | --- |
...
|                  | 0   | 100 match |        | tcp any           | eq        | https     | any count      |          |
|                  | 0   | 110 match |        | tcp any           | any       | eq http   | count          |          |
UsingClassifierPolicieswithMirrorActiontoFilterCapturedTraffic|40
...
Manager(#)
forthiscommand.
NetworkConfigurationValidator|43
...
<REMOTE-URL>
SpecifiestheremotedestinationURL.
...
Troubleshooting Web UI and REST API Access Issues | 144

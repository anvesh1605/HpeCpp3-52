...
| VSFauto-stacking                    |                                               |         | 15  |
|                                     | Peerdiscovery                                 |         | 15  |
|                                     | Auto-joinEligibility                          |         | 15  |
|                                     | Reservedinterfacesforauto-stacking            |         | 15  |
|                                     | Forceauto-joinsupport                         |         | 16  |
| Interoperation                      |                                               |         | 17  |
| Linkaggregation                     |                                               |         | 17  |
| Configuration                       | task                                          | list    | 19  |
| Stackdeploymentusingauto-stacking   |                                               |         | 19  |
|                                     | Designatingconductorswitch                    |         | 19  |
|                                     | Auto-stackingusingLED modebutton              |         | 20  |
|                                     | Auto-stackingusingCLI command                 |         | 21  |
|                                     | Auto-stackingusingzero-touchprovisioning(ZTP) |         | 22  |
|                                     | Auto-stackingusingArubaCX mobileapp           |         | 22  |
| Manualconfiguration                 |                                               |         | 23  |
|                                     | VSFlinks                                      |         | 23  |
|                                     | Secondarymember                               |         | 24  |
|                                     | Membernumber                                  |         | 24  |
|                                     | Memberprovisioning                            |         | 24  |
|                                     | AccesstoVSFmembers                            |         | 25  |
| Stackmanagement                     |                                               |         | 25  |
|                                     | Consoles                                      |         | 25  |
|                                     | Managementinterface                           |         | 25  |
|                                     | Splitdetection                                |         | 25  |
|                                     | Automatedimagesync                            |         | 27  |
|                                     | Reboot                                        |         | 27  |
|                                     | Memberadditionwithauto-stacking               |         | 28  |
|                                     | Memberadditionwithoutauto-stacking            |         | 28  |
|                                     | Memberreplacementwithauto-stacking            |         | 28  |
|                                     | Memberreplacementwithoutauto-stacking         |         | 28  |
|                                     | Memberremoval                                 |         | 28  |
3
AOS-CX10.12VirtualSwitchingFramework(VSF)Guide| (6200,6300SwitchSeries)

StackandPortLEDstates 29
| Use cases                                             |     |     | 30  |
| ----------------------------------------------------- | --- | --- | --- |
| Formingafour-memberringsetupusingauto-stackingcommand |     |     | 30  |
Formingafour-memberchainsetupusinglinkconfigurationcommandwithauto-join 32
Forminganeight-memberringsetupmanuallyusinglinkconfigurationwithoutauto-stack-
| ing          |          |         | 33  |
| ------------ | -------- | ------- | --- |
| VSF enhanced | software | upgrade | 37  |
Upgradescope 37
| VSFESUoperation |     |     | 37  |
| --------------- | --- | --- | --- |
Step1:Imagedownloadandvalidation 37
Step2:Installtheimageinthestandby&members 37
Step3:Freezethesystem 37
Step4:Performtheupgradeforthelinemodules 38
Step5:Recoverthepreviousstate 38
Step6:Failoveroccursbetweentheconductorandthestandby 38
Step7:ThepreviousConductorwillupgradeitsimage 38
| VSFESUconsiderations |     |     | 38  |
| -------------------- | --- | --- | --- |
| VSFESUlimitations    |     |     | 38  |
Hardwarefaults 39
Prohibitedoperations 39
Scheduledjobs 39
InformationnotupdatedduringESU 39
Showtech 39
Featuresthatdon'tsupportuninterruptedoperationduringESU 39
| AAA                           |     |     | 39  |
| ----------------------------- | --- | --- | --- |
| PIMwithMSDP                   |     |     | 39  |
| DynautzESU                    |     |     | 40  |
| BFDESU                        |     |     | 40  |
| NAE                           |     |     | 40  |
| Featurereadinesscheck         |     |     | 40  |
| Restrictions                  |     |     | 40  |
| VSFESUerrorsandrecovery       |     |     | 40  |
| VSF commands                  |     |     | 41  |
| description                   |     |     | 41  |
| interface                     |     |     | 41  |
| issurollback-timer            |     |     | 42  |
| issuupdate-software           |     |     | 43  |
| link                          |     |     | 47  |
| member                        |     |     | 49  |
| showissu                      |     |     | 50  |
| showvsf                       |     |     | 55  |
...
| showvsfmember                 |     |     | 57  |
| showvsflink                   |     |     | 58  |
| showvsflinkdetail             |     |     | 59  |
| showvsflinkerror-detail       |     |     | 60  |
| showvsflinkerror-detailmember |     |     | 62  |
| showvsftopology               |     |     | 64  |
| shutdown                      |     |     | 64  |
| type                          |     |     | 65  |
| vsfforce-auto-join            |     |     | 66  |
| vsfmember                     |     |     | 67  |
| vsfmemberreboot               |     |     | 68  |
Contents|4
...
| vsfrenumber-to           |                                          |                 |           |                        | 69  |
| ------------------------ | ---------------------------------------- | --------------- | --------- | ---------------------- | --- |
| vsfsecondary-member      |                                          |                 |           |                        | 70  |
| vsfsplit-detect          |                                          |                 |           |                        | 71  |
| vsfstart-auto-stacking   |                                          |                 |           |                        | 72  |
| Configuration            |                                          | conflict        |           | finder recommendations | 74  |
| Considerations           |                                          | and             | best      | practices              | 77  |
| Debugging                | and                                      | troubleshooting |           |                        | 79  |
| Stacksplit               |                                          |                 |           |                        | 79  |
|                          | Step1: Verifysplithasoccurred            |                 |           |                        | 79  |
|                          | Step2:Identifyfailedlinkormember         |                 |           |                        | 80  |
|                          | Step3:Recoverorreplacefailedlinkormember |                 |           |                        | 80  |
|                          | Step4:Verifyproperstackoperation         |                 |           |                        | 81  |
| Misconfigurationrecovery |                                          |                 |           |                        | 81  |
| VSF switchoverbehaviors  |                                          |                 |           |                        | 82  |
...
AOS-CX 10.12 Virtual Switching Framework (VSF) Guide | (6200, 6300 Switch Series)
...
memberswitcheswillbeallowed.Connectionsbetweentheswitchesmustuse10G,25G,or50G
links.AllVSFlinksinastackshouldoperateatthesamespeed.
...
Protocol and feature details | 10
...
Protocol and feature details | 14
...
Only a switch with factory default configuration is considered to be auto-join eligible. In order to
support factory express deployments where the user wants to add a switch which is in its non-factory
default configuration, the force auto-join configuration support is provided. Use the vsf force-auto-

join command to force the switch to join the stack automatically. Once the user sets force auto-join in
the switch configuration, the switch will be considered as auto-join eligible and will join the stack even
...
Iss3u.ethevsf start-auto-stackingfromtheconfigurationcontexttostartauto-stacking.Thestack
membersrebootoneafteranotherandjointhestack.
| switch(config)# | vsf start-auto-stacking |     |     |
| --------------- | ----------------------- | --- | --- |
4. Issuea"showvsf"commandtoensurethatthestackhassuccessfullyformed.Alternatively,you
...
n Trafficwillbedisruptedforthedurationofthereboot.
...
Prerequisites
n Allswitchesmustbeinthefactorydefaultconfiguration.
n AllstackmembersmustbeconnectedinadesiredtopologyonthereservedVSFlinkports.Formore
| information,see | Reservedinterfacesforauto-stacking. |     |     |
| --------------- | ----------------------------------- | --- | --- |
Inthefollowingprocedure,thevsf start-auto-stackingcommandisusedtoformafour-member
stackwiththeringtopology:
| Figure1 Four-memberringsetup |     |     |     |
| ---------------------------- | --- | --- | --- |
Procedure
1. Rackupallthefourswitchesandphysicallyconnectthemonthereservedauto-stacking
interfacesinaringsetup.Formoreinformationonreservedinterfaces,see
Alternatively,youcanalsoaddmembersoneafteranother.
2. Designatethefirstswitchoftherackusingthevsf start-auto-stackingcommandasthe
conductor.Thelinksandsecondarymemberwillbeautomaticallyconfiguredontheconductor.
| switch(config)# | vsf start-auto-stacking |     |     |
| --------------- | ----------------------- | --- | --- |
Sincetheswitchesarealreadyphysicallyconnected,startingwiththesecondswitch,eachswitch
inthestackrebootsautomaticallyandjointhestackoneafteranotherautomatically.Therunning
configurationwillappearasshownbelow:
30
| AOS-CX10.12VirtualSwitchingFramework(VSF)Guide| |     | (6200,6300SwitchSeries) |     |
| ----------------------------------------------- | --- | ----------------------- | --- |
...
Chapter 5
|              |          |         | VSF | enhanced | software | upgrade |
| ------------ | -------- | ------- | --- | -------- | -------- | ------- |
| VSF enhanced | software | upgrade |     |          |          |         |
InVSFEnhancedSoftwareUpgrade(ESU),thefirmwareimageofthestackcanbeupdateddynamically
withminimaldowntime.Thestandbyandmembersofthestackareupgradeddynamicallywithout
havingthenecessityforthemtorebootatall.ThisminimizesthetrafficoutageduringESUasonthe
conductorisrebootedatthelaststage.Thestandbyofthestackthentakesoverasthenewconductor.
Theoldconductorrebootswiththeupgradedfirmwareversionandthenjoinsbackthestackseamlessly
asthenewstandby.WhentheconductorofthestackrebootsduringESU,theclientsdirectlyconnected
totheconductorwillseetrafficoutageuntilthetimeitjoinsthestackbackasthestandby.
n VSFESUissupportedontheAruba6300SwitchSeries.
n VSFESUissupportedforupgradesbetweenminorreleases.
n TheVSFESUfeatureusesISSUcommandsforitsoperations(configuration&showcommands).Refertothe
VSFcommandssectionforcommanddetails.
| Upgrade | scope |     |     |     |     |     |
| ------- | ----- | --- | --- | --- | --- | --- |
ThecurrentESUfeatureisintendedforupgradesbetweenminorreleases.Thisissuitableforstable
networksthatneedcriticalbugfixesorsecurityfixesinsteadoffullversionupgradestogetnew
functionality.
| VSF | ESU operation |     |     |     |     |     |
| --- | ------------- | --- | --- | --- | --- | --- |
ESUinthe6300consistsofaseriesofstepsdesignedtokeepthesysteminastablestatewhilethe
firmwareisupgradedandtorecoverthisstateaftersuchupgrade.
| Step | 1: Image download | and | validation |     |     |     |
| ---- | ----------------- | --- | ---------- | --- | --- | --- |
Thefirststepoftheprocessistodownloadtheimagewiththenewversionofthefirmwareandverify
thatitcomplieswiththeESUrulesandthesecuritychecks(e.g.validsignedimage).Theserulesare
internalcheckswhichverifythattheESUoperationcanbeperformedbetweenthecurrentimage
runningintheswitchandthenewone.
Uponsuccessfulverification,thenewimagewillbeinstalledinthebankthatdoesn'tstoretheimage
currentlyrunningontheswitch.Theoldimagewillbekeptinthealternativebankincaseafailback
processneedstobetriggeredduetoanerror.
| Step | 2: Install the | image | in the standby | & members |     |     |
| ---- | -------------- | ----- | -------------- | --------- | --- | --- |
Oncethenewimageisverified,thestandbyandmembersofthestackwillbeupgradedwiththisimage
withouthavingthemtoreboot.
...
frozen. This means that no further configuration will be allowed until the ESU is complete. In fact, no
configuration via CLI, REST, or SNMP is allowed once the ESU process starts (Step 1) in order to make
sure that the system doesn't become unstable once ESU has started. Informational queries are still
allowed. Any change in the network such as MAC learning will not be reflected until ESU is complete.
Please refer to Information not updated during ESU for additional information.
...
operation during ESU. Please refer to Features that don't support uninterrupted operation during ESU
...
sessions will be closed and the user will be required to log in again. There will be downtime on the
conductor until step #7.

Step 7: The previous Conductor will upgrade its image

The previous conductor will upgrade its image and take the role of Standby and joins the stack. The ESU
is complete at this point.

VSF ESU considerations
The first requirement for ESU is to ensure that traffic continues to pass through the stack uninterrupted
during the upgrade operation. In the event that something goes wrong traffic must be restored as soon
as possible. This could mean falling back to the previous image, or in some cases to fall forward to the
new one.
...
reacting to events. Please refer to Information not updated during ESU for additional information. The
amount of time where they are not operational will be kept as small as possible.

The only full control plane disruption is similar to the disruption caused by an HA failover event. This
means that the ESU will be as hitless as an HA failover. If a feature is not hitless during an HA failover
then it won't be hitless during ESU. Please refer to Features that don't support uninterrupted operation
during ESU for additional information.

The recommended stack topology should be Ring to start the ESU. The Standby and all members must
be operational and running. If any of them is in another state (e.g., booting) then the ESU process will
not start.

VSF ESU limitations

VSF enhanced software upgrade | 38

The ESU process currently has the following limitations:

Hardware faults

It is recommended that hardware faults are resolved prior to performing ESU. Fan faults and abnormal
temperature statuses should be addressed. Fans may increase in speed during the ESU process.

Prohibited operations

During ESU the following operations are not permitted:

n Any hardware hot swap

n Pressing any button

Performing any of these operations during an ESU could put the system in an error state that could
adversely affect the ESU. The system may not be able to address failures during the ESU. For example, if
network protocols require blocking a port, flush MAC, or routing tables, etc. the switch would not be
able to react to those tasks until the ESU is complete.

Scheduled jobs

Since no configuration is allowed during the ESU, it is possible that some scheduled jobs will fail if they
are attempted while the ESU is in progress. It is recommended to not execute any scheduled job during
ESU.

Information not updated during ESU

During ESU the following information may not be current until after ESU completes:

n Link state. Transitions may not be reflected until ESU is done.
...
n Some counters will stop increasing their value during ESU.

Show tech

The show tech command is enabled during ESU using the CLI, however it isn't possible to use it with the
REST API.

Features that don't support uninterrupted operation during ESU

During ESU the following features may be interrupted until after ESU completes:
...
Currently, PIM is not supported in ESU on RP routers, therefore traffic loss is expected during ESU on RP
routers where PIM and MSDP are enabled.

Dynautz ESU

All Dynamic Authorization requests will be rejected with NAK during ESU operation. Captive portal
...
Detect Multiplier=3). The setup should have less than 64 sessions, otherwise the ESU failover might not
be hitless for all sessions.

NAE

NAE will have a momentary disruption during ESU events due to the failover event. See the Network
Analytics Engine Guide for more information.

Feature readiness check

ESU will fail if the feature ready check does not pass. The feature ready check validates that none of the
...
In general, if any of the above is in a failed state it is recommendedto fix it and then upgrade to the
newer operating system image using the system reboot method instead of ESU. Some failed states will
...
1. VSF ESU is not supported on 6200 platforms

VSF ESU errors and recovery
...
VSF enhanced software upgrade | 40
...
issu update-software confirm.Thischangewillnotaffectanactivetimerandwillapplyonthenext
ISSU.Tocanceltheactivetimer,confirmthepreviousISSUwithissu confirm.
update-software
Disabledbydefault.
...
disk and can used to roll back to the pre-ISSU firmware. During the ISSU process all management
methods (CLI, REST, WebUI) will be blocked from making configuration changes to the switch. The
configuration block is active from the time ISSU starts until the the time ISSU switchover is complete.
After the ISSU switchover completes, the newly upgraded alternate management module is active and
switch configuration can resume.
...
timer. If the rollback timer is configured and this command is not
executed after an ISSU when it expires, then the pre-ISSU
checkpoint is copied to the startup configuration and the system
is rebooted to the image used before ISSU.
...
n TheVSFConductorwillrebootaspartoftheISSUprocess.ThiswillcausetheVSFConductor's
interfacestoflap.Iftheseinterfacesareparticipatinginspanning-treeasstandaloneinterfaces,then
itwilltriggerspanning-treere-convergence,resultingintrafficdisruptionforfewseconds.
n ItisrecommendedtoconfigurearingtopologybeforeinitiatingISSU.
...
Examples
Initiatinganin-servicesoftwareupgrade:
...
ShowingdetailedstatusforVSFESU:
| switch# | show issu |     |     |     |     |
| ------- | --------- | --- | --- | --- | --- |
ISSU Summary
============
...
| Command Information |     |            |     |                                  |                                           |
| Platforms           |     | Command    |     | context                          | Authority                                 |
| 6300                |     | Manager(#) |     |                                  | Administratorsorlocalusergroupmemberswith |
...
|     | 19  | link                 | 1 1/1/25 |         |     |
|     | 20  | vsf member           | 2        |         |     |
Configurationconflictfinderrecommendations|75
...
Considerations and best practices | 78
...
Debuggingandtroubleshooting|80
...
| 3.  | Attheprompt,issuetheerase |     | all | zeroizecommand. |     |
| --- | ------------------------- | --- | --- | --------------- | --- |
^C
Login: admin
Password:
...
| --- | --------- | ----- | ----------- | --- | --- |
4. Thisresetsthemembertofactory-defaultsettingsandtheswitchwillcomeupwithadefault
memberIDof1.
...
Debugging and troubleshooting | 82
...
| What is | VSF? |     |     |     |     |     |
| ------- | ---- | --- | --- | --- | --- | --- |
VirtualSwitchingFramework,orVSF,definesasinglevirtualswitchcomprisedofmultipleindividual
physicalswitchesthatareinterconnectedthroughstandardEthernetlinks.Theselinksarereferredtoas
VSFlinks.
...
VSFcanbeformedwithacombinationofanyoftheAruba6300F/MSwitchSeries(JL658A,JL659A,
JL660A,JL661A,JL662A,JL663A,JL664A,JL665A,JL666A,JL667A,JL668A,JL762A)oracombinationofany
oftheAruba6200FSwitchSeries(JL724A,JL725A,JL726A,JL727A,JL728A).
Aruba6200FSwitchSeriesonlysupportsfixedSKUs.
| What port | speeds | do VSF links | support? |     |     |     |
| --------- | ------ | ------------ | -------- | --- | --- | --- |
ForAruba6300F/MSwitchSeries:Alluplinkportswith10G,25G,and50Gspeedscanbeconfiguredas
VSFlinks.
...
| Can VSF | be disabled? |     |     |     |     |     |
| ------- | ------------ | --- | --- | --- | --- | --- |
UserscannotdisableVSF.AfactorydefaultswitchbootsupasaVSF-enableddevicewithitsMemberID
setto1.
| What is | a primary | switch in | VSF stack? Is it configurable? |     |     |     |
| ------- | --------- | --------- | ------------------------------ | --- | --- | --- |
OnlytheswitchwithaMemberIDof1willbetheprimaryswitchinaVSFstack.Thisswitchwillfunction
asthestackconductorandwilldrivethecontrolandmanagementplaneforthestack.
What is a secondary switch in a VSF stack? Is it configurable?
Thesecondaryswitchwillfunctionasthestandbyinastack.Inthecaseofauto-stacking,secondary
memberisautomaticallyconfiguredthroughbuttonpressorvsf start-auto-stackingcommand.
Inaddition,anymemberotherthanMember1canbeconfiguredmanuallyasthesecondaryswitch
| usingthevsf | secondary-member |     | <MEMBER-ID>command. |     |     |     |
| ----------- | ---------------- | --- | ------------------- | --- | --- | --- |
Arubastronglyrecommendsthatyouconfigureasecondarymember(standby)forstackhigh-
availability.
83
| AOS-CX10.12VirtualSwitchingFramework(VSF)Guide| |     |     | (6200,6300SwitchSeries) |     |     |     |
| ----------------------------------------------- | --- | --- | ----------------------- | --- | --- | --- |
...
the image to the device. The image will be downloaded to the stack conductor first and then synced with
other members of the stack automatically.
...
conductor will push its firmware copy to the device. Once the device receives a copy of the firmware, it
will reboot and rejoin the stack, now running the same version as the conductor.
...
The standby switch, if present, will take the role of the conductor. The old conductor switch will boot
and join the stack as the standby switch. This transition will be seamless with limited network impact.
...
they are waiting for the conductor to come back up. During this time, front plane ports of the members
will be down.
...
the stack conductor. If the VSF link is configured incorrectly or the member number is wrong, the device
...
VLAN/network or connect them directly to one another. The CLI command to enable split detection is
...
configurations associated with the member will also be removed. The member will boot and come back
...
This functionality is not supported. Before applying a configuration on a stack through Checkpoint
restore or TFTP/SFTP/USB download, you must ensure that the following configurations match exactly:

n The current stack VSF configurations.

n The VSF configurations that are part of the configuration file that is being restored or downloaded

from the server.

Specifically, the current VSF stack and the Checkpoint/downloaded configuration that will be applied on
the stack must have the same:
...
VSF link. So even if multiple ports were connected physically, stack will come up with single port per VSF
link only.

...
3
AOS-CX10.08IPServicesGuide| (6200 SwitchSeries)
...
AOS-CX 10.08 IP Services Guide | (6200 Switch Series)

5

|                                                       | nd-snoopingmax-bindings           |         |          |        | 142 |
| ----------------------------------------------------- | --------------------------------- | ------- | -------- | ------ | --- |
|                                                       | nd-snoopingnd-guard               |         |          |        | 143 |
|                                                       | nd-snoopingra-guard               |         |          |        | 144 |
|                                                       | nd-snoopingra-drop                |         |          |        | 145 |
|                                                       | nd-snoopingtrust                  |         |          |        | 146 |
|                                                       | shownd-snooping                   |         |          |        | 146 |
|                                                       | shownd-snoopingbinding            |         |          |        | 148 |
|                                                       | shownd-snoopingprefix-list        |         |          |        | 148 |
|                                                       | shownd-snoopingstatistics         |         |          |        | 149 |
| IP Tunnels                                            |                                   |         |          |        | 151 |
| ConfiguringanIPtunnel                                 |                                   |         |          |        | 151 |
| CreatinganIPv6inIPv4tunnelfortraversingapublicnetwork |                                   |         |          |        | 152 |
| CreatinganIPv6inIPv6tunnelfortraversingapublicnetwork |                                   |         |          |        | 153 |
| IPtunnelscommands                                     |                                   |         |          |        | 154 |
|                                                       | description                       |         |          |        | 154 |
|                                                       | destinationip                     |         |          |        | 155 |
|                                                       | destinationipv6                   |         |          |        | 156 |
|                                                       | interfacetunnel                   |         |          |        | 157 |
...
|                                                       | ipv6address                       |         |          |        | 159 |
|                                                       | ipmtu                             |         |          |        | 160 |
|                                                       | showinterfacetunnel               |         |          |        | 161 |
|                                                       | showrunning-configinterfacetunnel |         |          |        | 162 |
|                                                       | shutdown                          |         |          |        | 163 |
|                                                       | sourceip                          |         |          |        | 164 |
|                                                       | sourceipv6                        |         |          |        | 165 |
|                                                       | ttl                               |         |          |        | 165 |
| Internet                                              | Control                           | Message | Protocol | (ICMP) | 167 |
| ICMPmessagetypes                                      |                                   |         |          |        | 167 |
| WhenICMPmessagesaresent                               |                                   |         |          |        | 167 |
| ICMPredirectmessages                                  |                                   |         |          |        | 168 |
| WhenICMPredirectmessagesaresent                       |                                   |         |          |        | 168 |
| ICMPcommands                                          |                                   |         |          |        | 168 |
|                                                       | ipicmpredirect                    |         |          |        | 168 |
|                                                       | ipicmpthrottle                    |         |          |        | 169 |
|                                                       | ipicmpunreachable                 |         |          |        | 170 |
| DNS                                                   |                                   |         |          |        | 171 |
| DNSclient                                             |                                   |         |          |        | 171 |
| ConfiguringtheDNSclient                               |                                   |         |          |        | 171 |
| DNSclientcommands                                     |                                   |         |          |        | 172 |
|                                                       | ipdnsdomain-list                  |         |          |        | 172 |
|                                                       | ipdnsdomain-name                  |         |          |        | 173 |
|                                                       | ipdnshost                         |         |          |        | 174 |
|                                                       | ipdnsserveraddress                |         |          |        | 175 |
|                                                       | showipdns                         |         |          |        | 176 |
| ARP                                                   |                                   |         |          |        | 177 |
| ConfiguringproxyARP                                   |                                   |         |          |        | 178 |
| ConfiguringlocalproxyARP                              |                                   |         |          |        | 178 |
| DynamicARPInspection                                  |                                   |         |          |        | 179 |
| ARPcommands                                           |                                   |         |          |        | 179 |
|                                                       | arpinspection                     |         |          |        | 179 |
|                                                       | arpinspectiontrust                |         |          |        | 180 |
Contents|6

|                       | arpipv4mac                  |           | 181 |
| --------------------- | --------------------------- | --------- | --- |
|                       | cleararp                    |           | 181 |
|                       | iplocal-proxy-arp           |           | 182 |
|                       | ipv6neighbormac             |           | 183 |
|                       | ipproxy-arp                 |           | 184 |
|                       | showarp                     |           | 185 |
|                       | showarpinspectioninterface  |           | 186 |
|                       | showarpinspectionstatistics |           | 186 |
|                       | showarpstate                |           | 187 |
|                       | showarpsummary              |           | 188 |
|                       | showarptimeout              |           | 190 |
|                       | showarpvrf                  |           | 190 |
|                       | showipv6neighbors           |           | 192 |
|                       | showipv6neighborsstate      |           | 192 |
| Support               | and Other                   | Resources | 194 |
| AccessingArubaSupport |                             |           | 194 |
| AccessingUpdates      |                             |           | 194 |
|                       | ArubaSupportPortal          |           | 194 |
|                       | MyNetworking                |           | 195 |
| WarrantyInformation   |                             |           | 195 |
| RegulatoryInformation |                             |           | 195 |
| DocumentationFeedback |                             |           | 195 |
7
| AOS-CX10.08IPServicesGuide| | (6200 SwitchSeries) |     |     |
| --------------------------- | ------------------- | --- | --- |
...
file in IPv4 format (x.x.x.x), where x is a decimal number
from 0 to 255. You can remove leading zeros. For example, the
...
| --------- | --- | --- | ----------- | --- |
delay <DELAY>
Specifiesthedelayinsecondsbetweenwrites(whennecessary)to
...
| --------------- | --- | ---------- | -------- | --- |
CommandHistory
InternetControlMessageProtocol(ICMP)|168
...
Allplatforms config Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
InternetControlMessageProtocol(ICMP)|170
...
hexadecimalnumberfrom0toF.Range:4096to131072.Default:
131072.
mac <MAC-ADDR>> SpecifiestheMACaddressoftheneighbor(xx:xx:xx:xx:xx:xx),
wherexisahexadecimalnumberfrom0toF.Range:4096to

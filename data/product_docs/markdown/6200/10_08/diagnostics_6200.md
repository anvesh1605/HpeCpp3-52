...
3
AOS-CX10.08DiagnosticsandSupportabilityGuide| (6200SwitchSeries)
...
| Remote                       | syslog                             | 74  |
| Remotesyslogcommands         |                                    | 74  |
|                              | logging                            | 74  |
|                              | loggingfilter                      | 76  |
|                              | loggingfacility                    | 79  |
|                              | loggingpersistent-storage          | 80  |
| Runtime                      | Diagnostics                        | 82  |
| Runtimediagnosticcommands    |                                    | 82  |
|                              | diagnosticmonitor                  | 82  |
|                              | diagon-demand                      | 83  |
|                              | showdiagnostic                     | 84  |
Contents|4

|                                     | showdiagnosticevents | 84  |
| ----------------------------------- | -------------------- | --- |
| Service                             | OS                   | 86  |
| ServiceOSCLIlogin                   |                      | 86  |
| ServiceOSuseraccounts               |                      | 87  |
| ServiceOSbootmenu                   |                      | 87  |
| Consoleconfiguration                |                      | 88  |
| AOS-CXboot                          |                      | 88  |
| Filesystemaccess                    |                      | 89  |
| ServiceOSmountfailure               |                      | 90  |
| ServiceOSCLIcommandlist             |                      | 90  |
| ServiceOSCLIfeaturesandlimitations  |                      | 91  |
| ServiceOSCLIcommands                |                      | 91  |
|                                     | boot                 | 91  |
|                                     | cat                  | 92  |
|                                     | cdpath               | 93  |
|                                     | config-clear         | 93  |
...
|                                     | tftp                 | 112 |
|                                     | version              | 113 |
| In-System                           | Programming          | 115 |
| ShowtechcommandlistfortheISPfeature |                      | 115 |
| In-SystemProgrammingcommands        |                      | 115 |
|                                     | clearupdate-log      | 115 |
|                                     | showneeded-updates   | 115 |
| Selftest                            |                      | 117 |
| Selftestcommands                    |                      | 117 |
|                                     | fastboot             | 117 |
|                                     | showselftest         | 118 |
| Zeroization                         |                      | 121 |
| Zeroizationcommands                 |                      | 121 |
|                                     | eraseallzeroize      | 121 |
5
AOS-CX10.08DiagnosticsandSupportabilityGuide| (6200SwitchSeries)

| Terminal                                      | Monitor                                  |           |             |            |        | 123 |
| --------------------------------------------- | ---------------------------------------- | --------- | ----------- | ---------- | ------ | --- |
| Terminalmonitorcommands                       |                                          |           |             |            |        | 123 |
|                                               | loggingconsole{notify|severity|filter}   |           |             |            |        | 123 |
|                                               | showterminal-monitor                     |           |             |            |        | 124 |
|                                               | terminal-monitor{notify|severity|filter} |           |             |            |        | 125 |
| Troubleshooting                               |                                          | Web       | UI and REST | API Access | Issues | 127 |
| HTTP404errorwhenaccessingtheswitchURL         |                                          |           |             |            |        | 127 |
| HTTP401error"Loginfailed:sessionlimitreached" |                                          |           |             |            |        | 127 |
| Support                                       | and Other                                | Resources |             |            |        | 129 |
| AccessingArubaSupport                         |                                          |           |             |            |        | 129 |
...
AOS-CX 10.08 Diagnostics and Supportability Guide | (6200 Switch Series)
...
!
| !Version   | ArubaOS-CX ML.10.06.0001 |        |
| ---------- | ------------------------ | ------ |
...
Troubleshooting Web UI and REST API Access Issues | 128

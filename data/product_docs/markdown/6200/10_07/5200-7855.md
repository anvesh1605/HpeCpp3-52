AOS-CX 10.07 Web UI Guide

6100, 6200, 6300, 6400 Switch Series

Part Number: 5200-7855
...
| TroubleshootingWebUIaccessissues    |                                                |        | 9   |
|                                     | HTTP404errorwhenaccessingtheswitchURL          |        | 9   |
|                                     | HTTP401error"Loginfailed:sessionlimitreached"  |        | 9   |
|                                     | "NotAuthorized"isdisplayedinsteadofpagecontent |        | 10  |
...
| Navigationpane                      |                                                |        | 18  |
| Overviewpage                        |                                                |        | 20  |
| AnalyticsDashboard                  |                                                |        | 23  |
| Interfacespage                      |                                                |        | 25  |
|                                     | Editinganinterface                             |        | 26  |
| VLANspage                           |                                                |        | 27  |
|                                     | AddinganddeletingaVLAN                         |        | 28  |
|                                     | EditingaVLAN                                   |        | 29  |
| LAGspage                            |                                                |        | 30  |
|                                     | AddinganddeletingaLAG                          |        | 30  |
|                                     | EditingaLAG                                    |        | 31  |
| Userspage                           |                                                |        | 31  |
|                                     | Addinganddeletingauser                         |        | 32  |
|                                     | Changingthepasswordforauser                    |        | 33  |
| PoEpage                             |                                                |        | 33  |
|                                     | EditingthePoEsettingsforaswitchport            |        | 35  |
| VSFpage                             |                                                |        | 35  |
| VSXpage                             |                                                |        | 36  |
| Environmentalpage                   |                                                |        | 38  |
| Logpage                             |                                                |        | 38  |
| NameServerpage                      |                                                |        | 40  |
| SNMPpage                            |                                                |        | 41  |
|                                     | AddinganddeletinganSNMPv3user                  |        | 42  |
|                                     | EditinganSNMPv3user                            |        | 42  |
3
AOS-CX10.07WebUIGuide| (6100,6200,6300,6400SwitchSeries)

|                                       | AddinganddeletinganSNMPcommunity                     |         |           |          | 43  |
| ------------------------------------- | ---------------------------------------------------- | ------- | --------- | -------- | --- |
|                                       | AddinganddeletinganSNMPtrapreceiver                  |         |           |          | 43  |
|                                       | EditinganSNMPtrapreceiver                            |         |           |          | 44  |
| ConfigMgmtpage                        |                                                      |         |           |          | 44  |
| FirmwareUpdatepage                    |                                                      |         |           |          | 45  |
| Pingpage                              |                                                      |         |           |          | 46  |
| Traceroutepage                        |                                                      |         |           |          | 47  |
| ShowTechpage                          |                                                      |         |           |          | 48  |
| SpanningTreepage                      |                                                      |         |           |          | 48  |
|                                       | Editingthespanningtreesettings                       |         |           |          | 49  |
| ConnectedClientspage                  |                                                      |         |           |          | 49  |
| ConnectedDevicesConfigurationpage     |                                                      |         |           |          | 50  |
|                                       | Editingconnecteddevicesattheswitchlevel              |         |           |          | 51  |
|                                       | Editingconnecteddevicesconfigurationatinterfacelevel |         |           |          | 51  |
| PKIpage                               |                                                      |         |           |          | 52  |
|                                       | AddinganddeletinganESTProfile                        |         |           |          | 53  |
|                                       | ViewinganESTProfile                                  |         |           |          | 54  |
|                                       | AddinganddeletingaTAProfile                          |         |           |          | 54  |
|                                       | EditingaTAProfile                                    |         |           |          | 56  |
|                                       | Addinganddeletingacertificate                        |         |           |          | 56  |
|                                       | Uploadingacertificate                                |         |           |          | 57  |
|                                       | Viewinganddownloadingacertificate                    |         |           |          | 58  |
|                                       | Editingassociatedapplicationdetails                  |         |           |          | 58  |
| PortSecuritypage                      |                                                      |         |           |          | 58  |
|                                       | Editingportsecurity                                  |         |           |          | 59  |
| SupportFilepage                       |                                                      |         |           |          | 60  |
|                                       | Creatinganddeletingsupportfiles                      |         |           |          | 61  |
|                                       | Downloadingasupportfile                              |         |           |          | 62  |
| Finding                               | alert details                                        | using   | the Web   | UI       | 63  |
| Working                               | with the                                             | network | analytics | features | 66  |
| ViewingagentinformationusingtheWebUI  |                                                      |         |           |          | 66  |
| WorkingwithanAnalyticstimeseriesgraph |                                                      |         |           |          | 69  |
|                                       | Customizingdatadisplayedonthegraph                   |         |           |          | 70  |
|                                       | Zoominginonthegraph                                  |         |           |          | 72  |
|                                       | Downloadingthegraphasanimageor.csvfile               |         |           |          | 72  |
|                                       | Viewinganalertonthegraph                             |         |           |          | 73  |
ArubaNetworkAnalyticsEnginescripts,agents,andtroubleshootinginformation 76
| Support               | and other          | resources |     |     | 77  |
| --------------------- | ------------------ | --------- | --- | --- | --- |
| AccessingArubaSupport |                    |           |     |     | 77  |
| Accessingupdates      |                    |           |     |     | 77  |
|                       | ArubaSupportPortal |           |     |     | 77  |
|                       | MyNetworking       |           |     |     | 78  |
| Warrantyinformation   |                    |           |     |     | 78  |
...
AOS-CX 10.07 Web UI Guide | (6100, 6200, 6300, 6400 Switch Series)
...
port (6200, 6300, 6400 switches only; the 6100 switches do not have a management port) to access the
Web UI.
...
The 6100 switch only include the default VRF; there is no mgmt VRF.

To use the Web UI to make configuration changes—such as adding users—the following must be true:

n The system that you are using to access the Web UI must be on the same network and the subnet as the
...
n View and configure Network Analytics Engine agents, scripts, and alerts. Not applicable to the 6100
...
Toggle Locator LED menu in the top banner allows you to turn the switch locator LED on or

off. In the case of a stack, this menu lists all the member switches in the stack. You can turn the
...
1. For columns that have a drop-down list as a filter, click the down arrow to display the list and select
an item from the list. The data displayed in the column will be filtered to just the specified data.
...
scripts. Not applicable to the 6100 Switch Series.
...
that support VSF. Not applicable to the 6100 Switch Series.
...
back to match the client time later, the Time Series Database does not overwrite the old data. Therefore the client
...
Clicking the link displays the Analytics Dashboard. Not applicable to the 6100
Switch Series.
...
panel is displayed for the switches that support VSF. Clicking the link displays
the VSF page.
...
The 6100 Switch Series does not support he Network Analytics Engine, so the there is no Analytics Dashboard in

the Web UI for that switch.
...
port as native-tagged. Not selecting the Tag checkbox, leaves the ports as native-untagged.
...
| a.  | IntheEditVlandialogbox,selectIPConfiguration. |     |
| --- | --------------------------------------------- | --- |
...
c. EntertheIPAddresswiththesubnetmaskintheIPv4format(x.x.x.x/x).
| d.   | ClickOK. |     |
| ---- | -------- | --- |
| LAGs | page     |     |
TheLAGspagedisplaysalistofLAGs.DetailsoneachLAGinclude:NameoftheLAG,whethertheadmin
statusisupordown,LAGbondstatus,whethertheLAGisamulti-chassisLAG,alistofdowninterfaces,alist
ofupinterfaces,alistofVLANs,whethertrunkallowedornotallowed,andalistofIPaddresses.
| Figure | 12 LAGsPage |     |
| ------ | ----------- | --- |
LinksintheInterfacesandVLANscolumnsallowyoutodrilldowntotherespectiveInterfacesorVLANs
pages,auto-selectingtheappropriateresource.SelectingarowintheLAGslistdisplaysmoreinformationon
theLAG.DetailsincludeInterfacesandLAGstatistics.
YoucanaddanddeletestaticLAGs.YoucaneditaLAGandaddordeleteports,andsettheadminstatus.
UsetheShow/HideColumnFiltersbuttonorColumnSettingsbuttontocustomizethetabledisplay.
| Adding | and deleting | a LAG |
| ------ | ------------ | ----- |
ToaddaLAG:
1. Inthenavigationpane,selectLAGs.
TheLAGspageisdisplayed.
AOS-CX10.07WebUIGuide|(6100,6200,6300,6400SwitchSeries) 30
...
TheInterfacespanelshowsthedetailsofallPoEports.YoucaneditthePoEsettingsandenableordisable
PoEonaport.
| Interface | panel |     |     |     |
| --------- | ----- | --- | --- | --- |
...
| n   | Alloc-by Configuration:Powerallocationbyusageorclass. |     |     |     |
| n   | PowerEnable:Enableordisablepowerontheport.            |     |     |     |
Pre-StandardDetect:Enableordisablepre-standarddevicedetection.
n
4. ClickChange.
VSF page
...
n The switches synchronize their configuration and state information over a user-configured inter-switch
...
In the Trap Receivers panel, click Add.

The Add Trap Host dialog box is displayed.

3. Configure the following parameters:

n Host: A valid IPv4 or IPv6 address of the SNMP host.

n Type: The type of SNMP message, trap or inform.

n Version: The SNMP version, v1, v2c, or v3.

n User ID: The user ID for authentication. The user ID is required only if the SNMP version is v3.

n Community: The community name available in the switch. The default community name is

public. The community name is not required when the SNMP version is v3.

n Port: The SNMP port on which the host listens for the trap requests. The default port number is

162.

n VRF: The VRF available on the switch.
...
In the Trap Receivers panel, select the trap receiver that you want to delete, and click Delete.
...
In the Trap Receivers panel, select the trap receiver, and click Edit.
...
n Copy from or to various configurations: running to startup, running to checkpoint, checkpoint to startup,
...
In the navigation pane, expand Traffic, and select Spanning Tree.
...
n Status: Option to enable or disable spanning tree.

n Mode: Option to select the Multiple Spanning Tree or Rapid Per-Vlan Spanning Tree mode.

n Config Name: A name for the Multiple Spanning Tree configuration. This field is displayed only if

the Multiple Spanning Tree mode is selected.

n Config Revision: A revision number of the Multiple Spanning Tree configuration. This field is

displayed only if the Multiple Spanning Tree mode is selected.

n Priority: A priority for the spanning tree configuration.
...
| Figure 29 ConnectedDevicespage |     |     |     |
| ------------------------------ | --- | --- | --- |
ConnectedClientspanel
TheConnectedClientspaneldisplaysthedeviceID,IPaddress,devicename,localandremoteports,
...
DiscoveryProtocol(LLDP),andclienttrackingareenabledordisabledattheswitchandinterfacelevel.You
canconfigurethesesettingstodiscoverandshareinformationabouttheconnectednetworkdevicesatthe
switchandinterfacelevel.
AOS-CX10.07WebUIGuide|(6100,6200,6300,6400SwitchSeries) 50

Figure 30 Connected Devices page
...
n CDP: Enables or disables CDP support globally on all active interfaces. By default, CDP is enabled.
...
LLDP neighbors. However, the port drops inbound LLDP packets from LLDP neighbors without
...
o off: This setting disables LLDP packet transmissions and reception on a port. In this state, the
...
Figure 31 WebUI Overview Dashboard
...
Figure 32 WebUI Overview Dashboard
...
The Authorized Client Limit panel displays the maximum number of authenticated client sessions
allowed on the selected port.
...
In the navigation pane, expand Security, and select Port Security.

The Port Security page is displayed.

2.

In the Access Ports panel, click Edit.
...
Support File page
Supported only on the 6100 Switch Series.
...
| ------------- | ------------- | ------- | ------------- | --------- | ------ |
| Finding alert | details using | the Web | UI            |           |        |
Thischapterisnotapplicabletothe6100SwitchSeries,whichdoesnotsupporttheNetworkAnalyticsEngine.
...
| Figure | 34 AlertspanelonAnalyticsDashboard |     |     |     |     |
| ------ | ---------------------------------- | --- | --- | --- | --- |
...
Figure 36 Alert Details dialog box

To view the Action Result Output dialog box for an action, click the Output link.

Finding alert details using the Web UI | 64

Figure 37 Action Result dialog box
...
Forexample,ifthetimeonswitchissetto2hoursaheadoftheclientmanuallyinsteadofbychanging
thetimezoneoffset,theagentdataispopulatedaccordingtothenewtimeonswitch.Iftheswitchtime
issetbacktomatchclienttimelater,theTimeSeriesDatabasedoesnotoverwritetheolddata.Therefore
theclientWebUIshowsinaccuratedata.
Procedure
...
| Figure | 38 AnalyticspanelonOverviewpage |     |     |     |     |     |     |
| ------ | ------------------------------- | --- | --- | --- | --- | --- | --- |
...
Figure 40 Agent Details panels example
...
Figure 43 Agent Details panel including graph
...
Figure 44 Graph with tooltip displayed
...
| Figure | 46 Zoomoptionsportionofagraph |     |     |     |
| ------ | ----------------------------- | --- | --- | --- |
...
AOS-CX10.07WebUIGuide|(6100,6200,6300,6400SwitchSeries) 72

Figure 47 Graph with down arrow highlighted
...
Figure 48 Agent Details before navigating to an alert
...
Figure 49 Graphwithalertbutnotmetricfor1/1/3
2. Toadjustthegraphdisplaytoshowthemetricsforthealert,dothefollowing:
a. Locatethealertonthegraphandclickthealerttriangleflag.TheAlert Detailsdialogboxis
displayed.
| Figure         | 50 AlertdetailsboxwithView | onGraphbuttondisplayed |
| -------------- | -------------------------- | ---------------------- |
| b. ClickViewon | Graph.                     |                        |
3. Ifthegraphisshowingeightmetricsandthemetricyouwanttodisplayistheninthmetric,youmust
chooseanexistingmetrictoclearsothatthegraphcanshowthemetricassociatedwiththealert.For
example:
AOS-CX10.07WebUIGuide|(6100,6200,6300,6400SwitchSeries) 74

Figure 51 Dialog box prompting you to clear a metric

a. Clear the selection box for the metrics you no longer want to show. For example:

Figure 52 Dialog box with 1/1/9 removed
...
Figure 53 Graph showing alert and metric 1/1/3

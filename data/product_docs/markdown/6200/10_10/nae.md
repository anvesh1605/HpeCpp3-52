...
AOS-CX 10.10 Network Analytics Engine Guide | (6200, 6300, 6400, 8xxx, 9300, 10000 Switch Series)
...
| Scriptstatus                                       |           |        |           | 33  |
5
AOS-CX10.10NetworkAnalyticsEngineGuide| (6200,6300,6400,8xxx,9300,10000SwitchSeries)
...
| Agentstatus                                         |                                        |            |        | 53  |
| Behaviorswhenmultipleagentsmonitorthesameresource   |                                        |            |        | 54  |
...
| ----------------------------------- | --- | --- | --- | --- |
Error:"Timeseriesdatacannotbegenerated...TheURIisinvalidornotconfigured" 63
...
| Actions |                                                         | 119 |
|         | Predefinedactions                                       | 120 |
|         | ActionCLI,CLIaction                                     | 120 |
|         | ActionCustomReport                                      | 121 |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 7
...
|                                  | IO Limiting               |           |               | 129 |
|                                  | TimeSeriesLimiting        |           |               | 129 |
|                                  | AlertThrottling           |           |               | 130 |
|                                  | RulesLimiting             |           |               | 130 |
|                                  | AlertSizeLimiting         |           |               | 130 |
| Network                          | Analytics                 | Engine    | Lite          | 131 |
| UseCases                         |                           |           |               | 133 |
| Network                          | Analytics                 | Engine    | commands      | 136 |
| shownae-agent                    |                           |           |               | 136 |
| shownae-agentalerts              |                           |           |               | 138 |
| shownae-agentalertsdetails       |                           |           |               | 140 |
| shownae-script                   |                           |           |               | 141 |
| showrunning-config(nae-lite)     |                           |           |               | 143 |
| Network                          | Analytics                 | Engine    | Lite commands | 144 |
| actions                          |                           |           |               | 144 |
| desc                             |                           |           |               | 146 |
| disable                          |                           |           |               | 147 |
| monitorresource                  |                           |           |               | 148 |
| nae-agentlite                    |                           |           |               | 151 |
| nae-agentliteactivate            |                           |           |               | 152 |
| set-conditionmonitor             |                           |           |               | 153 |
| set-conditionwatch               |                           |           |               | 155 |
| showrunning-confignae-agent      |                           |           |               | 157 |
| tags                             |                           |           |               | 158 |
| watchevent-log                   |                           |           |               | 159 |
| HTTPS                            | server commands           |           |               | 161 |
| https-servermax-user-sessions    |                           |           |               | 161 |
| https-serverrestaccess-mode      |                           |           |               | 161 |
| https-serversessioncloseall      |                           |           |               | 162 |
| https-serversession-timeout      |                           |           |               | 163 |
| https-servervrf                  |                           |           |               | 164 |
| showhttps-server                 |                           |           |               | 165 |
| Support                          | and Other                 | Resources |               | 167 |
| AccessingArubaSupport            |                           |           |               | 167 |
| AccessingUpdates                 |                           |           |               | 168 |
|                                  | ArubaSupportPortal        |           |               | 168 |
|                                  | MyNetworking              |           |               | 168 |
| WarrantyInformation              |                           |           |               | 168 |
| RegulatoryInformation            |                           |           |               | 168 |
|8
...
| ------------ | ------- | --- | --- |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 16
...
AOS-CX Network Analytics Engine (NAE) Design
...
Thenameoftheagent.
n
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 32
...
Prerequisites
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 46
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 61
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 63
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 65
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 67
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 82
...
| --------------------------- | --- | --- | -------- | --- |
Description
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 88
...
circumstances.
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 90
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 94
...
Description
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 96
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 106
...
Description
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 122
...
| ----------------- | --- | ----------- | ------------- |
| ActionCLI("top    |     | cpu")       |               |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 126
...
Liteagent
| Configuringthe | desc <DESCRIPTION> |     |     |     |
| -------------- | ------------------ | --- | --- | --- |
descriptionfor
theNAE-Lite
agent
| Disablingthe | disable |     |     |     |
| ------------ | ------- | --- | --- | --- |
NAE-Liteagent
...
| -------------- | ------- | -------------- | --------- | ----------- |
monitorfor
group-by {count | sum | min | max | average } [over <DURATION>]]
system
...
timeseriesdata
Settingthe set-condition monitor <MONITOR-NAME> {{lt | le | eq | ne | gt | ge}
...
|           |               | cli top | memory         |            |        |           |     |     |     |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 133
...
| --------- | ---- | ------------ | --- | -------- | --- | --- | --- | --- |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 135
...
Indicatesthattheagentisenabledontheswitch.
Status
Thecurrentstateoftheagent.Statusvaluesarethefollowing:
CRITICAL
Theagenthasencounteredacriticalerrorduringexecution.Forinformationabouttheerror,see
...
Description
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 138
...
| --------- | --- | --- | ----------- |
<AGENT-NAME>
SpecifiesthenameoftheNAE-Liteagent.
...
| --------- | --- | --- | --- | --- | --- | --- | ----------- | --- |
<AGENT-NAME>
SpecifiesthenameoftheNAE-Liteagent.Length:3to
80alphanumericcharacters,includingunderscore(_).
<INSTANCE-ID>
Specifiestheinstanceofthealert.Number1represents
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 140
...
switchesthatsupportVSX.
Usage
ThiscommandshowsthefollowinginformationabouttheArubaNetworkAnalyticsEnginescriptsthat
areavailableontheswitch:
Script Name
...
| 10.07orearlier --    |     |     |     |
Command Information
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 142
...
| --- | ----- | --- | --- | --- | --- | ---------------------------------- |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 144
...
| Command Information                 |         |         |                   |              |
| Platforms                           | Command | context | Authority         |              |
6200 config-nae-agent- Administratorsorlocalusergroupmemberswithexecution
| 6300 | condition |     | rightsforthiscommand. |     |
| ---- | --------- | --- | --------------------- | --- |
6400
8320
8325
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 146
...
NetworkAnalyticsEngineLitecommands|147
...
| ------------------------------ | --- | --- | --- | --- | ---------------------------- |
cpu:ConfigurestheCPU
| o system | {cpu | memory} | {management-module |     | |   | n   |
| -------- | -------------- | ------------------ | --- | --- | --- |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 148
...
| ----------------- | --- | --------- | --- | --- | --- |
storageutilizationmonitoring.
| system storage | coredump | line-module |     |     |                              |
| -------------- | -------- | ----------- | --- | --- | ---------------------------- |
| o              |          |             |     |     | n management-module:Monitors |
| <SLOT-ID>      |          |             |     |     | resourcesofthemanagement     |
n For6300and6200SwitchSeries:
module.
n line-module:Monitors
| o system {cpu | | memory} | vsf member | <MEMBER-ID> |     |     |
| ------------- | --------- | ---------- | ----------- | --- | --- |
resourcesofthelinemodule.
| o system storage | {nos | | security | | coredump | |   |     |
| ---------------- | ---- | ---------- | ---------- | --- | --- |
n nos:Monitorsthenetwork
| logs | selftest} | vsf | member | <MEMBER-ID> |     |     |
| ---------------- | --- | ------ | ----------- | --- | --- |
operatingsystemstorage
n For8320,8325,8360,and9300SwitchSeries:
utilization.
| o system {cpu | | memory} |     |     |     |     |
| ------------- | --------- | --- | --- | --- | --- |
n security:Monitorsthe
o system storage {nos | security | coredump | securitystorageutilization.
| logs | selftest} |     |     |     |     | n coredump:Monitorsthe |
| ---------------- | --- | --- | --- | --- | ---------------------- |
coredumpstorageutilization.
n logs:Monitorsthelogstorage
utilization.
n selftest:Monitorstheself-
teststorageutilization.
n <SLOT-ID>:Configurethe
moduleslotID.<SLOT-ID>isthe
mandatoryparameterfor
...
ThememberIDisthe
mandatoryparameter.
group-by {count | sum | min | max | average} Groupsthemonitoreddatabased
...
monitoreddata.
n min:Groupsbyminimumvalue
ofthemonitoreddata.
n max:Groupsthedataby
maximumvalueofthe
monitoreddata.
n average:Groupsbyaverage
NetworkAnalyticsEngineLitecommands|149
...
Configuring the monitor for calculating the average CPU usage over the 30 minutes duration (8320,
8325, 8360, and 9300 Switch Series):
...
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 152
...
| Platforms           | Command | context | Authority         |
6200 config-nae-agent Administratorsorlocalusergroupmemberswithexecution
| 6300 | config-nae-agent- |     | rightsforthiscommand. |
| ---- | ----------------- | --- | --------------------- |
6400
condition
8320
...
| Parameter |     |     | Description |
| --------- | --- | --- | ----------- |
<WATCH-NAME> Specifiesthenameofthewatch.Thismustbealreadydefined
...
logmessages.
any
Includesanyofthespecifiedlistsofregularexpressionsinevent-
logmessages
<REGEX-LIST> Specifiesthecomma-separatedlistofoneormoreregular
expressionsthatmustbematchedagainsttheeventlog
messages.Optional.
exclude
Configuresthelistofstringsmatchingtheregularexpression
thatmustbeincludedintheeventlogmessage.Optional.
| count <COUNT> |     | Limitsthenumberoftimesthattheconditiontobemet |
| ------------- | --- | --------------------------------------------- |
onceineveryspecifiedcount.Optional.Forexample,if
youwanttomonitormacmovementintheVLANforevery
10thtime,thenthecountmustbespecifiedas10.
Range:1to4294967295.
Example
...
clear-condition watch ipsla_status
...
| --------------- | ---------------------- | --- |
| Command History |                        |     |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 156
...
| Command History           |     |         |                 |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 158
...
9300
10000
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 160
...
| Release         |         |              |     |                 | Modification      |     |
| 10.08           |         |              |     |                 | Commandintroduced |     |
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 163
...
VSXpeerswitchisnotdisplayed.Thisparameterisavailableon
switchesthatsupportVSX.
AOS-CX10.10NetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 165

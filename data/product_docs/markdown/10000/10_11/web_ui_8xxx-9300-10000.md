...
| ------ | ----- | ----- | ------------ | -------- | ----- | ------ |
|        | the   | Web   |              | UI Guide |       |        |
| 8320,  | 8325, | 8360, | 8400,        | 9300,    | 10000 | Switch |
Series
...
3
AOS-CX10.11IntroductiontotheWebUIGuide| (8xxx,9300,10000SwitchSeries)
...
|                                       | Firmwaresitedistribution                      |         |           |          | 40  |
|                                       | Downloadingfirmwarefromaremoteswitch          |         |           |          | 41  |
|                                       | DownloadingfirmwarefromaremoteHTTPserver      |         |           |          | 43  |
| FirmwareMgmtpage                      |                                               |         |           |          | 43  |
|                                       | EnablingfirmwaresitedistributionusingtheCLI   |         |           |          | 43  |
|                                       | EnablingfirmwaresitedistributionusingtheWebUI |         |           |          | 44  |
| Pingpage                              |                                               |         |           |          | 44  |
| Traceroutepage                        |                                               |         |           |          | 45  |
| ShowTechpage                          |                                               |         |           |          | 46  |
| SpanningTreepage                      |                                               |         |           |          | 46  |
|                                       | Editingthespanningtreesettings                |         |           |          | 48  |
| ConnectedClientspage                  |                                               |         |           |          | 48  |
| PKIpage                               |                                               |         |           |          | 49  |
|                                       | AddinganddeletinganESTProfile                 |         |           |          | 50  |
|                                       | ViewinganESTProfile                           |         |           |          | 51  |
|                                       | AddinganddeletingaTAProfile                   |         |           |          | 51  |
...
ArubaNetworkAnalyticsEnginescripts,agents,andtroubleshootinginformation 73
| Support               | and Other          | Resources |     |     | 74  |
| --------------------- | ------------------ | --------- | --- | --- | --- |
| AccessingArubaSupport |                    |           |     |     | 74  |
| AccessingUpdates      |                    |           |     |     | 75  |
|                       | ArubaSupportPortal |           |     |     | 75  |
|                       | MyNetworking       |           |     |     | 75  |
...
JL711A, JL700C, JL701C, JL702C, JL703C, JL706C, JL707C, JL708C, JL709C, JL710C, JL711C, JL704C,
JL705C, JL719C, JL718C, JL717C, JL720C, JL722C, JL721C )
...
AOS-CX 10.11 Introduction to the Web UI Guide | (8xxx, 9300, 10000 Switch Series)
...
Enables you to configure the switch to distribute firmware to other switches.
...
from another switch in the network. It enables switches to download firmware from switch or remote server
rather than all switches requesting multiple downloads from a remote location. This reduces the traffic to
external networks, reduces network overhead, and speeds up the upgrade process.
...
Figure23 EnablingtheFirmwareDistributionServerfeature
...
Figure24 Firmwaredownloaderrormessage
| Downloadingfirmware | froma remote | switch |
| ------------------- | ------------ | ------ |
...
Image bank in the remote switch. Firmware from either the primary or secondary bank
...
Figure 25 Example of downloading an image from a remote switch
...
Figure 26 WebUI warning before downloading firmware from a remote switch

AOS-CX Web UI pages | 42

| Downloadingfirmware |     | froma | remote | HTTPserver |     |
| ------------------- | --- | ----- | ------ | ---------- | --- |
...
http://www.example.com/images/FL_10_06_0100AM.swi?merchantId=ACTIVATE_DROPBOX
| VRF      |                                              | VRFtoreachtheHTTPserver. |     |     |     |
| -------- | -------------------------------------------- | ------------------------ | --- | --- | --- |
| Figure27 | Exampleofdownloadinganimagefromaremoteserver |                          |     |     |     |
...
| Firmware | Mgmt | page |     |     |     |
| -------- | ---- | ---- | --- | --- | --- |
TheFirmwareMgmtpagecontainsthemechanismtoenabletheFirmware Site Distributionfeature.This
featuremustenabledonaremoteswitchinordertoallowittoshareitsfirmwareimage(s)withother
switchesinyournetworkandcanbeenableeitherviaCLIorWebUI.
...
TheFirmwareMgmtpagealsoallowsyoutoenableordisablethefirmwaresitedistributionfeatureandcan
beaccessedthroughthefollowingpath:Navigation pane > System> Firmware Mgmt.
| Figure28 | EnablingfirmwaresitedistributionusingtheWebUI |     |     |     |
| -------- | --------------------------------------------- | --- | --- | --- |
Whentheimagehasbeensuccessfullydownloadedthesystemwilldisplayaconfirmationmessage.
Figure29
WebUIfirmwaresystemupdateconfirmationmessage
Ping page
AOS-CXWebUIpages|44
...
Figure 34 Connected Devices page
...
Figure 35 WebUI Overview Dashboard
...
Supported only on the 8320, 8325, 8360, 9300, and 10000 Switch Series.
...
| Figure37 | AlertspanelonAnalyticsDashboard |     |     |     |     |
| -------- | ------------------------------- | --- | --- | --- | --- |
...
Figure 41 Analytics panel on Overview page
...
Figure 43 Agent Details panels example
...
Figure 46 Agent Details panel including graph
...
Figure 47 Graph with tooltip displayed
...
Figure 49 Zoom options portion of a graph
...
Figure 50 Graph with down arrow highlighted
...
Figure 51 Agent Details before navigating to an alert
...
Figure 52 Graph with alert but not metric for 1/1/3
...
Figure 53 Alert details box with View on Graph button displayed
...
Figure 54 Dialog box prompting you to clear a metric

a. Clear the selection box for the metrics you no longer want to show. For example:

Figure 55 Dialog box with 1/1/9 removed
...
Figure 56 Graph showing alert and metric 1/1/3

...
| SNMPwrite:Configurations            |                                        | 9   |
| SNMPMIBview                         |                                        | 11  |
|                                     | ConfiguringSNMPMIB view                | 11  |
|                                     | SNMPMIBviewlimitations                 | 12  |
| SNMPtraps                           |                                        | 12  |
| ConfiguringSNMP                     |                                        | 13  |
| SNMPcommands                        |                                        | 15  |
|                                     | event-trap-enable                      | 15  |
|                                     | lldptrapenable                         | 15  |
|                                     | mac-notifytraps                        | 18  |
|                                     | rmonalarm                              | 19  |
|                                     | rmonalarm{enable|disable}{index|all}   | 20  |
|                                     | showconfiguration-changestrap          | 21  |
|                                     | showmac-notify                         | 22  |
|                                     | showmac-notifyport                     | 22  |
|                                     | showrmonalarm                          | 23  |
|                                     | showsnmpagent-port                     | 25  |
|                                     | showsnmpcommunity                      | 25  |
|                                     | showsnmpsystem                         | 26  |
|                                     | showsnmptrap                           | 27  |
|                                     | showsnmpviews                          | 27  |
|                                     | showsnmpvrf                            | 29  |
|                                     | showsnmpv3context                      | 29  |
|                                     | showsnmpv3engine-id                    | 30  |
|                                     | showsnmpv3security-level               | 31  |
|                                     | showsnmpv3users                        | 31  |
|                                     | snmp-serveragent-port                  | 32  |
|                                     | snmp-servercommunity                   | 33  |
|                                     | snmp-servercommunityview               | 35  |
|                                     | snmp-serverhistorical-counters-monitor | 36  |
|                                     | snmp-serverhost                        | 37  |
|                                     | snmp-serverresponse-source             | 39  |
|                                     | snmp-serversnmpv3-only                 | 40  |
|                                     | snmp-serversystem-contact              | 40  |
|                                     | snmp-serversystem-description          | 41  |
|                                     | snmp-serversystem-location             | 42  |
3
AOS-CX10.11SNMP/MIBGuide| (AllAOS-CXSeriesSwitches)

|                                   | snmp-servertrap                               |           | 43  |
| --------------------------------- | --------------------------------------------- | --------- | --- |
|                                   | snmp-servertrapaaa-server-reachability-status |           | 44  |
|                                   | snmp-servertrapconfiguration-changes          |           | 45  |
|                                   | snmp-servertrapmac-notify                     |           | 46  |
|                                   | snmp-servertrapmodule                         |           | 46  |
...
| UpdatedMIBsandTrapsforAOS-CX10.11 |                                               |           | 60  |
| MVRP                              |                                               |           | 60  |
|                                   | Tunnelling                                    |           | 60  |
| OIDsthatsupportSNMPread-write     |                                               |           | 61  |
| OIDsthatsupportSNMPread-create    |                                               |           | 61  |
| Support                           | and Other                                     | Resources | 62  |
| AccessingArubaSupport             |                                               |           | 62  |
| AccessingUpdates                  |                                               |           | 63  |
|                                   | ArubaSupportPortal                            |           | 63  |
|                                   | MyNetworking                                  |           | 63  |
| WarrantyInformation               |                                               |           | 63  |
| RegulatoryInformation             |                                               |           | 63  |
| DocumentationFeedback             |                                               |           | 64  |
Contents|4
...
AOS-CX 10.11 SNMP/MIB Guide | (All AOS-CX Series Switches)
...
SNMP
SNMP
SimpleNetworkManagementProtocol(SNMP)isanInternet-standardprotocolusedformanagingand
monitoringthedevicesconnectedtoanetworkbycollecting,organizing,andmodifyinginformation
aboutmanageddevicesonIPnetworks.
| SNMP | write: | PoE | write | capabilities |     |
| ---- | ------ | --- | ----- | ------------ | --- |
PoE enable
ThePoEenableisrequestedthroughSNMPtoenablethePoEinterface.Theadmin_disableSNMPvalue
isupdatedtoenablethePoEinterface.
PoE disable
ThePoEdisableisrequestedthroughSNMPtodisablethePoEinterface.Theadmin_disableSNMP
valueisupdatedtodisablethePoEinterface.
PoE cycle
ThePoEcycleisafeaturewhereyoucanrequestaPoEportresetwithatimeoutrangingfrom1to60
seconds.ThePoEcycleisrequestedthroughtheSNMPservertodisableandenableaPoEinterfacewith
aninputtimeoutof1to60seconds.ThePoEhandlesthePoEdisableandenableeventswhentheSNMP
valueisupdatedforadmin_disablecorrespondingly.Itisaone-timeoperation.
PoE priority
PoEpriorityhandlesthepowerprioritytodecidethenumberofportstobepoweredupaccordingtothe
setpriority.ThisSNMPrequestsetsthePoEinterfacePoEprioritytooneofthesethreevalues:
n critical
n high
n low(Thedefaultpriorityislow)
...
o
Anoctetistwohexadecimalcharactersseparatedby:(colon).Onlyhexadecimalcharactersare
acceptedinthisfield.
Forexample,OIDmaskFF:A0is11111111:10100000.
| SNMP MIB | view | limitations |     |     |     |     |     |
| -------- | ---- | ----------- | --- | --- | --- | --- | --- |
Ansnmpwalkwithacommunityorv3userattachedtocontexttakesprecedenceoverSNMPMIBview.
Ifthecontextisattachedtotheuserorcommunity,theSNMPMIBviewconfiguredtothev3useror
...
| --------- | --- | --- | --- | --- | --- | --- | ----------- |
sysUpTimeInstance 1.3.6.1.2.1.1.3.0 Containstheuptimeforthesystemin
SNMP|12

| Parameter |     | OID | Description |
| --------- | --- | --- | ----------- |
centiseconds
snmpTrapOID 1.3.6.1.6.3.1.1.4.1 ContainstheOIDfortheeventlogtrap
eventIndex 1.3.6.1.2.1.16.9.1.1.1 Containsanindexthatuniquelyidentifies
anevent
eventDescription 1.3.6.1.2.1.16.9.1.1.2 Containstheeventlogmessage
| Link-up and | link-down | traps |     |
| ----------- | --------- | ----- | --- |
StandardIF-MIBlink-upandlink-downtrapswillbesentonlink-statechangewhenaninterfaceis
configuredusingtrap link-statusorwhenuser_config:link_state_snmp_trapissettotrue.The
trapsendsthecurrentinformationforifindex,adminstatus,operationalstatus,andinterfacename.
LinkuptrapOID:1.3.6.1.6.3.1.1.5.4
LinkdowntrapOID:1.3.6.1.6.3.1.1.5.3
| Parameter |     | OID | Description |
| --------- | --- | --- | ----------- |
sysUpTimeInstance 1.3.6.1.2.1.1.3.0 Containstheuptimeforthesystemin
centiseconds
| snmpTrapOID |     | 1.3.6.1.6.3.1.1.4.1 | ContainstheOIDforthelinkupor |
| ----------- | --- | ------------------- | ---------------------------- |
linkdowntrap
ifIndex 1.3.6.1.2.1.2.2.1.1.X Containstheifindexfortheinterface
ifAdminStatus 1.3.6.1.2.1.2.2.1.7.X Containstheadminstatusfortheinterface
...
withthedefault/mgmtVRFusingthecommandsnmp-server vrf <NAME>.Forexample,usethe
...
Updated MIBs and Traps for AOS-CX 10.11
...
MVRP
The HPE-MVRP-MIB is renamed to ARUBAWIRED-MVRP-MIB.mib.

Tunnelling

Tunnel-MIB:RFC4087 is supported for SNMP read-only access for L3 GRE, IPv6 in IPv4 (6in4,) and IPv6 in
IPv6 (6in6) tunnels.

New implemented MIB objects

n TunnelIfTable

o tunnelIfLocalAddress

o tunnelIfRemoteAddress

o tunnelIfEncapsMethod
...
o tunnelIfAddressType

o tunnelIfLocalInetAddress

o tunnelIfRemoteInetAddress

o tunnelIfEncapsLimit

n tunnelConfigTable

o tunnelConfigIfIndex

o tunnelConfigStatus

| 60

n tunnelInetConfigTable
o tunnelInetConfigIfIndex
o tunnelInetConfigStatus
o tunnelInetConfigStorageType
| OIDs that | support | SNMP | read-write |     |
| --------- | ------- | ---- | ---------- | --- |
ThefollowingtablecontainstheOIDsthatsupportSNMPread-write:
| Software Feature |     | MIB File       |     | OID |
| ---------------- | --- | -------------- | --- | --- |
| SNMPv2System     |     | SNMPv2-MIB.mib |     |     |
n sysContact
n sysName
n sysLocation
PoE
|           |     | n ARUBAWIRED-POE.mib    |     | n arubaWiredPoePethPsePortPoECycle |
| --------- | --- | ----------------------- | --- | ---------------------------------- |
|           |     | n POWER-ETHERNET-MIB    |     | n pethPsePortAdminEnable           |
| Interface |     | IF-MIB                  |     | ifAdminStatus                      |
|           |     | n                       |     | n                                  |

...
|                                                         | showobject-group                       | 89  |
3
AOS-CX10.11ACLsandClassifierPoliciesGuide| (6300,6400,8360SwitchSeries)
...
|                                         | classresequence      |                   |                | 127 |
|                                         | classreset           |                   |                | 128 |
|                                         | clearpolicyhitcounts |                   |                | 129 |
|                                         | policy               |                   |                | 131 |
|                                         | policycopy           |                   |                | 135 |
|                                         | policyresequence     |                   |                | 136 |
|                                         | policyreset          |                   |                | 137 |
|                                         | showclass            |                   |                | 138 |
|                                         | showpolicy           |                   |                | 139 |
| Classifier                              | policies             | configuration     | example        | 145 |
| Configuringtheclassifierpoliciesexample |                      |                   |                | 145 |
| ACL and                                 | Policy               | hardware resource | considerations | 148 |
| TCAMlookups                             |                      |                   |                | 148 |
| Matchingprecedenceorder                 |                      |                   |                | 149 |
| L4portranges                            |                      |                   |                | 150 |
| Contextgroupselectors                   |                      |                   |                | 150 |
| ACLandPolicyhardwareresourcecommands    |                      |                   |                | 151 |
|                                         | showresources        |                   |                | 151 |
|                                         | showresources        |                   |                | 153 |
| Support                                 | and Other            | Resources         |                | 155 |
| AccessingArubaSupport                   |                      |                   |                | 155 |
| AccessingUpdates                        |                      |                   |                | 156 |
|                                         | ArubaSupportPortal   |                   |                | 156 |
|                                         | MyNetworking         |                   |                | 156 |
| WarrantyInformation                     |                      |                   |                | 156 |
| RegulatoryInformation                   |                      |                   |                | 156 |
| DocumentationFeedback                   |                      |                   |                | 157 |
Contents|4
...
AOS-CX 10.11 ACLs and Classifier Policies Guide | (6300, 6400, 8360 Switch Series)
...
ACL that will be applied to a VLAN.

Specifies a time-to-live (hop limit) value.
Range: 0 to 255. Not supported for ACLs.

Keeps the hit counts of the number of
packets matching this ACE.

Keeps a log of the number of packets
matching this ACE. Works with both permit
and deny actions. Works with ACLs applied
on ingress or egress, except for control plane.

Adds a comment to an ACE. The no form
removes only the comment from the ACE.
...
When an ACL fails to apply, that ACL should be fixed as soon as possible. The reset command is sufficient to

return the configuration back into the last good state. If a switch reboots with a failed ACL application in the

configuration, when the switch comes up, some ports may stay down because the configuration is not valid.
...
config
The access-list ip <ACL-
NAME> command takes
you into the named ACL
...
Works with ACLs applied on ingress or egress, except
for control plane.
...
deny actions. Works with ACLs applied on ingress or egress, except for control plane.
...
switch(config)#
|     | object-group | ipv6 | address | my_ipv6_group | reset |
| --- | ------------ | ---- | ------- | ------------- | ----- |
switch(config)#
Formoreinformationonfeaturesthatusethiscommand,refertotheACLsandClassifiersPolicyGuideforyour
switchmodel.
...
| ------------------------ | --- | ----- | ------- | --------- | --- |
| switch(config-class-ip)# |     | exit  |         |           |     |
Classifierpoliciesconfigurationexample|146
...
Support and Other Resources | 156

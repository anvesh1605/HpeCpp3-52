...
AOS-CX 10.16.xxxx Hardening Guide | (All Switch Series)
...
4
AOS-CX10.16.xxxxHardeningGuide| (AllSwitchSeries)
...
notification services are provided by a Security Alerts mailing list, with subscriptions offered via the self-
service portal. For more information , refer to the Security Incident Response Policy.
...
The 100xx, 8xxx and 93xx Switch series ship with these services enabled only on the mgmt VRF, while
6400, 6300, 6200 and 5420 switches ship with these services enabled on both the default and mgmt
VRFs.
...
| --- | -------- | --- | --- | ---------------------------------- |
runsself-tests.
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 13
...
n WebUI
n RESTAPI
n HPEArubaNetworkingCXMobileApp
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 15
...
ServiceOS shall default to standard secure mode if Zeroization fails while setting to standard or
...
o RESTInterfaceGETmethodavailableonlyforfollowingresourcesonly
Auditlog:/logs/audit
l
l Eventlog:/logs/event
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 19
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 23
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 25
...
n Failthrough–Authorizationfail-throughisrecommendedonlyfordeploymentswherethereare
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 27
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 29
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 31
...
| --------------- | --- | --------------------- | --------- |
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 33
...
managementprotocols.
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 35
...
| -------- | -------- | --- | ---- | --- | --- | --- | --- | --- |
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 41

ThefollowingsectionsdescribesecurityandhardeningworkflowsforSpanningTree.
BPDU Protection
Varioussecuritymechanismsareinplacetoprotectspanningtreeconfigurationsfrominterferenceand
...
|     |     |     |     | Max |     | Static |     | Dynamic |     |     |     |
| --- | --- | --- | --- | --- | --- | ------ | --- | ------- | --- | --- | --- |
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 43
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 45
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 47
...
interface(port)matchtheIPbindingdatabaseentry.
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 49
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 51
...
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 53
...
PIM SSM
AOS-CX10.16.xxxxHardeningGuide|(AllSwitchSeries) 55
...
Networking Solution Exchange. These scripts can help in hardening the switch control planeThese
scripts can help in hardening the switch control plane.
...
DisabletheHPEArubaNetworkingCentralclientusingthefollowingcommands:
n
switch(config)#
hpe-anw-central

...
AOS-CX 10.10 Introduction to the Web UI Guide | (8xxx, 9300, 10000 Switch Series)
...
| ConfigMgmtpage                      |                                                |               | 39  |
4
AOS-CX10.10IntroductiontotheWebUIGuide| (8xxx,9300,10000SwitchSeries)
...
| ShowTechpage                          |                                        |         |           |          | 43  |
| SpanningTreepage                      |                                        |         |           |          | 43  |
|                                       | Editingthespanningtreesettings         |         |           |          | 45  |
| ConnectedClientspage                  |                                        |         |           |          | 45  |
| PKIpage                               |                                        |         |           |          | 46  |
|                                       | AddinganddeletinganESTProfile          |         |           |          | 47  |
|                                       | ViewinganESTProfile                    |         |           |          | 47  |
|                                       | AddinganddeletingaTAProfile            |         |           |          | 48  |
...
|                                       | Downloadingasupportfile                |         |           |          | 54  |
| Finding                               | alert details                          | using   | the Web   | UI       | 55  |
| Working                               | with the                               | network | analytics | features | 57  |
| ViewingagentinformationusingtheWebUI  |                                        |         |           |          | 57  |
| WorkingwithanAnalyticstimeseriesgraph |                                        |         |           |          | 61  |
|                                       | Customizingdatadisplayedonthegraph     |         |           |          | 62  |
|                                       | Zoominginonthegraph                    |         |           |          | 63  |
|                                       | Downloadingthegraphasanimageor.csvfile |         |           |          | 64  |
|                                       | Viewinganalertonthegraph               |         |           |          | 64  |
ArubaNetworkAnalyticsEnginescripts,agents,andtroubleshootinginformation 67
| Support                            | and Other          | Resources |     |     | 69  |
| ---------------------------------- | ------------------ | --------- | --- | --- | --- |
| AccessingHPEArubaNetworkingSupport |                    |           |     |     | 69  |
| AccessingUpdates                   |                    |           |     |     | 70  |
|                                    | ArubaSupportPortal |           |     |     | 70  |
|                                    | MyNetworking       |           |     |     | 70  |
| WarrantyInformation                |                    |           |     |     | 70  |
...
6. SelectEnableorDisablefortheFlow Control Status.
...
LinksintheInterfacesandLAGscolumnsallowyoutodrilldowntotherespectiveInterfacesorLAGs
pages,auto-selectingtheappropriateresource.
SelectingarowintheVLANslist,displaysmoreinformationontheVLANinthedetailspane.Details
include:VLANmode,AdminState,LinkState,andtheassociatedLAGname.
...
AOS-CX10.10IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 24
...
AOS-CX10.10IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 36
...
Working with the network analytics features | 60
...
following:
AOS-CX10.10IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 67

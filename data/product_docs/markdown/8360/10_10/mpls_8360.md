...
AOS-CX 10.10 MPLS Guide | (8360 Switch Series)
...
| LDP anddownstreamlabelallocation             |               |               | 11  |
| Label-basedforwarding                        |               |               | 11  |
| MPLS L3VPN forwarding                        |               |               | 12  |
| MPLS L3VPN requirementsandrecommendations    |               |               | 13  |
| MPLS L3VPN QoS                               |               |               | 13  |
| MPLS L3VPN trafficloadbalancing              |               |               | 14  |
| SameCEAS                                     |               |               | 14  |
| LDPpacketcapture                             |               |               | 15  |
| VPNv4packetcapture                           |               |               | 15  |
| Supported                                    | features      | and standards | 17  |
| Defaultbehaviors                             |               |               | 17  |
| Supportedfeatures                            |               |               | 17  |
| Scale                                        |               |               | 17  |
| Bestpractices                                |               |               | 18  |
| SupportedRFCsandstandards                    |               |               | 19  |
| Configuration                                | task          | list          | 20  |
| ConfiguringMPLSandLDPglobally                |               |               | 20  |
| ConfiguringMPLSandLDPonaninterface           |               |               | 20  |
| ConfiguringIBGP VPNv4peering                 |               |               | 20  |
| ConfiguringVPN                               |               |               | 21  |
| ConfiguringEBGPpeeringbetweenPEandCE         |               |               | 21  |
| Use cases                                    |               |               | 23  |
| Usecase1: MPLS L3VPN withdualhomedVSXCE      |               |               | 23  |
| Usecase2: MPLS L3VPN withhubandspokeVRFs     |               |               | 97  |
| MPLS                                         | commands      |               | 141 |
| bindipv4(lsplabelimposition)                 |               |               | 141 |
| bindipv4input(staticlspbinding)              |               |               | 143 |
| clearmplsstatistics                          |               |               | 144 |
| crossconnectinput(staticlspbindinglabelswap) |               |               | 144 |
| enable(mplsglobally)                         |               |               | 146 |
| enable(mplsldp)                              |               |               | 147 |
| enable(mplsstaticlsp)                        |               |               | 148 |
| enablempls(interface)                        |               |               | 149 |
| mplsldpgracefulrestarttimers                 |               |               | 150 |
| label-range(staticlsp)                       |               |               | 152 |
4
AOS-CX10.10MPLSGuide| (8360SwitchSeries)

| label-protocolldp                        |                     |           | 153 |
| ---------------------------------------- | ------------------- | --------- | --- |
| mpls                                     |                     |           | 154 |
| mplsldpenable                            |                     |           | 154 |
| mplsldpentropylabelinsertion             |                     |           | 155 |
| mplsldpdiscoveryhelloholdtime(global)    |                     |           | 156 |
| mplsldpdiscoveryhelloholdtime(interface) |                     |           | 157 |
| mplsldpsessionholdtime(interface)        |                     |           | 158 |
| pingmpls                                 |                     |           | 159 |
| router-id(mplsldp)                       |                     |           | 161 |
| sessionholdtime(mplsldpglobally)         |                     |           | 163 |
| showbgpvpnv4unicast                      |                     |           | 164 |
| showcapacitiesmpls                       |                     |           | 169 |
| showmplsforwarding                       |                     |           | 170 |
| showmplslabel-rangestatic-lsp            |                     |           | 172 |
| showmplsldpbindings                      |                     |           | 172 |
| showmplsldpdiscovery                     |                     |           | 173 |
| showmplsldpgraceful-restart              |                     |           | 174 |
| showmplsldpneighbor                      |                     |           | 175 |
| static-lsp                               |                     |           | 176 |
| traceroutempls                           |                     |           | 177 |
| Debugging                                | and troubleshooting |           | 179 |
| Troubleshootingsteps                     |                     |           | 180 |
| Frequentlyaskedquestions                 |                     |           | 187 |
| Support                                  | and Other           | Resources | 189 |
| AccessingArubaSupport                    |                     |           | 189 |
| AccessingUpdates                         |                     |           | 190 |
| WarrantyInformation                      |                     |           | 190 |
| RegulatoryInformation                    |                     |           | 190 |
| DocumentationFeedback                    |                     |           | 191 |
|5
...
2. LSR2 will receive the packet, see inbound label 1001, swap it with label 2001 and send it towards

LSR3.

3. LSR3 will receive the packet, see inbound label 2001, pop it and send the packet using its

IP routing table to the destination.
...
(OSPF) and Border Gateway Protocol (BGP). Routing Information Protocol(RIP) is not currently
supported for communication between Customer Edge and Provider Edge.
...
o o E.g. if the network between P and PE is X.0.0.0/24 with an interface address of P as X.0.0.1/24

and address of PE as X.0.0.2/24, the LDP binding on PE for the X.0.0.0/24 network will be shown as
X.0.0.1/32
...
n UseasingleASfortheMPLSnetwork
n UtilizeEBGPbetweenCEandPEfordynamicrouting,useuniqueCEAS#ifpossible
UseredundantVPNv4RRstoavoidfullmeshIBGPpeers
n
...
Supportedfeaturesandstandards|18

n The l3vpn-only command should only be configured under the VRF context

n Implicit null is not supported, explicit null has to be configured on 3rd party egress PE towards AOS-
...
The MPLS and MPLS L3 VPN implementation uses standards based protocols as described in the
following RFCs:

n RFC 2547, BGP/MPLS VPNs

n RFC 3031, Multiprotocol Label Switching Architecture

n RFC 3032, MPLS Label Stack Encoding

n RFC 3036, LDP Specification

n RFC 3443, Time To Live (TTL) Processing in Multi-Protocol Label Switching (MPLS) Networks

n RFC 4182, Removing a Restriction on the use of MPLS Explicit NULL

n RFC 4364, BGP/MPLS IP Virtual Private Networks (VPNs)

n RFC 6388, Label Distribution Protocol Extensions for Point-to-Multipoint and Multipoint-to-Multipoint
...
| Step               |            | Command |                 |     | Comments |
| 1.EnterBGP context |            | router  | bgp <AS-NUMBER> |     |          |
20
AOS-CX10.10MPLSGuide|(8360SwitchSeries)

| Step | Command |     |     |     | Comments |
| ---- | ------- | --- | --- | --- | -------- |
2.Specifyremote neighbor <IP-ADDRESS> remote-as ThesameASnumbershouldbeused
| BGP neighborandremote | <AS-NUMBER> |     |     |     | betweenP/PE.OSPF shouldbe    |
| --------------------- | ----------- | --- | --- | --- | ---------------------------- |
| AS                    |             |     |     |     | enabledbeforeBGP toadvertise |
loopbackIPsbetweenLSRs.
| 3.Specifysource  | neighbor | <IP-ADDRESS> |          | update- |     |
| ---------------- | -------- | ------------ | -------- | ------- | --- |
| IP/interface for | source   | loopback     | <NUMBER> |         |     |
IBGP peering
| 4.EnterVPNv4address | address-family |     | vpnv4 | unicast |     |
| ------------------- | -------------- | --- | ----- | ------- | --- |
family
| 5.ActivateIBGP neighbor | neighbor  | <IP-ADDRESS> |     | activate |     |
| ----------------------- | --------- | ------------ | --- | -------- | --- |
| 6.Sendextended          | neighbor  | <IP-ADDRESS> |     | send-    |     |
| communities             | community | extended     |     |          |     |
Thedescriptions,syntax,andexamplesforthecommandslistedabovecanbefoundintheIPRoutingGuide.
| Configuring | VPN |         |     |     |          |
| ----------- | --- | ------- | --- | --- | -------- |
| Step        |     | Command |     |     | Comments |
1.CreatedesiredVRF vrf <VRF-NAME> ThiscommandcanbefoundintheIP
RoutingGuide.
2.SpecifyauniqueRDperPE, rd number:number Thiscommandcanbefoundinthe
| perVRF |     |     |     |     | VXLANGuide. |
| ------ | --- | --- | --- | --- | ----------- |
3.EnableVPNv4addressfamily l3vpn-only l3vpn-onlyunderVRFcontextis
requiredforVPNv4addressfamilyto
beactive.
4.EnterIPv4unicastaddress address-family ipv4 unicast ThiscommandcanbefoundintheIP
| family |     |     |     |     | RoutingGuide. |
| ------ | --- | --- | --- | --- | ------------- |
5.Specifydesiredroute-target route-target export <AS- Theroute target both
forexport NUMBER:ID> | <IP-ADDRESS:ID number:numbercommandmayalso
beusedasanalternative.This
6.Specifydesiredroute-target route-target import <AS- commandcanbefoundintheVXLAN
| forimport   |      | NUMBER:ID> | | <IP-ADDRESS:ID |     | Guide.   |
| ----------- | ---- | ---------- | ---------------- | --- | -------- |
| Configuring | EBGP | peering    | between          | PE  | and CE   |
| Step        |      | Command    |                  |     | Comments |
1.EnterinterfacefacingCE interface <IFNAME> DesiredIP addresswillalsoneedto
beadded.
Configurationtasklist|21

| Step                      | Command        |             | Comments |
| ------------------------- | -------------- | ----------- | -------- |
| 2.AttachVRFtointerface    | vrf attach     | <VRF-NAME>  |          |
| 3.EnterBGPcontext         | router bgp     | <AS-NUMBER> |          |
| 4.EnterdesiredVRF context | vrf <VRF-NAME> |             |          |
5.SpecifyremoteCE IP neighbor <IP-ADDRESS> remote- EBGP shouldbeusedbetweenCE/PE
withdifferentAS.
as <AS-NUMBER>
| 6.EnterIPv4unicastcontextfor | address-family | ipv4 unicast |     |
| ---------------------------- | -------------- | ------------ | --- |
VRF
| 7.ActivetheEBGP neighbor | neighbor | IP-address activate |     |
| ------------------------ | -------- | ------------------- | --- |
8.Redistributeconnectedroute redistribute connected Optional.Onlyrequiredifconnected
| toremotePEsandCEs |     |     | routesneedtobeadvertised. |
| ----------------- | --- | --- | ------------------------- |
Thedescriptions,syntax,andexamplesforthecommandslistedabovecanbefoundintheIPRoutingGuide.
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 22
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 25
...
| --- | ------- | --- | --- | --- | --- | --- | --- | --- | ------- | ------ |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 27
...
| !Version ArubaOS-CX | GL.10.09.0001BF |     |     |     |
| ------------------- | --------------- | --- | --- | --- |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 29
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 31
...
| Address-family  |     | : IPv4   | Unicast |     |     |     |     |     |     |
-----------------------------
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 33
...
|                     | 20.3.1.2 | vlan2032 | -   |     |
| [20/0] 00h:54m:06s  |          |          |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 35
...
| -------------- | --- | ------ | ------- | --- | --- | --- | --- | --- |
-----------------------------
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 37
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 39
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 41
...
| Exit Bindings : 2    |     |     |
| Transit Bindings : 4 |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 43
...
----------------------------------------------------------------------------------
---------------------------------------
| LDP 1.1.1.1/32 |         |             | default     |     | 30.0.0.1 |     | exp-null |     |       |
| -------------- | ------- | ----------- | ----------- | --- | -------- | --- | -------- | --- | ----- |
| 1/1/14         | default |             | operational |     |          |     |          |     |       |
| LDP 2.2.2.2/32 |         |             | default     |     | 30.0.1.1 |     | exp-null |     |       |
| 1/1/15         | default |             | operational |     |          |     |          |     |       |
| LDP 3.3.3.3/32 |         |             | default     |     | 30.0.2.2 |     | exp-null |     | lag99 |
| default        |         | operational |             |     |          |     |          |     |       |
| LDP 5.5.5.5/32 |         |             | default     |     | 30.0.2.2 |     | 19       |     | lag99 |
| default        |         | operational |             |     |          |     |          |     |       |
Exit Bindings:
...
----------------------------------------------------------------------------------
-------------------------------
| LDP 1.1.1.1/32 |     |     | 16  | 1/1/14 |     | default |     | 30.0.0.1 |     |
| -------------- | --- | --- | --- | ------ | --- | ------- | --- | -------- | --- |
exp-null operational
| LDP 5.5.5.5/32 |     |     | 17  | lag99 |     | default |     | 30.0.2.2 |     |
| -------------- | --- | --- | --- | ----- | --- | ------- | --- | -------- | --- |
19 operational
| LDP 2.2.2.2/32 |     |     | 18  | 1/1/15 |     | default |     | 30.0.1.1 |     |
| -------------- | --- | --- | --- | ------ | --- | ------- | --- | -------- | --- |
exp-null operational
| LDP 3.3.3.3/32 |     |     | 19  | lag99 |     | default |     | 30.0.2.2 |     |
| -------------- | --- | --- | --- | ----- | --- | ------- | --- | -------- | --- |
exp-null operational
...
| Conn. Established |         |        | : 1           |     |     | Conn. Dropped     |          |     | : 0         |
| Passive           |         |        | : No          |     |     | Update-Source     |          |     | : loopback0 |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 45
...
| Conn. Established |         |        | : 1           |     |     | Conn. Dropped     |          |     | : 0         |
| Passive           |         |        | : No          |     |     | Update-Source     |          |     | : loopback0 |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 47
...
| ------------ | --- | ---------- | --- | ------- | --- | ------ | ------ | ----------- | --- |
| Total number |     | of entries |     | 0       |     |        |        |             |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 49
...
| ip ospf     | 1 area 0.0.0.0 |     |     |     |
| mpls enable |                |     |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 51
...
30.0.3.2/32
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 53
...
----------------------------------------------------------------------------------
---------------------------------------
| LDP 1.1.1.1/32 |         |     | default     |     | 30.0.3.1 |     |     | exp-null |     |
| -------------- | ------- | --- | ----------- | --- | -------- | --- | --- | -------- | --- |
| 1/1/25         | default |     | operational |     |          |     |     |          |     |
| LDP 2.2.2.2/32 |         |     | default     |     | 30.0.4.1 |     |     | exp-null |     |
| 1/1/26         | default |     | operational |     |          |     |     |          |     |
| LDP 3.3.3.3/32 |         |     | default     |     | 30.0.5.2 |     |     | exp-null |     |
| lag100         | default |     | operational |     |          |     |     |          |     |
| LDP 4.4.4.4/32 |         |     | default     |     | 30.0.5.2 |     |     | 18       |     |
| lag100         | default |     | operational |     |          |     |     |          |     |
Exit Bindings:
| Origin Prefix |     |     | Incoming | Service | Egress |     |     | Status |     |
| ------------- | --- | --- | -------- | ------- | ------ | --- | --- | ------ | --- |
...
----------------------------------------------------------------------------------
-------------------------------
| LDP 1.1.1.1/32 |     |     | 16  | 1/1/25 |     | default |     |     | 30.0.3.1 |
| -------------- | --- | --- | --- | ------ | --- | ------- | --- | --- | -------- |
exp-null operational
| LDP 4.4.4.4/32 |     |     | 17  | lag100 |     | default |     |     | 30.0.5.2 |
| -------------- | --- | --- | --- | ------ | --- | ------- | --- | --- | -------- |
18 operational
| LDP 2.2.2.2/32 |     |     | 18  | 1/1/26 |     | default |     |     | 30.0.4.1 |
| -------------- | --- | --- | --- | ------ | --- | ------- | --- | --- | -------- |
exp-null operational
| LDP 3.3.3.3/32 |     |     | 19  | lag100 |     | default |     |     | 30.0.5.2 |
| -------------- | --- | --- | --- | ------ | --- | ------- | --- | --- | -------- |
exp-null operational
...
| Cfg. Hold         | Time      | : 180         |     |     | Cfg.          | Keep    | Alive | : 60        |     |
| Neg. Hold         | Time      | : 180         |     |     | Neg.          | Keep    | Alive | : 60        |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 55
...
| Cfg. Hold         | Time    |        | : 180         |     |     | Cfg. Keep         | Alive    |     | : 60        |
| Neg. Hold         | Time    |        | : 180         |     |     | Neg. Keep         | Alive    |     | : 60        |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 57
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 59
...
| Address-family |     | : L2VPN | EVPN |     |     |     |             |     |             |     |
-----------------------------
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 61
...
rd 2:1
l3vpn-only
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 63
...
| --- | -------- | -------- | --------- | --- | --- | --- | --- | --- | --- |
|     | neighbor | 20.1.1.1 | remote-as |     | 100 |     |     |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 65
...
| ------------- | ------ | ------- | ------- | -------- |
| Egress        | Egress | Status  |         |          |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 67
...
----------------------------------------------------------------------------------
---------------------------------------
| LDP    | 2.2.2.2/32   |     | default     |     | 30.0.3.2 |     | 18       |
| ------ | ------------ | --- | ----------- | --- | -------- | --- | -------- |
| 1/1/40 | default      |     | operational |     |          |     |          |
| LDP    | 2.2.2.2/32   |     | default     |     | 30.0.0.2 |     | 18       |
| 1/1/39 | default      |     | operational |     |          |     |          |
| LDP    | 3.3.3.3/32   |     | default     |     | 30.0.3.2 |     | 19       |
| 1/1/40 | default      |     | operational |     |          |     |          |
| LDP    | 3.3.3.3/32   |     | default     |     | 30.0.0.2 |     | 19       |
| 1/1/39 | default      |     | operational |     |          |     |          |
| LDP    | 4.4.4.4/32   |     | default     |     | 30.0.0.2 |     | exp-null |
| 1/1/39 | default      |     | operational |     |          |     |          |
| LDP    | 5.5.5.5/32   |     | default     |     | 30.0.3.2 |     | exp-null |
| 1/1/40 | default      |     | operational |     |          |     |          |
| BGP    | 201.0.0.0/24 |     | vrf_1       |     | 3.3.3.3  |     | 21       |
| 1/1/40 | default      |     | operational |     |          |     |          |
| BGP    | 202.0.0.0/24 |     | vrf_2       |     | 3.3.3.3  |     | 22       |
| 1/1/40 | default      |     | operational |     |          |     |          |
Exit Bindings:
| Origin | Prefix |     | Incoming | Service | Egress |     | Status |
| ------ | ------ | --- | -------- | ------- | ------ | --- | ------ |
...
----------------------------------------------------------------------------------
-------------------------------
| LDP       | 4.4.4.4/32  |                 | 16  | 1/1/39 |     | default | 30.0.0.2 |
| --------- | ----------- | --------------- | --- | ------ | --- | ------- | -------- |
|           | exp-null    | operational     |     |        |     |         |          |
| LDP       | 5.5.5.5/32  |                 | 17  | 1/1/40 |     | default | 30.0.3.2 |
|           | exp-null    | operational     |     |        |     |         |          |
| LDP       | 2.2.2.2/32  |                 | 18  | 1/1/40 |     | default | 30.0.3.2 |
|           | 18          | operational     |     |        |     |         |          |
| LDP       | 2.2.2.2/32  |                 | 18  | 1/1/39 |     | default | 30.0.0.2 |
|           | 18          | operational     |     |        |     |         |          |
| LDP       | 3.3.3.3/32  |                 | 19  | 1/1/40 |     | default | 30.0.3.2 |
|           | 19          | operational     |     |        |     |         |          |
| LDP       | 3.3.3.3/32  |                 | 19  | 1/1/39 |     | default | 30.0.0.2 |
|           | 19          | operational     |     |        |     |         |          |
...
| Peer-group     |         |        | :             |         |     |                   |          |     |        |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 69
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 71
...
|            |     |             | 30.0.0.2 |     | 1/1/39    |     | -   |     |     |     |
| [110/200]  |     | 01h:12m:16s |          |     |           |     |     |     |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 73
...
| ------------------ | --------- | --- | --- | --- |
| vlan trunk allowed | 2041-2042 |     |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 75
...
| -------- | ------ | ------------ | --- | ----- | --- | --- | --- | ------- | --------- |
| Neighbor | ID     | Priority     |     | State |     |     | Nbr | Address | Interface |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 77
...
----------------------------------------------------------------------------------
---------------------------------------
| LDP    | 1.1.1.1/32   |     | default     | 30.0.1.2 | 16       |
| ------ | ------------ | --- | ----------- | -------- | -------- |
| 1/1/45 | default      |     | operational |          |          |
| LDP    | 1.1.1.1/32   |     | default     | 30.0.4.2 | 16       |
| 1/1/46 | default      |     | operational |          |          |
| LDP    | 3.3.3.3/32   |     | default     | 30.0.4.2 | 19       |
| 1/1/46 | default      |     | operational |          |          |
| LDP    | 3.3.3.3/32   |     | default     | 30.0.1.2 | 19       |
| 1/1/45 | default      |     | operational |          |          |
| LDP    | 4.4.4.4/32   |     | default     | 30.0.1.2 | exp-null |
| 1/1/45 | default      |     | operational |          |          |
| LDP    | 5.5.5.5/32   |     | default     | 30.0.4.2 | exp-null |
| 1/1/46 | default      |     | operational |          |          |
| BGP    | 201.0.0.0/24 |     | vrf_1       | 3.3.3.3  | 21       |
| 1/1/46 | default      |     | operational |          |          |
| BGP    | 202.0.0.0/24 |     | vrf_2       | 3.3.3.3  | 22       |
...
|         | Outgoing Status |     |                 |         |             |
|         |                 |     | Label Interface | VRF     | Address     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 79

Label
----------------------------------------------------------------------------------
-------------------------------
| LDP       | 1.1.1.1/32  |             |            | 16  |     | 1/1/45 |     | default |     |     | 30.0.1.2 |
| --------- | ----------- | ----------- | ---------- | --- | --- | ------ | --- | ------- | --- | --- | -------- |
|           | 16          | operational |            |     |     |        |     |         |     |     |          |
| LDP       | 1.1.1.1/32  |             |            | 16  |     | 1/1/46 |     | default |     |     | 30.0.4.2 |
|           | 16          | operational |            |     |     |        |     |         |     |     |          |
| LDP       | 4.4.4.4/32  |             |            | 17  |     | 1/1/45 |     | default |     |     | 30.0.1.2 |
|           | exp-null    | operational |            |     |     |        |     |         |     |     |          |
| LDP       | 5.5.5.5/32  |             |            | 18  |     | 1/1/46 |     | default |     |     | 30.0.4.2 |
|           | exp-null    | operational |            |     |     |        |     |         |     |     |          |
| LDP       | 3.3.3.3/32  |             |            | 19  |     | 1/1/45 |     | default |     |     | 30.0.1.2 |
|           | 19          | operational |            |     |     |        |     |         |     |     |          |
| LDP       | 3.3.3.3/32  |             |            | 19  |     | 1/1/46 |     | default |     |     | 30.0.4.2 |
|           | 19          | operational |            |     |     |        |     |         |     |     |          |
...
| Route Refresh                |            |        |               |         | Yes         |                   |            | Yes        |             |
| Graceful                     | Restart    |        |               |         | Yes         |                   |            | Yes        |             |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 81
...
| --------------- | --- | ------- | ------- | --- | --- | --- | --- | --- | --- |
| Address-family  |     | : IPv4  | Unicast |     |     |     |     |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 83
...
| Prefix |     | Nexthop |     |     | Interface | VRF(egress) |     | Origin/ |     |
| ------ | --- | ------- | --- | --- | --------- | ----------- | --- | ------- | --- |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 85
...
| ----------- | ---------- | --- |
lag 100
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 87
...
|     | remote | binding:      | lsr:5.5.5.5:0 | label: | exp-null |     |
30.0.3.2/32
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 89
...
----------------------------------------------------------------------------------
---------------------------------------
| LDP 1.1.1.1/32   |         | default     | 30.0.5.1 | 16       |       |
| ---------------- | ------- | ----------- | -------- | -------- | ----- |
| lag100           | default | operational |          |          |       |
| LDP 1.1.1.1/32   |         | default     | 30.0.2.1 | 16       | lag99 |
| default          |         | operational |          |          |       |
| LDP 2.2.2.2/32   |         | default     | 30.0.2.1 | 18       | lag99 |
| default          |         | operational |          |          |       |
| LDP 2.2.2.2/32   |         | default     | 30.0.5.1 | 18       |       |
| lag100           | default | operational |          |          |       |
| LDP 4.4.4.4/32   |         | default     | 30.0.2.1 | exp-null | lag99 |
| default          |         | operational |          |          |       |
| LDP 5.5.5.5/32   |         | default     | 30.0.5.1 | exp-null |       |
| lag100           | default | operational |          |          |       |
| BGP 101.0.0.0/24 |         | vrf_1       | 1.1.1.1  | 20       |       |
| lag100           | default | operational |          |          |       |
| BGP 102.0.0.0/24 |         | vrf_2       | 1.1.1.1  | 22       |       |
| lag100           | default | operational |          |          |       |
Exit Bindings:
Usecases|90
...
| Weight              |             |         | :          | 0           |         |     | Fall-over     |            |       | : No        |     |
| Confederation-Peers |             |         | :          | No          |         |     |               |            |       |             |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 91
...
| Total number         |     | of entries |     | 6       |     |        |        |     |             |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 93
...
| --------------- | -------- | ------- | --- | --- | --- | --- |
| Address-family  | : IPv4   | Unicast |     |     |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 95
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 97

CE1 Configuration
CE1# show run Current configuration: ! !Version ArubaOS-CX TL.10.09.0001AX
!export-password: default hostname CE1 profile l3-core logging console severity
crit cli-session timeout 0 ! ! ! ! ! ssh server vrf mgmt vlan 1,2001,2071
interface mgmt no shutdown ip dhcp interface 1/1/43 no shutdown description
Towards 101 subnet no routing vlan trunk native 1 vlan trunk allowed 2071
interface 1/1/44 no shutdown description Towards PE1 no routing vlan trunk native
1 vlan trunk allowed 2001 interface vlan 2001 description Towards PE1 ip address
20.0.1.1/24 interface vlan 2071 description Towards 101 subnet ip address
20.7.1.2/24 ip ospf 1 area 0.0.0.0 ! ! ! ! ! router ospf 1 area 0.0.0.0 router bgp
100 neighbor 20.0.1.2 remote-as 6488163 neighbor 20.0.1.2 description Towards PE1
neighbor 20.7.1.1 remote-as 100 neighbor 20.7.1.1 description Towards 101 subnet
address-family ipv4 unicast neighbor 20.0.1.2 activate neighbor 20.0.1.2 send-
community both neighbor 20.0.1.2 soft-reconfiguration inbound neighbor 20.7.1.1
activate neighbor 20.7.1.1 next-hop-self exit-address-family ! https-server vrf
mgmt
CE1 Verification
...
| Gr. Stalepath     |          | Time   | : 300         |              |     | Remove            | Private-AS |      | : No       |
| TTL               |          |        | : 255         |              |     | Local Cluster-ID  |            |      | :          |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 99
...
CE2 Configuration
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 101
...
| Routemap     |          | In     | :         |     |     |                   |          |     |        |
| Routemap     |          | Out    | :         |     |     |                   |          |     |        |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 103
...
| [20/0]      |     | 00h:23m:22s |          |     |          |     |     |     |     |     |     |     |
| 20.1.1.0/24 |     |             | -        |     | vlan2011 |     |     | -   |     |     | C   |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 105
...
| Last         | Err    | Rcvd        |      | : No             | Error |          |               |       |            |
| Last         | SubErr |             | Rcvd | : No             | Error |          |               |       |            |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 107
...
CE4 Configuration
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 109
...
| Address                      |             | family IPv6 | Unicast          |     | No               | No         |            |
| Address                      |             | Family :    | IPv4 Unicast     |     |                  |            |            |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 111
...
| interface mgmt |     |     |     |     |     |
| -------------- | --- | --- | --- | --- | --- |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 113
...
----------------------------------------------------------------------------------
---------------------------------------
| LDP 2.2.2.2/32   |         |     | default     |     | 30.0.1.2 | 17       |
| ---------------- | ------- | --- | ----------- | --- | -------- | -------- |
| 1/1/38           | default |     | operational |     |          |          |
| LDP 3.3.3.3/32   |         |     | default     |     | 30.0.1.2 | 18       |
| 1/1/38           | default |     | operational |     |          |          |
| LDP 4.4.4.4/32   |         |     | default     |     | 30.0.1.2 | exp-null |
| 1/1/38           | default |     | operational |     |          |          |
| BGP 0.0.0.0/0    |         |     | spoke_1     |     | 3.3.3.3  | 19       |
| 1/1/38           | default |     | operational |     |          |          |
| BGP 20.4.1.0/24  |         |     | spoke_1     |     | 3.3.3.3  | 19       |
| 1/1/38           | default |     | operational |     |          |          |
| BGP 20.5.1.0/24  |         |     | spoke_1     |     | 3.3.3.3  | 19       |
| 1/1/38           | default |     | operational |     |          |          |
| BGP 20.6.1.0/24  |         |     | spoke_1     |     | 3.3.3.3  | 19       |
| 1/1/38           | default |     | operational |     |          |          |
| BGP 151.0.0.0/24 |         |     | spoke_1     |     | 3.3.3.3  | 19       |
| 1/1/38           | default |     | operational |     |          |          |
| BGP 201.0.0.0/24 |         |     | spoke_1     |     | 3.3.3.3  | 19       |
| 1/1/38           | default |     | operational |     |          |          |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 115
...
----------------------------------------------------------------------------------
-------------------------------
| LDP | 4.4.4.4/32 |             |     | 16  |     | 1/1/38 |     | default |     |     | 30.0.1.2 |
| --- | ---------- | ----------- | --- | --- | --- | ------ | --- | ------- | --- | --- | -------- |
|     | exp-null   | operational |     |     |     |        |     |         |     |     |          |
| LDP | 2.2.2.2/32 |             |     | 17  |     | 1/1/38 |     | default |     |     | 30.0.1.2 |
|     | 17         | operational |     |     |     |        |     |         |     |     |          |
| LDP | 3.3.3.3/32 |             |     | 18  |     | 1/1/38 |     | default |     |     | 30.0.1.2 |
|     | 18         | operational |     |     |     |        |     |         |     |     |          |
PE1#
...
| ------------------- |            |        | -----         |         | ----- |                   |            |      |             |
| Open                |            |        |               | 1       | 1     |                   |            |      |             |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 117
...
| PE1# show | bgp | all-vrf | all summary |     |     |     |     |     |     |
| --------- | --- | ------- | ----------- | --- | --- | --- | --- | --- | --- |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 119
...
exit-address-family
cli-session
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 121
...
----------------------------------------------------------------------------------
---------------------------------------
| LDP 1.1.1.1/32  |         |     | default     |     | 30.0.2.2 | 16       |
| --------------- | ------- | --- | ----------- | --- | -------- | -------- |
| 1/1/44          | default |     | operational |     |          |          |
| LDP 3.3.3.3/32  |         |     | default     |     | 30.0.2.2 | 18       |
| 1/1/44          | default |     | operational |     |          |          |
| LDP 4.4.4.4/32  |         |     | default     |     | 30.0.2.2 | exp-null |
| 1/1/44          | default |     | operational |     |          |          |
| BGP 0.0.0.0/0   |         |     | spoke_2     |     | 3.3.3.3  | 19       |
| 1/1/44          | default |     | operational |     |          |          |
| BGP 20.4.1.0/24 |         |     | spoke_2     |     | 3.3.3.3  | 19       |
| 1/1/44          | default |     | operational |     |          |          |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 123

| BGP    | 20.5.1.0/24  |         |     | spoke_2 |             |     | 3.3.3.3 |     |     | 19  |     |
| ------ | ------------ | ------- | --- | ------- | ----------- | --- | ------- | --- | --- | --- | --- |
| 1/1/44 |              | default |     |         | operational |     |         |     |     |     |     |
| BGP    | 20.6.1.0/24  |         |     | spoke_2 |             |     | 3.3.3.3 |     |     | 19  |     |
| 1/1/44 |              | default |     |         | operational |     |         |     |     |     |     |
| BGP    | 101.0.0.0/24 |         |     | spoke_2 |             |     | 3.3.3.3 |     |     | 19  |     |
| 1/1/44 |              | default |     |         | operational |     |         |     |     |     |     |
| BGP    | 151.0.0.0/24 |         |     | spoke_2 |             |     | 3.3.3.3 |     |     | 19  |     |
| 1/1/44 |              | default |     |         | operational |     |         |     |     |     |     |
Exit Bindings:
| Origin | Prefix |     |     | Incoming |     | Service | Egress |     |     | Status |     |
| ------ | ------ | --- | --- | -------- | --- | ------- | ------ | --- | --- | ------ | --- |
...
----------------------------------------------------------------------------------
-------------------------------
| LDP | 1.1.1.1/32 |             |     | 16  |     | 1/1/44 |     | default |     |     | 30.0.2.2 |
| --- | ---------- | ----------- | --- | --- | --- | ------ | --- | ------- | --- | --- | -------- |
|     | 16         | operational |     |     |     |        |     |         |     |     |          |
| LDP | 4.4.4.4/32 |             |     | 17  |     | 1/1/44 |     | default |     |     | 30.0.2.2 |
|     | exp-null   | operational |     |     |     |        |     |         |     |     |          |
| LDP | 3.3.3.3/32 |             |     | 18  |     | 1/1/44 |     | default |     |     | 30.0.2.2 |
|     | 18         | operational |     |     |     |        |     |         |     |     |          |
PE2#
...
| Last SubErr       |         | Rcvd   | : No Error    |         |     |                   |          |      |             |
| Graceful-Restart  |         |        | : Enabled     |         |     | Gr. Restart       |          | Time | : 120       |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 125
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 127
...
| ------------------------ | ---- | --- | --- | --- |
vrf hub_export
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 129
...
| ------- | --- | --- | --- | ------- | --- | --- | -------- | --- | ----- |
PE3 Verification
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 131
...
----------------------------------------------------------------------------------
---------------------------------------
| LDP 1.1.1.1/32   |     | default     |     | 30.0.3.1 | 16       | lag99 |
| ---------------- | --- | ----------- | --- | -------- | -------- | ----- |
| default          |     | operational |     |          |          |       |
| LDP 2.2.2.2/32   |     | default     |     | 30.0.3.1 | 17       | lag99 |
| default          |     | operational |     |          |          |       |
| LDP 4.4.4.4/32   |     | default     |     | 30.0.3.1 | exp-null | lag99 |
| default          |     | operational |     |          |          |       |
| BGP 101.0.0.0/24 |     | hub_import  |     | 1.1.1.1  | 19       | lag99 |
| default          |     | operational |     |          |          |       |
| BGP 201.0.0.0/24 |     | hub_import  |     | 2.2.2.2  | 19       | lag99 |
| default          |     | operational |     |          |          |       |
Exit Bindings:
| Origin Prefix |     | Incoming | Service | Egress | Status |     |
| ------------- | --- | -------- | ------- | ------ | ------ | --- |
...
----------------------------------------------------------------------------------
-------------------------------
| LDP 1.1.1.1/32 |     | 16  | lag99 | default | 30.0.3.1 |     |
| -------------- | --- | --- | ----- | ------- | -------- | --- |
16 operational
| LDP 2.2.2.2/32 |     | 17  | lag99 | default | 30.0.3.1 |     |
| -------------- | --- | --- | ----- | ------- | -------- | --- |
Usecases|132

|     | 17         |     | operational |     |     |       |     |         |     |     |          |
| --- | ---------- | --- | ----------- | --- | --- | ----- | --- | ------- | --- | --- | -------- |
| LDP | 4.4.4.4/32 |     |             | 18  |     | lag99 |     | default |     |     | 30.0.3.1 |
|     | exp-null   |     | operational |     |     |       |     |         |     |     |          |
PE3#
...
| Rt. | Reflect. |     | Client | : No |     |     | Send | Community |     | : both |     |
| --- | -------- | --- | ------ | ---- | --- | --- | ---- | --------- | --- | ------ | --- |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 133
...
| Address                      |             | family IPv6  | Unicast    |                |     | No          |                  |            | No         |            |
| Address                      |             | family VPNv4 | Unicast    |                |     | No          |                  |            | No         |            |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 135
...
| Total number     |                | of entries | 7        |     |     |        |        |     |             |     |
PE3#
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 137
...
| [20/0]       | 00h:28m:22s |          |     |          |     |     |     |     |
VRF: hub_import
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 139
...
decimal value from 0 to 255 and the number of bits in an
IPv4 address mask in CIDR format (x), where x is a decimal
number from 0 to 32.
...
pecifies the MPLS label to apply. Range: 16-1048575.
...
sswitch(config-mpls-static-lsp)# bind ipv4 2.2.2.0/24 output 1/1/1 20.0.0.2 20
...
8360 config-mpls-static- Administratorsorlocalusergroupmemberswithexecution
lsp
...
| ---------- | --- | --------------------------------------------- | --- | --- |
| <in-label> |     | SpecifiestheMPLSlabeltobind.Range:16-1048575. |     |     |
Usage
...
| 10.09                           |                         | Commandintroduced |             |           |
| Command                         | Information             |                   |             |           |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 143

| Platforms |     | Command | context |     | Authority |     |
| --------- | --- | ------- | ------- | --- | --------- | --- |
8360 config-aruba- Administratorsorlocalusergroupmemberswithexecution
|            |            | central    |          |           | rightsforthiscommand. |     |
| ---------- | ---------- | ---------- | -------- | --------- | --------------------- | --- |
...
| <LABEL>   |     |     |     |     | Specifiesthelabelforwhichstatisticswillbecleared. |     |
Examples
...
<out-label>
SpecifiestheMPLSlabeltoapply.Range:16-1048575.
explicit-null
SpecifiesanIETFMPLSIPv4explicitnulllabel(0).
Usage
...
o LAGmemberinterfacescannotbeusedwiththiscommand.
...
| The egress | interface | must have | an IP address | assigned. |
| ---------- | --------- | --------- | ------------- | --------- |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 145
...
| switch(config-mpls)# |      | static-lsp  |             |     |     |     |
switch(config-mpls-static-lsp)#
|     |     |     | crossconnect | input 35 output | 1/1/1 60.0.0.20 | 40  |
| --- | --- | --- | ------------ | --------------- | --------------- | --- |
The next hop IP address must be in the same subnet as interface 1/1/1.
...
| switch(config-mpls)# |      | static-lsp  |             |     |     |     |
switch(config-mpls-static-lsp)#
|     |     |     | crossconnect | input 35 output | 1/1/1 10.0.0.1 | 40  |
| --- | --- | --- | ------------ | --------------- | -------------- | --- |
The next hop IP address cannot be the same as any interface 1/1/1 primary or
| secondary | addresses. |     |     |     |     |     |
| --------- | ---------- | --- | --- | --- | --- | --- |
...
| Command Information  |         |           |                   |
| Platforms            | Command | context   | Authority         |
8360 config-mpls Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
| enable (mpls | ldp) |     |     |
| ------------ | ---- | --- | --- |
enable
...
Usage
n TheLDPbackofftimercannotbeconfigured.Itissettoexponentiallybackoffsessionretryattempts
...
DisablingMPLSLDP:
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 147
...
| 10.09               |           |                | Commandintroduced |     |
| Command Information |           |                |                   |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 149
...
| Parameter          |     |           |     |     | Description |
| ------------------ | --- | --------- | --- | --- | ----------- |
| forwarding-holding |     | <SECONDS> |     |     |             |
SpecifiestheamountoftimeinsecondsthattheMPLS
forwardingstateshouldbepreservedafterthecontrol
planerestarts.Range:30-600.Default:150.
max-recovery <SECONDS> Specifiestheamountoftimeinsecondsthatthestalelabel
bindingsshouldbekeptontherouteraftertheLDPsession
hasbeenreestablished.Range:15-600.Default:120.
| neighbor-liveness |     | <SECONDS> |     |     |     |
| ----------------- | --- | --------- | --- | --- | --- |
Specifiestheamountoftimeinsecondsthattherouterwill
waitfortheLDPsessiontobereestablished.Iftherouter
cannotreestablishtheLDPsessionwithinthattime,the
routerdeletesallthestaleLDPbindingsreceivedfromthat
LDPneighbor.Range:5-300.Default:120.
Examples
...
|                 |             | graceful-restart-timers |         | max-recovery | 30  |
| --------------- | ----------- | ----------------------- | ------- | ------------ | --- |
| Changing the    | timer value | will restart            | any LDP | sessions.    |     |
| This may result | in traffic  | loss.                   |         |              |     |
| Continue (y/n)? | y           |                         |         |              |     |
...
switch(config-mpls-ldp)#
|                 |             | no graceful-restart-timers |         | max-recovery | 30  |
| --------------- | ----------- | -------------------------- | ------- | ------------ | --- |
| Changing the    | timer value | will restart               | any LDP | sessions.    |     |
| This may result | in traffic  | loss.                      |         |              |     |
| Continue (y/n)? | y           |                            |         |              |     |
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 151
...
| Parameter |     |     |     |     | Description |     |
| --------- | --- | --- | --- | --- | ----------- | --- |
<start-label-range> SelectsthestartofthestaticLSPlabelrange.Range:16-1048575.
<end-label-range> SelectstheendofthestaticLSPlabelrange.Range:16-1048575.
Usage
...
| Command Information |         |         |     |                   |     |
| Platforms           | Command | context |     | Authority         |     |
8360 config-mpls-static- Administratorsorlocalusergroupmemberswithexecutionrights
|                   | lsp |     |     | forthiscommand. |     |
| ----------------- | --- | --- | --- | --------------- | --- |
| label-protocol    |     | ldp |     |                 |     |
| label-protocol    | ldp |     |     |                 |     |
...
| Release              |                   |     |                | Modification      |     |
| 10.09                |                   |     |                | Commandintroduced |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 153

| Command Information |         |         |           |
| ------------------- | ------- | ------- | --------- |
| Platforms           | Command | context | Authority |
8360 config-mpls Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
mpls
mpls
no mpls
...
| ------------- | ------- | --- | --- | ----- | --------- | --- |
| entropy label |         |     |     |       |           |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 155
...
| Parameter |     |     | Description |     |
| --------- | --- | --- | ----------- | --- |
<SECONDS> Specifiesthediscoveryholdtimeinseconds.Range:15-65535.
Default:15.
Usage
MPLScommands |156
...
Thediscoveryhellointervaltimeisauto-computedasonethirdofthehelloholdtime.
n
Examples
...
| Command                  | Information |      |                |     |                   |          |     |
| Platforms                | Command     |      | context        |     | Authority         |          |     |
8360 config-mpls-ldp Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
...
| Parameter |     |     |     |     | Description |     |     |
| --------- | --- | --- | --- | --- | ----------- | --- | --- |
<SECONDS> Specifiesthediscoverhelloholdtimeonaninterface.Range:15-
65535.Default:15.
Usage
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 157
...
| Parameter |     |     |     |     | Description                                          |     |     |
| --------- | --- | --- | --- | --- | ---------------------------------------------------- | --- | --- |
| <TIME>    |     |     |     |     | Specifiesthesessionholdtimefortheinterfaceinseconds. |     |     |
Range:15-65535.Default:40.
Usage
MPLScommands |158

n TheinterfaceLDPsessionholdtimeoverridesglobalhelloholdtime.
n RoutingmustbeconfiguredbeforechangingLDPsessionholdtimeonaninterface.
Examples
...
responsesfromtheremotetarget.Itisusedadebuggingandanalyticstooltoverifyconnectivitywithin
MPLSnetworks.
| Parameter |     |     |     | Description |     |     |
| --------- | --- | --- | --- | ----------- | --- | --- |
ipv4 <IP-ADDR/MASK> SpecifiestargetIPaddressandmaskoftheremotesubnettoping.
source <IP-ADDR> SpecifiesthesourceIPv4addressfortherequestpacket.
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 159
...
127.0.0.1.
ttl <HOPS>
Specifiesthemaxnumberofhopsapacketcantakeenrouteto
itsdestination.Range:1-255.Default:64.
size <BYTES> Specifiesthesizeofthepackettobesentinbytes.Range:0-9600.
Default:0.
...
| --------- | --- | --- | --- | ----------- | --- | --- |
<IFNAME>
SpecifiestheloopbackinterfacefortheMPLSLDProuterID.
Usage
n ThereisapossibilityofMPLStrafficdisruptionwheneverarouterIDisdeletedorupdatedtoanother
loopbackinterface.
n TheMPLSrouterIDinterfacemustbealoopbackinterfacewithanIPv4addressconfigured.
...
| Continue                 | (y/n)?     |                |           |           |         |               |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 161
...
| -------------------- | --- | -------------- | --- | --- | --- | --- |
switch(config-mpls-ldp)#
|     |     |     | no router-id |     | loopback2 | confirm |
| --- | --- | --- | ------------ | --- | --------- | ------- |
...
|                  | config-mpls-ldp    |       | forthiscommand. |     |
| ---------------- | ------------------ | ----- | --------------- | --- |
...
| Parameter |     |     | Description |     |
| --------- | --- | --- | ----------- | --- |
<SECONDS> Specifiesthesessionholdtimeinseconds.Range:15-65535.
Default:40.
Usage
n Thedefaultsessionholdtimeis40seconds
n Thesessionholdtimeconfiguredonaninterfacesupersedestheglobalconfiguration.
Thesessionkeepaliveintervaltimeisautocomputedasonesixthoftheholdtime.
n
Examples
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 163
...
| Parameter |     |     |     |     | Description |
| --------- | --- | --- | --- | --- | ----------- |
<IP-ADDR>/<MASK> SpecifiestheIPnetworkandmaskofaspecificBGProuteinIPv4
format(x.x.x.x/M),wherexisadecimalnumberfrom0to255and
MisthenumberofbitsinCIDRformatfrom0to32.
community
SelectsroutesthatbelongtospecifiedBGPcommunities.
| extcommunity |             |     |     |     | Selectsunicastrouteswithextendedcommunities. |
| ------------ | ----------- | --- | --- | --- | -------------------------------------------- |
| neighbors    | [<IP-ADDR>] |     |     |     |                                              |
SelectsBGPneighborconnectionparametersforallneighborsor
theIPaddressofaspecificneighborinIPv4format(x.x.x.x)where
xisadecimalnumberfrom0to255.
| paths    |     |     |     |     | SelectsASPathinformationofthevpnv4routesinBGPRIB. |
| -------- | --- | --- | --- | --- | ------------------------------------------------- |
| summary  |     |     |     |     | SelectsasummaryofBGPneighborstatus.               |
...
switch#
|     | show | bgp | vpnv4 | unicast extcommunity |     |     |     |     |     |
| --- | ---- | --- | ----- | -------------------- | --- | --- | --- | --- | --- |
Status codes: s suppressed, d damped, h history, * valid, > best, = multipath,
|        |        | i internal, |      | e external | S            | Stale, | R Removed, | a additional-paths |     |
| ------ | ------ | ----------- | ---- | ---------- | ------------ | ------ | ---------- | ------------------ | --- |
| Origin | codes: | i -         | IGP, | e - EGP, ? | - incomplete |        |            |                    |     |
VRF : default
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 165
...
| Updates             |             |      | 7               |       | 7                |            |      |             |
| Keepalives          |             |      | 67              | 67    |                  |            |      |             |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 167
...
----------------------------------------------------------------------------------
-------
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 169
...
Description
ShowstheMPLSforwardingtable.
Usage
n Forwardingtablefilterswillbeimplementedatalaterdate.
Whenrunningthiscommandonahuge-scalesetup,showingthefulltablesmighttakeawhile.
n
Examples
ShowingtheMPLSforwardingtable:
...
| 22           |            |     |      | 22  |             | 33    |     |         |     |     |     |
| Command      | History    |     |      |     |             |       |     |         |     |     |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 171
...
| Command   | Information |         |         |                   |
| Platforms |             | Command | context | Authority         |
8360 Operator(>)orManager Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
(#)
...
| Parameter |     |     | Description |     |
| --------- | --- | --- | ----------- | --- |
<IP-ADDR> SpecifiesthepeerMPLSLDProuterIDinx.x.x.xformat,wherexis
adecimalvaluefrom0to255.
Examples
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 173
...
| show | mpls | ldp neighbor |          |     |     |     |
Description
ShowsinformationaboutLDPneighborsinthecurrentsession(s).Thereconnectandrecoverytimeare
thetimesadvertisedbythepeerdevice.
Examples
ShowingLDPneighbors:
...
ShowingLDPneighborswhengracefulrestarthasbeenconfigured:
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 175
...
| --------- | ----------- | ------- | --- | --- | --- | ------------------------------ |
| Platforms | Command     | context |     |     |     | Authority                      |
| 8360      | config-mpls |         |     |     |     | Administratorsorlocalusergroup |
memberswithexecutionrightsfor
thiscommand.
| traceroute | mpls |     |     |     |     |     |
| ---------- | ---- | --- | --- | --- | --- | --- |
traceroute mpls ipv4 <IP-ADDR/MASK> [source <IP-ADDR> | destination <IP-ADDR> | ttl
| <HOPS> | timeout | <TIME> | | fed-type | ldp] |     |     |     |
| ---------------- | ------ | ---------- | ---- | --- | --- | --- |
Description
...
| ! 2 10.0.1.2 | 1 ms     |               |                |     |       |     |
| Command      | History  |               |                |     |       |     |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 177
...
| ---------- | --- | --- | -------- | --- | ------ | --- | --- | --- | --- | --- |
Debuggingandtroubleshooting|180
...
| PE1# | show mpls | forwarding |     |     |     |     |     |     |     |
| ---- | --------- | ---------- | --- | --- | --- | --- | --- | --- | --- |
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 181
...
Debuggingandtroubleshooting|182
...
PingfromCEtoremoteCEWANandLANtoverifyMPLSL3VPNconnectivity:
CE1#
|     | ping          | 20.2.0.2 |            |            |     |        |            |     |     |     |
| --- | ------------- | -------- | ---------- | ---------- | --- | ------ | ---------- | --- | --- | --- |
...
TraceroutefromCEtoremoteCEtoverifythehopinformationoverMPLSL3VPN:
...
PingfromPEtoremotePEtoverifyMPLSL3VPNconnectivity:
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 183

|     | --- 20.2.0.1         |              | ping | statistics                |           | --- |           |       |      |        |     |
| --- | -------------------- | ------------ | ---- | ------------------------- | --------- | --- | --------- | ----- | ---- | ------ | --- |
|     | 5 packets            | transmitted, |      | 5                         | received, |     | 0% packet | loss, | time | 4091ms |     |
|     | rtt min/avg/max/mdev |              |      | = 0.279/0.299/0.334/0.021 |           |     |           | ms    |      |        |     |
TraceroutefromPEtoremotePEtoverifyhopinformationoverMPLSL3VPN:
...
OningressPE,verifythatroutesfromboththeconnectedCEandremotePEarelearned.Iftheexpected
routeisnotlearned,checkiftheCEandremotePEarelearningandadvertisingroutes.Intheexample
below,20.2.0.0/24istheroutefromtheremotePEand101.0.0.0/24istheroutefromthedirectly
connectedCE:
...
|     | Displaying    | ipv4  | routes      | selected  |     | for | forwarding |     |     |     |     |
Debuggingandtroubleshooting|184
...
VerifyCELANroutesappearintheoutput:
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 185
...
| [0/0]        | -           |          |     |        |     |     |         |     |     |
|              |             |          |     | 1/1/25 |     |     | default |     | B/V |
| 101.0.0.0/24 |             | 1.1.1.1  |     |        |     |     |         |     |     |
| [200/0]      | 00h:11m:46s |          |     |        |     |     |         |     |     |
| 201.0.0.0/24 |             | 20.2.0.2 |     | 1/1/26 |     |     | -       |     | B/E |
| [20/0]       | 00h:11m:44s |          |     |        |     |     |         |     |     |
| Total Route  | Count       | : 5      |     |        |     |     |         |     |     |
Debuggingandtroubleshooting|186
...
AOS-CX10.10MPLSGuide|(8360SwitchSeries) 187

No, only L3 routing between CEs is supported across MPLS L3 VPN network. VXLAN can be used on CEs
to provide L2 subnet stretching over the MPLS L3 VPN network.
...
explicit-null configuration for LDP label distribution. This enables BGP session establishment through
the MPLS core.
...
Debugging and troubleshooting | 188

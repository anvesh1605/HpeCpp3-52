...
AOS-CX 10.13 Introduction to the Web UI Guide | (8xxx, 9300, 10000 Switch Series)
...
|                                     | EditinganSNMPv3user                            |               | 35  |
|                                     | AddinganddeletinganSNMPcommunity               |               | 36  |
|                                     | AddinganddeletinganSNMPtrapreceiver            |               | 36  |
|                                     | EditinganSNMPtrapreceiver                      |               | 37  |
| Sessionpage                         |                                                |               | 37  |
| ConfigMgmtpage                      |                                                |               | 39  |
4
AOS-CX10.13IntroductiontotheWebUIGuide| (8xxx,9300,10000SwitchSeries)

| FirmwareUpdatepage                    |                                               |         |           |          | 40  |
| ------------------------------------- | --------------------------------------------- | ------- | --------- | -------- | --- |
|                                       | Firmwaresitedistribution                      |         |           |          | 41  |
|                                       | Downloadingfirmwarefromaremoteswitch          |         |           |          | 42  |
|                                       | DownloadingfirmwarefromaremoteHTTPserver      |         |           |          | 43  |
| FirmwareMgmtpage                      |                                               |         |           |          | 44  |
|                                       | EnablingfirmwaresitedistributionusingtheCLI   |         |           |          | 44  |
|                                       | EnablingfirmwaresitedistributionusingtheWebUI |         |           |          | 44  |
| Pingpage                              |                                               |         |           |          | 45  |
| Traceroutepage                        |                                               |         |           |          | 46  |
| ShowTechpage                          |                                               |         |           |          | 47  |
| SpanningTreepage                      |                                               |         |           |          | 47  |
...
| PKIpage                               |                                               |         |           |          | 50  |
|                                       | AddinganddeletinganESTProfile                 |         |           |          | 51  |
|                                       | ViewinganESTProfile                           |         |           |          | 51  |
|                                       | AddinganddeletingaTAProfile                   |         |           |          | 52  |
|                                       | EditingaTAProfile                             |         |           |          | 53  |
|                                       | Addinganddeletingacertificate                 |         |           |          | 53  |
|                                       | Uploadingacertificate                         |         |           |          | 54  |
|                                       | Viewinganddownloadingacertificate             |         |           |          | 55  |
|                                       | Editingassociatedapplicationdetails           |         |           |          | 55  |
| SupportFilepage                       |                                               |         |           |          | 56  |
|                                       | Creatinganddeletingsupportfiles               |         |           |          | 57  |
|                                       | Downloadingasupportfile                       |         |           |          | 58  |
| Finding                               | alert details                                 | using   | the Web   | UI       | 59  |
| Working                               | with the                                      | network | analytics | features | 61  |
| ViewingagentinformationusingtheWebUI  |                                               |         |           |          | 61  |
| WorkingwithanAnalyticstimeseriesgraph |                                               |         |           |          | 65  |
|                                       | Customizingdatadisplayedonthegraph            |         |           |          | 66  |
|                                       | Zoominginonthegraph                           |         |           |          | 67  |
|                                       | Downloadingthegraphasanimageor.csvfile        |         |           |          | 68  |
|                                       | Viewinganalertonthegraph                      |         |           |          | 68  |
ArubaNetworkAnalyticsEnginescripts,agents,andtroubleshootinginformation 71
| Support                            | and Other          | Resources |     |     | 73  |
| ---------------------------------- | ------------------ | --------- | --- | --- | --- |
| AccessingHPEArubaNetworkingSupport |                    |           |     |     | 73  |
| AccessingUpdates                   |                    |           |     |     | 74  |
|                                    | ArubaSupportPortal |           |     |     | 74  |
|                                    | MyNetworking       |           |     |     | 74  |
| WarrantyInformation                |                    |           |     |     | 74  |
...
AOS-CX10.13IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 36
...
imagebank.
AOS-CX10.13IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 42
...
AOS-CX10.13IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 44
...
following:
AOS-CX10.13IntroductiontotheWebUIGuide|(8xxx,9300,10000SwitchSeries) 71

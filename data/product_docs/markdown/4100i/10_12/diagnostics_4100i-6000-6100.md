...
| Logmessages                                       |                                                    | 31  |
3
AOS-CX10.12DiagnosticsandSupportabilityGuide| (4100i,6000,6100SwitchSeries)
...
|                              | diagcable-diagnostic            | 34  |
| Supportability               | Copy                            | 37  |
| TFTPVxLANSupport             |                                 | 37  |
| Supportabilitycopycommands   |                                 | 37  |
|                              | copycheckpoint                  | 37  |
|                              | copycommand-output              | 38  |
|                              | copydiag-dumpfeature<FEATURE>   | 39  |
|                              | copydiag-dumplocal-file         | 41  |
|                              | copy<IMAGE>                     | 42  |
|                              | copyrunning-config              | 43  |
|                              | copyshow-techfeature            | 44  |
|                              | copyshow-techlocal-file         | 45  |
|                              | copystartup-config              | 46  |
|                              | copysupport-files               | 47  |
|                              | copysupport-fileslocal-file     | 49  |
|                              | copysupport-log                 | 50  |
| Traceroute                   |                                 | 52  |
...
|                              | ping6                           | 62  |
| Troubleshooting              |                                 | 65  |
|                              | Operationnotpermitted           | 65  |
|                              | Networkisunreachable            | 65  |
|                              | Destinationhostunreachable      | 66  |
| Remote                       | syslog                          | 67  |
| SyslogoverVXLAN support      |                                 | 67  |
| Remotesyslogcommands         |                                 | 67  |
|                              | clearaccounting-logs            | 67  |
|                              | logging                         | 68  |
|                              | loggingaccounting-format-native | 70  |
|                              | loggingfilter                   | 71  |
|                              | loggingfacility                 | 74  |
|                              | loggingpersistent-storage       | 75  |
| Runtime                      | Diagnostics                     | 77  |
| Runtimediagnosticcommands    |                                 | 77  |
|                              | diagnosticmonitor               | 77  |
|                              | diagon-demand                   | 78  |
|                              | showdiagnostic                  | 79  |
|                              | showdiagnosticevents            | 81  |
| Service                      | OS                              | 83  |
| ServiceOSCLIlogin            |                                 | 83  |
Contents|4

| ServiceOSuseraccounts               |                                          | 84  |
| ----------------------------------- | ---------------------------------------- | --- |
| ServiceOSbootmenu                   |                                          | 84  |
| Consoleconfiguration                |                                          | 85  |
| AOS-CXboot                          |                                          | 85  |
| Filesystemaccess                    |                                          | 86  |
| ServiceOSmountfailure               |                                          | 87  |
| ServiceOSCLIcommandlist             |                                          | 87  |
| ServiceOSCLIfeaturesandlimitations  |                                          | 88  |
| ServiceOSCLIcommands                |                                          | 88  |
|                                     | boot                                     | 89  |
|                                     | cat                                      | 89  |
|                                     | cdpath                                   | 90  |
|                                     | config-clear                             | 90  |
...
|                                     | update                                   | 107 |
|                                     | version                                  | 108 |
| In-System                           | Programming                              | 110 |
| ShowtechcommandlistfortheISPfeature |                                          | 110 |
| In-SystemProgrammingcommands        |                                          | 110 |
|                                     | clearupdate-log                          | 110 |
|                                     | showneeded-updates                       | 110 |
| Selftest                            |                                          | 112 |
| Selftestcommands                    |                                          | 112 |
|                                     | fastboot                                 | 112 |
|                                     | showselftest                             | 113 |
| Zeroization                         |                                          | 116 |
| Zeroizationcommands                 |                                          | 116 |
|                                     | eraseallzeroize                          | 116 |
| Terminal                            | Monitor                                  | 119 |
| Terminalmonitorcommands             |                                          | 119 |
|                                     | loggingconsole{notify|severity|filter}   | 119 |
|                                     | showterminal-monitor                     | 120 |
|                                     | terminal-monitor{notify|severity|filter} | 121 |
5
AOS-CX10.12DiagnosticsandSupportabilityGuide| (4100i,6000,6100SwitchSeries)

| Troubleshooting                               |                    | Web       | UI and REST | API Access | Issues | 123 |
| --------------------------------------------- | ------------------ | --------- | ----------- | ---------- | ------ | --- |
| HTTP404errorwhenaccessingtheswitchURL         |                    |           |             |            |        | 123 |
| HTTP401error"Loginfailed:sessionlimitreached" |                    |           |             |            |        | 123 |
| Support                                       | and Other          | Resources |             |            |        | 125 |
| AccessingArubaSupport                         |                    |           |             |            |        | 125 |
| AccessingUpdates                              |                    |           |             |            |        | 126 |
|                                               | ArubaSupportPortal |           |             |            |        | 126 |
|                                               | MyNetworking       |           |             |            |        | 126 |
| WarrantyInformation                           |                    |           |             |            |        | 126 |
| RegulatoryInformation                         |                    |           |             |            |        | 126 |
| DocumentationFeedback                         |                    |           |             |            |        | 127 |
Contents|6
...
AOS-CX 10.12 Diagnostics and Supportability Guide | (4100i, 6000, 6100 Switch Series)
...
The name of a feature, for example aaa.
Required.
...
Specifiesthenameofthesourcefileordirectory.
...
Troubleshooting Web UI and REST API Access Issues | 124

...
3
| AOS-CX10.12IPServicesGuide| | (4100i,6000,6100 | SwitchSeries) |     |
| --------------------------- | ---------------- | ------------- | --- |
...
AOS-CX 10.12 IP Services Guide | (4100i, 6000, 6100 Switch Series)
...
|                                 | ipv6address                       |         |          |        | 202 |
|                                 | ipmtu                             |         |          |        | 203 |
|                                 | showinterfacetunnel               |         |          |        | 204 |
|                                 | showrunning-configinterfacetunnel |         |          |        | 205 |
|                                 | shutdown                          |         |          |        | 206 |
|                                 | sourceip                          |         |          |        | 207 |
|                                 | sourceipv6                        |         |          |        | 208 |
|                                 | ttl                               |         |          |        | 208 |
|                                 | vrfattach                         |         |          |        | 209 |
| IPsectunnelscommands            |                                   |         |          |        | 210 |
|                                 | description                       |         |          |        | 210 |
|                                 | destinationip                     |         |          |        | 211 |
|                                 | ipmtu                             |         |          |        | 212 |
|                                 | showcapacities-status             |         |          |        | 213 |
|                                 | showcapacities-statustunneling    |         |          |        | 213 |
|                                 | showinterfacetunnel               |         |          |        | 214 |
|                                 | showinterfacetunnelbrief          |         |          |        | 215 |
|                                 | showrunning-configinterfacetunnel |         |          |        | 216 |
|                                 | showrunning-configcurrent-context |         |          |        | 217 |
|                                 | sourceip                          |         |          |        | 218 |
|                                 | vrfattach                         |         |          |        | 218 |
| IP Source                       | Lockdown                          |         |          |        | 220 |
| IPsourcelockdowncommands        |                                   |         |          |        | 220 |
|                                 | IPsourcelockdownresourceextended  |         |          |        | 220 |
| IPv4sourcelockdowncommands      |                                   |         |          |        | 221 |
|                                 | ipv4source-binding                |         |          |        | 221 |
|                                 | ipv4source-lockdown               |         |          |        | 222 |
|                                 | ipv4source-lockdownhardwareretry  |         |          |        | 223 |
|                                 | showipv4source-binding            |         |          |        | 224 |
|                                 | showipv4source-lockdown           |         |          |        | 224 |
| IPv6sourcelockdowncommands      |                                   |         |          |        | 227 |
|                                 | ipv6source-binding                |         |          |        | 227 |
|                                 | ipv6source-lockdown               |         |          |        | 228 |
|                                 | ipv6source-lockdownhardwareretry  |         |          |        | 229 |
|                                 | showipv6source-binding            |         |          |        | 230 |
|                                 | showipv6source-lockdown           |         |          |        | 230 |
| Internet                        | Control                           | Message | Protocol | (ICMP) | 234 |
| ICMPmessagetypes                |                                   |         |          |        | 234 |
| WhenICMPmessagesaresent         |                                   |         |          |        | 234 |
| ICMPredirectmessages            |                                   |         |          |        | 235 |
| WhenICMPredirectmessagesaresent |                                   |         |          |        | 235 |
| ICMPcommands                    |                                   |         |          |        | 235 |
|                                 | ipicmpredirect                    |         |          |        | 235 |
|                                 | ipicmpthrottle                    |         |          |        | 236 |
|                                 | ipicmpunreachable                 |         |          |        | 237 |
DNS 238
| DNSclient               |     |     |     |     | 238 |
| ----------------------- | --- | --- | --- | --- | --- |
| ConfiguringtheDNSclient |     |     |     |     | 238 |
7
| AOS-CX10.12IPServicesGuide| | (4100i,6000,6100 | SwitchSeries) |     |     |     |
| --------------------------- | ---------------- | ------------- | --- | --- | --- |

| DNSclientcommands     |                             |           | 239 |
| --------------------- | --------------------------- | --------- | --- |
|                       | ipdnsdomain-list            |           | 239 |
|                       | ipdnsdomain-name            |           | 240 |
|                       | ipdnshost                   |           | 240 |
...
|                       | arpcache-limit              |           | 245 |
|                       | arpinspection               |           | 245 |
|                       | arpinspectiontrust          |           | 246 |
|                       | arpipv4mac                  |           | 247 |
|                       | arpprocess-grat-arp         |           | 248 |
|                       | cleararp                    |           | 249 |
|                       | debugarp-security           |           | 250 |
|                       | iplocal-proxy-arp           |           | 251 |
|                       | ipproxy-arp                 |           | 252 |
|                       | ipv6neighbormac             |           | 253 |
|                       | showarp                     |           | 254 |
|                       | showarpinspectioninterface  |           | 254 |
|                       | showarpinspectionstatistics |           | 256 |
|                       | showarpinspectionvlan       |           | 256 |
|                       | showarpstate                |           | 257 |
|                       | showarpsummary              |           | 258 |
|                       | showarptimeout              |           | 260 |
|                       | showarpvrf                  |           | 260 |
|                       | showipv6neighbors           |           | 262 |
|                       | showipv6neighborsstate      |           | 262 |
|                       | showtecharp-security        |           | 264 |
| NLBcommands           |                             |           | 265 |
|                       | arpipv4mac                  |           | 265 |
|                       | showarp                     |           | 266 |
...
| Command Information         |             |         |               |
| Platforms                   | Command     | context | Authority     |
config-dhcp-server Administratorsorlocalusergroupmemberswithexecution
...
|     | Command Information |         |              |           |
|     | Platforms           | Command | context      | Authority |
config-dhcp-server-pool Administratorsorlocalusergroupmemberswith
...
Administratorsorlocalusergroupmemberswith
executionrightsforthiscommand.
option
...
|     | Platforms | Command | context |     | Authority |     |     |
| --- | --------- | ------- | ------- | --- | --------- | --- | --- |
config-dhcpv6-server Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
dns-server
...
|     | Command Information                |         |         |     |              |          |
|     | Platforms                          | Command | context |     | Authority    |          |
config-dhcpv6-server-pool Administratorsorlocalusergroupmemberswith
executionrightsforthiscommand.
option
...
82),thisdefaultconfigurationisused:
option
...
switch(config)#
no dhcpv6-snooping authorized-server ABCD:5ACD::2000 vrf default
| Command History     |         |         |     |                                                 |
| ------------------- | ------- | ------- | --- | ----------------------------------------------- |
| Release             |         |         |     | Modification                                    |
| 10.09               |         |         |     | Commandintroducedforthe6000and6100SwitchSeries. |
...
seconds:
switch(config)#
|     | dhcpv6-snooping |     | flash-storage | delay 1200 |
| --- | --------------- | --- | ------------- | ---------- |
Warning: Using flash storage reduces switch lifetime. It is recommended to use an
external-storage.
| Do you want | to continue | (y/n)? | y   |     |
...
| Command   | Information |     |         |     |                    |           |     |     |
| Platforms | Command     |     | context |     |                    | Authority |     |     |
config-dhcpv6-guard-policy Administratorsorlocalusergroupmemberswith
executionrightsforthiscommand.
preference
...
| Command                  | Information |           |          |                 |                    |                                           |      |
| Platforms                |             | Command   |          | context         |                    | Authority                                 |      |
|                          |             | config    |          |                 |                    | Administratorsorlocalusergroupmemberswith |      |
...
| Platforms      | Command     | context | Authority    |     |
config-vlan-<VLAN-ID>
OperatorsorAdministratorsorlocalusergroupmembers
...
SpecifiesthenumberforanexistingIPtunnel.Range:1to
127.
DHCPOptions|200
...
| Command Information    |           |               |               |
| Platforms              | Command   | context       | Authority     |
config-gre-if Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
ipv6 address
...
| --------------- | ------- | ---------- | -------- | --- |
| Command         | History |            |          |     |
InternetControlMessageProtocol(ICMP)|235
...
Allplatforms config Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
InternetControlMessageProtocol(ICMP)|237
...
| --- | --- | --- | --- | --- | ------------------------------------------------------ | --- |
above.
notice:SetsARPsecuritydebuglogfilteringtoNoticeand
n
above.

...
|                                                           | showaccess-list                        |       | 60  |
|                                                           | showaccess-listcontrol-plane           |       | 64  |
|                                                           | showaccess-listhitcounts               |       | 66  |
|                                                           | showaccess-listhitcountscontrol-plane  |       | 69  |
|                                                           | showaccess-listsecure-update           |       | 70  |
|                                                           | showcapacities                         |       | 71  |
|                                                           | showcapacities-status                  |       | 73  |
| Classifier                                                | policies                               |       | 77  |
| Trafficpolicing                                           |                                        |       | 77  |
| Typesofpolicyactions                                      |                                        |       | 78  |
| Howpolicymatchingworks                                    |                                        |       | 79  |
| Activeclassconfigurationversususer-specifiedconfiguration |                                        |       | 79  |
Activepolicyconfigurationversususer-specifiedconfiguration 80
|                          | Considerationsforwhenapolicyisappliedperinterface |     | 80  |
| ------------------------ | ------------------------------------------------- | --- | --- |
| Classifierpolicycommands |                                                   |     | 83  |
|                          | Classifierpolicyapplication                       |     | 83  |
|                          | applypolicy(config-if,config-lag-if,config-vlan)  |     | 83  |
|                          | applypolicy(config)                               |     | 86  |
|                          | classcopy                                         |     | 87  |
|                          | classip                                           |     | 88  |
|                          | classipv6                                         |     | 95  |
|                          | classmac                                          |     | 102 |
...
|                                         | showclass                             |               |          |                | 114 |
|                                         | showpolicy                            |               |          |                | 115 |
| Classifier                              | policies                              | configuration | example  |                | 120 |
| Configuringtheclassifierpoliciesexample |                                       |               |          |                | 120 |
| ACL and                                 | Policy                                | hardware      | resource | considerations | 123 |
| ShowResources                           |                                       |               |          |                | 123 |
|                                         | EventLogs                             |               |          |                | 123 |
|                                         | Limitationsandexclusions              |               |          |                | 123 |
| TCAMresourceconsumptionandlookups       |                                       |               |          |                | 124 |
|                                         | Forthe6000,6100,and4100iswitchseries: |               |          |                | 124 |
| Matchingprecedenceorder                 |                                       |               |          |                | 127 |
| L4portranges                            |                                       |               |          |                | 127 |
| Contextgroupselectors                   |                                       |               |          |                | 128 |
| ACLandPolicyhardwareresourcecommands    |                                       |               |          |                | 129 |
|                                         | showresources                         |               |          |                | 129 |
| Support                                 | and Other                             | Resources     |          |                | 132 |
| AccessingHPEArubaNetworkingSupport      |                                       |               |          |                | 132 |
...
<SRC-IP-ADDRESS>-specifiesthesourceIPv6hostaddress.
n
...
| LENGTH>]} |     |     | n any-specifiesanydestinationIPv6address.          |
| --------- | --- | --- | -------------------------------------------------- |
|           |     |     | n <DST-IP-ADDRESS>-specifiesthedestinationIPv6host |
address.
o <PREFIX-LENGTH>-specifiestheaddressbitstomask(CIDR
subnetmasknotation).Range:1to128.
[{eq|gt|lt} <PORT>|range <MIN- Specifiestheport,orportrange.Portnumbersareintherangeof
| PORT><MAX-PORT>] |     | 0to65535. |                                    |
| ---------------- | --- | --------- | ---------------------------------- |
...
| Command |     | History |     |     |     |     |     |     |     |
| ------- | --- | ------- | --- | --- | --- | --- | --- | --- | --- |
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 75
...
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 89
...
{any|<SRC-IP-ADDRESS>[/{<PREFIX-LENGTH>|<SUBNET-MASK>}]}
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 95
...
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 105
...
| switch(config)# | policy | MY_POLICY | reset |     |
| --------------- | ------ | --------- | ----- | --- |
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 113
...
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 117
...
| --------------- | ------ | --------------- | --- | --- | --- |
Classifierpoliciesconfigurationexample|121
...
singlefeature'suse.
Figure1 TCAMIngress
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 125
...
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 127
...
n TCAMlookups
n Policers
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 129
...
| ---- | --- | --- | ------------------------------------- |
AOS-CX10.15.xxxxACLsandClassifierPoliciesGuide|(4100i,6000,6100SwitchSeries) 131

...
|                                            | bfd                                         | 25  |
|                                            | bfd<IPV4-ADDR>                              | 25  |
|                                            | bfdall-interfaces(OSPF)                     | 26  |
|                                            | bfddetect-multiplier                        | 27  |
|                                            | bfddisable                                  | 28  |
|                                            | bfdenable(Context:config-hsc)               | 29  |
|                                            | bfddisable(Context:config-hsc)              | 30  |
|                                            | bfdechodisable                              | 30  |
|                                            | bfdecho-src-ip-address                      | 31  |
|                                            | bfdmin-echo-receive-interval                | 32  |
|                                            | bfdmin-receive-interval                     | 33  |
|                                            | bfdmin-transmit-interval                    | 34  |
|                                            | clearbfdstatistics                          | 35  |
|                                            | ipospfbfd                                   | 36  |
|                                            | ipospfbfddisable                            | 37  |
|                                            | iproutebfd                                  | 38  |
|                                            | ipv6ospfv3bfd                               | 39  |
|                                            | ipv6ospfv3bfddisable                        | 39  |
|                                            | neighborfall-overbfd(context:config-router) | 40  |
|                                            | showbfd                                     | 41  |
|                                            | showbfdinterface                            | 43  |
3
AOS-CX10.09HighAvailabilityGuide| (6200,6300,6400,8xxxSwitchSeries)

|                                    | showhsc                                     |     | 45  |
| ---------------------------------- | ------------------------------------------- | --- | --- |
| ERPS                               |                                             |     | 47  |
| Limitations,Conflicts,orExclusions |                                             |     | 47  |
| ERPSCommands                       |                                             |     | 49  |
|                                    | clearerpsring<RINGID>instance<ID>           |     | 49  |
|                                    | clearerpsstatistics                         |     | 50  |
|                                    | erpsring                                    |     | 50  |
|                                    | erpsring<RINGID><port0|port1>interface      |     | 51  |
|                                    | erpsring<RINGID>description                 |     | 52  |
|                                    | erpsring<RINGID>guard-interval              |     | 53  |
|                                    | erpsring<RINGID>hold-off-interval           |     | 54  |
|                                    | erpsring<RINGID>instance                    |     | 55  |
|                                    | erpsring<RINGID>instance<ID>control-vlan    |     | 56  |
|                                    | erpsring<RINGID>instance<ID>description     |     | 57  |
|                                    | erpsring<RINGID>instance<ID>enable          |     | 58  |
|                                    | erpsring<RINGID>instance<ID>protected-vlans |     | 59  |
erpsring<RINGID>instance<ID>protection-switch{{manual|force}
|                       | <PORT0>|<PORT1>}                      |           | 60  |
| --------------------- | ------------------------------------- | --------- | --- |
|                       | erpsring<RINGID>instance<ID>revertive |           | 62  |
|                       | erpsring<RINGID>instance<ID>role      |           | 63  |
|                       | erpsring<RINGID>instance<ID>rpl       |           | 64  |
|                       | erpsring<RINGID>meg-level             |           | 65  |
|                       | erpsring<RINGID>parent-ring           |           | 66  |
|                       | erpsring<RINGID>sub-ring              |           | 67  |
|                       | erpsring<RINGID>tcn-propogation       |           | 68  |
|                       | erpsring<RINGID>transmission-interval |           | 69  |
|                       | erpsring<RINGID>wtr-interval          |           | 70  |
|                       | showerpsstatistics                    |           | 71  |
|                       | showerpsstatus                        |           | 72  |
|                       | showerpssummary                       |           | 74  |
...
AOS-CX 10.09 High Availability Guide | (6200, 6300, 6400, 8xxx Switch Series)
...
6300 config-ospfv3-<INSTANCE-TAG> executionrightsforthiscommand.
6400
8320
8325
8360
...
ThenoformofthiscommandremovestheconfiguredBFDechopacketsinterval.Iftheintervalisnotset,
thedefaultintervalisused.
| Parameter |     | Description |
| --------- | --- | ----------- |
<INTERVAL> Specifiestheminimumreceptionintervalinmilliseconds.Avalue
of0meansthattheswitchdoesnotsupportreceptionofBFDecho
packets.Range:0,50to1000.Default:500.
32
AOS-CX10.09HighAvailabilityGuide| (6200,6300,6400,8xxxSwitchSeries)
...
ThenoformofthiscommandremovestheconfiguredBFDminimumintervalonaninterface.Iftheinterval
isnotset,thedefaultintervalisused.
| Parameter |     | Description |     |
| --------- | --- | ----------- | --- |
<INTERVAL> Specifiestheminimumreceiveintervalinmilliseconds.Avalueof
0meansthattheswitchdoesnotsupportreceptionofBFDcontrol
packets.Range:500to20000. Default:3000.
Examples
...
ThenoformofthiscommandremovestheconfiguredBFDminimumtransmittedintervalonaninterface.If
theintervalisnotset,thedefaultintervalisused.
| Parameter |     | Description |     |
| --------- | --- | ----------- | --- |
<INTERVAL> Specifiestheminimumtransmitintervalinmilliseconds.Range:
500to20000(6300,6400,8360,8400), 50to20000(8320,8325).
Default:3000.
Usage
...
Whenevertheminimumtimeintervalissettoavaluelessthan1000ms,BFDautomaticallyadjuststhe
n
transmissionintervalto1000msifanyofthefollowingconditionsapply:
o Thesessionisoperatinginasynchronousmodeandechoisenabled.
Thesessionstateisinanyotherstatethanup.
o
AsdescribedinRFC5880,thisbehavioroccursbecauseBFDechoprovidesquickdetectionwhichallowsthe
BFDasynchronoussessiontoloweritstraffic/resourcerequirements.
Examples
...
| --------- | --- | --- | --- | ----------- |
<DEST-IPV4-ADDR>
SpecifiesaroutedestinationinIPv4format(x.x.x.x),wherexis
...
| Platforms | Commandcontext |     | Authority |     |
| --------- | -------------- | --- | --------- | --- |
6200 config-router Administratorsorlocalusergroupmemberswithexecutionrights
| 6300 |     |     | forthiscommand. |     |
| ---- | --- | --- | --------------- | --- |
6400
8320
...
| ---------------------- | --- | ------------------- | --- | -------------- | --- | --- |
Controldetectiontimeexpired(1):ThesessionhasstoppedreceivingBFDcontrolpacketsfromthepeer
n
afteronedetectiontime.
Echofunctionfailed:ThesessionhasstoppedreceivingBFDEchopackets,sothesessionwasdeclared
n
Down.
...
Concatenatedpathdown:Notsetinthisrelease.
n
...
Usersmustexplicitlyhandlethedynamicchangeofaportfromtrunktoaccessinthefollowingcases:
n
...
| Platforms | Commandcontext |     |     | Authority |
| --------- | -------------- | --- | --- | --------- |
6200 config-erps-ring-<ringid> Administratorsorlocalusergroupmemberswithexecution
...
| --------- | --- | -------------------------------------------- | --- |
| <RINGID>  |     | Required,specifiestheIDofthering.Range:1-239 |     |
<100 milliseconds> Required,specifiesthehold-offintervalinunitsof100ms.Default:
0.
Examples
...
Force:Theswitchblocksaspecificringinterfaceregardlessoftheprotectionswitchingstateofthering
n
instance.
Manual:Theswitchblocksaspecificringinterfaceifnootherprotectionswitcheventisactiveonthering
n
instance.
ERPS|60
...
<ID>
Required,specifiestheERPSringinstanceidentifier.Range:1-2.
<PORT0> Required,configureport0tobeRPLportinthisERPSringinstance.
<PORT1>
...
n
Manual-switch:ManualprotectionswitchingtriggeredbyAdmin-down.
n
Force-switch:Forcedprotectionswitchingtriggeredbyadmin.
n
Aringinstancehasthefollowingreasonsfor"down"state:
ERPS|72

Disabled:Ringinstanceisadministrativelydisabled.
n
Inconsistent Port Config:Thesameportisconfiguredasport0andport1orRPLportisconfiguredby
n
Admin-down.
| Incomplete | Port Config:Onlyoneornoringportisconfigured. |     |     |     |     |
| ---------- | -------------------------------------------- | --- | --- | --- | --- |
n
| ProtectedVLANs | Not | Configured:ProtectedVLANlistisempty. |     |     |     |
| -------------- | --- | ------------------------------------ | --- | --- | --- |
n
| ControlVLAN | Not Configured:ControlVLANisnotconfigured. |     |     |     |     |
| ----------- | ------------------------------------------ | --- | --- | --- | --- |
n

...
3
AOS-CX10.11EventLogMessageReferenceGuide| (AllSwitchSeries)
...
| Dicovery   |                | and Capability |            |        | Exchange | (DCBx) | events | 69  |
| DNS        | client         | events         |            |        |          |        |        | 71  |
| Dot1x      | supplicant     |                | events     |        |          |        |        | 72  |
| DPSE       | events         |                |            |        |          |        |        | 73  |
| ECMP       | events         |                |            |        |          |        |        | 75  |
| ERPS       | events         |                |            |        |          |        |        | 77  |
| EVPN       | events         |                |            |        |          |        |        | 81  |
| External   |                | Storage        | events     |        |          |        |        | 85  |
| Fan events |                |                |            |        |          |        |        | 87  |
| Fault      | monitor        |                | events     |        |          |        |        | 92  |
| Firmware   |                | Update         | events     |        |          |        |        | 94  |
| Hardware   |                | Health         | Monitor    |        | events   |        |        | 96  |
| Hardware   |                | switch         | controller |        | sync     | events |        | 99  |
| HTTPS      | Server         | events         |            |        |          |        |        | 102 |
| In-System  |                | Programming    |            |        | events   |        |        | 104 |
| Interface  |                | events         |            |        |          |        |        | 107 |
| Internal   |                | storage        | events     |        |          |        |        | 109 |
| IP source  |                | lockdown       |            | events |          |        |        | 110 |
| IP tunnels |                | events         |            |        |          |        |        | 112 |
| IP-SLA     | events         |                |            |        |          |        |        | 116 |
| IPv6       | Router         | Advertisement  |            |        | events   |        |        | 118 |
Contents|4

| IRDP          | events      |            |         |               |        |        | 123 |
| ------------- | ----------- | ---------- | ------- | ------------- | ------ | ------ | --- |
| Job scheduler |             | events     |         |               |        |        | 124 |
| L3 Encap      |             | capacity   | events  |               |        |        | 125 |
| L3 Resource   |             | Manager    |         | events        |        |        | 126 |
| LACP          | events      |            |         |               |        |        | 127 |
| LAG           | events      |            |         |               |        |        | 133 |
| Layer         | 3 Interface |            | events  |               |        |        | 136 |
| LED events    |             |            |         |               |        |        | 143 |
| LLDP          | events      |            |         |               |        |        | 144 |
| Loop          | Protect     | events     |         |               |        |        | 147 |
| Loopback      |             | events     |         |               |        |        | 149 |
| MAC           | address     | management |         |               | events |        | 150 |
| MAC           | Address     | mode       |         | configuration |        | events | 152 |
| MACsec        | events      |            |         |               |        |        | 153 |
| Management    |             | events     |         |               |        |        | 155 |
| MDNS          | events      |            |         |               |        |        | 156 |
| MGMD          | events      |            |         |               |        |        | 157 |
| Mirroring     |             | events     |         |               |        |        | 162 |
| Module        | events      |            |         |               |        |        | 164 |
| MPLS          | events      |            |         |               |        |        | 172 |
| MSDP          | events      |            |         |               |        |        | 173 |
| Multicast     |             | Traffic    | Manager |               | events |        | 175 |
| Multiple      | spanning    |            | tree    | protocol      |        | events | 176 |
| MVRP          | events      |            |         |               |        |        | 180 |
| NAE           | Agents      | events     |         |               |        |        | 182 |
| NAE           | events      |            |         |               |        |        | 183 |
| NAE           | script      | generation |         | events        |        |        | 186 |
5
AOS-CX10.11EventLogMessageReferenceGuide| (AllSwitchSeries)

| NAE Scripts     | events        |          |               |        | 187 |
| --------------- | ------------- | -------- | ------------- | ------ | --- |
| ND snooping     | events        |          |               |        | 190 |
| NDM             | events        |          |               |        | 192 |
| NTP events      |               |          |               |        | 199 |
| OSPFv2          | events        |          |               |        | 201 |
| OSPFv3          | events        |          |               |        | 204 |
| Password        | Reset         | events   |               |        | 206 |
| PIM events      |               |          |               |        | 207 |
| Policies        | events        |          |               |        | 214 |
| Port access     | events        |          |               |        | 215 |
| Port access     | group         | based    | policy events |        | 218 |
| Port access     | roles         | events   |               |        | 220 |
| Port events     |               |          |               |        | 221 |
| Port security   | events        |          |               |        | 223 |
| Port Statistics | events        |          |               |        | 224 |
| Power           | events        |          |               |        | 225 |
| Power           | over Ethernet | events   |               |        | 230 |
| PTP events      |               |          |               |        | 239 |
| QoS ASIC        | Provider      | events   |               |        | 243 |
| Quality         | of Service    | events   |               |        | 245 |
| Rapid           | per VLAN      | Spanning | Tree Protocol | events | 246 |
| RBAC            | events        |          |               |        | 249 |
| Redundant       | Management    |          | events        |        | 250 |
| Replication     | Manager       | events   |               |        | 252 |
| REST            | events        |          |               |        | 253 |
| Self Test       | events        |          |               |        | 265 |
| sFlow           | events        |          |               |        | 266 |
Contents|6

| SFTP           | Client     | events  |           |           |              | 273 |
| -------------- | ---------- | ------- | --------- | --------- | ------------ | --- |
| Smartlink      |            | events  |           |           |              | 274 |
| SNMP           | events     |         |           |           |              | 275 |
| SSH client     |            | events  |           |           |              | 278 |
| SSH server     |            | events  |           |           |              | 279 |
| Supportability |            |         | events    |           |              | 282 |
| SYS events     |            |         |           |           |              | 289 |
| SYSMON         |            | events  |           |           |              | 291 |
| TCAM           | events     |         |           |           |              | 293 |
| Telnet         | server     |         | events    |           |              | 297 |
| Temperature    |            |         | events    |           |              | 299 |
| Time           | management |         |           | events    |              | 302 |
| Transceiver    |            |         | events    |           |              | 303 |
| UDLD           | events     |         |           |           |              | 306 |
| UDP            | Broadcast  |         | Forwarder |           | events       | 308 |
| UFD            | events     |         |           |           |              | 309 |
| User           | management |         |           | events    |              | 310 |
| User-based     |            | tunnels |           | events    |              | 312 |
| Virtual        | Switching  |         |           | Extension | (VSX) events | 320 |
| Virtual        | Switching  |         |           | Framework | (VSF) events | 328 |
| VLAN           | events     |         |           |           |              | 338 |
| VLAN           | Interface  |         | events    |           |              | 342 |
| VRF events     |            |         |           |           |              | 343 |
| VRF Manager    |            |         | events    |           |              | 344 |
| VRRP           | events     |         |           |           |              | 345 |
| VSX Sync       |            | events  |           |           |              | 351 |
| VXLAN          | agent      |         | events    |           |              | 352 |
7
AOS-CX10.11EventLogMessageReferenceGuide| (AllSwitchSeries)

| VXLAN                 | events             |           | 353 |
| --------------------- | ------------------ | --------- | --- |
| Zero                  | touch provisioning | events    | 357 |
| Support               | and Other          | Resources | 363 |
| AccessingArubaSupport |                    |           | 363 |
| AccessingUpdates      |                    |           | 364 |
|                       | ArubaSupportPortal |           | 364 |
|                       | MyNetworking       |           | 364 |
| Warrantyinformation   |                    |           | 364 |
| RegulatoryInformation |                    |           | 364 |
| Documentationfeedback |                    |           | 365 |
Contents|8
...
AOS-CX 10.11 Event Log Message Reference Guide | (All Switch Series)
...
DicoveryandCapabilityExchange(DCBx)events|70
...
HardwareHealthMonitorevents|97
...
Hardwareswitchcontrollersyncevents|100
...
| Event       | ID: 7218 |                                        |     |
In-SystemProgrammingevents|105
...
| ------- | ---------- | ------ | --------------- | ---------------- |
IPv6RouterAdvertisementevents|119
...
IPv6RouterAdvertisementevents|121
...
MACaddressmanagementevents|151
...
| Event | ID: 2010 |     |     |
| ----- | -------- | --- | --- |
Multiplespanningtreeprotocolevents|177
...
Multiplespanningtreeprotocolevents|179
...
| Event | ID: 5010 |     |     |     |
| ----- | -------- | --- | --- | --- |
RapidperVLANSpanningTreeProtocolevents|247
...
VirtualSwitchingFramework(VSF)events|331
...
Virtual Switching Framework (VSF) events | 337
...
| ----- | ------------------- | --------- |
Zerotouchprovisioningevents|358
...
Event ID: 8723
Zerotouchprovisioningevents|360

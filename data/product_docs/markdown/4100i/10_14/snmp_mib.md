...
AOS-CX 10.14.xxxx SNMP/MIB Guide | (All AOS-CX Series Switches)
...
|                                     | showsnmpv3security-level                      | 36  |
|                                     | showsnmpv3users                               | 36  |
|                                     | snmp-serveragent-port                         | 37  |
|                                     | snmp-servercommunity                          | 38  |
|                                     | snmp-servercommunityview                      | 40  |
|                                     | snmp-serverhistorical-counters-monitor        | 41  |
|                                     | snmp-serverhost                               | 42  |
|                                     | snmp-serverresponse-source                    | 45  |
|                                     | snmp-serversnmpv3-only                        | 47  |
|                                     | snmp-serversystem-contact                     | 48  |
|                                     | snmp-serversystem-description                 | 48  |
|                                     | snmp-serversystem-location                    | 49  |
|                                     | snmp-servertrap                               | 50  |
|                                     | snmp-servertrapaaa-server-reachability-status | 51  |
4
AOS-CX10.14.xxxxSNMP/MIBGuide| (AllAOS-CXSeriesSwitches)

|                                    | snmp-servertrapconfiguration-changes |           | 52  |
| ---------------------------------- | ------------------------------------ | --------- | --- |
|                                    | snmp-servertrapmac-notify            |           | 53  |
|                                    | snmp-servertrapmodule                |           | 54  |
|                                    | snmp-servertrapport-security         |           | 54  |
|                                    | snmp-servertrapsnmp                  |           | 55  |
|                                    | snmp-servertrap-sourceinterfacevrf   |           | 56  |
|                                    | snmp-servertrapvsx                   |           | 57  |
|                                    | snmp-serverview                      |           | 58  |
|                                    | snmp-servervrf                       |           | 59  |
|                                    | snmpv3context                        |           | 60  |
|                                    | snmpv3engine-id                      |           | 61  |
|                                    | snmpv3security-level                 |           | 62  |
|                                    | snmpv3user                           |           | 63  |
|                                    | snmpv3userview                       |           | 66  |
| EntityMIBsupport                   |                                      |           | 67  |
| LocationoftheMIBfilesontheweb      |                                      |           | 68  |
| UpdatedMIBsandTrapsforAOS-CX10.14  |                                      |           | 68  |
|                                    | NewMIBObjectsIntroducedin10.14       |           | 68  |
| UpdatedMIBsforAOS-CX10.14.1000     |                                      |           | 68  |
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 13
...
SNMP traps
Event log traps
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 15
...
Example 2
Thisexamplecreatesthefollowingconfiguration:
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 17
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 21
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 23
...
| index     | <INDEX> |     |     |     |     | SpecifiestheRMONalarmindex.Range:1to20. |     |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 25
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 27
...
| Last sampled      | value : 0               |          |
| Command History   |                         |          |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 29
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 31
...
| Mask :    | none               |     |     |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 33
...
| Command History |                                 |           |     |     |     |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 35
...
| ------------------------ | --- | --- | --- | -------------- | --- | ---------- | ---- | --- |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 37
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 39
...
| 10.07orearlier      |     |             |     | --                          |
| Command Information |     |             |     |                             |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 41
...
switch(config)#
|     | no snmp-server |     | host a:b::c:d | trap | version | v3 user Admin |
| --- | -------------- | --- | ------------- | ---- | ------- | ------------- |
...
responses.
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 45
...
9300
10000
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 47
...
| --- | --- | ----------- | --- | --------------- | --- | ---- | --- |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 49
...
Description
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 51
...
Allplatforms config Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 53
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 55
...
n KAupanddown
n MCLAGupanddown
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 57
...
| ------------------ | ----- | --- | --- | --- |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 59
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 61
...
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 63
...
| -------- | ------ | --------------- | --- | --- | --- | --- | --- |
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 65
...
n Fantrays
n Fans
AOS-CX10.14.xxxxSNMP/MIBGuide|(AllAOS-CXSeriesSwitches) 67
...
Updated MIBs and Traps for AOS-CX 10.14
...
New MIB Objects Introduced in 10.14

Updated MIB file: ARUBAWIRED-INTERFACE-MIB.mib

The ARUBAWIRED-INTERFACE-MIB.mib MIB now includes a table with information about the rate of
the physical ports of this device.

This table, arubaWiredIfRateTable, includes the following objects:

n arubaWiredIfRateIndex: An index that uniquely identifies a row in the physical port stat table.

n arubaWiredIfRateInterval: Rate collection interval in seconds.

n arubaWiredIfRateInBytes: Received bytes per second over the rate interval.

n arubaWiredIfRateOutBytes: Transmitted bytes per second over the rate interval.

n arubaWiredIfRateInBcastPkts: Received broadcast packets per second over the rate interval

n arubaWiredIfRateInMcastPkts: Received multicast packets per second over the rate interval.

n arubaWiredIfRateInUcastPkts: Received unicast packets per second over the rate interval.

n arubaWiredIfRateInTotalPkts: Received packets per second over the rate interval.

n arubaWiredIfRateOutBcastPkts: Transmitted broadcast packets per second over the rate interval.

n arubaWiredIfRateOutMcastPkts: Transmitted multicast packets per second over the rate interval.

n arubaWiredIfRateOutUcastPkts: Transmitted unicast packets per second over the rate interval.

n arubaWiredIfRateOutTotalPkts: Transmitted packets per second over the rate interval.

n arubaWiredIfRateInUtilization: Inbound interface utilization over the rate interval.

n arubaWiredIfRateOutUtilization: Outbound interface utilization over the rate interval.

Updated MIBs for AOS-CX 10.14.1000

This MIB provides the detailed information of the transceivers modules plugged into the switch ports.

Updated MIB file: ARUBAWIRED-PM-MIB.mib

| 68

arubaWiredPmXcvrTable
...
1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.2

arubaWiredPmXcvrDescription

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.3

arubaWiredPmXcvrProductNum

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.4

arubaWiredPmXcvrSerialNum

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.5

arubaWiredPmXcvrPartNum

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.6
arubaWiredPmXcvrType
1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.7

arubaWiredPmXcvrConnectorType

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.8

arubaWiredPmXcvrConnectorStatus

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.9

arubaWiredPmXcvrConnectorStatusReason

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.10

arubaWiredPmXcvrCableType

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.11

arubaWiredPmXcvrWavelength

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.12

arubaWiredPmXcvrSmfTxDist

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.13

arubaWiredPmXcvrMmfOm1TxDist

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.14

arubaWiredPmXcvrMmfOm2TxDist

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.15

arubaWiredPmXcvrMmfOm3TxDist

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.16

arubaWiredPmXcvrMmfOm4TxDist

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.17

arubaWiredPmXcvrMmfOm5TxDist

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.18

arubaWiredPmXcvrCableLength

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.19

arubaWiredPmXcvrMaxSpeed

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.20

arubaWiredPmXcvrMaxPower

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.21

arubaWiredPmXcvrAdapterType

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.22
arubaWiredPmXcvrAdapterStatus
1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.23

arubaWiredPmXcvrAdapterStatusReason

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.24

arubaWiredPmXcvrAdapterProductNum

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.25

arubaWiredPmXcvrAdapterSerialNum

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.26

arubaWiredPmXcvrThermalClass

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.27

arubaWiredPmXcvrDiagnostics

1.3.6.1.4.1.47196.4.1.1.3.27.1.1.1.28

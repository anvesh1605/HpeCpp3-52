...
|                                     | showmac-address-tableinterface                | 19  |
|                                     | showmac-address-tablelockout                  | 19  |
|                                     | showmac-address-tableport                     | 20  |
|                                     | showmac-address-tablestatic                   | 21  |
|                                     | showmac-address-tablevlan                     | 21  |
|                                     | static-mac                                    | 22  |
| VLANs                               |                                               | 24  |
| VLANinterfaces                      |                                               | 24  |
|                                     | Accessinterface                               | 24  |
...
|                                     | vlanname                                      | 43  |
3
AOS-CX10.10Layer-2BridgingGuide| 4100i,6000,6100,6200SwitchSeries
...
| MVRPcommands                         |                                        |       | 97  |
| ------------------------------------ | -------------------------------------- | ----- | --- |
|                                      | clearmvrpstatistics                    |       | 97  |
|                                      | mvrp                                   |       | 98  |
|                                      | mvrpregistration                       |       | 98  |
|                                      | mvrptimer                              |       | 99  |
|                                      | showmvrpconfig                         |       | 100 |
|                                      | showmvrpstate                          |       | 101 |
|                                      | showmvrpstatistics                     |       | 102 |
...
| STPsupportedplatformsandstandards    |                                        |       | 114 |
|                                      | Scale                                  |       | 114 |
| RPVST+protocolandfeaturedetails      |                                        |       | 115 |
|                                      | RPVST+vPorts                           |       | 118 |
| RPVST+configurationtasks             |                                        |       | 119 |
|                                      | ViewingRPVST+information               |       | 121 |
| RPVST+Considerationsandbestpractices |                                        |       | 122 |
| RPVST+usecases                       |                                        |       | 124 |
|                                      | RPVST+usecase:Deterministicrootbridges |       | 124 |
|                                      | SwitchAconfiguration                   |       | 125 |
|                                      | SwitchBconfiguration                   |       | 125 |
|                                      | SwitchCandDconfiguration               |       | 126 |
|                                      | Checkingtheconfiguration               |       | 126 |
|                                      | Observeportbehaviorandstate            |       | 127 |
|                                      | RPVST+usecase:BPDUprotection           |       | 129 |
|                                      | RPVST+usecase:Rootprotection           |       | 132 |
|                                      | RPVST+usecase:Spanningtreeonedgeports  |       | 134 |
|                                      | RPVST+usecase:Preventingloops          |       | 136 |
| RPVST+commands                       |                                        |       | 138 |
|                                      | clearspanning-treestatistics           |       | 138 |
|                                      | showcapacitiesrpvst                    |       | 138 |
|                                      | showcapacities-statusrpvst             |       | 139 |
|                                      | showspanning-tree                      |       | 140 |
|                                      | showspanning-treedetail                |       | 141 |
|                                      | showspanning-treeinconsistent-ports    |       | 142 |
|                                      | showspanning-treesummaryport           |       | 143 |
|                                      | showspanning-treesummaryroot           |       | 144 |
|                                      | showspanning-treevlan                  |       | 145 |
|                                      | showspanning-treevlandetail            |       | 146 |
|                                      | spanning-treebpdu-guardtimeout         |       | 148 |
|                                      | spanning-treeextend-system-id          |       | 148 |
|                                      | spanning-treeignore-pvid-inconsistency |       | 149 |
5
AOS-CX10.10Layer-2BridgingGuide| 4100i,6000,6100,6200SwitchSeries
...
|                                         | udldretries                           |           | 220 |
| Private                                 | VLAN                                  |           | 221 |
| PrivateVLANcommands                     |                                       |           | 224 |
|                                         | diagnostics                           |           | 224 |
|                                         | private-vlan                          |           | 225 |
|                                         | private-vlanport-type                 |           | 226 |
|                                         | showcapacitiesprivate-vlan            |           | 227 |
|                                         | showcapacities-statusprivate-vlan     |           | 228 |
|                                         | showprivate-vlan                      |           | 228 |
|                                         | showprivate-vlanassociation           |           | 229 |
|                                         | showprivate-vlaninconsistency         |           | 230 |
|                                         | showprivate-vlanport-type             |           | 232 |
|                                         | showrunning-configurationprivate-vlan |           | 233 |
|                                         | showtechprivate-vlan                  |           | 233 |
...
| spanning-treerpvst-mstpinterconnectvlan |                                       |           | 239 |
7
AOS-CX10.10Layer-2BridgingGuide| 4100i,6000,6100,6200SwitchSeries
...
AOS-CX 10.10 Layer-2 Bridging Guide | 4100i, 6000, 6100, 6200 Switch Series
...
switch#
|                | show mac-address-table |         | count vlan   | 100 |
| -------------- | ---------------------- | ------- | ------------ | --- |
| Number         | of MAC addresses       | : 5     |              |     |
| Command        | History                |         |              |     |
| Release        |                        |         | Modification |     |
...
2. Switch to the interface that you want to define as an access interface with the command
...
Loopprotectioncanbeconfiguredonamaximumof40942048VLANsacrossallinterfaces.
...
VLAN Registrar Applicant Forbid
...
Figure 4 RSTP topology with VLANs 10 and 20 blocked
...
Figure 5 RPVST+ topology with VLAN 10 blocked

RVPST+ creates another spanning tree for VLAN 20.

Figure 6 RPVST+ topology with VLAN 20 blocked
...
Figure 7 RPVST+ topology with shared links and redundant path blocking
...
Figure 8 RPVST+ topology with vPorts
...
| show | spanning-tree | summary | root |     |     |     |
| ---- | ------------- | ------- | ---- | --- | --- | --- |
Spanningtreeprotocols(STP)|121

| RPVST+                                  | Considerations |     | and best     | practices |     |
| --------------------------------------- | -------------- | --- | ------------ | --------- | --- |
| n ForthebestRPVST+experience,useatleast |                |     | AOS-CX10.07. |           |     |
...
behaviorofanaccessswitch,TCNguardcanbeapplied(usingcommandspanning-tree
tcn-
...
TheRootandSecondaryrootaretypicallyplacedattheCoreoftheLayer2domain. Figure9,
Deterministicrootbridges(physical)showsthephysicaltopologyand Figure10,Deterministicroot
...
| Figure9 | Deterministicrootbridges(physical) |     |     |
| ------- | ---------------------------------- | --- | --- |
Figure10
Deterministicrootbridges(logical)
124
| AOS-CX10.10Layer-2BridgingGuide| |     | 4100i,6000,6100,6200SwitchSeries |     |
| -------------------------------- | --- | -------------------------------- | --- |
...
Figure10,Deterministicrootbridges(logical)foreachswitchcanbeobservedshowingaloopfreeLayer
...
anetworkloop.
| Figure14 | Topologywithanundesiredloop |     |     |
| -------- | --------------------------- | --- | --- |
...
| Figure15 | TopologywithloopeliminatedbyRPVST+ |     |     |
| -------- | ---------------------------------- | --- | --- |
Procedure
1. ConfigureswitchA.
...
Examples
Showingcapacities-statusona6200switch:
| switch#    | show       | capacities-status |          | rpvst        |       |     |         |     |     |
| ---------- | ---------- | ----------------- | -------- | ------------ | ----- | --- | ------- | --- | --- |
| System     | Capacities |                   | Status : | Filter RPVST |       |     |         |     |     |
| Capacities | Status     |                   | Name     |              | Value |     | Maximum |     |     |
--------------------------------------------------------------------------
| Number | of RPVST | VLANs  | configured |     |     | 3   |     | 32   |     |
| ------ | -------- | ------ | ---------- | --- | --- | --- | --- | ---- | --- |
| Number | of RPVST | VPORTs | configured |     |     | 9   |     | 1024 |     |
...
| ------- | ------ | --- | --- | --- |
switch(config)#
|     | spanning-tree |     | extend-system-id | enable |
| --- | ------------- | --- | ---------------- | ------ |
...
Figure 16 Network with four MST regions and four switches per region

Figure 17 MST region 3
...
Aportstateisnotexclusivelyassociatedwithaportrole.Thefollowingtablelststheportstatesthat
eachportrolesupports.(AnXindicatesthattheportsupportsthisstate,whileadash[—]indicatesthat
theportdoesnotsupportthisstate.)
Port role
Port state
Root port/
...
| Discarding | X   | X   | X   |     | X   |
CIST calculation
DuringtheCISTcalculation,thefollowingprocesstakesplace:
n ThedevicewiththehighestpriorityiselectedastherootbridgeoftheCIST.
n MSTPgeneratesanISTwithineachMSTregionthroughcalculation.
n MSTPregardseachMSTregionasasingledeviceandgeneratesaCSTamongtheseMSTregions
throughcalculation.
TheCSTandISTsconstitutetheCISToftheentirenetwork.
MSTI calculation
WithinanMSTregion,MSTPgeneratesdifferentMSTIsfordifferentVLANsbasedontheVLAN-to-
instancemappings.Foreachspanningtree,MSTPperformsaseparatecalculationprocesssimilarto
spanningtreecalculationinSTP.
InMSTP,aBPDUpacketisforwardedalongthefollowingpaths:
n WithinanMSTregion,thepacketisforwardedalongthecorrespondingMSTI.
n BetweentwoMSTregions,thepacketisforwardedalongtheCST.
| MSTP on VSX |     |     |     |     |     |
| ----------- | --- | --- | --- | --- | --- |
SeetheVirtualSwitchingExtension(VSX)GuideforimportantinformationwhenconfiguringMSTPwith
VSX.
164
| AOS-CX10.10Layer-2BridgingGuide| | 4100i,6000,6100,6200SwitchSeries |     |     |     |     |
| -------------------------------- | -------------------------------- | --- | --- | --- | --- |
...
| Figure18 | Physicaltopologybeforeloopelimination |     |     |
| -------- | ------------------------------------- | --- | --- |
...
Figure19 MSTPloopelimination,initialconfiguration
...
Figure20 MSTPloopelimination,refinedconfiguration
Procedure
...
switch(config)#
|     | spanning-tree |     | config-revision | 40  |
| --- | ------------- | --- | --------------- | --- |
...
Applies only to the Aruba 6200 Switch Series.

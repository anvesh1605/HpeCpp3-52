...
AOS-CX 10.14.xxxx Monitoring Guide | (8400 Switch Series)
...
|                                                   | icmp-echo                          |              |          |             |               | 40  |
5
AOS-CX10.14.xxxxMonitoringGuide| (8400SwitchSeries)
...
|                                                  | vrf                        |            | 53  |
|                                                  | showinterface              |            | 54  |
|                                                  | showinterfacestatistics    |            | 60  |
| Mirroring                                        |                            |            | 64  |
| MirroringandsFlow                                |                            |            | 64  |
| Mirrorstatistics                                 |                            |            | 65  |
| Classifierpoliciesandmirroringsessions           |                            |            | 65  |
| Mirroringcommands                                |                            |            | 66  |
|                                                  | clearmirror                |            | 66  |
|                                                  | comment                    |            | 67  |
|                                                  | copytcpdump-pcap           |            | 68  |
|                                                  | copytshark-pcap            |            | 69  |
|                                                  | destinationcpu             |            | 69  |
|                                                  | destinationinterface       |            | 70  |
|                                                  | destinationtunnel          |            | 71  |
|                                                  | diagnostic                 |            | 73  |
|                                                  | diagutilitiestcpdump       |            | 74  |
|                                                  | disable                    |            | 76  |
|                                                  | enable                     |            | 76  |
|                                                  | mirrorsession              |            | 77  |
|                                                  | showmirror                 |            | 78  |
|                                                  | sourceinterface            |            | 80  |
|                                                  | sourcevlan                 |            | 82  |
| Monitoring                                       | a device                   | using SNMP | 85  |
| Breakout                                         | cable support              |            | 86  |
| Limitationswithbreakoutcablesupport              |                            |            | 86  |
| Breakoutcablesupportcommands                     |                            |            | 86  |
|                                                  | split                      |            | 86  |
| Aruba                                            | AirWave                    |            | 89  |
| SNMPsupportandAirWave                            |                            |            | 89  |
|                                                  | SNMPontheswitch            |            | 89  |
| SupportedfeatureswithAirWaveandtheAOS-CXswitch   |                            |            | 90  |
| ConfiguringtheAOS-CXswitchtobemonitoredbyAirWave |                            |            | 90  |
| AirWavecommands                                  |                            |            | 91  |
|                                                  | logging                    |            | 91  |
|                                                  | snmp-servercommunity       |            | 93  |
|                                                  | snmp-serverhost            |            | 94  |
|                                                  | snmp-servervrf             |            | 96  |
|                                                  | snmpv3context              |            | 96  |
|                                                  | snmpv3user                 |            | 97  |
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 20
...
| Do you    | want to save | the current   | configuration | (y/n)? n       |
| This will | reboot the   | entire switch | and render    | it unavailable |
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 22
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 24
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 30
...
| Command | History |     |     |     |
| ------- | ------- | --- | --- | --- |
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 32
...
| --- | --- | --- | --- | --- | ------------------------------------- |
Examples
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 34
...
memberswithexecutionrightsforthis
command.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 36
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 39
...
| ----------------------- | --- | --- | --- | --- |
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 41
...
Examples
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 43
...
|         | Probes      |         | Timed-out         |              |          | : 0           |
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 45
...
| IP-SLA          | Session  |                   | Cumulative  | Counters          |                        |     |     |     |
| Total           | Probes   | Transmitted       |             |                   | : 1                    |     |     |     |
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 47
...
executionrightsforthiscommand.
stop-test
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 49
...
to1440.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 51
...
executionrightsforthiscommand.
vrf
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 53
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 55
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 57
...
| 12:36:56 | UTC 2018) |     |     |     |              |             |
Showinginterfacelink-status:
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 59
...
(#)
commandfromtheoperatorcontext(>)only.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 63
...
8400 Manager(#) Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 68
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 70
...
enable
enable
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 76
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 78
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 80
...
entirely.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 82
...
8400 config Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 84
...
rightsforthiscommand.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 88
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 91
...
| --------------- | --- | ----------- | --------- | ------- | --- |
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 93
...
Allplatforms Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 95
...
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 97
...
Allplatforms config Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.14.xxxxMonitoringGuide|(8400SwitchSeries) 99

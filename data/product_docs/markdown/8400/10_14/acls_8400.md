...
AOS-CX 10.14.xxxx ACLs and Classifier Policies Guide | (8400 Switch Series)
...
5
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide| (8400SwitchSeries)
...
|                                         | showresources                         |               |          |                | 156 |
| Configurable                            | high                                  | capacity      | TCAM     |                | 161 |
| ConfiguringthehighcapacityTCAM          |                                       |               |          |                | 161 |
|                                         | Performingtheconfiguration            |               |          |                | 161 |
|                                         | Verifyingtheupdatedconfiguration      |               |          |                | 162 |
|                                         | VSX syncrequirements                  |               |          |                | 162 |
| HighcapacityTCAMcommands                |                                       |               |          |                | 163 |
|                                         | systemhigh-capacity-tcamaccess-listip |               |          |                | 163 |
|                                         | showsystemhigh-capacity-tcam          |               |          |                | 165 |
| Support                                 | and Other                             | Resources     |          |                | 167 |
| AccessingHPEArubaNetworkingSupport      |                                       |               |          |                | 167 |
| AccessingUpdates                        |                                       |               |          |                | 168 |
| WarrantyInformation                     |                                       |               |          |                | 168 |
| RegulatoryInformation                   |                                       |               |          |                | 168 |
| DocumentationFeedback                   |                                       |               |          |                | 168 |
|6
...
*3*3=81).
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 12
...
| ------------- | --- | ------------ | --- | ------------ | ---- | ------------- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 14
...
| Sequence        |             | Comment |      |             |     |     |          |
|                 |             | Action  |      |             |     | L3  | Protocol |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 16
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 18
...
| Type     | Name        |     |         |     |     |
| Sequence | Comment     |     |         |     |     |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 20
...
any
172.16.1.0/255.255.255.0
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 26
...
|          | Destination | IP Address |     | Destination | L4 Port(s) |
|          | Additional  | Parameters |     |             |            |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 28
...
| --- | ------ | --- | --- | --- |
172.26.1.0/255.255.255.0
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 30
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 32
...
n
TheAruba8400SwitchseriescannotmatchonMLD(MulticastListenerDiscovery)packetsusingthe
ICMPv6protocolnumber 58 duetotheHop-by-Hopoptionsextensionheaderwhichispresenton
MLDpackets. Thepresenceoftheextensionheaderinthepacketcausesthe8400tomatchon
protocolnumber0(HOPOPT)andnotprotocolnumber58(ICMPv6).Therefore,toachievethe
wantedmatchings,specifyprotocol0(NOT58)inyourACEs.
...
| ---- | ----------- | --- | --- | --- | --- | --- |
|      | 10 permit   |     |     |     | udp |     |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 36
...
|                          | Additional  | Parameters       |                     |            |
-------------------------------------------------------------------------------
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 38
...
|     | Hit-counts: |     | enabled |     |     |     |
| --- | ----------- | --- | ------- | --- | --- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 40
...
| --- | --- | ---------------------- | --- | --- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 42
...
ACE.
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 44
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 46
...
VLAN: 1
35 permit 0xeeee
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 48
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 50
...
| Release        |         |     |     | Modification |     |     |
| 10.07orearlier |         |     |     | --           |     |     |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 52
...
| ----------- | ----------- | ---------------------- | --- | ------- | --- |
| 10 permit   | tcp         | 172.16.2.0/255.255.0.0 |     | any ack |     |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 54
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 56
...
Description
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 58
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 60
...
VLANcontext.
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 62
...
trafficdirection.
Examples
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 64
...
| Command History |     |     |     |
| --------------- | --- | --- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 66
...
no <SEQUENCE-NUMBER>
Description
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 68
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 72
...
| Command History |     |     |     |
| --------------- | --- | --- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 74
...
Description
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 76
...
|          | Source           | IP Address |           | Source      | L4 Port(s) |
|          | Destination      | IP         | Address   | Destination | L4 Port(s) |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 78
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 80
...
| 20 permit |     | tcp |     |
| --------- | --- | --- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 82
...
|            |                  | - 10 permit   | udp any 172.16.1.0/255.255.255.0 |         |             |       |
|            |                  | 0 20 permit   | tcp 172.16.2.0/255.255.0.0       |         | gt 1023 any | count |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 84
...
switchesthatsupportVSX.
Usage
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 86
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 88
...
IPv4andIPv6neighborscombined).OnAruba8320,8325,8400,9300and10000Switchseries,IPv6
neighborswillcountavalueoftwoforeachneighbor,astheytakeuptwicethespaceinhardwareas
comparedtoIPv4neighbors.Inpreviousreleases,theoutputtheshow capacities-status l3-resources
commandcountedIPv4andIPv6neighborsasconsumingthesamenumberofresources/spacein
hardware.
ForSpineandL3-coreprofilesonAruba8320,8325and10000Switchseries,theIPv6Routeentrysizeisstillone
foreachneighbor.ForLeafandL3-aggprofiles,theentrysizeisalsooneforIPv6routeswithaprefixgreaterthan
64.
Examples
...
| ------ | --------- | ------- | ------------- | ----------- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 90
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 92
...
| 10.07orearlier      |     |     | --           |
| Command Information |     |     |              |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 94
...
| --- | ------------ | ----------- | --------- | --- | ----- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 98
...
my_policy
10
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 104
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 106
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 108
...
| 11   | ignore      |     |     |     |     | udp |     |
any
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 110
...
| no <SEQUENCE-NUMBER> |     | comment               |     |     |
Description
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 112
...
The following match criteria are not supported on Aruba 8400 Switch series:
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 116
...
forthiscommand.
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 118
...
|          | Source      | IP Address | Source      | L4 Port(s) |
|          | Destination | IP Address | Destination | L4 Port(s) |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 124
...
| Sequence Comment          |           |              |           |
| Action                    |           |              | EtherType |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 128
...
| Sequence        | Comment |         |                  |            |           |     |     |
|                 | Action  |         |                  |            | EtherType |     |     |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 130
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 132
...
|     | MY_CLASS3 | ipv4 |     |     |     |     |
| --- | --------- | ---- | --- | --- | --- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 136
...
| Release         |     |     | Modification |
| 10.07orearlier  |     |     | --           |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 138
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 140
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 142
...
| --- | --- | --- | ---- | ----- | --------------- | ------- | --- | -------------- | ------- | --- |
|     |     |     | 0 20 | match | icmpv6 1000::10 |         | any | count [ 0 kbps | conform | ]   |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 144
...
|     |     | 0 10 | match tcp any | any count | [ 0 | kbps conform | ]   |     |
| --- | --- | ---- | ------------- | --------- | --- | ------------ | --- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 146
...
| interface 1/1/1 |                 |            |      |                    |
| apply policy    | RATE_LIMIT_HTTP | in         |      |                    |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 150
...
processedinswitchhardware.ADC(analyticsdatacollection)alsoconsumesTCAMlookups.Aswitch
cansupportalimitednumberofACLandpolicyfeaturesatthesametime.Usethecommandshow
| resources | tomonitorTCAM resourcesandlookups. |     |     |     |     |     |
| --------- | ---------------------------------- | --- | --- | --- | --- | --- |
...
TCAMentries;twolookupsareneeded.However,ittakestwolookupstocontainquadruplewidthTCAM
entries,andbothofthetwolookupsmustbeinthesamecycle.
...
| Feature           | name | Preselector        |     |     | Width | Lookups |
| ----------------- | ---- | ------------------ | --- | --- | ----- | ------- |
...
| ----------------- | ----------- | --- | --- |
IngressIPV4HighCapacityACL IPv4packetsonphysicalinterfaces 1 1
Result
...
| VXLANTunnelControlPlane | Physicalinterfaces | 4   | 2   |
| ----------------------- | ------------------ | --- | --- |
Policing
...
| RoutedIngressUnicastIPv4 | IPv4packetsonphysicalinterfaces | 1   | 1   |
Counter
ACLandPolicyhardwareresourceconsiderations|152

| Feature name             |     | Preselector                     | Width | Lookups |
| ------------------------ | --- | ------------------------------- | ----- | ------- |
| RoutedIngressUnicastIPv6 |     | IPv6packetsonphysicalinterfaces | 1     | 1       |
Counter
...
| no shutdown |                    |            |     |     |
| l3-counters | rx                 |            |     |     |
Here'showthelookupswillbeallocated:
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 153

only match on IPv6 & card port traffic. There is also room for the ingress TCAM group that matches on
the recycle port which is used to make ACL Logging work.

Here's an example config that takes advantage of most of the IPv6 & card ports lookups and shows
that the routed & IPv4 & card ports preselector is full:
...
Here's how the lookups will be allocated:

Note: Port IPv4 ACLs and features applied on egress use dedicated hardware and do not conflict with the lookup

usage of any of the previous features. However, the TCAM entries are in a shared space between ingress and

egress, except for the High-capacity TCAM/LPM entries.

Egress features such as IPv4 ACLs applied "out" to route-only ports use dedicated lookup hardware, but they

share TCAM entries with ingress features.
...
ACL and Policy hardware resource considerations | 154
...
Applies only to deny, not permit: If a policy counts and mirrors a packet which also matches an ACL
that counts the packet, the hitcounts for the ACL and policy will not increment. Mirrored packets should
...
| ------- | -------------- | --- | --- | --- | --- | --- | --- | --- | --- |
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 157
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 159
...
AOS-CX10.14.xxxxACLsandClassifierPoliciesGuide|(8400SwitchSeries) 163
...
| --- | --- | --- | ----------------------------------------------------- | --- |
commandfromtheoperatorcontext(>)only.
ConfigurablehighcapacityTCAM|166

...
|                                                         | showobject-group                       | 84  |
| ACL configuration                                       | examples                               | 87  |
3
AOS-CX10.11ACLsandClassifierPoliciesGuide| (8400SwitchSeries)

| IPv4ACLexampleoverview                                    |          |     |     |     | 87  |
| --------------------------------------------------------- | -------- | --- | --- | --- | --- |
| DefiningandapplyinganIPv4ACL                              |          |     |     |     | 87  |
| IPv6ACLexampleoverview                                    |          |     |     |     | 88  |
| DefiningandapplyinganIPv6ACL                              |          |     |     |     | 88  |
| Classifier                                                | policies |     |     |     | 90  |
| Trafficpolicing                                           |          |     |     |     | 90  |
| Typesofpolicyactions                                      |          |     |     |     | 91  |
| Howpolicymatchingworks                                    |          |     |     |     | 92  |
| Activeclassconfigurationversususer-specifiedconfiguration |          |     |     |     | 92  |
Activepolicyconfigurationversususer-specifiedconfiguration 93
|                          | Considerationsforwhenapolicyisappliedperinterface |     |     |     | 94  |
| ------------------------ | ------------------------------------------------- | --- | --- | --- | --- |
| Classifierpolicycommands |                                                   |     |     |     | 96  |
|                          | Classifierpolicyapplication                       |     |     |     | 96  |
applypolicy(config-if,config-lag-if,config-if-vlan,config-vlan) 96
|                                         | classcopy                             |               |          |                | 100 |
| --------------------------------------- | ------------------------------------- | ------------- | -------- | -------------- | --- |
|                                         | classip                               |               |          |                | 102 |
|                                         | classipv6                             |               |          |                | 109 |
...
|                                         | classresequence                       |               |          |                | 120 |
|                                         | classreset                            |               |          |                | 122 |
|                                         | clearpolicyhitcounts                  |               |          |                | 122 |
|                                         | policy                                |               |          |                | 124 |
|                                         | policycopy                            |               |          |                | 129 |
|                                         | policyresequence                      |               |          |                | 129 |
|                                         | policyreset                           |               |          |                | 130 |
|                                         | showclass                             |               |          |                | 131 |
|                                         | showpolicy                            |               |          |                | 133 |
| Classifier                              | policies                              | configuration |          | example        | 138 |
| Configuringtheclassifierpoliciesexample |                                       |               |          |                | 138 |
| ACL and                                 | Policy hardware                       |               | resource | considerations | 141 |
| TCAMlookups                             |                                       |               |          |                | 141 |
| Matchingprecedenceorder                 |                                       |               |          |                | 141 |
| L4portranges                            |                                       |               |          |                | 142 |
| ACLandPolicyhardwareresourcecommands    |                                       |               |          |                | 143 |
|                                         | showresources                         |               |          |                | 143 |
| Configurable                            | high                                  | capacity      | TCAM     |                | 145 |
| ConfiguringthehighcapacityTCAM          |                                       |               |          |                | 145 |
|                                         | Performingtheconfiguration            |               |          |                | 145 |
|                                         | Verifyingtheupdatedconfiguration      |               |          |                | 146 |
|                                         | VSX syncrequirements                  |               |          |                | 146 |
| HighcapacityTCAMcommands                |                                       |               |          |                | 147 |
|                                         | systemhigh-capacity-tcamaccess-listip |               |          |                | 147 |
|                                         | showsystemhigh-capacity-tcam          |               |          |                | 149 |
...
AOS-CX 10.11 ACLs and Classifier Policies Guide | (8400 Switch Series)
...
| Parameter       |     |     | Description                               |
| --------------- | --- | --- | ----------------------------------------- |
| ecn <ECN-VALUE> |     |     | SpecifiesanExplicitCongestionNotification |
value.Range:0to3.
ip-precedence <IP-PRECEDENCE-VALUE> SpecifiesanIPprecedencevalue.Range:0to
7.
tos <TOS-VALUE>
SpecifiestheTypeofServicevalue.Range:0
to31.
...
| --------------- | --- | --- | -------------------------------------- |
Range:0to255.
| count |     |     | Keepsthehitcountsofthenumberof |
| ----- | --- | --- | ------------------------------ |
packetsmatchingthisACE.
log
Keepsalogofthenumberofpackets
matchingthisACE.Workswithdenyactions
butnotwithpermitactions.WorkswithACLs
appliedoningressoregress,exceptfor
controlplane.
...
The8400switchcannotmatchonMLD(MulticastListenerDiscovery)packetsusingtheICMPv6protocol
number 58 duetotheHop-by-HopoptionsextensionheaderwhichispresentonMLDpackets. Thepresenceof
theextensionheaderinthepacketcausesthe8400tomatchonprotocolnumber0(HOPOPT)andnotprotocol
number58(ICMPv6).Therefore,toachievethewantedmatchings,specifyprotocol0(NOT58)inyourACEs.
...
| in         |     |     |     | Selectstheinbound(ingress)trafficdirection. |     |     |     |
Usage
EachACLofagiventypecanbeappliedtothesameVLANonce.Therefore,usingtheapply
n access-
...
| --- | --- | --- | ------------------------------------------- | --- | --- |
out
(notapplicabletoVLANs)selectstheoutbound(egress)traffic
...
switch(config)#
|     | object-group | ip  | address | my_ip_group | reset |
| --- | ------------ | --- | ------- | ----------- | ----- |
switch(config)#
...
| Platforms           | Command | context | Authority    |
Allplatforms config Administratorsorlocalusergroupmemberswithexecutionrights
|     | Theobject-group |     | forthiscommand. |
| --- | --------------- | --- | --------------- |
ipv6 address
commandtakesyouinto
thenamedaddress
...
AllIPv4orIPv6ACLsappliedtointerfaceVLANs(routedin).
n
| Parameter      |           |     | Description                           |     |
| -------------- | --------- | --- | ------------------------------------- | --- |
| interface      | <IF-NAME> |     | Specifiestheinterfacename(portorLAG). |     |
...
| --------- | --- | --- | ----------- | --- |
<POLICE-ACTIONS>
Policeactionscanbethefollowing{cir <RATE-
|     |     |     | BPS>cbs <BYTES> | exceed}where: |
| --- | --- | --- | --------------- | ------------- |
cir kbps <RATE-KBPS>
SpecifiesaCommittedInformationRatevaluein
...
| --------------- | ------ | --------------- | --- | --- | --- |
Classifierpoliciesconfigurationexample|139
...
| -------- | ------------ | --- | --- | --- | --- | --- | --- | --- | --- | --- |
ConfigurablehighcapacityTCAM|146
...
| --- | --- | --- | ----------------------------------------------------- | --- |
commandfromtheoperatorcontext(>)only.
ConfigurablehighcapacityTCAM|150

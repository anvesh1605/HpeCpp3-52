...
3
AOS-CX10.12IPServicesGuide| (8400SwitchSeries)
...
AOS-CX 10.12 IP Services Guide | (8400 Switch Series)
...
|                                                       | shownd-snoopingra-guardpolicy            | 211 |
| ----------------------------------------------------- | ---------------------------------------- | --- |
|                                                       | shownd-snoopingra-guardvlan              | 212 |
...
|                                                       | ttl                                      | 238 |
|                                                       | vrfattach                                | 239 |
| IPsectunnelscommands                                  |                                          | 241 |
|                                                       | description                              | 241 |
|                                                       | destinationip                            | 241 |
|                                                       | ipmtu                                    | 242 |
|                                                       | showcapacities-status                    | 243 |
|                                                       | showcapacities-statustunneling           | 244 |
|                                                       | showinterfacetunnel                      | 245 |
|                                                       | showinterfacetunnelbrief                 | 246 |
|                                                       | showrunning-configinterfacetunnel        | 246 |
|                                                       | showrunning-configcurrent-context        | 247 |
|                                                       | sourceip                                 | 248 |
|                                                       | vrfattach                                | 249 |
| IP Source                                             | Lockdown                                 | 250 |
| IPsourcelockdowncommands                              |                                          | 250 |
|                                                       | IPsourcelockdownresourceextended         | 250 |
| IPv4sourcelockdowncommands                            |                                          | 251 |
|                                                       | ipv4source-binding                       | 251 |
|                                                       | ipv4source-lockdown                      | 252 |
|                                                       | ipv4source-lockdownhardwareretry         | 253 |
|                                                       | showipv4source-binding                   | 254 |
|                                                       | showipv4source-lockdown                  | 254 |
| IPv6sourcelockdowncommands                            |                                          | 257 |
|                                                       | ipv6source-binding                       | 257 |
|                                                       | ipv6source-lockdown                      | 258 |
|                                                       | ipv6source-lockdownhardwareretry         | 259 |
|                                                       | showipv6source-binding                   | 260 |
7
AOS-CX10.12IPServicesGuide| (8400SwitchSeries)

|                                 | showipv6source-lockdown     |           |          |        | 260 |
| ------------------------------- | --------------------------- | --------- | -------- | ------ | --- |
| Internet                        | Control                     | Message   | Protocol | (ICMP) | 264 |
| ICMPmessagetypes                |                             |           |          |        | 264 |
| WhenICMPmessagesaresent         |                             |           |          |        | 264 |
| ICMPredirectmessages            |                             |           |          |        | 265 |
| WhenICMPredirectmessagesaresent |                             |           |          |        | 265 |
| ICMPcommands                    |                             |           |          |        | 265 |
|                                 | ipicmpredirect              |           |          |        | 265 |
|                                 | ipicmpthrottle              |           |          |        | 266 |
|                                 | ipicmpunreachable           |           |          |        | 267 |
| DNS                             |                             |           |          |        | 268 |
| DNSclient                       |                             |           |          |        | 268 |
| ConfiguringtheDNSclient         |                             |           |          |        | 268 |
| DNSclientcommands               |                             |           |          |        | 269 |
|                                 | ipdnsdomain-list            |           |          |        | 269 |
|                                 | ipdnsdomain-name            |           |          |        | 270 |
|                                 | ipdnshost                   |           |          |        | 271 |
|                                 | ipdnsserveraddress          |           |          |        | 272 |
|                                 | showipdns                   |           |          |        | 273 |
| ARP                             |                             |           |          |        | 276 |
| ConfiguringproxyARP             |                             |           |          |        | 277 |
| ConfiguringlocalproxyARP        |                             |           |          |        | 277 |
| ARPcommands                     |                             |           |          |        | 278 |
|                                 | arpcache-limit              |           |          |        | 278 |
|                                 | arpinspection               |           |          |        | 278 |
|                                 | arpinspectiontrust          |           |          |        | 279 |
|                                 | arpipv4mac                  |           |          |        | 280 |
|                                 | arpprocess-grat-arp         |           |          |        | 281 |
|                                 | cleararp                    |           |          |        | 282 |
|                                 | debugarp-security           |           |          |        | 283 |
|                                 | iplocal-proxy-arp           |           |          |        | 284 |
|                                 | ipproxy-arp                 |           |          |        | 285 |
|                                 | ipv6neighbormac             |           |          |        | 286 |
|                                 | showarp                     |           |          |        | 287 |
|                                 | showarpinspectioninterface  |           |          |        | 287 |
|                                 | showarpinspectionstatistics |           |          |        | 289 |
|                                 | showarpinspectionvlan       |           |          |        | 290 |
|                                 | showarpstate                |           |          |        | 291 |
|                                 | showarpsummary              |           |          |        | 292 |
|                                 | showarptimeout              |           |          |        | 294 |
|                                 | showarpvrf                  |           |          |        | 295 |
|                                 | showipv6neighbors           |           |          |        | 296 |
|                                 | showipv6neighborsstate      |           |          |        | 297 |
|                                 | showtecharp-security        |           |          |        | 298 |
| Network                         | Load                        | Balancing | (NLB)    |        | 300 |
| NLBcommands                     |                             |           |          |        | 300 |
|                                 | arpipv4mac                  |           |          |        | 300 |
|                                 | showarp                     |           |          |        | 301 |
|                                 | showipigmpsnoopingvlangroup |           |          |        | 302 |
| Support                         | and Other                   | Resources |          |        | 303 |
| AccessingArubaSupport           |                             |           |          |        | 303 |
Contents|8
...
IntheVSXsetup,whenthenumberofclientsintheleasetableismore,theserverdaemonwillhave
n
...
| ------------------- | ------- | ------- | --------- |
| Platforms           | Command | context | Authority |
8400 config-vlan Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
| dhcpv4-snooping    |                         | allow-overwrite-binding |     |
| ------------------ | ----------------------- | ----------------------- | --- |
| dhcpv4-snooping    | allow-overwrite-binding |                         |     |
...
informationistobecleared.
port <PORT-NUM>
Specifiestheport(interface)forwhichallNDbindinginformation
istobecleared.
...
| Command        | Information |     |         |     |              |
| Platforms      | Command     |     | context |     | Authority    |
config-vlan Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
| nd-snooping    |           | mac-check |     |     |     |
| -------------- | --------- | --------- | --- | --- | --- |
| nd-snooping    | mac-check |           |     |     |     |
...
| Command Information   |           |                |              |     |     |
| Platforms             | Command   | context        | Authority    |     |     |
8400 config-gre-if Administratorsorlocalusergroupmemberswithexecutionrights
...
| Command        | Information |     |         |             |                  |
| Platforms      | Command     |     | context |             | Authority        |
8400 config-ip-if Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
| interface | tunnel |     |     |     |     |
| --------- | ------ | --- | --- | --- | --- |
...
| --------------- | ------- | ---------- | -------- | --- |
| Command         | History |            |          |     |
InternetControlMessageProtocol(ICMP)|265
...
Allplatforms config Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
InternetControlMessageProtocol(ICMP)|267
...
| --- | --- | --- | --- | -------------------------------------------------------- | --- | --- |
alert:SetsARPsecuritydebuglogfilteringtoAlertandabove.
n
...
| Command Information |         |         |              |     |     |
| Platforms           | Command | context | Authority    |     |     |
8400 config-ifandconfig- Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.
if-vlan
show arp
show arp

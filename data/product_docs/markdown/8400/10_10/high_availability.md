...
AOS-CX 10.10 High Availability Guide | (6200, 6300, 6400, 8xxx, 9300, 10000 Switch Series)
...
| HighAvailabilityOverview                   |                                             | 11  |
| ManagementModuleFailoverOverview           |                                             | 12  |
| AAAonSwitcheswithMultipleManagementModules |                                             | 14  |
| HighAvailabilityCommands                   |                                             | 14  |
|                                            | redundancyswitchover                        | 15  |
| BFD                                        |                                             | 16  |
| BFDFeatures                                |                                             | 16  |
| ConfiguringBFDforanIPv4StaticRoute         |                                             | 17  |
| ConfiguringBFDforBGP                       |                                             | 18  |
| ConfiguringBFDForOSPFv2                    |                                             | 20  |
| ConfiguringBFDForOSPFv3                    |                                             | 22  |
| ConfiguringBFDforPIMOverIPv4               |                                             | 23  |
| ConfiguringBFDforPIMOverIPv6               |                                             | 24  |
| ConfiguringBFDforVRRP                      |                                             | 26  |
| BFDCommands                                |                                             | 27  |
|                                            | bfd                                         | 27  |
|                                            | bfd<IPV4-ADDR>                              | 27  |
|                                            | bfdall-interfaces(OSPF)                     | 28  |
|                                            | bfddetect-multiplier                        | 29  |
|                                            | bfddisable                                  | 30  |
|                                            | bfdenable(Context:config-hsc)               | 31  |
|                                            | bfddisable(Context:config-hsc)              | 32  |
|                                            | bfdechodisable                              | 32  |
|                                            | bfdecho-src-ip-address                      | 34  |
|                                            | bfdmin-echo-receive-interval                | 34  |
|                                            | bfdmin-receive-interval                     | 35  |
|                                            | bfdmin-transmit-interval                    | 36  |
|                                            | clearbfdstatistics                          | 38  |
|                                            | ipospfbfd                                   | 38  |
|                                            | ipospfbfddisable                            | 39  |
|                                            | iproutebfd                                  | 40  |
|                                            | ipv6ospfv3bfd                               | 41  |
|                                            | ipv6ospfv3bfddisable                        | 42  |
|                                            | neighborfall-overbfd(context:config-router) | 43  |
|                                            | showbfd                                     | 43  |
|                                            | showbfdinterface                            | 46  |
|                                            | showhsc                                     | 48  |
| ERPS                                       |                                             | 49  |
5
AOS-CX10.10HighAvailabilityGuide| (6200,6300,6400,8xxx,9300,10000SwitchSeries)
...
|                                    | <PORT0>|<PORT1>}                      |           | 63  |
| ---------------------------------- | ------------------------------------- | --------- | --- |
|                                    | erpsring<RINGID>instance<ID>revertive |           | 64  |
|                                    | erpsring<RINGID>instance<ID>role      |           | 65  |
|                                    | erpsring<RINGID>instance<ID>rpl       |           | 66  |
...
| AccessingUpdates                   |                                       |           | 80  |
|                                    | ArubaSupportPortal                    |           | 80  |
|                                    | MyNetworking                          |           | 80  |
| WarrantyInformation                |                                       |           | 80  |
| RegulatoryInformation              |                                       |           | 81  |
| DocumentationFeedback              |                                       |           | 81  |
|6
...
| redundancy switchover |            |     |     |
Description
CausestheswitchtoimmediatelyswitchovertotheStandbyManagementModule.Thiscommandmust
beexecutedfromtheActiveManagementModuleandwillfailiftheStandbyManagementModuleisin
afailedstateornotpresent.
Examples
...
9300
10000
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 15
...
n IPv6 BFD sessions are not supported (8320, 8325, and 8360, and 9300 switches only)
...
BFDcontrolpacketsonan
interface.
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 18
...
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 20
...
|     | switch(config-if)# | exit      |          |           |     |     |     |
|     | switch(config)#    | interface | 1/1/2    |           |     |     |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 22
...
| ----------- | --- | --- | --- | --- | -------- | ---- | --- | --- | --- | --- | --- |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 24
...
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 26
...
| ------------------ | --- | ------ | --- |
bfd all-interfaces
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 28
...
| Command Information      |         |         |                    |           |
| Platforms                | Command | context |                    | Authority |
6200 config-ospf-<INSTANCE-TAG> Administratorsorlocalusergroupmemberswith
...
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 30
...
| ---------------- | ------- | --- | --- |
| bfd echo disable |         |     |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 32
...
Togglingthisfeatureon8325,8360or9300switchesmaycauserouteflapping.
Authority
Examples
Onthe6400SwitchSeries,interfaceidentificationdiffers.
...
| Platforms           | Command | context   |       | Authority    |
6200 config Administratorsorlocalusergroupmemberswithexecution
| 6300 | config-if |     |     | rightsforthiscommand. |
| ---- | --------- | --- | --- | --------------------- |
6400
8320
8325
...
Description
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 34
...
controlpackets.Range:500to20000. Default:3000.
Examples
...
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 36
...
besettoatleast3.
n Ifbfd detect-multiplierissetto1,thentheminimumtransmitintervalmustbesettoatleast
3000ms.
...
switch#
|                | clear       | bfd statistics | session 1    |
| -------------- | ----------- | -------------- | ------------ |
| Command        | History     |                |              |
| Release        |             |                | Modification |
| 10.07orearlier |             |                | --           |
...
| ip ospf    | bfd |     |     |
| no ip ospf | bfd |     |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 38
...
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 40
...
9300
10000
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 42
...
Currently,BFDissupportedonlywithIPv4neighbors.
| Parameter |     |     |     | Description |     |     |     |
| --------- | --- | --- | --- | ----------- | --- | --- | --- |
...
| Command                | Information |         |             |              |              |           |     |
| Platforms              |             | Command | context     | Authority    |              |           |     |
6200 config-router Administratorsorlocalusergroupmemberswithexecution
| 6300 |     |     |     | rightsforthiscommand. |     |     |     |
| ---- | --- | --- | --- | --------------------- | --- | --- | --- |
6400
8320
...
------- --------- --------- ------------------------------- ----------------------
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 44
...
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 46
...
9300
10000
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 48
...
| ------- | ------- | ---- | ------ | ---------- | --- |
| Command | History |      |        |            |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 51
...
8320
8325
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 53
...
| Command                     | Information |         |           |     |              |           |
| Platforms                   |             | Command | context   |     |              | Authority |
6200 config-erps-ring-<ringid> Administratorsorlocalusergroupmemberswith
ERPS|54
...
| 6300 |     |     |     | executionrightsforthiscommand. |
| ---- | --- | --- | --- | ------------------------------ |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 55
...
| 10.07orearlier              |             |      |      | --                   |     |
| Command                     | Information |      |      |                      |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 57
...
| Command                           | History |     |           |     |                 |     |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 59
...
| Release                           |         |          | Modification |     |
| 10.07orearlier                    |         |          | --           |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 61
...
| Parameter      |           |     | Description                                  |         |     |
| <RINGID>       |           |     | Required,specifiestheIDofthering.Range:1-239 |         |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 63
...
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 65
...
| ---- | --- | --- | --- | --- | ----------------------------------------- |
executionrightsforthiscommand.
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 69
...
| 6300 |     |     |     | executionrightsforthiscommand. |
| ---- | --- | --- | --- | ------------------------------ |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 71
...
| 10.07orearlier              |             |      |      | --              |     |
| Command                     | Information |      |      |                 |     |
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 73
...
Protection:Protectionswitchinghasbeentriggeredbyalocalorremotelinkfailure.
n
n Pending:Pendingclearanceofapreviousprotectionswitch.
n Down:Ringinstanceisnotactive.
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 75
...
Inconsistent Port Config:Thesameportisconfiguredasport0andport1orRPLportisconfigured
n
byAdmin-down.
| n Incomplete |       | Port Config:Onlyoneornoringportisconfigured. |                                      |     |     |     |     |
| ------------ | ----- | -------------------------------------------- | ------------------------------------ | --- | --- | --- | --- |
| Protected    | VLANs | Not                                          | Configured:ProtectedVLANlistisempty. |     |     |     |     |
n
...
9300
10000
AOS-CX10.10HighAvailabilityGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 77

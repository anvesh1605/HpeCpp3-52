...
AOS-CX 10.16.xxxx Diagnostics and Supportability Guide | (8400 Switch Series)
...
| Logmessages                                       |                                                    | 36  |
5
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide| (8400SwitchSeries)
...
Using classifier policies for traffic capture and analysis 77
| Remote                    | syslog                          |     | 83  |
| ------------------------- | ------------------------------- | --- | --- |
| Remotesyslogcommands      |                                 |     | 83  |
|                           | clearaccounting-logs            |     | 83  |
|                           | logging                         |     | 84  |
|                           | loggingaccounting-format-native |     | 87  |
|                           | loggingfilter                   |     | 87  |
|                           | loggingfacility                 |     | 90  |
|                           | loggingpersistent-storage       |     | 91  |
| Runtime                   | Diagnostics                     |     | 93  |
| Runtimediagnosticcommands |                                 |     | 93  |
|                           | diagnosticmonitor               |     | 93  |
|                           | diagon-demand                   |     | 94  |
|6
...
| MissingRearDisplayModuleFailure     |                                | 110 |
| ServiceOSCLIcommandlist             |                                | 111 |
| ServiceOSCLIfeaturesandlimitations  |                                | 111 |
| ServiceOSCLIcommands                |                                | 112 |
|                                     | boot                           | 112 |
|                                     | cat                            | 112 |
|                                     | cdpath                         | 113 |
|                                     | config-clear                   | 114 |
...
|                                     | secure-mode                    | 129 |
|                                     | sh                             | 131 |
|                                     | systemserviceospassword-prompt | 131 |
|                                     | umount                         | 132 |
|                                     | update                         | 133 |
|                                     | tftp                           | 134 |
|                                     | version                        | 135 |
...
|                                     | fastboot                       | 138 |
|                                     | showselftest                   | 140 |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 7

| Zeroization                                   |                                          |           |             |            |        | 143 |
| --------------------------------------------- | ---------------------------------------- | --------- | ----------- | ---------- | ------ | --- |
| Zeroizationcommands                           |                                          |           |             |            |        | 143 |
|                                               | eraseallzeroize                          |           |             |            |        | 143 |
| Terminal                                      | Monitor                                  |           |             |            |        | 146 |
| Terminalmonitorcommands                       |                                          |           |             |            |        | 146 |
|                                               | loggingconsole{notify|severity|filter}   |           |             |            |        | 146 |
|                                               | showterminal-monitor                     |           |             |            |        | 147 |
|                                               | terminal-monitor{notify|severity|filter} |           |             |            |        | 148 |
| Troubleshooting                               |                                          | Web       | UI and REST | API Access | Issues | 150 |
| HTTP404errorwhenaccessingtheswitchURL         |                                          |           |             |            |        | 150 |
| HTTP401error"Loginfailed:sessionlimitreached" |                                          |           |             |            |        | 150 |
| Support                                       | and Other                                | Resources |             |            |        | 152 |
| AccessingHPEArubaNetworkingSupport            |                                          |           |             |            |        | 152 |
| AccessingUpdates                              |                                          |           |             |            |        | 153 |
| WarrantyInformation                           |                                          |           |             |            |        | 153 |
| RegulatoryInformation                         |                                          |           |             |            |        | 153 |
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 14
...
| -------------------- | --- | ------- | --- | ---- | ---------- | --- |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 16
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 18
...
| -------- | ---------- | --- | --- |
| Command  | History    |     |     |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 20
...
| Maxsize         | :              | 10MB                  |     |     |     |
switch(config)#
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 24
...
rightsforthiscommand.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 28
...
local.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 30
...
Allplatforms Manager(#) Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 32
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 41
...
mgmt
CopyingthekernelcoredumpfromslotID1/1totheURLwiththeVRFnamedmgmt:
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 43
...
| 10.07orearlier                   |                |            | --                   |
| Command Information              |                |            |                      |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 45
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 49
...
[;blocksize=<VAL>]/<FILE>
n {sftp://|scp://<USER>@}{<IP>|<HOST>}
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 51
...
Allplatforms Manager(#) Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 53
...
| Release         |          | Modification |     |
| 10.07orearlier  |          | --           |     |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 57
...
VRFnamedmgmt:
switch#
copy support-log crash-handler 1/1 sftp://user@10.0.14.206/cras_3_8 vrf
mgmt
| Command History     |         |         |                   |
| ------------------- | ------- | ------- | ----------------- |
| Release             |         |         | Modification      |
...
Allplatforms Manager(#) Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 59
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 62
...
| -------------- | ----------- | --- | --- | --- | --- | --- |
| Command        | Information |     |     |     |     |     |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 64
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 68
...
timeout <TIME> Specifiesthepingtimeoutinseconds.Range:1-60seconds,
default:2seconds.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 72
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 74
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 79
...
|               |       |                      |          |                    |         |             | Usingclassifier |          | policiesfortrafficcaptureandanalysis|80 |
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 81
...
| ---------- | ----------------- | --- | --- | ----------------- | --- |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 87
...
andemergency(7)
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 91
...
| 10.07orearlier     |                |       |                       | --           |     |         |
| Command            | Information    |       |                       |              |     |         |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 95
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 97
...
Iteration
-------------- ------ ---------- ------------ ------------- ------------- --------
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 99
...
| 1 2019-09-16           | 03:57:41 | 2019-09-16          | 03:57:41 |     |     |
| fan2_eeprom            | Pass     | 0x0                 | 0x0      | 0   | 0   |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 101
...
| jericho_tmp            | Pass     | 0x0                 | 0x0      | 0   | 0   |
| 2 2019-09-16           | 04:23:08 | 2019-09-16          | 04:13:32 |     |     |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 103
...
8400 Manager(#) Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 105
...
Example
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 108
...
| --- | ------ | ------- | ---- | ------ | -------------- | --- | --- | ------- | --- | --- |
|     | switch | login:  |      |        |                |     |     |         |     |     |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 110
...
rightsforthiscommand.
cat
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 112
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 114
...
erase zeroize
Description
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 116
...
n Software images are copied to RAM to be restored on completion.

n All bits undergo a 0>1>0 transition to completely zeroize data. This data is not recoverable.

n This feature can be used to remove all configuration settings or system alterations for debugging or

troubleshooting.

n The zeroization process takes approximately two minutes.
...
Allplatforms ServiceOS(SVOS>) Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 118
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 120
...
SVOS>
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 122
...
includeallandusb.
Examples
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 124
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 126
...
| Release        |         |     | Modification |
| 10.07orearlier |         |     | --           |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 128
...
| Command | History |     |     |     |     |     |     |
| ------- | ------- | --- | --- | --- | --- | --- | --- |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 130
...
| Release         |     |     | Modification |
| 10.07orearlier  |     |     | --           |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 132
...
| Command History |     |     |     |     |
| --------------- | --- | --- | --- | --- |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 134
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 140
...
| Platforms      | Command        |          | context     | Authority           |           |
| Allplatforms   | Manager(#)     |          |             |                     |           |
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 142
...
Allplatforms Manager(#) Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 145
...
AOS-CX10.16.xxxxDiagnosticsandSupportabilityGuide|(8400SwitchSeries) 148

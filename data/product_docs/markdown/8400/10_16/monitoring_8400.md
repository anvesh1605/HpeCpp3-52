...
AOS-CX 10.16.xxxx Monitoring Guide | (8400 Switch Series)
...
|                                                   | showrunning-configexternal-storage |         |                    |               | 32  |
|                                                   | type                               |         |                    |               | 33  |
|                                                   | username                           |         |                    |               | 34  |
|                                                   | vrf                                |         |                    |               | 35  |
| IP-SLA                                            |                                    |         |                    |               | 36  |
| IP-SLAguidelines                                  |                                    |         |                    |               | 36  |
| LimitationswithVoIPSLAs                           |                                    |         |                    |               | 37  |
| IP-SLAcommands                                    |                                    |         |                    |               | 37  |
|                                                   | http                               |         |                    |               | 37  |
|                                                   | https                              |         |                    |               | 39  |
|                                                   | icmp-echo                          |         |                    |               | 41  |
...
|                                                   | ip-slaresponder                    |         |                    |               | 43  |
5
AOS-CX10.16.xxxxMonitoringGuide| (8400SwitchSeries)

|                                                  | showip-slaall           |            | 45  |
| ------------------------------------------------ | ----------------------- | ---------- | --- |
|                                                  | showip-slaresponder     |            | 47  |
|                                                  | showip-sla              |            | 48  |
|                                                  | start-test              |            | 50  |
|                                                  | stop-test               |            | 50  |
|                                                  | tcp-connect             |            | 51  |
...
|                                                  | vrf                     |            | 56  |
|                                                  | showinterface           |            | 56  |
|                                                  | showinterfacestatistics |            | 63  |
| Mirroring                                        |                         |            | 67  |
| MirroringandsFlow                                |                         |            | 67  |
| Mirrorstatistics                                 |                         |            | 68  |
| Classifierpoliciesandmirroringsessions           |                         |            | 68  |
| Mirroringcommands                                |                         |            | 69  |
|                                                  | clearmirror             |            | 69  |
|                                                  | comment                 |            | 70  |
|                                                  | copytcpdump-pcap        |            | 71  |
|                                                  | copytshark-pcap         |            | 72  |
...
Aruba 8400 switch series member, slot, and port
notation
...
Power supplies are on the front of the switch behind the bezel above the line modules and
management modules. Power supplies are labeled in software as Member/PSU: 1/1 through 1/4.
...
commands.
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 20
...
| Do you    | want to save | the current   | configuration | (y/n)? n       |
| This will | reboot the   | entire switch | and render    | it unavailable |
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 22
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 24
...
| Command Information |                                       |         |              |           |
| Platforms           | Command                               | context |              | Authority |
| 8400                | config-external-storage-<VOLUME-NAME> |         |              |           |
disable
disable
no disable
Description
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 29
...
| 10.07orearlier |             |     |     | --           |
| Command        | Information |     |     |              |
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 31
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 33
...
memberswithexecutionrightsforthis
command.
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 35
...
| Command | History |     |
| ------- | ------- | --- |
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 40
...
(default).
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 42
...
udp-echo Enablesresponderforudp-echo
probes.
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 46
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 48
...
stop-test
Description
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 50
...
interval <HISTORY-INTERVAL>] [name-server {<IPV4-ADDR-DNS-SERVER>|<IPV6-ADDR-DNS-SERVER>}
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 52
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 56
...
Shows additional statistics, including the tx filtered and rx
filtered counters.

n Rx filter packets are protocol packets received when the

protocol is disabled on the switch and there is only one port in

the VLAN. Protocols include OSPF, PIM, RIP, LACP, and LLDP.
n An example of a Tx filtered packet would be a multicast packet

being filtered from going out of the ingress port.

Shows statistics rounded to the nearest power of 1000, for
example, 1K, 345M, 2G. This is available only in the CLI interface
output.
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 58
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 60
...
| Packets |     |     |     |     |     | 15  |     | 15  |     | 30  |
| ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 62
...
| Allplatforms        | Operator(>)orManager |         |                               |
(#)
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 66
...
8400 Manager(#) Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 71
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 73
...
enable
enable
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 79
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 81
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 83
...
Reenterthesource vlan <VLAN-NUM> <direction>commandwiththenewpreferreddirection.
n
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 85
...
Ifthemirrorisconfiguredinbothdirection,onecopyofthepacketwillbemirrored.
n
n TomirrorroutedpacketsreceivedonaVLANandtransmittedoutadifferentVLAN,enabletx
...
destination.
Ifthemirrorisconfiguredinthebothdirection,twocopiesofthepacketsaremirroredtothemirror
n
destination.
...
8400 config Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 87
...
rightsforthiscommand.
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 91
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 94
...
| --------------- | --- | ----------- | --------- | ------- | --- |
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 96
...
Allplatforms Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 98
...
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 100
...
Allplatforms config Administratorsorlocalusergroupmemberswithexecution
rightsforthiscommand.
AOS-CX10.16.xxxxMonitoringGuide|(8400SwitchSeries) 102

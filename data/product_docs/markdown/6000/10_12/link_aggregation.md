...
|                                                           | Configuringalayer2dynamicaggregationgroup            | 20  |
| Layer3aggregationgroups                                   |                                                      | 23  |
|                                                           | Configuringalayer3staticaggregationgroup             | 23  |
...
3
AOS-CX10.12LinkAggregationGuide| (AllSwitchSeries)

| description(lag)                    |                                |            | 39  |
| ----------------------------------- | ------------------------------ | ---------- | --- |
| hash                                |                                |            | 40  |
| interfacelag                        |                                |            | 41  |
| ipaddress(interfacelag)             |                                |            | 42  |
| ipv6address (lag)                   |                                |            | 43  |
| lacpfallback                        |                                |            | 44  |
...
| lacpmode                            |                                |            | 47  |
| lacpport-id                         |                                |            | 48  |
| lacpport-priority                   |                                |            | 49  |
| lacprate                            |                                |            | 49  |
| lacpsystem-priority                 |                                |            | 50  |
| lag                                 |                                |            | 51  |
| showinterface(LAG)                  |                                |            | 52  |
| showlacpaggregates(LAG)             |                                |            | 54  |
| showlacpconfiguration               |                                |            | 55  |
| showlacpinterfaces                  |                                |            | 56  |
| showlag                             |                                |            | 59  |
...
AOS-CX 10.12 Link Aggregation Guide | (All Switch Series)

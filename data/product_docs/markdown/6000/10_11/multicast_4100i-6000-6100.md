...
3
AOS-CX10.11MulticastGuide| (4100i,6000,6100SwitchSeries)
...
|                       | ipv6mldquerier                        |           | 83  |
| --------------------- | ------------------------------------- | --------- | --- |
|                       | ipv6mldquerierinterval                |           | 84  |
|                       | ipv6mldlast-member-query-interval     |           | 84  |
|                       | ipv6mldquerierquery-max-response-time |           | 85  |
|                       | ipv6mldrobustness                     |           | 86  |
|                       | ipv6mldstatic-group                   |           | 86  |
|                       | ipv6mldversion                        |           | 87  |
|                       | ipv6mldversionstrict                  |           | 88  |
| Support               | and Other                             | Resources | 89  |
| AccessingArubaSupport |                                       |           | 89  |
| AccessingUpdates      |                                       |           | 90  |
|                       | ArubaSupportPortal                    |           | 90  |
|                       | MyNetworking                          |           | 90  |
| WarrantyInformation   |                                       |           | 90  |
| RegulatoryInformation |                                       |           | 90  |
| DocumentationFeedback |                                       |           | 91  |
5
AOS-CX10.11MulticastGuide| (4100i,6000,6100SwitchSeries)
...
AOS-CX 10.11 Multicast Guide | (4100i, 6000, 6100 Switch Series)
...
Description
ThiscommanddelaystherefreshforsomeIGMPorMLDprotocol-relatedvalues.Whenthiscommand
isenabled,IGMP/MLDlast_reporter value,source,group,orquerieruptime,andthecreate timeand
expiry timevalueswillbeupdatedbasedontheconfiguredtimervalues.Bydefault,thetimervalueis
30seconds.Thiscommandisdisabledbydefault,wherethevalueslistedabovewillbeupdatedfor
everycontrolpacket.BestpracticesistoenablethisfeaturewhenCPUutilizationbytheOVSDBserveris
increasingbecauseofincreasedMGMDoperations.
| Parameter |     |     |     | Description |     |     |
| --------- | --- | --- | --- | ----------- | --- | --- |
timer <value>
Numberofsecondsthetimerwilldelaytheupdate.Range:5-
30.
Example
ConfiguringtheMGMDdelayedrefresh.
| switch(config)# |     | mgmd | delayed-refresh |     | timer 20 |     |
| --------------- | --- | ---- | --------------- | --- | -------- | --- |
DisablingtheMGMDdelayedrefresh.feature:
| switch(config)#     |         | no mgmd | delayed-refresh |                   | timer | 20  |
| ------------------- | ------- | ------- | --------------- | ----------------- | ----- | --- |
| Command History     |         |         |                 |                   |       |     |
| Release             |         |         |                 | Modification      |       |     |
...
| port <IF-NAME> |     |     |     |
| -------------- | --- | --- | --- |
DisplayinformationforaVLAN port.Specifytheportnamein
...
interfaceorVLAN
group <x:x::x:x> [source <x:x::x:x>] ShowMLDgroupinformationforthespecifiedgroup,
groupandinterface,orgroupandvlan.Includetheoptional
source <x:x::x:x>parametertodislaysource
informationforthegroup.
...
additionalparametersapplyadditionalfilters:
n all-vrfs:DisplayMLDstatic-groupinformationforall
VRFs
vrf <vrf-name>:DisplayMLDstatic-groupinformation
n
fortheselectedVRF
statistics DisplayallMLDstatistics,orincludeoneoftheadditional
parametersapplyadditionalfilters:
n all-vrfs:DisplayMLDstatisticsinformationforall
VRFs
n vrf <vrf-name>:DisplayMLDstatisticsinformation
fortheselctedVRF
Examples

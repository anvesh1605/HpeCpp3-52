...
AOS-CX 10.10 Job Scheduler Guide | (4100i, 6xxx, 8xxx, 9300, 10000 Switch Series)
...
| Job Scheduler                       |                                  |           | 9   |
| WorkingwithJobScheduler             |                                  |           | 9   |
|                                     | Porttoggleexample                |           | 9   |
|                                     | Switchrebootexample              |           | 11  |
| JobSchedulercommands                |                                  |           | 12  |
|                                     | job                              |           | 12  |
|                                     | schedule                         |           | 14  |
|                                     | showcapacities(job,schedule)     |           | 17  |
|                                     | showjob                          |           | 18  |
|                                     | showrunning-config(job,schedule) |           | 20  |
|                                     | showschedule                     |           | 22  |
...
4
AOS-CX10.10JobSchedulerGuide| (4100i,6xxx,8xxx,9300,10000SwitchSeries)
...
AOS-CX10.10JobSchedulerGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 11
...
| particularswitch,usecommandshow |     |     | job. |
| ------------------------------- | --- | --- | ---- |
capacities
...
switch(config)#
CreatingajobnamedReboot_sw1thatsavestherunningconfigurationandthenrebootstheswitch:
AOS-CX10.10JobSchedulerGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 13
...
dailyselectsdaily.
AOS-CX10.10JobSchedulerGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 15
...
AOS-CX10.10JobSchedulerGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 17
...
AOS-CX10.10JobSchedulerGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 19
...
Current configuration:
AOS-CX10.10JobSchedulerGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 21
...
| --- | --- | --- | --- | --- | --- | ----------------------------------------------------- | --- |
commandfromtheoperatorcontext(>)only.
AOS-CX10.10JobSchedulerGuide|(4100i,6xxx,8xxx,9300,10000SwitchSeries) 23

...
AOS-CX 10.14.xxxx Network Analytics Engine Guide | (6200, 6300, 6400, 8xxx, 9300, 10000 Switch Series)
...
| Scriptstatus                                       |           |        |           | 33  |
5
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide| (6200,6300,6400,8xxx,9300,10000SwitchSeries)
...
| Using the                                                 | Aruba Solutions | Exchange  | (ASE) | 72  |
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 7
...
| UseCases                              |                           |        |               | 135 |
| Network                               | Analytics                 | Engine | commands      | 138 |
| naecli-authorization                  |                           |        |               | 138 |
| shownae-agent                         |                           |        |               | 139 |
| shownae-agentalerts                   |                           |        |               | 141 |
| shownae-agentalertsdetails            |                           |        |               | 142 |
| shownae-script                        |                           |        |               | 144 |
| uerieshowrunning-config(nae-lite)     |                           |        |               | 145 |
...
| monitorresource                       |                           |        |               | 151 |
| nae-agentlite                         |                           |        |               | 154 |
| nae-agentliteactivate                 |                           |        |               | 155 |
| 2set-conditionmonitor                 |                           |        |               | 156 |
| 5set-conditionwatch                   |                           |        |               | 158 |
| showrunning-confignae-agent           |                           |        |               | 160 |
| tags                                  |                           |        |               | 161 |
| watchevent-log                        |                           |        |               | 162 |
| HTTPS                                 | server commands           |        |               | 164 |
| https-serverauthenticationcertificate |                           |        |               | 164 |
| https-serverauthenticationpassword    |                           |        |               | 165 |
| https-servermax-user-sessions         |                           |        |               | 166 |
| https-serverrestaccess-mode           |                           |        |               | 166 |
| https-serversessioncloseall           |                           |        |               | 167 |
| https-serversession-timeout           |                           |        |               | 168 |
| https-servervrf                       |                           |        |               | 169 |
| showhttps-server                      |                           |        |               | 170 |
| showhttps-serverauthentication        |                           |        |               | 171 |
| showhttps-serverrestimages            |                           |        |               | 172 |
|8

| Support               | and Other          | Resources | 174 |
| --------------------- | ------------------ | --------- | --- |
| AccessingArubaSupport |                    |           | 174 |
| AccessingUpdates      |                    |           | 175 |
|                       | ArubaSupportPortal |           | 175 |
|                       | MyNetworking       |           | 175 |
| WarrantyInformation   |                    |           | 175 |
| RegulatoryInformation |                    |           | 175 |
| DocumentationFeedback |                    |           | 176 |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 9
...
| ------------ | ------- | --- | --- |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 16
...
Thenameoftheagent.
n
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 32
...
Prerequisites
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 46
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 63
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 65
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 67
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 69
...
UsingtheArubaSolutionsExchange(ASE)|73
...
Using the Aruba Solutions Exchange (ASE) | 75
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 84
...
high_threshold_factor=2,
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 96
...
Example:
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 102
...
| -------------------- | --- | --- | --------------- | -------- | ------- | --- |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 108
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 114
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 118
...
|     | <tr align="center"> |     |     |     |     |
| --- | ------------------- | --- | --- | --- | --- |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 124
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 135
...
| --------- | ---- | ------------ | --- | --- | -------- | --- | --- | --- |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 137
...
Usage
TheoutputofthiscommandshowsthefollowinginformationabouttheArubaNetworkAnalytics
Engineagentsthatareconfiguredandenabledontheswitch:
| Parameter  | Description                                     |     |
| ---------- | ----------------------------------------------- | --- |
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 140
...
switch#
|     | show nae-agent |     | memory_monitor |     | alerts |
| --- | -------------- | --- | -------------- | --- | ------ |
...
theWebUI.
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 142
...
The script syntax and components (manifest, parameters, monitor, condition, and action) are in
...
8360
8400
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 146
...
| 10.09                     |     |            | Commandintroduced |
| Command Information       |     |            |                   |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 150
...
|     | monitor | sys_cpu | resource system | cpu vsf member | 1   |
| --- | ------- | ------- | --------------- | -------------- | --- |
...
8320,8325,8360,and9300SwitchSeries):
...
| 10.09   |     | Commandintroduced |     |     |     |
Command Information
NetworkAnalyticsEngineLitecommands|153
...
| Release         |     |           | Modification      |     |
| 10.09           |     |           | Commandintroduced |     |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 154
...
| --------- | --- | ----------- | --- | --- | --- |
n transition
<DURATION> Specifiesthetimeduration.Thedefinedtimedurationare:
...
count <COUNT>
Limitsthenumberoftimesthattheconditiontobemet
...
| 10.09   |     |             |     |     |     | Commandintroduced |     |     |     |
| Command |     | Information |     |     |     |                   |     |     |     |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 160
...
| Release         |     |     |     | Modification      |     |     |
| 10.09           |     |     |     | Commandintroduced |     |     |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 162
...
ontheswitch.
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 166
...
| --------------- | ------- | ------------ | --- | --------------- | --- | --- |
| Command         | History |              |     |                 |     |     |
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 168
...
Bydefault,Aruba8100,8320,8325,8360,8400,9300,and10000SwitchSerieshaveanHTTPSserver
enabledonthemgmtVRF.
Bydefault,theAruba6200,6300,and6400SwitchSerieshaveanHTTPSserverenabledonthemgmt
VRFandonthedefaultVRF.
...
| --------------- | ------------ | --- | -------- |
| switch(config)# | https-server | vrf | vrfprogs |
TheAruba6200switchessupportonlytwoVRFs.OnemanagementVRFandonedefaultVRF.Youcannotadd
anotherVRF.
| Command History     |         |         |              |
| ------------------- | ------- | ------- | ------------ |
| Release             |         |         | Modification |
...
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 170
...
| --------- | --- | --- | ----------- |
images
Showsfirmwareimagelocation.
AOS-CX10.14.xxxxNetworkAnalyticsEngineGuide|(6200,6300,6400,8xxx,9300,10000SwitchSeries) 172

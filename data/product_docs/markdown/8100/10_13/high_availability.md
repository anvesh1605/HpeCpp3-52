...
AOS-CX 10.13 High Availability Guide | (4100i, 6200, 6300, 6400, 8xxx, 9300, 10000 Switch Series)
...
|                                            | clearbfdstatistics                          | 40  |
|                                            | ipospfbfd                                   | 41  |
|                                            | ipospfbfddisable                            | 42  |
|                                            | iproutebfd                                  | 42  |
|                                            | ipv6ospfv3bfd                               | 44  |
|                                            | ipv6ospfv3bfddisable                        | 44  |
|                                            | neighborfall-overbfd(context:config-router) | 45  |
|                                            | showbfd                                     | 46  |
|                                            | showbfdinterface                            | 49  |
|                                            | showhsc                                     | 51  |
5
AOS-CX10.13HighAvailabilityGuide| (4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries)

| ERPS                               |                                             |     | 53  |
| ---------------------------------- | ------------------------------------------- | --- | --- |
| Limitations,Conflicts,orExclusions |                                             |     | 54  |
| ERPSCommands                       |                                             |     | 55  |
|                                    | clearerpsring<RINGID>instance<ID>           |     | 55  |
|                                    | clearerpsstatistics                         |     | 56  |
|                                    | erpsring                                    |     | 57  |
|                                    | erpsring<RINGID><port0|port1>interface      |     | 58  |
|                                    | erpsring<RINGID>description                 |     | 59  |
|                                    | erpsring<RINGID>guard-interval              |     | 60  |
|                                    | erpsring<RINGID>hold-off-interval           |     | 61  |
|                                    | erpsring<RINGID>instance                    |     | 62  |
|                                    | erpsring<RINGID>instance<ID>control-vlan    |     | 63  |
|                                    | erpsring<RINGID>instance<ID>description     |     | 64  |
|                                    | erpsring<RINGID>instance<ID>enable          |     | 65  |
|                                    | erpsring<RINGID>instance<ID>protected-vlans |     | 66  |
erpsring<RINGID>instance<ID>protection-switch{{manual|force}
|                       | <PORT0>|<PORT1>}                      |           | 67  |
| --------------------- | ------------------------------------- | --------- | --- |
|                       | erpsring<RINGID>instance<ID>revertive |           | 69  |
|                       | erpsring<RINGID>instance<ID>role      |           | 70  |
|                       | erpsring<RINGID>instance<ID>rpl       |           | 71  |
|                       | erpsring<RINGID>meg-level             |           | 72  |
|                       | erpsring<RINGID>parent-ring           |           | 73  |
|                       | erpsring<RINGID>sub-ring              |           | 74  |
|                       | erpsring<RINGID>tcn-propogation       |           | 75  |
|                       | erpsring<RINGID>transmission-interval |           | 76  |
|                       | erpsring<RINGID>wtr-interval          |           | 77  |
|                       | showerpsstatistics                    |           | 78  |
|                       | showerpsstatus                        |           | 80  |
|                       | showerpssummary                       |           | 82  |
...
interface.
Configuringthetimerstobetooaggressive(forexample,detect-multiplierof1)cansometimes
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 20
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 22
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 24
...
| ----------- | --- | --- | --- | --- | -------- | ---- | --- | --- | --- | --- | --- |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 26
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 28
...
| ------------------ | --- | ------ | --- |
bfd all-interfaces
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 30
...
| 10.07orearlier |     | --           |     |
Command Information
| Platfor Command                 | context |     | Authorit  |
| ------------------------------- | ------- | --- | --------- |
| ms                              |         |     | y         |
...
bfd disable
Description
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 32
...
| ---------------- | ------- | --- | --- |
| bfd echo disable |         |     |     |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 34
...
| 6400 |     |     | rightsforthiscommand. |     |
| ---- | --- | --- | --------------------- | --- |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 36
...
| 10.07orearlier      |     |                             | --           |     |
| Command Information |     |                             |              |     |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 38
...
| ------- | ------- | -------------- | --- | --------- | --- |
| Command | History |                |     |           |     |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 40
...
Description
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 42
...
| --------- | --- | --- | --- | ----------- |
<DEST-IPV4-ADDR>
SpecifiesaroutedestinationinIPv4format(x.x.x.x),wherexisa
decimalnumberfrom0to255.
...
Onthe6400SwitchSeries,interfaceidentificationdiffers.
EnablingBFDoninterface1/1/1:
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 44
...
Init
n
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 46
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 48
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 50
...
9300
10000
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 52
...
| ---- | --- | --- | --------------------- |
6300
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 57
...
| 10.07orearlier             |             |      | --             |     |
| Command                    | Information |      |                |     |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 59
...
| Release                     |         |      |      | Modification         |     |
| 10.07orearlier              |         |      |      | --                   |     |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 61
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 63
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 65
...
ringinstance.
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 67
...
| Release                            |         |      |          | Modification |
| 10.07orearlier                     |         |      |          | --           |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 69
...
<ID>
Required,specifiestheERPSringinstanceidentifier.Range:1-2.
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 71
...
| erps ring   | <RINGID> |          |             |     |     |
| parent-ring |          | <RINGID> |             |     |     |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 73
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 75
...
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 77
...
| FS             | 0/0          |     | 0/0          |
| Command        | History      |     |              |
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 79
...
=================================
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 81
...
9300
10000
AOS-CX10.13HighAvailabilityGuide|(4100i,6200,6300,6400,8xxx,9300,10000SwitchSeries) 83

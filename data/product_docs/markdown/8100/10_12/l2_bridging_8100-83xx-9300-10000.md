...
|                                     | description                                   | 43  |
3
AOS-CX10.12Layer-2BridgingGuide| 8100,83xx,9300,10000SwitchSeries
...
| MVRP                               |                                       |       | 93  |
| ---------------------------------- | ------------------------------------- | ----- | --- |
| MVRPfunctionalityandlimitations    |                                       |       | 93  |
| MRPmessages                        |                                       |       | 94  |
|                                    | Joinmessage                           |       | 94  |
|                                    | Newmessage                            |       | 94  |
|                                    | Leavemessage                          |       | 95  |
...
|                                    | mvrp                                  |       | 108 |
|                                    | mvrpregistration                      |       | 109 |
|                                    | mvrptimer                             |       | 110 |
|                                    | showmvrpconfig                        |       | 111 |
|                                    | showmvrpstate                         |       | 111 |
|                                    | showmvrpstatistics                    |       | 112 |
| Spanning                           | tree protocols                        | (STP) | 115 |
| Protocolsandfeaturedetails         |                                       |       | 115 |
| STP                                |                                       |       | 115 |
|                                    | Rootbridge                            |       | 115 |
|                                    | Rootport                              |       | 115 |
|                                    | Designatedbridgeanddesignatedport     |       | 115 |
|                                    | Pathcost                              |       | 116 |
|                                    | STPtimers                             |       | 116 |
|                                    | BPDUforwardingmechanism               |       | 117 |
|                                    | STPprotocolpackets                    |       | 117 |
|                                    | Comparingspanningtreeoptions          |       | 118 |
|                                    | Preparingforspanningtreeconfiguration |       | 118 |
|                                    | STPcostcalculation                    |       | 119 |
|                                    | Simplifiedcalculationoverview         |       | 119 |
|                                    | Calculationexample                    |       | 120 |
| STPsupportedplatformsandscale      |                                       |       | 125 |
|                                    | Scale                                 |       | 125 |
| MSTPprotocolandfeaturedetails      |                                       |       | 125 |
|                                    | MSTPkeyconcepts                       |       | 126 |
| MSTPconfigurationtasks             |                                       |       | 129 |
| MSTPconsiderationsandbestpractices |                                       |       | 130 |
| MSTPusecases                       |                                       |       | 131 |
|                                    | MSTPusecase:Preventingloops           |       | 131 |
|                                    | MSTPusecase:Deterministicrootbridges  |       | 134 |
|                                    | SwitchAconfiguration                  |       | 135 |
|                                    | SwitchBconfiguration                  |       | 135 |
|                                    | SwitchCandDconfiguration              |       | 136 |
|                                    | Checkingtheconfiguration              |       | 136 |
|                                    | Observeportbehaviorandstate           |       | 137 |
|                                    | MSTPusecase:BPDUprotection            |       | 139 |
|                                    | MSTPusecase:Rootprotection            |       | 141 |
|                                    | MSTPusecase:Spanningtreeonedgeports   |       | 144 |
| MSTPcommands                       |                                       |       | 147 |
|                                    | clearspanning-treestatistics          |       | 147 |
|                                    | showspanning-tree                     |       | 147 |
|                                    | showspanning-treedetail               |       | 148 |
|                                    | showspanning-treeinconsistent-ports   |       | 150 |
5
AOS-CX10.12Layer-2BridgingGuide| 8100,83xx,9300,10000SwitchSeries
...
|                                   | showcapacities-statusrpvst              |           | 215 |
| --------------------------------- | --------------------------------------- | --------- | --- |
|                                   | showspanning-tree                       |           | 215 |
|                                   | showspanning-treedetail                 |           | 217 |
|                                   | showspanning-treeinconsistent-ports     |           | 218 |
|                                   | showspanning-treesummaryport            |           | 219 |
|                                   | showspanning-treesummaryroot            |           | 220 |
|                                   | showspanning-treevlan                   |           | 221 |
|                                   | showspanning-treevlandetail             |           | 222 |
|                                   | spanning-treebpdu-guardtimeout          |           | 224 |
|                                   | spanning-treeextend-system-id           |           | 225 |
|                                   | spanning-treeignore-pvid-inconsistency  |           | 225 |
|                                   | spanning-treelink-type                  |           | 227 |
...
|                                   | udldretries                             |           | 249 |
| Private                           | VLAN                                    |           | 250 |
| PrivateVLANcommands               |                                         |           | 255 |
|                                   | diag-dumpprivate-vlanbasic              |           | 255 |
|                                   | private-vlan                            |           | 256 |
|                                   | private-vlanport-type                   |           | 257 |
|                                   | showcapacitiesprivate-vlan              |           | 259 |
|                                   | showcapacities-statusprivate-vlan       |           | 259 |
|                                   | showprivate-vlan                        |           | 260 |
|                                   | showprivate-vlanassociation             |           | 261 |
|                                   | showprivate-vlaninconsistency           |           | 262 |
|                                   | showprivate-vlanport-type               |           | 264 |
|                                   | showrunning-configurationprivate-vlan   |           | 265 |
|                                   | showtechprivate-vlan                    |           | 266 |
...
AOS-CX 10.12 Layer-2 Bridging Guide | 8100, 83xx, 9300, 10000 Switch Series
...
Spanning tree protocols (STP) | 192
...
Spanning tree protocols (STP) | 198
...
The Root and Secondary root are typically placed at the Core of the Layer 2 domain. Figure 19,
Deterministic root bridges (physical) shows the physical topology and Figure 20, Deterministic root
bridges (logical) shows the logical topology. Switch A and Switch B are the core/center of the Layer 2
domain, and they provide root redundancy for each other.

Figure 19 Deterministic root bridges (physical)
...
Spanning tree protocols (STP) | 236
...
Limit with VSF:ThenumberofphysicalportsallowedtobePVLANsecondaryportsfromeachVSF
n
...
inconsistency command displays VLANs that are disabled by PVLAN in case of
...
Configurations are only applicable to primary VLAN SVIs and are applied internally on all
...
In case of any PVLAN inconsistencies, all authenticated clients on that port would move to

unauthorized state. The clients are reauthorized once the inconsistency is removed on that
...
PVLAN agnostic. PVLAN and port-type can be configured in port-security enabled ports.

Radius VSA

VSA ID: 64 is added as a new authorization parameter for Aruba-PVLAN-Port-Type.
...
PVLANporttypeforarolewhenintheconfig-pa-rolecontext.MultiplesecondaryVLANsassociated
withthesameprimaryVLANcannotbetaggedunderasecondaryport.
...
| --------- | --- | ------- | --- | ------- | --------- | --- | --- | --- |
8100 config-if Administratorsorlocalusergroupmemberswithexecutionrights
| 8325 |     | config-pa-role |     |     | forthiscommand. |     |     |     |
| ---- | --- | -------------- | --- | --- | --------------- | --- | --- | --- |
8360
10000

...
AOS-CX 10.14 Event Log Message Reference Guide | (All Switch Series)
...
| Console                             | events     |            |        |            |        |        |              | 61  |
5
AOS-CX10.14EventLogMessageReferenceGuide| (AllSwitchSeries)
...
| Injected      | Views       |               |           |               |            |        | 148 |
| In-System     |             | Programming   |           |               | events     |        | 149 |
| Interface     |             | and           | Interface |               | Diagnostic | events | 152 |
| Internal      | storage     |               | events    |               |            |        | 155 |
| IP Flow       | Information |               |           | Export        | events     |        | 156 |
| IP Flow       | Monitoring  |               |           | Advertisement |            | events | 157 |
| IP source     |             | lockdown      |           | events        |            |        | 159 |
| IP tunnels    |             | events        |           |               |            |        | 161 |
| IP-SLA        | events      |               |           |               |            |        | 165 |
| IPSec         | tunnel      | offload       |           | events        |            |        | 167 |
| IPv6 Router   |             | Advertisement |           |               | events     |        | 168 |
| IRDP          | events      |               |           |               |            |        | 173 |
| ISSU          | events      |               |           |               |            |        | 174 |
| Job scheduler |             |               | events    |               |            |        | 177 |
| L3 Encap      |             | capacity      |           | events        |            |        | 178 |
| L3 Resource   |             | Manager       |           |               | events     |        | 179 |
| LACP          | events      |               |           |               |            |        | 181 |
| LAG events    |             |               |           |               |            |        | 187 |
| Launch        | Daemon      |               | (LaunchD) |               | events     |        | 190 |
| Layer         | 3 Interface |               |           | events        |            |        | 191 |
| LED events    |             |               |           |               |            |        | 198 |
| LLDP          | events      |               |           |               |            |        | 199 |
| Loop          | Protect     | events        |           |               |            |        | 202 |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 7

| Loopback    |          | events     |         |               |        |        |        | 205 |
| ----------- | -------- | ---------- | ------- | ------------- | ------ | ------ | ------ | --- |
| MAC         | address  | management |         |               | events |        |        | 206 |
| MAC         | Address  | mode       |         | configuration |        | events |        | 208 |
| MAC         | Learning |            | events  |               |        |        |        | 209 |
| MACsec      | events   |            |         |               |        |        |        | 211 |
| Management  |          | events     |         |               |        |        |        | 214 |
| MDNS        | events   |            |         |               |        |        |        | 215 |
| MGMD        | events   |            |         |               |        |        |        | 216 |
| Mirroring   |          | events     |         |               |        |        |        | 222 |
| Module      | events   |            |         |               |        |        |        | 224 |
| MPLS        | events   |            |         |               |        |        |        | 233 |
| MSDP        | events   |            |         |               |        |        |        | 234 |
| Message     | Session  |            | Relay   | Protocol      |        | events |        | 236 |
| Multicast   |          | HelperD    | events  |               |        |        |        | 239 |
| Multicast   |          | Traffic    | Manager |               | events |        |        | 242 |
| Message     | Session  |            | Relay   | Protocol      |        | (MSRP) | events | 243 |
| MVRP        | events   |            |         |               |        |        |        | 247 |
| NAE         | Agents   | events     |         |               |        |        |        | 249 |
| NAE         | events   |            |         |               |        |        |        | 250 |
| NAE         | script   | generation |         | events        |        |        |        | 253 |
| NAE         | Scripts  | events     |         |               |        |        |        | 254 |
| ND snooping |          | events     |         |               |        |        |        | 257 |
| NDM         | events   |            |         |               |        |        |        | 259 |
| NTP         | events   |            |         |               |        |        |        | 266 |
| OSPFv2      | events   |            |         |               |        |        |        | 268 |
| OSPFv3      | events   |            |         |               |        |        |        | 271 |
| Packet      | capture  |            | events  |               |        |        |        | 272 |
|8

| Password    |            | Reset             | events   |        |               |        | 276 |
| ----------- | ---------- | ----------------- | -------- | ------ | ------------- | ------ | --- |
| PIM         | events     |                   |          |        |               |        | 277 |
| Policies    | events     |                   |          |        |               |        | 284 |
| Port        | access     | events            |          |        |               |        | 285 |
| Port        | access     | application-based |          |        | policy events |        | 293 |
| Port        | access     | group             | based    | policy | events        |        | 294 |
| Port        | access     | roles             | events   |        |               |        | 296 |
| Port        | events     |                   |          |        |               |        | 297 |
| Port        | security   | events            |          |        |               |        | 299 |
| Port        | Statistics | events            |          |        |               |        | 300 |
| Power       | events     |                   |          |        |               |        | 301 |
| Power       | over       | Ethernet          | events   |        |               |        | 306 |
| PTP events  |            |                   |          |        |               |        | 315 |
| Proxy       | ARP        | events            |          |        |               |        | 320 |
| QoS         | ASIC       | Provider          | events   |        |               |        | 321 |
| Quality     | of         | Service           | events   |        |               |        | 323 |
| Queue       | Monitoring |                   | events   |        |               |        | 323 |
| Rapid       | per        | VLAN              | Spanning | Tree   | Protocol      | events | 325 |
| RBAC        | events     |                   |          |        |               |        | 329 |
| Redundant   |            | Management        |          | events |               |        | 330 |
| Replication |            | Manager           | events   |        |               |        | 332 |
| REST        | events     |                   |          |        |               |        | 333 |
| Self Test   |            | events            |          |        |               |        | 345 |
| Self Test   |            | Monitor           | events   |        |               |        | 346 |
| sFlow       | events     |                   |          |        |               |        | 347 |
| SFTP        | Client     | events            |          |        |               |        | 354 |
| Smartlink   |            | events            |          |        |               |        | 355 |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 9

| SNMP           | events     |         |           |           |              | 356 |
| -------------- | ---------- | ------- | --------- | --------- | ------------ | --- |
| SSH client     |            | events  |           |           |              | 359 |
| SSH server     |            | events  |           |           |              | 360 |
| Supportability |            |         | events    |           |              | 365 |
| SYS events     |            |         |           |           |              | 372 |
| SYSMON         |            | events  |           |           |              | 375 |
| TCAM           | events     |         |           |           |              | 377 |
| Telnet         | server     |         | events    |           |              | 381 |
| Temperature    |            |         | events    |           |              | 384 |
| Time           | management |         |           | events    |              | 387 |
| TPM            | events     |         |           |           |              | 388 |
| Traffic        | Insight    |         | events    |           |              | 389 |
| Transceiver    |            |         | events    |           |              | 391 |
| UDLD           | events     |         |           |           |              | 395 |
| UDP            | Broadcast  |         | Forwarder |           | events       | 397 |
| UFD            | events     |         |           |           |              | 398 |
| User           | management |         |           | events    |              | 399 |
| User-based     |            | tunnels |           | events    |              | 401 |
| Virtual        | Switching  |         |           | Extension | (VSX) events | 409 |
| Virtual        | Switching  |         |           | Framework | (VSF) events | 417 |
| VLAN           | events     |         |           |           |              | 429 |
| VLAN           | Interface  |         | events    |           |              | 435 |
| VRF events     |            |         |           |           |              | 436 |
| VRF Manager    |            |         | events    |           |              | 437 |
| VRRP           | events     |         |           |           |              | 438 |
| VSX Sync       |            | events  |           |           |              | 445 |
| VXLAN          | agent      |         | events    |           |              | 446 |
|10

| VXLAN                              | events             |           | 447 |
| ---------------------------------- | ------------------ | --------- | --- |
| Zero                               | touch provisioning | events    | 452 |
| Support                            | and Other          | Resources | 458 |
| AccessingHPEArubaNetworkingSupport |                    |           | 458 |
| AccessingUpdates                   |                    |           | 459 |
| Warrantyinformation                |                    |           | 459 |
| RegulatoryInformation              |                    |           | 459 |
| Documentationfeedback              |                    |           | 459 |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 11
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 16
...
| Category | BFD          |          |             |            |               |
| Severity | Warning      |          |             |            |               |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 33
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 35
...
name>
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 38
...
| Event ID: 15304 |                                                   |     |     |     |
Message
PIMBidi{state}onInterface{if_name}
| Category | BidirectionalPIM |     |     |     |
| -------- | ---------------- | --- | --- | --- |
| Severity | Information      |     |     |     |
Description
ThislogeventinformsaboutPIMBidistateoninterface
| Event ID: 15305 |     |     |     |     |
| --------------- | --- | --- | --- | --- |
41
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries)
...
Aruba Activate server {activate_address} is reachable via VRF {vrf}.
...
Received certificate from Aruba Activate server, processing with certificate manager.
...
Aruba Activate server sent a CA certificate to be installed.

Event ID: 14603

Message

Aruba Central location {central_location} successfully fetched from {central_source} via
...
Unable to fetch Aruba Central location {central_location} from {central_source} via VRF
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 54
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 56
...
| Event ID: | 11805 |     |     |     |     |
| --------- | ----- | --- | --- | --- | --- |
Message Endpointhasbeenexecutedforcontainer{name}withnoparameters.
63
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries)
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 68
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 78
...
Event ID: 8215
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 81
...
| -------- | -------------- | --- | --- |
| Severity | Information    |     |     |
Description LogeventwhenaclientreceivesIPv6addressfromDHCPserveralongwithstatic
attributes
Event ID: 8319
| Message     | Client{mac}onvlan{vid},port{port}released{client_ip}. |     |     |
| ----------- | ----------------------------------------------------- | --- | --- |
| Category    | DHCPv6snooping                                        |     |     |
| Severity    | Information                                           |     |     |
| Description | LogeventwhenaclientreleasesIPv6address.               |     |     |
DHCPv6snoopingevents|88
...
| Severity |     | Warning             |     |     |     |
Description
Logeventthatindicatesthechassisrequiresareboot.
| Event ID: | 13902 |     |     |     |     |
| --------- | ----- | --- | --- | --- | --- |
...
Event ID: 8515
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 104
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 116
...
Event ID: 4408
Message
User{user}:hot-patch"{hotpatch_name}"downloadedvia{dnld_type}from{host
| Category | FirmwareUpdate |     |     |
| -------- | -------------- | --- | --- |
| Severity | Information    |     |     |
Description
Indicatesthatahot-patchimagewasdownloadedsuccesfullyfromaremotesour
Event ID: 4409
Message User{user}:hot-patch"{hotpatch_name}"downloadedvia{dnld_type}.
| Category | FirmwareUpdate |     |     |
| -------- | -------------- | --- | --- |
| Severity | Information    |     |     |
Description Indicatesthatahot-patchimagewasdownloadedsuccesfullyfromalocalsource
Event ID: 4410
...
Event ID: 13903
| Message     | EventreportedwhenFQTSSreceiveddeallocrequest |     |     |     |
| ----------- | -------------------------------------------- | --- | --- | --- |
| Category    | FQTSS                                        |     |     |     |
| Severity    | Warning                                      |     |     |     |
| Description | EventreportedwhenFQTSSreceiveddeallocrequest |     |     |     |
Event ID: 13904
Message Resource{request_type}requested:{streamid}stream_meter{stream_meter_id}port_
...
| Severity | Information |     |     |     |
Description
Eventreportedwhenstreamisrequestingforhardwareresource
Event ID: 13905
Message Stream{streamid}port{port_name}request_type{req_type}responsestream_status
...
| Severity | Information |     |     |     |
Description
Eventreportedwhenstreamreceivedaresponsefromthehardware
129
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries)
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 139
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 142
...
| Message | Hot-patch | {patch_name} | failed | to download' |
| ------- | --------- | ------------ | ------ | ------------ |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 144
...
Event ID: 7218
In-SystemProgrammingevents|150
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 151
...
Event ID: 410
InterfaceandInterfaceDiagnosticevents|153
...
| Severity | Information      |     |     |     |
Description
LogeventthatindicatesglobalconfigurationforFlowTrackingfeature
Event ID: 15102
...
Event ID: 15103
Message
BULKSYNCeventreceivedfromlinecard{node_id}
| Category | IPFlowMonitoring |     |     |     |
| -------- | ---------------- | --- | --- | --- |
| Severity | Information      |     |     |     |
Description
...
IP Flow Monitoring Advertisement events | 158
...
| ------- | ---------- | ------ | --------------- | ---------------- |
IPv6RouterAdvertisementevents|169
...
| -------- | ----------------------- | ------------- | ------------ | ------ |
| Category | IPv6RouterAdvertisement |               |              |        |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 170
...
IPv6RouterAdvertisementevents|171
...
| Event ID: 11504 |                                             |     |          |               |                 |     |
Message
OverlayECMProute{prefix}hasbeenprogrammedasasingleroute.
| Category | L3ResourceManager |     |     |     |     |     |
| -------- | ----------------- | --- | --- | --- | --- | --- |
| Severity | Information       |     |     |     |     |     |
...
L3 Resource Manager events | 180
...
incomplete
Event ID: 1315
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 183
...
Event ID: 1325
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 185
...
| Description | LogsthatcaputreLACPGracefulShutforLAGinterface |                   |
Event ID: 1326
Message Interface{intf_id}enabledbyfallback-staticforlag{lag_id}
| Category | LACP        |     |
| -------- | ----------- | --- |
| Severity | Information |     |
Description
...
Event ID: 1327
Message
Interface{intf_id}disabledbyfallback-staticforlag{lag_id}
| Category    | LACP                                        |     |
| ----------- | ------------------------------------------- | --- |
| Severity    | Information                                 |     |
| Description | Logwheninterfaceisdisabledbyfallback-static |     |
Event ID: 1328
Message Interface{intf_id}lag{lag_id}blockedaslinkpartnersonvsxprimaryandsecondary
mismatch
| Category | LACP        |     |
| -------- | ----------- | --- |
| Severity | Information |     |
Description Logwheninterfaceisblockedduetomismatchingpartneronthevsxinterface
LACPevents|186
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 189
...
interface.
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 201
...
MACaddressmanagementevents|207
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 213
...
errors.
Event ID: 2615
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 218
...
| Event ID:   | 15503                                |     |     |     |     |     |
Message
MSRPisactiveonport{port}
| Category | MessageSessionRelayProtocol |     |     |     |     |     |
| -------- | --------------------------- | --- | --- | --- | --- | --- |
| Severity | Information                 |     |     |     |     |     |
Description
EventreportedwhenMSRPbecomesactiveonport
| Event ID:   | 15504                                      |     |     |     |     |     |
| ----------- | ------------------------------------------ | --- | --- | --- | --- | --- |
...
Message Session Relay Protocol events | 237
...
| Severity |     | Information      |     |     |     |
Description
Eventraisedwhenvxlanreplicationmodeisconfiguredorapplied
| Event ID: | 15902 |     |     |     |     |
| --------- | ----- | --- | --- | --- | --- |
...
| --------- | ----- | --- | --- | --- | --- |
Message
Underlaymulticastvxlanreplicationforvni{vni_id}floodgroupipissetto{flood_group_
...
| --------- | ----- | --- | --- | --- | --- |
Message
Underlaymulticastvxlanreplicationtunnel{encap_type}pim_bidirstateforfloodgroup
...
MessageSessionRelayProtocol(MSRP) events|244
...
| ------- | ----------- | --------- | ------- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 245
...
MessageSessionRelayProtocol(MSRP) events|246
...
| Severity    | Debug                                       |            |
| Description | LogeventwheninstantiatedfromactiveNAEagent. |            |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 256
...
Description Logeventwhenaspecificdynamicbindingentryonavlaniscleared.
Event ID: 8405
Message ND packet of type=<type> received on port:<port> vlan:<vlan> with
257
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries)
...
| ------- | ---------- | -------- | --------- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 261
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 263
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 265
...
| -------- | --------- | -------- | --- |
| Category | PIM       |          |     |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 279
...
| Category | PIM |     |     |
| -------- | --- | --- | --- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 281
...
Port access group based policy events | 295
...
| -------- | ---------- | --------- | ----------------- | ----- |
| Category | Power      |           |                   |       |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 303
...
| ----------- | ------------------------------ | --- |
| Severity    | Info                           |     |
| Description | LogPSUfaulteventinpreviousboot |     |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 305
...
| -------- | ----------------- | ----- | --- | --- |
| Category | PoweroverEthernet |       |     |     |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 312
...
Power over Ethernet events | 313
...
Event ID: 12115
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 317
...
Event ID: 12119
Message PTPoffsethasreachedbeyondthethreshold{low_limit}<{curr_offset}<{high_limit}
| Category | PTP     |     |     |     |     |     |
| -------- | ------- | --- | --- | --- | --- | --- |
| Severity | Warning |     |     |     |     |     |
Description EventreportedifPTPoffsetgoesbeyondthethresholdvalue.
Event ID: 12120
...
| --------- | ---- | --- | --- | --- | --- |
Message
QoSwarning:{warning_string}
Category QualityofService
Severity Warning
Description
Logswarningeventwhenthreshold-profileisenabledonportandifportotherthan
...
Rapid per VLAN Spanning Tree Protocol events | 326
...
Rapid per VLAN Spanning Tree Protocol events | 328
...
| ------- | -------------- | ----- | --- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 335
...
| -------- | ---------- | ---------- | ------------ | --------------- |
| Category | REST       |            |              |                 |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 337
...
Event ID: 4648
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 341
...
| Severity |     | Emergency       |     |     |     |
Description
LogswhenafailureisreportedbytheFIPSPOSTservice.
| Event ID: | 16002 |                                            |     |     |     |
| --------- | ----- | ------------------------------------------ | --- | --- | --- |
...
| --------- | ----- | --- | --- | --- | --- |
Message
Thecryptographicself-testmonitorhasdetectedareportedtestfailure.Theself-test
...
| -------- | ------------- | ------ | --------- | --------------- |
| Category | sFlow         |        |           |                 |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 349
...
Event ID: 1026
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 351
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 353
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 358
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 367
...
| --- | -------------- | --------- | --- | --- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 369
...
| Category    | Supportability             |          |                       |     |
| Severity    | Information                |          |                       |     |
| Description | Logsrebootcountinformation |          |                       |     |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 371
...
Detected DDR errors during uboot BIST, module {module} reported
{error_sbe}
...
| -------- | ------------- | --------- | --------- | ---------- | --- |
| Category | TCAM          |           |           |            |     |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 379
...
Event ID: 9715
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 403
...
| ------- | ---------- | ---------- | -------- | -------------- | --- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 405
...
Event ID: 9735
Message Operational state of <zone> zone is DOWN due to <reason>.
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 407
...
VirtualSwitchingExtension(VSX)events|410
...
| ------- | --------------- | ------ | ---------- | ---------- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 411
...
| ------- | --------------- | ------------- | ----- | ----------- |
VirtualSwitchingExtension(VSX)events|412
...
| -------- | ------------------------------ | ------- | --- |
| Category | VirtualSwitchingExtension(VSX) |         |     |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 413
...
| -------- | ------------------------------ | ----- | ------------------------------- |
| Category | VirtualSwitchingExtension(VSX) |       |                                 |
VirtualSwitchingExtension(VSX)events|414
...
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 415
...
VirtualSwitchingExtension(VSX)events|416
...
VirtualSwitchingFramework(VSF)events|418
...
| --- | ------- | --------------- | --- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 419
...
| ------- | -------- | ------------ | --- | --- |
VirtualSwitchingFramework(VSF)events|420
...
| -------- | ------------------------------ | --------- | ----------- | ----------- |
| Category | VirtualSwitchingFramework(VSF) |           |             |             |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 421
...
VirtualSwitchingFramework(VSF)events|422
...
interface
Event ID: 9939
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 423
...
Switch with mac <mac_address> failed to autojoin on link <link>, port
<port>
...
Event ID: 9948
Message Interface <port_id> in VSF link <link> detected a peer with
|          | inconsistent                   | VSF link | configuration |     |     |     |
| -------- | ------------------------------ | -------- | ------------- | --- | --- | --- |
| Category | VirtualSwitchingFramework(VSF) |          |               |     |     |     |
| Severity | Warning                        |          |               |     |     |     |
Description logeventwheninterfaceisininconsistentlinkconfigurationerror
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 425
...
Virtual Switching Framework (VSF) events | 426
...
Virtual Switching Framework (VSF) events | 428
...
Event ID: 2115
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 431
...
Event ID: 3725
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 442
...
Zero touch provisioning events | 453
...
| ------- | ------------- | -------- | --------------------- |
AOS-CX10.14EventLogMessageReferenceGuide|(AllSwitchSeries) 454
...
| -------- | --------------------- | ---------------- | ------ | ------------ | --- |
| Category | Zerotouchprovisioning |                  |        |              |     |
Zerotouchprovisioningevents|455
...
Logs related to ztp configurations - Aruba Central FQDN or IPv4 not provided
...
Zero touch provisioning events | 457

...
|                                      | GETmethod                           |             |          | 12  |
|                                      | Resourcecollections                 |             |          | 12  |
| RESTAPIaccessmodes                   |                                     |             |          | 12  |
|                                      | Read-writeaccessmode                |             |          | 12  |
|                                      | Read-onlyaccessmode                 |             |          | 13  |
| RESTAPIURI                           |                                     |             |          | 13  |
|                                      | PartsofaURI                         |             |          | 13  |
|                                      | URIpath,includingpathparameters     |             |          | 13  |
|                                      | Querycomponent                      |             |          | 14  |
| Resources                            |                                     |             |          | 14  |
|                                      | Resourcecollectionsandsingletons    |             |          | 15  |
|                                      | Collections                         |             |          | 15  |
|                                      | Subcollections                      |             |          | 15  |
|                                      | Singletons                          |             |          | 16  |
|                                      | Categoriesofresourceattributes      |             |          | 16  |
|                                      | Configurationattributes             |             |          | 16  |
|                                      | Writableattributes                  |             |          | 16  |
|                                      | Statusattributes                    |             |          | 16  |
|                                      | Statisticsattributes                |             |          | 16  |
|                                      | Attributecategoriesmightvary        |             |          | 17  |
| Enabling                             | Access                              | to the REST | API      | 18  |
| Settingtheadminpassword              |                                     |             |          | 18  |
| ShowingtheRESTAPIaccessconfiguration |                                     |             |          | 19  |
| DisablingaccesstotheRESTAPI          |                                     |             |          | 19  |
| HTTPSservercommands                  |                                     |             |          | 20  |
...
|                                      | showhttps-server                    |             |          | 24  |
3
AOS-CX10.08RESTAPIGuide| (4100i,6xxx,8xxxSwitchSeries)
...
| ----------------------------------------------------- | -------------------------------------- | --- | --- |
| Partsofasubscribemessage                              |                                        |     | 78  |
|                                                       | Subscribemessageexample                |     | 78  |
|                                                       | Componentsofasubscribemessage          |     | 78  |
| Partsofasubscriptionsuccessmessage                    |                                        |     | 78  |
|                                                       | Examplesuccessmessage                  |     | 79  |
|                                                       | Componentsofsubscriptionsuccessmessage |     | 79  |
|                                                       | Componentsofatopic                     |     | 79  |
| Partsofanotificationmessage                           |                                        |     | 80  |
|                                                       | Notificationmessageexamples            |     | 80  |
|                                                       | Componentsofanotificationmessage       |     | 81  |
|                                                       | Componentsofatopic                     |     | 81  |
| Example:Browser-basedWebSocketconnection              |                                        |     | 82  |
|                                                       | Abouttheexample                        |     | 82  |
|                                                       | Examplescreen                          |     | 83  |
|                                                       | ExampleHTMLsource                      |     | 83  |
| Example:Gettinginformationaboutcurrentsubscribers     |                                        |     | 85  |
| Troubleshooting                                       |                                        |     | 87  |
| Generaltroubleshootingtips                            |                                        |     | 87  |
|                                                       | Connectivity                           |     | 87  |
|                                                       | Resources,attributes,andbehaviors      |     | 87  |
|                                                       | GET,PUT,POST,andDELETEmethods          |     | 87  |
|                                                       | Hardwareandotherfeatures               |     | 89  |
| RESTAPIresponsecodes                                  |                                        |     | 89  |
| Error"'admin'passwordisnotset"                        |                                        |     | 90  |
| Error"certificateverifyfailed"returnedfromcurlcommand |                                        |     | 91  |
...
HTTP404error"Objectnotfound"onobjectwith"ports/"or"interfaces/"inURIPath 94
...
AOS-CX 10.08 REST API Guide | (4100i, 6xxx, 8xxx Switch Series)
...
The REST API versions supported on the AOS-CX switches are v1, v10.04, and v10.08. The REST API version
...
The REST depth parameter for v10.04 and later has a default of 1 and a range of 1 through 4. The REST
depth=1 parameter for v10.04 and later is equivalent to the REST v1 depth=0, and so on.
...
Introduction to the AOS-CX REST API | 16
...
Bydefault,8320,8325,8360,and8400SwitchSerieshaveanHTTPSserverenabledonthemgmtVRF.
...
Subscriptionthrottlingcanalsobeusedtohandlenotificationsforresourceattributesthatonlyprovide
interval-basednotifications,knownason-demandattributes.
Showingasubscriptionforanon-demandattributeswithanintervalof10seconds:
{
| "type":     | "subscribe", |     |     |     |
| ----------- | ------------ | --- | --- | --- |
| "interval": | 10,          |     |     |     |
...
In Figure2,Subscriptionthrottlingnotificationsforon-demandattributes,thesystemsentanotification
fortheon-demandattributesduringtheintervalspecifiedintheexampleabove.
| Figure2 Subscriptionthrottlingnotificationsforon-demandattributes |             |         |     |     |
| ----------------------------------------------------------------- | ----------- | ------- | --- | --- |
...
| -------- | -------------- | --- | ------- | ------- |
AOS-CXreal-timenotificationssubsystem|78
...
operationresponseisreturnedifyouattemptaDELETErequestonthesystemresource.
Invalid
Action
...
A request was made with an URI that contains rest/v10.xx/ and ports/ or interfaces/ in the URI path,
...
accessed through the REST v10.04 and later API.

...
| VLANcommands                        |                                               | 43  |
3
AOS-CX10.09Layer-2BridgingGuide| 8320,8325,8360SwitchSeries

|                                       | description                           | 43  |
| ------------------------------------- | ------------------------------------- | --- |
|                                       | vlanname                              | 44  |
|                                       | showcapacities-statusvlan-count       | 45  |
|                                       | showcapacitiessvi-count               | 45  |
|                                       | showcapacitiesvlan-count              | 46  |
|                                       | showcapacities-statusvlan-translation | 46  |
|                                       | showsysteminternal-vlan-range         | 47  |
|                                       | showvlan                              | 48  |
|                                       | showvlanport                          | 49  |
|                                       | showvlansummary                       | 50  |
|                                       | showvlantranslation                   | 50  |
|                                       | showvlantranslationpending            | 52  |
|                                       | showvlanvoice                         | 53  |
|                                       | shutdown                              | 53  |
|                                       | systeminternal-vlan-range             | 54  |
|                                       | systemvlan-client-presence-detect     | 55  |
...
AOS-CX 10.09 Layer-2 Bridging Guide | 8320, 8325, 8360 Switch Series

5

|                                 | spanning-treemode                       | 152 |
| ------------------------------- | --------------------------------------- | --- |
|                                 | spanning-treeport-priority              | 153 |
|                                 | spanning-treeport-type                  | 154 |
|                                 | spanning-treepriority                   | 155 |
|                                 | spanning-treeroot-guard                 | 156 |
|                                 | spanning-treerpvst-filter               | 157 |
|                                 | spanning-treerpvst-guard                | 158 |
|                                 | spanning-treerpvst-mstpinterconnectvlan | 159 |
|                                 | spanning-treetcn-guard                  | 159 |
|                                 | spanning-treetransmit-hold-count        | 160 |
|                                 | spanning-treetrap                       | 161 |
| MVRP                            |                                         | 164 |
| MVRPfunctionalityandlimitations |                                         | 164 |
| MRPmessages                     |                                         | 165 |
|                                 | Joinmessage                             | 165 |
|                                 | Newmessage                              | 165 |
|                                 | Leavemessage                            | 165 |
...
| MVRPscenario2                   |                                         | 171 |
| MVRPcommands                    |                                         | 178 |
|                                 | clearmvrpstatistics                     | 178 |
|                                 | mvrp                                    | 179 |
|                                 | mvrpregistration                        | 179 |
|                                 | mvrptimer                               | 180 |
|                                 | showmvrpconfig                          | 181 |
|                                 | showmvrpstate                           | 182 |
|                                 | showmvrpstatistics                      | 183 |
| UDLD                            |                                         | 185 |
| ConfiguringUDLD                 |                                         | 186 |
| UDLDscenario                    |                                         | 187 |
| UDLDcommands                    |                                         | 188 |
|                                 | clearudldstatistics                     | 188 |
|                                 | showudld                                | 189 |
|                                 | udld                                    | 191 |
|                                 | udldinterval                            | 192 |
|                                 | udldmode                                | 194 |
|                                 | udldretries                             | 196 |
| Private                         | VLAN                                    | 197 |
| PrivateVLANcommands             |                                         | 201 |
|                                 | diagnostics                             | 201 |
|                                 | private-vlan                            | 201 |
|                                 | private-vlanport-type                   | 202 |
|                                 | showcapacitiesprivate-vlan              | 203 |
|                                 | showcapacities-statusprivate-vlan       | 204 |
|                                 | showprivate-vlan                        | 205 |
|                                 | showprivate-vlanassociation             | 206 |
|                                 | showprivate-vlaninconsistency           | 207 |
|                                 | showprivate-vlanport-type               | 208 |
|                                 | showrunning-configurationprivate-vlan   | 209 |
|                                 | showtechprivate-vlan                    | 210 |
Contents|6

| Support               | and Other          | Resources | 213 |
| --------------------- | ------------------ | --------- | --- |
| AccessingArubaSupport |                    |           | 213 |
| AccessingUpdates      |                    |           | 214 |
|                       | ArubaSupportPortal |           | 214 |
|                       | MyNetworking       |           | 214 |
| WarrantyInformation   |                    |           | 214 |
| RegulatoryInformation |                    |           | 214 |
| DocumentationFeedback |                    |           | 215 |
7
AOS-CX10.09Layer-2BridgingGuide| 8320,8325,8360SwitchSeries
...
switch#
|              | show mac-address-table |       | interface | 1/1/1     |
| ------------ | ---------------------- | ----- | --------- | --------- |
| MAC age-time |                        | : 300 | seconds   |           |
| Number       | of MAC addresses       | : 1   |           |           |
...
AningresstaggedframewithVLANIDof6arrivesoninterface1/1/13.Theswitchacceptsthisframeand
n
...
| Accessinterfacewith:     | 1. Untagged     | 1. UntaggedonVLANX |
VLANID=X
...
| AOS-CX |     |     | PVOS |     |     |     | Comware |     |     |
| ------ | --- | --- | ---- | --- | --- | --- | ------- | --- | --- |
Notdirectlysupportedin
VLANs|29

| interface  | 1/1/1     |     |                        |     |                             |        |     |     |
| ---------- | --------- | --- | ---------------------- | --- | --------------------------- | ------ | --- | --- |
|            |           |     | Notdirectlysupportedin |     | Comware.Apossibleworkaround |        |     |     |
| no routing |           |     | PVOS.Scenario1isa      |     | is:                         |        |     |     |
...
Sameasscenario1,butallowsuntagged traffic. port link-type hybrid
| trafficonVLAN10aswell. |     |     |     |     | port | hybrid | protocol-vlan |     |
| ---------------------- | --- | --- | --- | --- | ---- | ------ | ------------- | --- |
vlan 10
...
Whenprotocol-mappedVLANsareconfigured,untaggedpacketsthatareingressingarecheckedforthe
n
protocoltypeandswitchedaccordingtotheprotocol-mappedVLANconfigurationforthatprotocolon
theinterface.
n Iftherearenoprotocol-mappedVLANsconfigured,alluntaggedpacketsareswitchedaspartoftheport-
...
On the Aruba 8360 Switch Series, If VLAN translations is configured, the trunk allowed list for the VLANs is
not honored. Only VLANs that are present as translation VLANs in VT rules, and the native VLAN of the port
are respected. Packets that ingress the port with VLANs other than those configured for VLAN translation,
are dropped.

On the Aruba 8320, 8325, Switch Series, If VLAN translations is configured, VLAN trunk allowed VLANs are
respected and traffic is allowed.
...
(Layer 2) interfaces. All interfaces are non-routed (Layer 2) by default when created. Use routing and no
routing commands to move ports between Layer 3 and Layer 2 interfaces; this makes the port an access
port in VLAN 1 by default.
...
| 3. Disableroutingwiththecommandno |     |     | routing. |     |
| --------------------------------- | --- | --- | -------- | --- |
4. AssignthenativeVLANIDwiththecommandvlan trunk native.Iftaggingisrequiredforthenative
...
VLAN100carriestagged/untaggedtrafficfromtheserverandonlyuntaggedtraffictotheserver.
n
Procedure
...
Description
ConfigurestheVLANrangereservedforinternaluseforroute-onlyportsandLAGs.TheinternalVLANrange
cannotincludeanyVLANsthatarealreadyinuse.
IfthenumberofinternalVLANsislessthanthenumberofroute-onlyportsandLAGs,someportswillbe
blockedandunabletobeused.WhentheinternalVLANrangeismodified,trafficonroute-onlyportsand
LAGsisbrieflyinterruptedwhiletheyaremovedtothenewrange.
...
| ---- | --- | ----------------------------- |
confirm Automaticallyacknowledgewarningandskipconfirmationprompt.
Examples
...
configured with vlan trunk allowed all. By default, dynamic VLANs are not included in the trunk allowed
list. This command is used at the system-level.
...
no vlan <VLAN-LIST>
Description
CreatesaVLANandchangestotheconfig-vlan-idcontextfortheVLAN.Bydefault,theVLANisenabled.
TodisableaVLAN,usetheshutdowncommand.
IfthespecifiedVLANexists,thiscommandchangestotheconfig-vlan-idcontextfortheVLAN.Ifarange
ofVLANsisspecified,thecontextdoesnotchange.
...
ProtocolVLANshouldbedifferentfromaccessVLANs.
n
VLANshouldbeconfiguredontheswitch.
n
...
OntheAruba8360SwitchSeries:TrafficfortranslatedVLANsandnativeVLANisallowed,andVLANswhich
arepartoftheVLANtrunkallowedlistareblocked.
OntheAruba8320,8325SwitchSeries:AlongwithtranslatedandnativeVLANs,VLANtrunkallowedVLANs
arealsorespectedandtrafficisallowed.
...
| <VLAN-2>  |     |     | SpecifiesthenumberofatranslatedVLAN.Range:1-4040. |
Usage
...
Foragivenport,VLANtranslationcannotbeappliedifthereareanyPrivate-VLAN(PVLAN)configuration
n
(s)ontheswitch(appliestoAruba8360SwitchSeries).VLANtranslationandPVLANsaremutually
exclusivefeatures.
Examples
...
Ifanactionisconfiguredafteraloopisdetected,thenthenewactiononlytakeseffectafterthere-enable
timerexpires.Tohavetheactiontakeeffectimmediately,disableandthenre-enableloopprotect.
...
aneventlogmessage.
tx-disable
Theportthattransmittedtheloopdetectionpacketisdisabled.
...
mode as RPVST+ on a switch and then enabling spanning tree automatically creates a spanning tree instance
for each VLAN on the switch. Configuration with default settings is automatic, and in many cases does not
require any adjustments. This includes operation with spanning tree regions in your network running STP,
MSTP, or RSTP.
...
1Gbpslinkspeedequalsapathcostof20,000.
n
...
<VLAN-ID>
SpecifiestheVLAN IDforthetopologychangetrap.Range:1to
4094.
...
| --------- | --- | --- | --- | --- | ----------- | --- |
<DELAY-IN-SECS>
Specifiestheforwarddelaytimeinseconds.Default:15seconds.
Range:4-30.
Examples
...
100Mbpslinkspeedequalsapathcostof200000.
n
...
| --------- | --- | ----------- |
<HOP-COUNT>
Specifiesthemaximumnumberofhops.Range:1to40.Default:
20.
Examples
...
| Parameter |     |     |     | Description |     |
| --------- | --- | --- | --- | ----------- | --- |
<PRIORITY-MULTIPLIER> Specifiestheportpriorityasamultiplier.Default:8,exceptforLAG
interfaceswherethedefaultis4.Range:0to15.
...
admin-network Specifiestheporttypeasadministrativenetwork.Whenthisoption
154
| AOS-CX10.09Layer-2BridgingGuide| |     |     | 8320,8325,8360SwitchSeries |     |     |
| -------------------------------- | --- | --- | -------------------------- | --- | --- |
...
Enabling SNMP notification when a new root is elected on any MST
instance on the switch.

Enabling SNMP notification when a topology change event occurs
in the specified MST instance on the switch.

Specifies the instance ID for the topology change trap. Range: 0 to
64.
...
Enabling SNMP notification when the root-guard finds the port
inconsistent for any MST instance on the switch.

loop-guard-inconsistency

Enabling SNMP notification when the loop-guard finds the port
inconsistent for any MST instance on the switch.
...
Example
Thisexamplecreatesthefollowingconfiguration:
EnablesUDLDoninterface1/1/1.
n
| SetstheUDLDmodetorfc5171 |     | aggressive. |     |     |     |
| ------------------------ | --- | ----------- | --- | --- | --- |
n
...
Switch mode can be configured to support under 100ms (8325) unidirectional link detection times.
...
scale.Thedetectiontimecolumnisthetotaldetectiontimethatisachievedwiththosesettings.Formore
than16links,theintervalmustbesetto200msorhigher.
...
Applies only to the Aruba 8325, and 8360 Switch Series.
...
PVLAN with VXLAN applies only to the 8325, and 8360 Switch Series.
...
| Platforms | Commandcontext |     | Authority |     |     |
| --------- | -------------- | --- | --------- | --- | --- |
8360 config-vlan-<VLAN-ID> Administratorsorlocalusergroupmemberswithexecutionrights
forthiscommand.

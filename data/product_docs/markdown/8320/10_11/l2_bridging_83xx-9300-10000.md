...
|                                     | description                                   | 43  |
3
AOS-CX10.11Layer-2BridgingGuide| 83xx,9300,10000SwitchSeries
...
| STPsupportedplatformsandscale      |                                         |       | 117 |
|                                    | Scale                                   |       | 117 |
| MSTPprotocolandfeaturedetails      |                                         |       | 117 |
|                                    | MSTPkeyconcepts                         |       | 118 |
| MSTPconfigurationtasks             |                                         |       | 121 |
| MSTPconsiderationsandbestpractices |                                         |       | 122 |
| MSTPusecases                       |                                         |       | 123 |
|                                    | MSTPusecase:Preventingloops             |       | 123 |
|                                    | MSTPusecase:Deterministicrootbridges    |       | 126 |
|                                    | SwitchAconfiguration                    |       | 127 |
|                                    | SwitchBconfiguration                    |       | 127 |
|                                    | SwitchCandDconfiguration                |       | 128 |
|                                    | Checkingtheconfiguration                |       | 128 |
|                                    | Observeportbehaviorandstate             |       | 129 |
|                                    | MSTPusecase:BPDUprotection              |       | 131 |
|                                    | MSTPusecase:Rootprotection              |       | 133 |
|                                    | MSTPusecase:Spanningtreeonedgeports     |       | 136 |
| MSTPcommands                       |                                         |       | 139 |
|                                    | clearspanning-treestatistics            |       | 139 |
|                                    | showspanning-tree                       |       | 139 |
|                                    | showspanning-treedetail                 |       | 140 |
|                                    | showspanning-treeinconsistent-ports     |       | 142 |
|                                    | showspanning-treemst                    |       | 143 |
|                                    | showspanning-treemst-config             |       | 145 |
|                                    | showspanning-treemstdetail              |       | 146 |
|                                    | showspanning-treemst<INSTANCE-ID>       |       | 150 |
|                                    | showspanning-treemst<INSTANCE-ID>detail |       | 151 |
|                                    | showspanning-treemstinterface           |       | 152 |
|                                    | showspanning-treesummaryport            |       | 153 |
5
AOS-CX10.11Layer-2BridgingGuide| 83xx,9300,10000SwitchSeries
...
| --------------------------------- | --------------------------------------- | --------- | --- |
|                                   | spanning-treebpdu-guardtimeout          |           | 216 |
|                                   | spanning-treeextend-system-id           |           | 217 |
|                                   | spanning-treeignore-pvid-inconsistency  |           | 217 |
|                                   | spanning-treelink-type                  |           | 219 |
|                                   | spanning-treemode                       |           | 219 |
|                                   | spanning-treepathcost-type              |           | 220 |
|                                   | spanning-treerpvst-mstpinterconnectvlan |           | 221 |
|                                   | spanning-treetcn-guard                  |           | 222 |
|                                   | spanning-treevlan                       |           | 223 |
|                                   | spanning-treevlancost                   |           | 224 |
|                                   | spanning-treevlanport-priority          |           | 225 |
...
|                                   | private-vlan                            |           | 246 |
|                                   | private-vlanport-type                   |           | 248 |
|                                   | showcapacitiesprivate-vlan              |           | 249 |
...
AOS-CX 10.11 Layer-2 Bridging Guide | 83xx, 9300, 10000 Switch Series
...
On the Aruba 8360 Switch Series, If VLAN translations is configured, the trunk allowed list for the VLANs
...
On the Aruba 8360 Switch Series: Traffic for translated VLANs and native VLAN is allowed, and VLANs
which are part of the VLAN trunk allowed list are blocked.
...
configuration(s) on the switch (applies to Aruba 8360 Switch Series). VLAN translation and PVLANs are
...
Spanning tree protocols (STP) | 184
...
Spanning tree protocols (STP) | 186
...
Spanning tree protocols (STP) | 190
...
Spanning tree protocols (STP) | 228
...
Applies only to the Aruba 8325, 8100, 8360, 9300, and 10000 Switch Series.
...
| 10000 |            | config-pa-role |              |     | forthiscommand. |     |     |     |
| ----- | ---------- | -------------- | ------------ | --- | --------------- | --- | --- | --- |
...
PrimaryVLAN’sIGMPsnoopingconfigurationisapplied
n

...
| AAA events                          |               |            |              | 13  |
| Accounting                          | events        |            |              | 15  |
| ACLs                                | events        |            |              | 16  |
| Alarm                               | events        |            |              | 17  |
| ARP security                        | events        |            |              | 20  |
| ASIC table                          | full error    | for L3PD   | events       | 21  |
| BFD events                          |               |            |              | 24  |
| BGP events                          |               |            |              | 29  |
| Bluetooth                           | Management    | events     |              | 34  |
| CDP events                          |               |            |              | 36  |
| Certificate                         | management    | events     |              | 38  |
| Config                              | Management    | events     |              | 43  |
| Connectivity                        | Fault         | Management | (CFM) events | 45  |
| Console                             | events        |            |              | 46  |
| Container                           | manager       | events     |              | 47  |
| CoPP                                | events        |            |              | 48  |
| CPU_RX                              | events        |            |              | 51  |
| Credential                          | Manager       | events     |              | 52  |
3
AOS-CX10.12EventLogMessageReferenceGuide| (AllSwitchSeries)

| Device     | fingerprinting |                |            | events |          |        |        | 54  |
| ---------- | -------------- | -------------- | ---------- | ------ | -------- | ------ | ------ | --- |
| DHCP       | Relay          | events         |            |        |          |        |        | 55  |
| DHCP       | server         | events         |            |        |          |        |        | 56  |
| DHCPv4     |                | snooping       | events     |        |          |        |        | 59  |
| DHCPv6     |                | Relay          | events     |        |          |        |        | 64  |
| DHCPv6     |                | snooping       | events     |        |          |        |        | 65  |
| Dicovery   |                | and Capability |            |        | Exchange | (DCBx) | events | 70  |
| DNS        | client         | events         |            |        |          |        |        | 72  |
| Dot1x      | supplicant     |                | events     |        |          |        |        | 73  |
| DPSE       | events         |                |            |        |          |        |        | 74  |
| ECMP       | events         |                |            |        |          |        |        | 76  |
| ERPS       | events         |                |            |        |          |        |        | 78  |
| EVPN       | events         |                |            |        |          |        |        | 82  |
| External   |                | Storage        | events     |        |          |        |        | 86  |
| Fan events |                |                |            |        |          |        |        | 88  |
| Fault      | monitor        |                | events     |        |          |        |        | 93  |
| Firmware   |                | Update         | events     |        |          |        |        | 95  |
| Hardware   |                | Health         | Monitor    |        | events   |        |        | 97  |
| Hardware   |                | switch         | controller |        | sync     | events |        | 100 |
| HTTPS      | Server         | events         |            |        |          |        |        | 103 |
| In-System  |                | Programming    |            |        | events   |        |        | 105 |
| Interface  |                | events         |            |        |          |        |        | 108 |
| Internal   |                | storage        | events     |        |          |        |        | 110 |
| IP source  |                | lockdown       |            | events |          |        |        | 111 |
| IP tunnels |                | events         |            |        |          |        |        | 113 |
| IP-SLA     | events         |                |            |        |          |        |        | 117 |
| IPv6       | Router         | Advertisement  |            |        | events   |        |        | 119 |
Contents|4

| IRDP          | events      |            |         |               |        |        | 124 |
| ------------- | ----------- | ---------- | ------- | ------------- | ------ | ------ | --- |
| Job scheduler |             | events     |         |               |        |        | 125 |
| L3 Encap      |             | capacity   | events  |               |        |        | 126 |
| L3 Resource   |             | Manager    |         | events        |        |        | 127 |
| LACP          | events      |            |         |               |        |        | 128 |
| LAG           | events      |            |         |               |        |        | 134 |
| Layer         | 3 Interface |            | events  |               |        |        | 137 |
| LED events    |             |            |         |               |        |        | 144 |
| LLDP          | events      |            |         |               |        |        | 145 |
| Loop          | Protect     | events     |         |               |        |        | 148 |
| Loopback      |             | events     |         |               |        |        | 150 |
| MAC           | address     | management |         |               | events |        | 151 |
| MAC           | Address     | mode       |         | configuration |        | events | 153 |
| MACsec        | events      |            |         |               |        |        | 154 |
| Management    |             | events     |         |               |        |        | 156 |
| MDNS          | events      |            |         |               |        |        | 157 |
| MGMD          | events      |            |         |               |        |        | 158 |
| Mirroring     |             | events     |         |               |        |        | 163 |
| Module        | events      |            |         |               |        |        | 165 |
| MPLS          | events      |            |         |               |        |        | 173 |
| MSDP          | events      |            |         |               |        |        | 174 |
| Multicast     |             | Traffic    | Manager |               | events |        | 176 |
| Multiple      | spanning    |            | tree    | protocol      |        | events | 177 |
| MVRP          | events      |            |         |               |        |        | 181 |
| NAE           | Agents      | events     |         |               |        |        | 183 |
| NAE           | events      |            |         |               |        |        | 184 |
| NAE           | script      | generation |         | events        |        |        | 187 |
5
AOS-CX10.12EventLogMessageReferenceGuide| (AllSwitchSeries)

| NAE Scripts     | events        |          |               |        | 188 |
| --------------- | ------------- | -------- | ------------- | ------ | --- |
| ND snooping     | events        |          |               |        | 191 |
| NDM             | events        |          |               |        | 193 |
| NTP events      |               |          |               |        | 200 |
| OSPFv2          | events        |          |               |        | 202 |
| OSPFv3          | events        |          |               |        | 205 |
| Password        | Reset         | events   |               |        | 207 |
| PIM events      |               |          |               |        | 208 |
| Policies        | events        |          |               |        | 215 |
| Port access     | events        |          |               |        | 216 |
| Port access     | group         | based    | policy events |        | 219 |
| Port access     | roles         | events   |               |        | 221 |
| Port events     |               |          |               |        | 222 |
| Port security   | events        |          |               |        | 224 |
| Port Statistics | events        |          |               |        | 225 |
| Power           | events        |          |               |        | 226 |
| Power           | over Ethernet | events   |               |        | 231 |
| PTP events      |               |          |               |        | 240 |
| QoS ASIC        | Provider      | events   |               |        | 244 |
| Quality         | of Service    | events   |               |        | 246 |
| Rapid           | per VLAN      | Spanning | Tree Protocol | events | 247 |
| RBAC            | events        |          |               |        | 250 |
| Redundant       | Management    |          | events        |        | 251 |
| Replication     | Manager       | events   |               |        | 253 |
| REST            | events        |          |               |        | 254 |
| Self Test       | events        |          |               |        | 266 |
| sFlow           | events        |          |               |        | 267 |
Contents|6

| SFTP           | Client     | events  |           |           |              | 274 |
| -------------- | ---------- | ------- | --------- | --------- | ------------ | --- |
| Smartlink      |            | events  |           |           |              | 275 |
| SNMP           | events     |         |           |           |              | 276 |
| SSH client     |            | events  |           |           |              | 279 |
| SSH server     |            | events  |           |           |              | 280 |
| Supportability |            |         | events    |           |              | 283 |
| SYS events     |            |         |           |           |              | 290 |
| SYSMON         |            | events  |           |           |              | 292 |
| TCAM           | events     |         |           |           |              | 294 |
| Telnet         | server     |         | events    |           |              | 298 |
| Temperature    |            |         | events    |           |              | 300 |
| Time           | management |         |           | events    |              | 303 |
| Transceiver    |            |         | events    |           |              | 304 |
| UDLD           | events     |         |           |           |              | 307 |
| UDP            | Broadcast  |         | Forwarder |           | events       | 309 |
| UFD            | events     |         |           |           |              | 310 |
| User           | management |         |           | events    |              | 311 |
| User-based     |            | tunnels |           | events    |              | 313 |
| Virtual        | Switching  |         |           | Extension | (VSX) events | 321 |
| Virtual        | Switching  |         |           | Framework | (VSF) events | 329 |
| VLAN           | events     |         |           |           |              | 339 |
| VLAN           | Interface  |         | events    |           |              | 343 |
| VRF events     |            |         |           |           |              | 344 |
| VRF Manager    |            |         | events    |           |              | 345 |
| VRRP           | events     |         |           |           |              | 346 |
| VSX Sync       |            | events  |           |           |              | 352 |
| VXLAN          | agent      |         | events    |           |              | 353 |
7
AOS-CX10.12EventLogMessageReferenceGuide| (AllSwitchSeries)
...
| AccessingArubaSupport |                    |           | 364 |
| AccessingUpdates      |                    |           | 365 |
|                       | ArubaSupportPortal |           | 365 |
|                       | MyNetworking       |           | 365 |
| Warrantyinformation   |                    |           | 365 |
| RegulatoryInformation |                    |           | 365 |
| Documentationfeedback |                    |           | 366 |
Contents|8
...
AOS-CX 10.12 Event Log Message Reference Guide | (All Switch Series)
...
ASICtablefullerrorforL3PDevents|22
...
Bluetooth Management events | 35
...
| Event       | ID: 7710 |                                            |     |     |     |
Certificatemanagementevents|39
...
Certificatemanagementevents|41
...
Client <mac> on vlan <vid>, port <port> received <client_ip> from server <server_
ip> with lease <lease>. Nameserver: <nameserver_ip>, Gateway:<gateway_ip>.
...
Client received an IP address from DHCP server.
...
Gateway <gateway_ip>, Nameserver: <nameserver_ip>, Lease period <lease>.
...
Client attributes received for DHCP client.
...
Event ID: 8318
Message Client<mac>onvlan<vid>,port<port>received<client_ip>fromserver<server_
ip>withlease<lease>.Nameserver:<nameserver_ip>.
| Category    | DHCPv6snooping                             |     |     |
| ----------- | ------------------------------------------ | --- | --- |
| Severity    | Information                                |     |     |
| Description | ClientreceivedanIPv6addressfromDHCPserver. |     |     |
Event ID: 8319
Message Client<mac>onvlan<vid>,port<port>released<client_ip>.
| Category    | DHCPv6snooping                  |     |     |
| ----------- | ------------------------------- | --- | --- |
| Severity    | Information                     |     |     |
| Description | ClientsentareleasetoDHCPserver. |     |     |
Event ID: 8320
DHCPv6snoopingevents|68
...
Lease period expired for DHCP client.
...
DicoveryandCapabilityExchange(DCBx)events|71
...
HardwareHealthMonitorevents|98
...
Hardwareswitchcontrollersyncevents|101
...
| Event       | ID: 7218 |                                        |     |
In-SystemProgrammingevents|106
...
| ------- | ---------- | ------ | --------------- | ---------------- |
IPv6RouterAdvertisementevents|120
...
IPv6RouterAdvertisementevents|122
...
MACaddressmanagementevents|152
...
| Event | ID: 2010 |     |     |
| ----- | -------- | --- | --- |
Multiplespanningtreeprotocolevents|178
...
Multiplespanningtreeprotocolevents|180
...
Port access group based policy events | 220
...
| Event       | ID: 323 |                                    |     |
Message PSU<name>isnotsupportedbythesystem.PleaseinsertasupportedPSU.Refertothe
InstallationGuideforsupportedconfigurations.
| Category |     | Power |     |
| -------- | --- | ----- | --- |
| Severity |     | Error |     |
...
| Event | ID: 5010 |     |     |     |
| ----- | -------- | --- | --- | --- |
RapidperVLANSpanningTreeProtocolevents|248
...
VirtualSwitchingExtension(VSX)events|322
...
Event ID: 7020
VirtualSwitchingExtension(VSX)events|324
...
| ------- | -------------- | ----- | ------------------------------- |
VirtualSwitchingExtension(VSX)events|326
...
VirtualSwitchingExtension(VSX)events|328
...
VirtualSwitchingFramework(VSF)events|330
...
VirtualSwitchingFramework(VSF)events|332
...
VirtualSwitchingFramework(VSF)events|334
...
| ----- | ------------------- | -------- |
VirtualSwitchingFramework(VSF)events|336
...
Virtual Switching Framework (VSF) events | 338
...
| ----- | ------------------- | --------- |
Zerotouchprovisioningevents|359
...
Event ID: 8723
Zerotouchprovisioningevents|361
...
Zerotouchprovisioningevents|363

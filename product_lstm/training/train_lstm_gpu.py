...
def build_lookup_answers(records: Sequence[Dict[str, object]]) -> Dict[str, List[str]]:
...
def main() -> None:
    ...
    lookup_answers_path = output_dir / "target_lookup_answers.json"
    ...
    lookup_answers = build_lookup_answers(final_records)
    ...
    with lookup_answers_path.open("w", encoding="utf-8") as handle:
        json.dump(lookup_answers, handle, indent=2, ensure_ascii=False)
    ...
    metrics = {
        ...
        "lookup_answers_path": str(lookup_answers_path),

...
DEFAULT_MODEL_DIR = REPO_ROOT / "models" / "product_lstm"
DEFAULT_MODEL_PATH = DEFAULT_MODEL_DIR / "best_model.pt"
DEFAULT_TOKENIZER_PATH = DEFAULT_MODEL_DIR / "tokenizer.pkl"
DEFAULT_LABEL_ENCODER_PATH = DEFAULT_MODEL_DIR / "label_encoder.pkl"
DEFAULT_OUTPUT_DIR = Path(r"C:\Hpe\Train\outputs\product_lstm")
DEFAULT_SEED = 42

...
RELEASE_LSTM_DIR = ROOT_DIR / "release_lstm"
if str(RELEASE_LSTM_DIR) not in sys.path:
    sys.path.insert(0, str(RELEASE_LSTM_DIR))

import torch

import train_release_lstm as base
from product_lstm_utils import (
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a single Product LSTM prediction.")

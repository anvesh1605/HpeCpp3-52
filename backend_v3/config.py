...
# Keep Hugging Face downloads off the small default user cache on C:.
HF_CACHE_HOME = _env_path("HF_HOME", ROOT / ".hf_cache")
os.environ.setdefault("HF_HOME", str(HF_CACHE_HOME))
os.environ.setdefault("HUGGINGFACE_HUB_CACHE", str(HF_CACHE_HOME / "hub"))
os.environ.setdefault("TRANSFORMERS_CACHE", str(HF_CACHE_HOME / "transformers"))
